...
const browser_providers_conf_1 = require("../../../browser-providers.conf");
const saucelabs_daemon_1 = require("./saucelabs-daemon");
...
const daemon = new saucelabs_daemon_1.SaucelabsDaemon(username, accessKey, process.env['CIRCLE_BUILD_NUM'], Object.values(browser_providers_conf_1.customLaunchers), parallelExecutions, sauceConnect, { tunnelIdentifier });
