...
exports.AppModule = exports.TreeComponent = void 0;
...
let AppModule = (() => {
    let _classDecorators = [(0, core_1.NgModule)({ imports: [platform_browser_1.BrowserModule], bootstrap: [TreeComponent], declarations: [TreeComponent] })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
