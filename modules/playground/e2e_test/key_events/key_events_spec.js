...
const Key = protractor_1.protractor.Key;
describe('key_events', function () {
    ...
    it('should display correct key names', function () {
        const firstArea = protractor_1.element.all(protractor_1.by.css('.sample-area')).get(0);
    ...
    it('should correctly react to the specified key', function () {
        const secondArea = protractor_1.element.all(protractor_1.by.css('.sample-area')).get(1);
