...
exports.ExampleModule = exports.RelativeApp = void 0;
const core_1 = require("@angular/core");
const platform_browser_1 = require("@angular/platform-browser");
const platform_browser_dynamic_1 = require("@angular/platform-browser-dynamic");
const my_cmp_1 = require("./app/my_cmp");
let RelativeApp = (() => {
    ...
    let _classThis;
    var RelativeApp = _classThis = class {
    };
    __setFunctionName(_classThis, "RelativeApp");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        RelativeApp = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RelativeApp = _classThis;
})();
exports.RelativeApp = RelativeApp;
let ExampleModule = (() => {
    let _classDecorators = [(0, core_1.NgModule)({
            declarations: [RelativeApp, my_cmp_1.MyCmp],
