...
const animate_app_1 = require("./app/animate-app");
let ExampleModule = (() => {
    let _classDecorators = [(0, core_1.NgModule)({ declarations: [animate_app_1.AnimateApp], bootstrap: [animate_app_1.AnimateApp], imports: [animations_1.BrowserAnimationsModule] })];
