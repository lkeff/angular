...
const jsonp_comp_1 = require("./app/jsonp_comp");
let ExampleModule = (() => {
    let _classDecorators = [(0, core_1.NgModule)({
            bootstrap: [jsonp_comp_1.JsonpCmp],
            declarations: [jsonp_comp_1.JsonpCmp],
            imports: [platform_browser_1.BrowserModule, http_1.HttpClientModule, http_1.HttpClientJsonpModule],
        })];
