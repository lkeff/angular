...
exports.ExampleModule = exports.TodoApp = void 0;
const core_1 = require("@angular/core");
const platform_browser_1 = require("@angular/platform-browser");
const platform_browser_dynamic_1 = require("@angular/platform-browser-dynamic");
const TodoStore_1 = require("./app/TodoStore");
let TodoApp = (() => {
    ...
    let _classThis;
    var TodoApp = _classThis = class {
        constructor(todoStore, factory) {
...
let ExampleModule = (() => {
    let _classDecorators = [(0, core_1.NgModule)({ declarations: [TodoApp], bootstrap: [TodoApp], imports: [platform_browser_1.BrowserModule] })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
