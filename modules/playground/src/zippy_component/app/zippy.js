...
let Zippy = (() => {
    ...
    var Zippy = _classThis = class {
        ...
        constructor() {
            ...
            this.open = (__runInitializers(this, _title_extraInitializers), __runInitializers(this, _open_initializers, new core_1.EventEmitter()));
            this.close = (__runInitializers(this, _open_extraInitializers), __runInitializers(this, _close_initializers, new core_1.EventEmitter()));
            __runInitializers(this, _close_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "Zippy");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _title_decorators = [(0, core_1.Input)()];
        _open_decorators = [(0, core_1.Output)()];
        ...
        Zippy = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Zippy = _classThis;
})();
exports.Zippy = Zippy;
