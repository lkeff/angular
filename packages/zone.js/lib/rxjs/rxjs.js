...
function patchRxJs(Zone) {
    Zone.__load_patch('rxjs', (global, Zone, api) => {
        ...
        const patchObservable = function () {
            const ObservablePrototype = rxjs_1.Observable.prototype;
        ...
        api.patchMethod(rxjs_1.Observable.prototype, 'lift', (delegate) => (self, args) => {
        ...
        const patchSubscriber = function () {
            const next = rxjs_1.Subscriber.prototype.next;
            const error = rxjs_1.Subscriber.prototype.error;
            const complete = rxjs_1.Subscriber.prototype.complete;
