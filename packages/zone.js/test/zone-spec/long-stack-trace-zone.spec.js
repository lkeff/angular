...
const defineProperty = Object[(0, utils_1.zoneSymbol)('defineProperty')] || Object.defineProperty;
describe('longStackTraceZone', (0, test_util_1.ifEnvSupports)(test_util_1.isSupportSetErrorStack, function () {
    let log;
    let lstz;
    ...
    function expectElapsed(stack, expectedCount) {
        try {
    ...
    it('should produce long stack traces for optimized eventTask', (0, test_util_1.ifEnvSupports)(() => utils_1.isBrowser, function () {
        lstz.run(function () {
    ...
    it('should not overwrite long stack traces data for different optimized eventTasks', (0, test_util_1.ifEnvSupports)(() => utils_1.isBrowser, function () {
        lstz.run(function () {
            const button = document.createElement('button');
            const clickEvent = document.createEvent('Event');
            clickEvent.initEvent('click', true, true);
            ...
            setTimeout(function () {
                setTimeout(function () {
                    ...
                    promise.catch(function (error) {
                        ...
                        const longStackFrames = longStackTraceZoneSpec.getLongStackTrace(error);
