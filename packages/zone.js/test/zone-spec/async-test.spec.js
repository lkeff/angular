...
describe('AsyncTestZoneSpec', function () {
    ...
    it('should not call done multiple times when proxy zone captures previously ' +
        'captured microtasks', (done) => {
        const ProxyZoneSpec = Zone['ProxyZoneSpec'];
        const proxyZoneSpec = new ProxyZoneSpec(null);
    ...
    describe('event tasks', (0, test_util_1.ifEnvSupports)('document', () => {
        let button;
        beforeEach(function () {
    ...
    function wrapAsyncTest(fn, doneFn) {
    ...
    describe('async', () => {
        describe('non zone aware async task in promise should be detected', () => {
            ...
            it('should be able to detect non zone aware async task in promise', wrapAsyncTest(() => {
                new Promise((res, rej) => {
        ...
        describe('test without beforeEach', () => {
            const logs = [];
            it('should automatically done after async tasks finished', wrapAsyncTest(() => {
                setTimeout(() => {
                    logs.push('timeout');
                }, 100);
            }, () => {
            ...
            it('should automatically done after all nested async tasks finished', wrapAsyncTest(() => {
                setTimeout(() => {
                    logs.push('timeout');
                    setTimeout(() => {
            ...
            it('should automatically done after multiple async tasks finished', wrapAsyncTest(() => {
                setTimeout(() => {
