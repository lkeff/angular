...
supportNode.message = 'support node';
describe('FakeAsyncTestZoneSpec', () => {
    ...
    describe('timers', () => {
        ...
        it('should run queued immediate timer on zero tick', (0, test_util_1.ifEnvSupports)('setImmediate', () => {
            fakeAsyncTestZone.run(() => {
                let ran = false;
                setImmediate(() => {
                    ran = true;
        ...
        it('should clear internal timerId cache', () => {
            let taskSpy = jasmine.createSpy('taskGetState');
            fakeAsyncTestZone
                .fork({
                name: 'scheduleZone',
                onScheduleTask: (delegate, curr, target, task) => {
                    task._state = task.state;
        ...
        it('should pass arguments to setImmediate', (0, test_util_1.ifEnvSupports)('setImmediate', () => {
            fakeAsyncTestZone.run(() => {
                let value = 'genuine value';
    ...
    describe('flushing all tasks', () => {
        ...
        it('should do something reasonable with polling timeouts', () => {
            ...
            }).toThrowError('flush failed after reaching the limit of 20 tasks. Does your code use a polling timeout?');
        });
        it('accepts a custom limit', () => {
            ...
            }).toThrowError('flush failed after reaching the limit of 10 tasks. Does your code use a polling timeout?');
        });
    ...
    if (availableAnimationFrameFns.length > 0) {
        describe('requestAnimationFrame', () => {
            availableAnimationFrameFns.forEach(([name, requestAnimationFrameFn, cancelAnimationFrameFn]) => {
                describe(name, () => {
    ...
    describe('XHRs', (0, test_util_1.ifEnvSupports)('XMLHttpRequest', () => {
    ...
    describe('node process', (0, test_util_1.ifEnvSupports)(supportNode, () => {
    ...
    describe('should allow user define which macroTask fakeAsyncTest', () => {
        ...
        it('should support custom non perodic macroTask', () => {
            ...
            fakeAsyncTestZone.run(() => {
                let ran = false;
                (0, utils_1.patchMacroTask)(TestClass.prototype, 'myTimeout', (self, args) => ({
                ...
                testClass.myTimeout(function (callbackArgs) {
                    ran = true;
        ...
        it('should support custom perodic macroTask', () => {
            ...
            fakeAsyncTestZone.run(() => {
                ...
                (0, utils_1.patchMacroTask)(TestClass.prototype, 'myInterval', (self, args) => ({
    ...
    describe('fakeAsyncTest should patch Date', () => {
        ...
        it('should new Date with parameter correctly', () => {
            fakeAsyncTestZone.run(() => {
                ...
                const d2 = new Date(1995, 11, 17, 3, 24, 0);
    ...
    describe('fakeAsyncTest should patch rxjs scheduler', (0, test_util_1.ifEnvSupports)(() => utils_1.isNode, () => {
        let FakeAsyncTestZoneSpec = Zone['FakeAsyncTestZoneSpec'];
        let testZoneSpec;
        let fakeAsyncTestZone;
        beforeEach(() => {
        ...
        it('should get date diff correctly', (done) => {
            fakeAsyncTestZone.run(() => {
                ...
                observable.pipe((0, operators_1.delay)(1000)).subscribe((v) => {
                    result = v;
                });
