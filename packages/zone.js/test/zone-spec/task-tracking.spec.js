...
describe('TaskTrackingZone', function () {
    let _TaskTrackingZoneSpec = Zone['TaskTrackingZoneSpec'];
    let taskTrackingZoneSpec = null;
    let taskTrackingZone;
    beforeEach(() => {
        taskTrackingZoneSpec = new _TaskTrackingZoneSpec();
        taskTrackingZone = Zone.current.fork(taskTrackingZoneSpec);
    });
    it('should track tasks', (done) => {
    ...
    it('should capture task creation stacktrace', (done) => {
        taskTrackingZone.run(() => {
            ...
            expect(taskTrackingZoneSpec.macroTasks[0]['creationLocation']).toBeTruthy();
        });
    });
