...
describe('setTimeout', function () {
    it('should intercept setTimeout', function (done) {
        ...
        testZone.run(() => {
            const timeoutFn = function () {
                ...
                global[(0, utils_1.zoneSymbol)('setTimeout')](function () {
                    ...
                    expect(wtfMock.log[2]).toContain('# Zone:schedule:macroTask:setTimeout("<root>::ProxyZone::WTF::TestZone"');
                    expect(wtfMock.log[3]).toEqual('< Zone:invoke:unit-test');
                    expect(wtfMock.log[4]).toEqual('> Zone:invokeTask:setTimeout("<root>::ProxyZone::WTF::TestZone")');
    ...
    it('should call native clearTimeout with the correct context', function () {
        ...
        (0, timers_1.patchTimer)(fakeGlobal, 'set', 'clear', 'Timeout');
