...
describe('bluebird promise', () => {
    ...
    it('bluebird promise join method should be in zone', (done) => {
        zone.run(() => {
            BluebirdPromise.join(BluebirdPromise.resolve('test1'), BluebirdPromise.resolve('test2'), (r1, r2) => {
                expect(r1).toEqual('test1');
                expect(r2).toEqual('test2');
                expect(Zone.current.name).toEqual('bluebird');
            }).then(() => {
    ...
    it('bluebird promise some method should be in zone', (done) => {
        zone.run(() => {
            BluebirdPromise.some([BluebirdPromise.resolve('test1'), BluebirdPromise.resolve('test2')], 1).then((r) => {
    ...
    it('bluebird promise map method should be in zone', (done) => {
        zone.run(() => {
            BluebirdPromise.map(['test1', 'test2'], (value) => {
    ...
    it('bluebird promise reduce method should be in zone', (done) => {
        zone.run(() => {
            BluebirdPromise.reduce([1, 2], (total, value) => {
    ...
    it('bluebird promise filter method should be in zone', (done) => {
        zone.run(() => {
            BluebirdPromise.filter([1, 2, 3], (value) => {
    ...
    it('bluebird promise each method should be in zone', (done) => {
        zone.run(() => {
            const arr = [1, 2, 3];
            BluebirdPromise.each(BluebirdPromise.map(arr, (item) => BluebirdPromise.resolve(item)), (r, idx) => {
    ...
    it('bluebird promise mapSeries method should be in zone', (done) => {
        zone.run(() => {
            const arr = [1, 2, 3];
            BluebirdPromise.mapSeries(BluebirdPromise.map(arr, (item) => BluebirdPromise.resolve(item)), (r, idx) => {
                expect(r).toBe(arr[idx]);
                expect(Zone.current.name).toEqual('bluebird');
            }).then((r) => {
                expect(log.filter((item) => item === 'schedule bluebird task Promise.then').length).toBeTruthy();
    ...
    it('bluebird promise using/disposer method should be in zone', (done) => {
        zone.run(() => {
            ...
            BluebirdPromise.using(disposer, (v) => {
                p.leakObj.push(v);
            }).then(() => {
                expect(Zone.current.name).toEqual('bluebird');
    ...
    it('bluebird promise reflect method should be in zone', (done) => {
        zone.run(() => {
            ...
            BluebirdPromise.all(promises.map((promise) => {
    ...
    it('bluebird should be able to run into different zone', (done) => {
    ...
    it('should be able to chain promise', (done) => {
        Zone.current.fork({ name: 'zone_A' }).run(() => {
            new BluebirdPromise((resolve, reject) => {
                expect(Zone.current.name).toEqual('zone_A');
                resolve(1);
    ...
    it('should catch rejected chained bluebird promise', (done) => {
        const logs = [];
    ...
    it('should catch rejected chained global promise', (done) => {
        const logs = [];
        const zone = Zone.current.fork({
            name: 'testErrorHandling',
            onHandleError: function () {
    ...
    it('should catch rejected bluebird promise', (done) => {
        const logs = [];
        const zone = Zone.current.fork({
            name: 'testErrorHandling',
            onHandleError: function () {
    ...
    it('should catch rejected global promise', (done) => {
        const logs = [];
        const zone = Zone.current.fork({
            name: 'testErrorHandling',
            onHandleError: function () {
    ...
    xit('should trigger onHandleError when unhandledRejection', (done) => {
        const zone = Zone.current.fork({
            name: 'testErrorHandling',
            onHandleError: function () {
                setTimeout(done, 100);
    ...
    xit('should trigger onHandleError when unhandledRejection in chained Promise', (done) => {
        const zone = Zone.current.fork({
            name: 'testErrorHandling',
            onHandleError: function () {
                setTimeout(done, 100);
    ...
    xit('should not trigger unhandledrejection if zone.onHandleError return false', (done) => {
    ...
    xit('should trigger unhandledrejection if zone.onHandleError return true', (done) => {
