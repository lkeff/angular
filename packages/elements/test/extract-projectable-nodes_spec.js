...
const extract_projectable_nodes_1 = require("../src/extract-projectable-nodes");
describe('extractProjectableNodes()', () => {
    let elem;
    let childNodes;
    const expectProjectableNodes = (matches) => {
        ...
        expect((0, extract_projectable_nodes_1.extractProjectableNodes)(elem, selectors)).toEqual(expected);
    };
    const test = (matches) => () => expectProjectableNodes(matches);
    beforeEach(() => {
