...
function createCustomElement(component, config) {
    const inputs = (0, utils_1.getComponentInputs)(component, config.injector);
    ...
    const attributeToPropertyInputs = (0, utils_1.getDefaultAttributeToPropertyInputs)(inputs);
