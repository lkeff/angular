...
exports.DOMTestComponentRenderer = void 0;
...
let DOMTestComponentRenderer = (() => {
    ...
    let _classThis;
    let _classSuper = testing_1.TestComponentRenderer;
    var DOMTestComponentRenderer = _classThis = class extends _classSuper {
        constructor(_doc) {
            super();
            this._doc = _doc;
        }
        insertRootElement(rootElId) {
            ...
            const rootElement = (0, common_1.ɵgetDOM)().getDefaultDocument().createElement('div');
    ...
    __setFunctionName(_classThis, "DOMTestComponentRenderer");
    (() => {
        var _a;
