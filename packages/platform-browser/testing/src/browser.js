...
exports.BrowserTestingModule = exports.platformBrowserTesting = void 0;
/**
 * @license
...
const dom_test_component_renderer_1 = require("./dom_test_component_renderer");
/**
 * Platform for testing
 *
 * @publicApi
 */
exports.platformBrowserTesting = (0, core_1.createPlatformFactory)(index_1.platformBrowser, 'browserTesting');
/**
...
let BrowserTestingModule = (() => {
    ...
    let _classThis;
    var BrowserTestingModule = _classThis = class {
    };
    __setFunctionName(_classThis, "BrowserTestingModule");
    (() => {
