...
exports.HeroInMemDataService = void 0;
/**
...
let HeroInMemDataService = (() => {
    let _classDecorators = [(0, core_1.Injectable)()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var HeroInMemDataService = _classThis = class {
        createDb(reqInfo) {
            const heroes = [
                { id: 1, name: 'Windstorm' },
                { id: 2, name: 'Bombasto' },
            ...
            switch (returnType) {
                case 'observable':
                    return (0, rxjs_1.of)(db).pipe((0, operators_1.delay)(10));
                case 'promise':
    ...
    __setFunctionName(_classThis, "HeroInMemDataService");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        HeroInMemDataService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return HeroInMemDataService = _classThis;
})();
exports.HeroInMemDataService = HeroInMemDataService;
