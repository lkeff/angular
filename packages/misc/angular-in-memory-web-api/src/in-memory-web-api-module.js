...
exports.InMemoryWebApiModule = void 0;
const common_1 = require("@angular/common");
const http_1 = require("@angular/common/http");
const core_1 = require("@angular/core");
const http_client_in_memory_web_api_module_1 = require("./http-client-in-memory-web-api-module");
const interfaces_1 = require("./interfaces");
let InMemoryWebApiModule = (() => {
    let _classDecorators = [(0, core_1.NgModule)()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var InMemoryWebApiModule = _classThis = class {
        /**
            ...
            return {
                ...
                providers: [
                    ...
                    { provide: interfaces_1.InMemoryBackendConfig, useValue: options },
                    {
                        ...
                        useFactory: http_client_in_memory_web_api_module_1.httpClientInMemBackendServiceFactory,
    ...
    __setFunctionName(_classThis, "InMemoryWebApiModule");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        InMemoryWebApiModule = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return InMemoryWebApiModule = _classThis;
})();
