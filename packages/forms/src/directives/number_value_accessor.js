...
exports.NumberValueAccessor = void 0;
const core_1 = require("@angular/core");
const control_value_accessor_1 = require("./control_value_accessor");
const NUMBER_VALUE_ACCESSOR = {
    provide: control_value_accessor_1.NG_VALUE_ACCESSOR,
    useExisting: (0, core_1.forwardRef)(() => NumberValueAccessor),
    multi: true,
};
/**
 * @description
...
let NumberValueAccessor = (() => {
    ...
    var NumberValueAccessor = _classThis = class extends _classSuper {
        /**
    ...
    __setFunctionName(_classThis, "NumberValueAccessor");
    (() => {
        var _a;
