...
exports.CheckboxControlValueAccessor = void 0;
const core_1 = require("@angular/core");
const control_value_accessor_1 = require("./control_value_accessor");
const CHECKBOX_VALUE_ACCESSOR = {
    provide: control_value_accessor_1.NG_VALUE_ACCESSOR,
    useExisting: (0, core_1.forwardRef)(() => CheckboxControlValueAccessor),
    multi: true,
};
/**
 * @description
...
let CheckboxControlValueAccessor = (() => {
    ...
    var CheckboxControlValueAccessor = _classThis = class extends _classSuper {
        /**
    ...
    __setFunctionName(_classThis, "CheckboxControlValueAccessor");
    (() => {
        var _a;
