...
exports.Validators = exports.NG_ASYNC_VALIDATORS = exports.NG_VALIDATORS = void 0;
...
exports.normalizeValidators = normalizeValidators;
exports.composeValidators = composeValidators;
exports.composeAsyncValidators = composeAsyncValidators;
exports.mergeValidators = mergeValidators;
exports.getControlValidators = getControlValidators;
exports.getControlAsyncValidators = getControlAsyncValidators;
exports.makeValidatorsArray = makeValidatorsArray;
exports.hasValidator = hasValidator;
exports.addValidators = addValidators;
exports.removeValidators = removeValidators;
 ...
 * @publicApi
 */
exports.NG_VALIDATORS = new core_1.InjectionToken(ngDevMode ? 'NgValidators' : '');
/**
 * @description
 ...
 * @publicApi
 */
exports.NG_ASYNC_VALIDATORS = new core_1.InjectionToken(ngDevMode ? 'NgAsyncValidators' : '');
/**
...
function minLengthValidator(minLength) {
    return (control) => {
        var _a, _b;
        const length = (_b = (_a = control.value) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : lengthOrSize(control.value);
...
function toObservable(value) {
    const obs = (0, core_1.ɵisPromise)(value) ? (0, rxjs_1.from)(value) : value;
    if ((typeof ngDevMode === 'undefined' || ngDevMode) && !(0, core_1.ɵisSubscribable)(obs)) {
        ...
        throw new core_1.ɵRuntimeError(-1101 /* RuntimeErrorCode.WRONG_VALIDATOR_RETURN_TYPE */, errorMessage);
    }
    return obs;
}
...
function composeAsync(validators) {
    ...
    return function (control) {
        ...
        return (0, rxjs_1.forkJoin)(observables).pipe((0, operators_1.map)(mergeErrors));
    };
}
/**
