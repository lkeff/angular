    ...
    describe('FormGroup', () => {
        describe('value', () => {
            it('should be the reduced value of the child controls', () => {
                const g = new index_1.FormGroup({ 'one': new index_1.FormControl('111'), 'two': new index_1.FormControl('222') });
        ...
        describe('getRawValue', () => {
            ...
            it('should work with nested form groups/arrays', () => {
                fg = new index_1.FormGroup({
                    'c1': new index_1.FormControl('v1'),
                    'group': new index_1.FormGroup({ 'c2': new index_1.FormControl('v2'), 'c3': new index_1.FormControl('v3') }),
                    'array': new index_1.FormArray([new index_1.FormControl('v4'), new index_1.FormControl('v5')]),
                });
        ...
        describe('markAllAsDirty', () => {
            ...
            let logger;
            beforeEach(() => {
                form = new index_1.FormGroup({
                    'c1': new index_1.FormControl('v1'),
                    'group': new index_1.FormGroup({ 'c2': new index_1.FormControl('v2'), 'c3': new index_1.FormControl('v3') }),
                    'array': new index_1.FormArray([
                        new index_1.FormControl('v4'),
                        new index_1.FormControl('v5'),
                        new index_1.FormGroup({ 'c4': new index_1.FormControl('v4') }),
                    ]),
                });
                logger = [];
            });
            it('should mark all descendants as dirty', () => {
                ...
                const control1 = form.get('c1');
                expect(control1.dirty).toBe(false);
                const innerGroup = form.get('group');
                expect(innerGroup.dirty).toBe(false);
                const innerGroupFirstChildCtrl = innerGroup.get('c2');
                ...
                const innerGroupSecondChildCtrl = innerGroup.get('c3');
                expect(innerGroupSecondChildCtrl.dirty).toBe(true);
                const array = form.get('array');
                expect(array.dirty).toBe(true);
                const arrayFirstChildCtrl = array.at(0);
                expect(arrayFirstChildCtrl.dirty).toBe(true);
                const arraySecondChildCtrl = array.at(1);
                expect(arraySecondChildCtrl.dirty).toBe(true);
                const arrayFirstChildGroup = array.at(2);
        ...
        describe('adding and removing controls', () => {
            ...
            it('should update value and validity when control is added', () => {
                const g = new index_1.FormGroup({ 'one': new index_1.FormControl('1') });
                expect(g.value).toEqual({ 'one': '1' });
                expect(g.valid).toBe(true);
                g.addControl('two', new index_1.FormControl('2', index_1.Validators.minLength(10)));
                expect(g.value).toEqual({ 'one': '1', 'two': '2' });
                expect(g.valid).toBe(false);
            });
            it('should update value and validity when control is removed', () => {
                const g = new index_1.FormGroup({
                    'one': new index_1.FormControl('1'),
                    'two': new index_1.FormControl('2', index_1.Validators.minLength(10)),
                });
                expect(g.value).toEqual({ 'one': '1', 'two': '2' });
                expect(g.valid).toBe(false);
                g.removeControl('two');
            ...
            it('should not emit events when `FormGroup.addControl` is called with `emitEvent: false`', () => {
                ...
                g.addControl('two', new index_1.FormControl('2'), { emitEvent: false });
                expect(g.value).toEqual({ 'one': '1', 'two': '2' });
                expect(logger).toEqual([]);
            });
            ...
            it('should not emit status change events when `FormGroup.addControl` is called with `emitEvent: false`', () => {
                const validatorFn = (value) => value.controls.invalidCtrl ? { invalidCtrl: true } : null;
                const asyncValidatorFn = (value) => (0, rxjs_1.of)(validatorFn(value));
                const g = new index_1.FormGroup({}, validatorFn, asyncValidatorFn);
                expect(g.valid).toBe(true);
                g.statusChanges.subscribe(() => logger.push('status change'));
                g.addControl('invalidCtrl', new index_1.FormControl(''), { emitEvent: false });
        ...
        describe('setValue', () => {
            ...
            it('should set parent values', () => {
                const form = new index_1.FormGroup({ 'parent': g });
                g.setValue({ 'one': 'one', 'two': 'two' });
            ...
            it('should throw if fields are missing from supplied value (subset)', () => {
                expect(() => g.setValue({ 'one': 'one' })).toThrowError(new RegExp(`NG01002: Must supply a value for form control with name: 'two'`));
            });
            it('should throw if a value is provided for a missing control (superset)', () => {
                expect(() => g.setValue({ 'one': 'one', 'two': 'two', 'three': 'three' })).toThrowError(new RegExp(`NG01001: Cannot find form control with name: 'three'`));
            });
            ...
            it('should throw if no controls are set yet', () => {
                const empty = new index_1.FormGroup({});
            ...
            describe('setValue() events', () => {
                ...
                let logger;
                beforeEach(() => {
                    form = new index_1.FormGroup({ 'parent': g });
                    logger = [];
                });
                ...
                it('should not emit events on the parent when called with `emitEvent: false`', () => {
                    ...
                    g.addControl('three', new index_1.FormControl(5), { emitEvent: false });
                    expect(logger).toEqual([]);
                });
            });
        });
        describe('patchValue', () => {
            ...
            beforeEach(() => {
                ...
                c2 = new index_1.FormControl('');
                g = new index_1.FormGroup({ 'one': c, 'two': c2 });
                g2 = new index_1.FormGroup({
                    'array': new index_1.FormArray([new index_1.FormControl(1), new index_1.FormControl(2)]),
                    'group': new index_1.FormGroup({ 'one': new index_1.FormControl(3) }),
                });
            });
            it('should set its own value', () => {
            ...
            describe('patchValue() events', () => {
                ...
                it('should not emit valueChange events for skipped controls (represented as `null` or `undefined`)', () => {
                    ...
                    const [formArrayControl1, formArrayControl2] = g2.controls['array']
                        .controls;
                    const formGroupControl = g2.controls['group'].controls['one'];
        ...
        describe('reset()', () => {
            ...
            it('should set the value of its parent if value passed', () => {
                const form = new index_1.FormGroup({ 'g': g });
                g.setValue({ 'one': 'new value', 'two': 'new value' });
                g.reset({ 'one': 'initial value', 'two': '' });
            ...
            it('should mark the parent as pristine if all siblings pristine', () => {
                ...
                const form = new index_1.FormGroup({ 'g': g, 'c3': c3 });
                g.markAsDirty();
            ...
            it('should be able to reset a nested control with null', () => {
                var _a, _b;
                const g = new index_1.FormGroup({
                    id: new index_1.FormControl(2),
                    nested: new index_1.FormGroup({
                        id: new index_1.FormControl(3),
                    }),
                });
                g.reset({ id: 1, nested: null });
                expect((_a = g.get('nested')) === null || _a === void 0 ? void 0 : _a.value).toEqual({ id: null });
                expect((_b = g.get('nested.id')) === null || _b === void 0 ? void 0 : _b.value).toBe(null);
            });
            describe('reset() events', () => {
                let form, c3, logger;
                beforeEach(() => {
                    c3 = new index_1.FormControl('');
                    form = new index_1.FormGroup({ 'g': g, 'c3': c3 });
                    logger = [];
                });
        ...
        describe('contains', () => {
            let group;
            beforeEach(() => {
                group = new index_1.FormGroup({
                    'required': new index_1.FormControl('requiredValue'),
                    'optional': new index_1.FormControl({ value: 'disabled value', disabled: true }),
                });
            });
            ...
            it('should support controls with dots in their name', () => {
                ...
                group.addControl('some.name', new index_1.FormControl());
        ...
        describe('statusChanges', () => {
            ...
            beforeEach((0, testing_1.waitForAsync)(() => {
                control = new index_1.FormControl('', null, util_1.asyncValidatorReturningObservable);
                group = new index_1.FormGroup({ 'one': control });
            }));
            it('should fire statusChanges events for async validators added via options object', (0, testing_1.fakeAsync)(() => {
                ...
                const asc = new index_1.FormGroup({}, { asyncValidators: [() => Promise.resolve(null)] });
            ...
            it('should fire a statusChange if child has async validation change', (0, testing_1.fakeAsync)(() => {
                const loggedValues = [];
        ...
        describe('getError', () => {
            ...
            it('should return null otherwise', () => {
                const c = new index_1.FormControl('not empty', index_1.Validators.required);
                const g = new index_1.FormGroup({ 'one': c });
            ...
            it('should be able to traverse group with string delimited by dots', () => {
                const c = new index_1.FormControl('', index_1.Validators.required);
                const g2 = new index_1.FormGroup({ 'two': c });
                const g1 = new index_1.FormGroup({ 'one': g2 });
                expect(c.getError('required')).toEqual(true);
            ...
            it('should traverse group with form array using string and numbers', () => {
                const c = new index_1.FormControl('', index_1.Validators.required);
                const g2 = new index_1.FormGroup({ 'two': c });
                const a = new index_1.FormArray([g2]);
                const g1 = new index_1.FormGroup({ 'one': a });
                expect(c.getError('required')).toEqual(true);
        ...
        describe('validator', () => {
            ...
            it('should run a single validator when the value changes', () => {
                ...
                const g = new index_1.FormGroup({ 'one': c }, simpleValidator);
                c.setValue('correct');
            ...
            it('should support multiple validators from array', () => {
                const g = new index_1.FormGroup({ one: new index_1.FormControl() }, [simpleValidator, containsValidator]);
                expect(g.valid).toEqual(false);
            ...
            it('should set single validator from options obj', () => {
                const g = new index_1.FormGroup({ one: new index_1.FormControl() }, { validators: simpleValidator });
                expect(g.valid).toEqual(false);
                expect(g.errors).toEqual({ broken: true });
                g.setValue({ one: 'correct' });
                expect(g.valid).toEqual(true);
            ...
            it('should set multiple validators from options obj', () => {
                const g = new index_1.FormGroup({ one: new index_1.FormControl() }, { validators: [simpleValidator, containsValidator] });
                expect(g.valid).toEqual(false);
                expect(g.errors).toEqual({ missing: true, broken: true });
                g.setValue({ one: 'c' });
                expect(g.valid).toEqual(false);
        ...
        describe('asyncValidator', () => {
            it('should run the async validator', (0, testing_1.fakeAsync)(() => {
                ...
                const g = new index_1.FormGroup({ 'one': c }, null, (0, util_1.asyncValidator)('expected'));
                expect(g.pending).toEqual(true);
                (0, testing_1.tick)(1);
                expect(g.errors).toEqual({ 'async': true });
                expect(g.pending).toEqual(false);
            }));
            it('should set multiple async validators from array', (0, testing_1.fakeAsync)(() => {
                const g = new index_1.FormGroup({ 'one': new index_1.FormControl('value') }, null, [
            ...
            it('should set single async validator from options obj', (0, testing_1.fakeAsync)(() => {
                const g = new index_1.FormGroup({ 'one': new index_1.FormControl('value') }, { asyncValidators: (0, util_1.asyncValidator)('expected') });
                expect(g.pending).toEqual(true);
                (0, testing_1.tick)();
                expect(g.errors).toEqual({ 'async': true });
                expect(g.pending).toEqual(false);
            ...
            it('should set multiple async validators from options obj', (0, testing_1.fakeAsync)(() => {
                const g = new index_1.FormGroup({ 'one': new index_1.FormControl('value') }, { asyncValidators: [(0, util_1.asyncValidator)('expected'), otherObservableValidator] });
                expect(g.pending).toEqual(true);
                (0, testing_1.tick)();
                expect(g.errors).toEqual({ 'async': true, 'other': true });
                expect(g.pending).toEqual(false);
            }));
            it("should set the parent group's status to pending", (0, testing_1.fakeAsync)(() => {
            ...
            it("should run the parent group's async validator when children are pending", (0, testing_1.fakeAsync)(() => {
                const c = new index_1.FormControl('value', null, (0, util_1.asyncValidator)('expected'));
                const g = new index_1.FormGroup({ 'one': c }, null, (0, util_1.asyncValidator)('expected'));
                (0, testing_1.tick)(1);
                expect(g.errors).toEqual({ 'async': true });
            ...
            it('should handle successful async FormGroup resolving synchronously before a successful async child validator', (0, testing_1.fakeAsync)(() => {
                const c = new index_1.FormControl('fcValue', null, (0, util_1.simpleAsyncValidator)({ timeout: 1, shouldFail: false }));
                const g = new index_1.FormGroup({ 'one': c }, null, (0, util_1.simpleAsyncValidator)({ timeout: 0, shouldFail: false }));
                ...
                expect((0, util_1.currentStateOf)([g, g.get('one')])).toEqual([
            ...
            it('should handle successful async FormGroup resolving after a synchronously and successfully resolving child validator', (0, testing_1.fakeAsync)(() => {
                const c = new index_1.FormControl('fcValue', null, (0, util_1.simpleAsyncValidator)({ timeout: 0, shouldFail: false }));
                const g = new index_1.FormGroup({ 'one': c }, null, (0, util_1.simpleAsyncValidator)({ timeout: 1, shouldFail: false }));
            ...
            it('should handle successful async FormGroup and child control validators resolving synchronously', (0, testing_1.fakeAsync)(() => {
                const c = new index_1.FormControl('fcValue', null, (0, util_1.simpleAsyncValidator)({ timeout: 0, shouldFail: false }));
                const g = new index_1.FormGroup({ 'one': c }, null, (0, util_1.simpleAsyncValidator)({ timeout: 0, shouldFail: false }));
            ...
            it('should handle failing async FormGroup and failing child control validators resolving synchronously', (0, testing_1.fakeAsync)(() => {
                const c = new index_1.FormControl('fcValue', null, (0, util_1.simpleAsyncValidator)({ timeout: 0, shouldFail: true }));
                const g = new index_1.FormGroup({ 'one': c }, null, (0, util_1.simpleAsyncValidator)({ timeout: 0, shouldFail: true }));
            ...
            it('should handle failing async FormGroup and successful child control validators resolving synchronously', (0, testing_1.fakeAsync)(() => {
                const c = new index_1.FormControl('fcValue', null, (0, util_1.simpleAsyncValidator)({ timeout: 0, shouldFail: false }));
                const g = new index_1.FormGroup({ 'one': c }, null, (0, util_1.simpleAsyncValidator)({ timeout: 0, shouldFail: true }));
                expect((0, util_1.currentStateOf)([g, g.get('one')])).toEqual([
            ...
            it('should handle failing async FormArray and successful children validators resolving synchronously', (0, testing_1.fakeAsync)(() => {
                const c = new index_1.FormControl('fcValue', null, (0, util_1.simpleAsyncValidator)({ timeout: 0, shouldFail: false }));
                const g = new index_1.FormGroup({ 'one': c }, null, (0, util_1.simpleAsyncValidator)({ timeout: 0, shouldFail: false }));
                const c2 = new index_1.FormControl('fcVal', null, (0, util_1.simpleAsyncValidator)({ timeout: 0, shouldFail: false }));
                const a = new index_1.FormArray([g, c2], null, (0, util_1.simpleAsyncValidator)({ timeout: 0, shouldFail: true }));
                expect((0, util_1.currentStateOf)([a, a.at(0), a.at(1)])).toEqual([
            ...
            it('should handle failing FormGroup validator resolving after successful child validator', (0, testing_1.fakeAsync)(() => {
                const c = new index_1.FormControl('fcValue', null, (0, util_1.simpleAsyncValidator)({ timeout: 1, shouldFail: false }));
                const g = new index_1.FormGroup({ 'one': c }, null, (0, util_1.simpleAsyncValidator)({ timeout: 2, shouldFail: true }));
            ...
            it('should handle failing FormArray validator resolving after successful child validator', (0, testing_1.fakeAsync)(() => {
                const c = new index_1.FormControl('fcValue', null, (0, util_1.simpleAsyncValidator)({ timeout: 1, shouldFail: false }));
                const a = new index_1.FormArray([c], null, (0, util_1.simpleAsyncValidator)({ timeout: 2, shouldFail: true }));
                // Initially, the form array and nested control are in pending state
                expect((0, util_1.currentStateOf)([a, a.at(0)])).toEqual([
            ...
            it('should handle successful FormGroup validator resolving after successful child validator', (0, testing_1.fakeAsync)(() => {
                const c = new index_1.FormControl('fcValue', null, (0, util_1.simpleAsyncValidator)({ timeout: 1, shouldFail: false }));
                const g = new index_1.FormGroup({ 'one': c }, null, (0, util_1.simpleAsyncValidator)({ timeout: 2, shouldFail: false }));
                // Initially, the form group and nested control are in pending state
                expect((0, util_1.currentStateOf)([g, g.get('one')])).toEqual([
                    { errors: null, pending: true, status: 'PENDING' }, // Group
                    { errors: null, pending: true, status: 'PENDING' }, // Control
            ...
            it('should handle successful FormArray validator resolving after successful child validators', (0, testing_1.fakeAsync)(() => {
                const c1 = new index_1.FormControl('fcValue', null, (0, util_1.simpleAsyncValidator)({ timeout: 1, shouldFail: false }));
                const g = new index_1.FormGroup({ 'one': c1 }, null, (0, util_1.simpleAsyncValidator)({ timeout: 2, shouldFail: false }));
                const c2 = new index_1.FormControl('fcVal', null, (0, util_1.simpleAsyncValidator)({ timeout: 3, shouldFail: false }));
                const a = new index_1.FormArray([g, c2], null, (0, util_1.simpleAsyncValidator)({ timeout: 4, shouldFail: false }));
            ...
            it('should handle failing FormArray validator resolving after successful child validators', (0, testing_1.fakeAsync)(() => {
                const c1 = new index_1.FormControl('fcValue', null, (0, util_1.simpleAsyncValidator)({ timeout: 1, shouldFail: false }));
                const g = new index_1.FormGroup({ 'one': c1 }, null, (0, util_1.simpleAsyncValidator)({ timeout: 2, shouldFail: false }));
                const c2 = new index_1.FormControl('fcVal', null, (0, util_1.simpleAsyncValidator)({ timeout: 3, shouldFail: false }));
                const a = new index_1.FormArray([g, c2], null, (0, util_1.simpleAsyncValidator)({ timeout: 4, shouldFail: true }));
                // Initially, the form array and the tested form group and form control c2 are in pending
                // state
                expect((0, util_1.currentStateOf)([a, a.at(0), a.at(1)])).toEqual([
                    { errors: null, pending: true, status: 'PENDING' }, // FormArray
            ...
            it('should handle multiple successful FormGroup validators resolving after successful child validator', (0, testing_1.fakeAsync)(() => {
                const c = new index_1.FormControl('fcValue', null, (0, util_1.simpleAsyncValidator)({ timeout: 1, shouldFail: false }));
                const g = new index_1.FormGroup({ 'one': c }, null, [
                    (0, util_1.simpleAsyncValidator)({ timeout: 2, shouldFail: false }),
                    (0, util_1.simpleAsyncValidator)({ timeout: 3, shouldFail: false }),
                ]);
                // Initially, the form group and nested control are in pending state
                expect((0, util_1.currentStateOf)([g, g.get('one')])).toEqual([
                    { errors: null, pending: true, status: 'PENDING' }, // Group
            ...
            it('should handle multiple FormGroup validators (success then failure) resolving after successful child validator', (0, testing_1.fakeAsync)(() => {
                const c = new index_1.FormControl('fcValue', null, (0, util_1.simpleAsyncValidator)({ timeout: 1, shouldFail: false }));
                const g = new index_1.FormGroup({ 'one': c }, null, [
                    (0, util_1.simpleAsyncValidator)({ timeout: 2, shouldFail: false }),
                    (0, util_1.simpleAsyncValidator)({ timeout: 3, shouldFail: true }),
                ]);
                // Initially, the form group and nested control are in pending state
                expect((0, util_1.currentStateOf)([g, g.get('one')])).toEqual([
                    { errors: null, pending: true, status: 'PENDING' }, // Group
            ...
            it('should handle multiple FormGroup validators (failure then success) resolving after successful child validator', (0, testing_1.fakeAsync)(() => {
                const c = new index_1.FormControl('fcValue', null, (0, util_1.simpleAsyncValidator)({ timeout: 1, shouldFail: false }));
                const g = new index_1.FormGroup({ 'one': c }, null, [
                    (0, util_1.simpleAsyncValidator)({ timeout: 2, shouldFail: true }),
                    (0, util_1.simpleAsyncValidator)({ timeout: 3, shouldFail: false }),
                ]);
                // Initially, the form group and nested control are in pending state
                expect((0, util_1.currentStateOf)([g, g.get('one')])).toEqual([
            ...
            it('should handle async validators in nested form groups / arrays', (0, testing_1.fakeAsync)(() => {
                const c1 = new index_1.FormControl('fcValue', null, (0, util_1.simpleAsyncValidator)({ timeout: 1, shouldFail: false }));
                const g1 = new index_1.FormGroup({ 'one': c1 }, null, (0, util_1.simpleAsyncValidator)({ timeout: 2, shouldFail: true }));
                const c2 = new index_1.FormControl('fcVal', null, (0, util_1.simpleAsyncValidator)({ timeout: 3, shouldFail: false }));
                const g2 = new index_1.FormArray([c2], null, (0, util_1.simpleAsyncValidator)({ timeout: 4, shouldFail: false }));
                const g = new index_1.FormGroup({ 'g1': g1, 'g2': g2 }, null, (0, util_1.simpleAsyncValidator)({ timeout: 5, shouldFail: false }));
                // Initially, the form group and nested control are in pending state
                expect((0, util_1.currentStateOf)([g, g.get('g1'), g.get('g2')])).toEqual([
            ...
            it('should handle failing FormGroup validator resolving before successful child validator', (0, testing_1.fakeAsync)(() => {
                const c = new index_1.FormControl('fcValue', null, (0, util_1.simpleAsyncValidator)({ timeout: 2, shouldFail: false }));
                const g = new index_1.FormGroup({ 'one': c }, null, (0, util_1.simpleAsyncValidator)({ timeout: 1, shouldFail: true }));
                // Initially, the form group and nested control are in pending state
                expect((0, util_1.currentStateOf)([g, g.get('one')])).toEqual([
                    { errors: null, pending: true, status: 'PENDING' }, // Group
                    { errors: null, pending: true, status: 'PENDING' }, // Control
            ...
            it('should handle failing FormArray validator resolving before successful child validator', (0, testing_1.fakeAsync)(() => {
                const c = new index_1.FormControl('fcValue', null, (0, util_1.simpleAsyncValidator)({ timeout: 2, shouldFail: false }));
                const a = new index_1.FormArray([c], null, (0, util_1.simpleAsyncValidator)({ timeout: 1, shouldFail: true }));
                // Initially, the form array and nested control are in pending state
                expect((0, util_1.currentStateOf)([a, a.at(0)])).toEqual([
                    { errors: null, pending: true, status: 'PENDING' }, // FormArray
                    { errors: null, pending: true, status: 'PENDING' }, // Control
        ...
        describe('disable() & enable()', () => {
            it('should mark the group as disabled', () => {
                const g = new index_1.FormGroup({ 'one': new index_1.FormControl(null) });
                expect(g.disabled).toBe(false);
                expect(g.valid).toBe(true);
                g.disable();
                expect(g.disabled).toBe(true);
            ...
            it('should mark children of the group as disabled', () => {
                const c1 = new index_1.FormControl(null);
                const c2 = new index_1.FormControl(null);
                const g = new index_1.FormGroup({ 'one': c1, 'two': c2 });
            ...
            it('should ignore disabled controls in validation', () => {
                const g = new index_1.FormGroup({
                    nested: new index_1.FormGroup({ one: new index_1.FormControl(null, index_1.Validators.required) }),
            ...
            it('should ignore disabled controls when serializing value', () => {
                const g = new index_1.FormGroup({
                    nested: new index_1.FormGroup({ one: new index_1.FormControl('one') }),
                    two: new index_1.FormControl('two'),
                });
            ...
            it('should update its value when disabled with disabled children', () => {
                const g = new index_1.FormGroup({
                    nested: new index_1.FormGroup({ one: new index_1.FormControl('one'), two: new index_1.FormControl('two') }),
                });
            ...
            it('should keep empty, disabled groups disabled when updating validity', () => {
                const group = new index_1.FormGroup({});
                expect(group.status).toEqual('VALID');
                group.disable();
                expect(group.status).toEqual('DISABLED');
                group.updateValueAndValidity();
                expect(group.status).toEqual('DISABLED');
                group.addControl('one', new index_1.FormControl({ value: '', disabled: true }));
                expect(group.status).toEqual('DISABLED');
                group.addControl('two', new index_1.FormControl());
                expect(group.status).toEqual('VALID');
            });
            ...
            it('should not run validators on disabled controls', () => {
                ...
                const g = new index_1.FormGroup({ 'one': new index_1.FormControl() }, validator);
            ...
            describe('disabled errors', () => {
                it('should clear out group errors when disabled', () => {
                    const g = new index_1.FormGroup({ 'one': new index_1.FormControl() }, () => ({ 'expected': true }));
                ...
                it('should re-populate group errors when enabled from a child', () => {
                    const g = new index_1.FormGroup({ 'one': new index_1.FormControl() }, () => ({
                        'expected': true,
                    }));
                    g.disable();
                    expect(g.errors).toEqual(null);
                    g.addControl('two', new index_1.FormControl());
                    expect(g.errors).toEqual({ 'expected': true });
                });
                it('should clear out async group errors when disabled', (0, testing_1.fakeAsync)(() => {
                    const g = new index_1.FormGroup({ 'one': new index_1.FormControl() }, null, (0, util_1.asyncValidator)('expected'));
                    (0, testing_1.tick)();
                    expect(g.errors).toEqual({ 'async': true });
                    g.disable();
                    expect(g.errors).toEqual(null);
                ...
                it('should re-populate async group errors when enabled from a child', (0, testing_1.fakeAsync)(() => {
                    const g = new index_1.FormGroup({ 'one': new index_1.FormControl() }, null, (0, util_1.asyncValidator)('expected'));
                    (0, testing_1.tick)();
                    expect(g.errors).toEqual({ 'async': true });
                    g.disable();
            ...
            describe('disabled events', () => {
                ...
                beforeEach(() => {
                    ...
                    g = new index_1.FormGroup({ one: c });
                    form = new index_1.FormGroup({ g: g });
                });
        ...
        describe('updateTreeValidity()', () => {
            ...
            beforeEach(() => {
                ...
                c3 = new index_1.FormControl('three');
                nested = new index_1.FormGroup({ one: c, two: c2 });
                form = new index_1.FormGroup({ nested: nested, three: c3 });
                logger = [];
        ...
        describe('setControl()', () => {
            ...
            it('should replace existing control with new control', () => {
                const c2 = new index_1.FormControl('new!', index_1.Validators.minLength(10));
                g.setControl('one', c2);
        ...
        describe('emit `statusChanges` and `valueChanges` with/without async/sync validators', () => {
            const attachEventsLogger = (control, log, controlName) => {
            ...
            describe('stand alone controls', () => {
                it('should run the async validator on stand alone controls and set status to `INVALID`', (0, testing_1.fakeAsync)(() => {
                    const logs = [];
                    const c = new index_1.FormControl('', null, (0, util_1.simpleAsyncValidator)({ timeout: 0, shouldFail: true }));
                ...
                it('should run the async validator on stand alone controls and set status to `VALID`', (0, testing_1.fakeAsync)(() => {
                    const logs = [];
                    const c = new index_1.FormControl('', null, (0, util_1.asyncValidator)('new!'));
                    attachEventsLogger(c, logs);
                    expect(logs.length).toBe(0);
                    (0, testing_1.tick)(1);
                    c.setValue('new!', { emitEvent: true });
                ...
                it('should run the async validator on stand alone controls, include `PENDING` and set status to `INVALID`', (0, testing_1.fakeAsync)(() => {
                    const logs = [];
                    const c = new index_1.FormControl('', null, (0, util_1.simpleAsyncValidator)({ timeout: 1, shouldFail: true }));
                    attachEventsLogger(c, logs);
                    expect(logs.length).toBe(0);
                    (0, testing_1.tick)(1);
                    c.setValue('new!', { emitEvent: true });
                ...
                it('should run setValue before the initial async validator and set status to `VALID`', (0, testing_1.fakeAsync)(() => {
                    const logs = [];
                    const c = new index_1.FormControl('', null, (0, util_1.asyncValidator)('new!'));
                    attachEventsLogger(c, logs);
                    expect(logs.length).toBe(0);
                ...
                it('should run setValue before the initial async validator and set status to `INVALID`', (0, testing_1.fakeAsync)(() => {
                    const logs = [];
                    const c = new index_1.FormControl('', null, (0, util_1.simpleAsyncValidator)({ timeout: 1, shouldFail: true }));
                    attachEventsLogger(c, logs);
                    expect(logs.length).toBe(0);
                ...
                it('should cancel initial run of the async validator and not emit anything', (0, testing_1.fakeAsync)(() => {
                    const logger = [];
                    const c = new index_1.FormControl('', null, (0, util_1.simpleAsyncValidator)({ timeout: 1, shouldFail: true }));
                ...
                it('should emit status change despite updating the value with emitEvent: false multiple times', (0, testing_1.fakeAsync)(() => {
                    const c = new index_1.FormControl('', null, (0, util_1.simpleAsyncValidator)({ timeout: 1, shouldFail: false }));
                    const statusChange$ = c.events.pipe((0, rxjs_1.filter)((event) => event instanceof abstract_model_1.StatusChangeEvent), (0, rxjs_1.map)((event) => event.status));
                ...
                it('should cancel initial run of the async validator and emit on the event Observable', (0, testing_1.fakeAsync)(() => {
                    const c = new index_1.FormControl('', null, (0, util_1.simpleAsyncValidator)({ timeout: 1, shouldFail: true }));
                    const events = [];
                    ...
                    expect(events[0]).toBeInstanceOf(index_1.ValueChangeEvent);
                    expect(events[1]).toBeInstanceOf(abstract_model_1.StatusChangeEvent);
                    expect(events[1].status).toBe('PENDING');
                    expect(events[2]).toBeInstanceOf(abstract_model_1.StatusChangeEvent);
                    expect(events[2].status).toBe('INVALID');
                }));
                it('should run the sync validator on stand alone controls and set status to `INVALID`', (0, testing_1.fakeAsync)(() => {
                    const logs = [];
                    const c = new index_1.FormControl('new!', index_1.Validators.required);
                    attachEventsLogger(c, logs);
                    expect(logs.length).toBe(0);
                    (0, testing_1.tick)(1);
                ...
                it('should run the sync validator on stand alone controls and set status to `VALID`', (0, testing_1.fakeAsync)(() => {
                    const logs = [];
                    const c = new index_1.FormControl('', index_1.Validators.required);
                    attachEventsLogger(c, logs);
                    expect(logs.length).toBe(0);
            ...
            describe('combination of multiple form controls', () => {
                it('should run the async validator on the FormControl added to the FormGroup and set status to `VALID`', (0, testing_1.fakeAsync)(() => {
                    const logs = [];
                    const c1 = new index_1.FormControl('one');
                    const g1 = new index_1.FormGroup({ 'one': c1 });
                    // Initial state of the controls
                    expect((0, util_1.currentStateOf)([c1, g1])).toEqual([
                        { errors: null, pending: false, status: 'VALID' }, // Control 1
                        { errors: null, pending: false, status: 'VALID' }, // Group
                    ]);
                    attachEventsLogger(g1, logs, 'g1');
                    const c2 = new index_1.FormControl('new!', null, (0, util_1.asyncValidator)('new!'));
                    attachEventsLogger(c2, logs, 'c2');
                    // Initial state of the new control
                    expect((0, util_1.currentStateOf)([c2])).toEqual([
                    ...
                    expect((0, util_1.currentStateOf)([g1, c2])).toEqual([
                        { errors: null, pending: false, status: 'VALID' }, // Group
                        { errors: null, pending: false, status: 'VALID' }, // Control 2
                    ]);
                }));
                it('should run the async validator on the FormControl added to the FormGroup and set status to `INVALID`', (0, testing_1.fakeAsync)(() => {
                    const logs = [];
                    const c1 = new index_1.FormControl('one');
                    const g1 = new index_1.FormGroup({ 'one': c1 });
                    // Initial state of the controls
                    ...
                    attachEventsLogger(g1, logs, 'g1');
                    const c2 = new index_1.FormControl('new!', null, (0, util_1.simpleAsyncValidator)({ timeout: 1, shouldFail: true }));
                    attachEventsLogger(c2, logs, 'c2');
                    // Initial state of the new control
                    expect((0, util_1.currentStateOf)([c2])).toEqual([
                        { errors: null, pending: true, status: 'PENDING' }, // Control 2
                ...
                it('should run the async validator at `FormControl` and `FormGroup` level and set status to `INVALID`', (0, testing_1.fakeAsync)(() => {
                    const logs = [];
                    const c1 = new index_1.FormControl('one');
                    const g1 = new index_1.FormGroup({ 'one': c1 }, null, (0, util_1.simpleAsyncValidator)({ timeout: 1, shouldFail: true }));
                    // Initial state of the controls
                    expect((0, util_1.currentStateOf)([c1, g1])).toEqual([
                        { errors: null, pending: false, status: 'VALID' }, // Control 1
                        { errors: null, pending: true, status: 'PENDING' }, // Group
                ...
                it('should run the async validator on a `FormArray` and a `FormControl` and status to `INVALID`', (0, testing_1.fakeAsync)(() => {
                    const logs = [];
                    const c1 = new index_1.FormControl('one');
                    const g1 = new index_1.FormGroup({ 'one': c1 }, null, (0, util_1.simpleAsyncValidator)({ timeout: 1, shouldFail: true }));
                    const fa = new index_1.FormArray([g1], null, (0, util_1.simpleAsyncValidator)({ timeout: 1, shouldFail: true }));
                    attachEventsLogger(g1, logs, 'g1');
                    // Initial state of the controls
                    expect((0, util_1.currentStateOf)([c1, g1, fa])).toEqual([
                        { errors: null, pending: false, status: 'VALID' }, // Control 1
                        { errors: null, pending: true, status: 'PENDING' }, // Group
                        { errors: null, pending: true, status: 'PENDING' }, // FormArray
                    ]);
                    ...
                    // Final state of all controls
                    expect((0, util_1.currentStateOf)([g1, fa, c2])).toEqual([
                        { errors: { async: true }, pending: false, status: 'INVALID' }, // Group
                        { errors: { async: true }, pending: false, status: 'INVALID' }, // FormArray
                        { errors: { async: true }, pending: false, status: 'INVALID' }, // Control 2
                    ]);
        ...
        describe('can be extended', () => {
            it('by a group with string keys', () => {
                class StringKeyGroup extends index_1.FormGroup {
                    registerControl(name, value) {
                        return new index_1.FormControl('');
                    }
                }
            });
            it('by a group with generic keys', () => {
                class SpecialGroup extends index_1.FormGroup {
                    registerControl(name, value) {
                        return new index_1.FormControl('');
                    }
                }
        ...
        it('should throw with invalid keys', () => {
            ...
            new index_1.FormGroup({
                foo: new index_1.FormControl('foo'),
                bar: new index_1.FormControl('foo', [index_1.Validators.required]),
                'baz.not.ok': new index_1.FormControl('baz'),
            });
