...
exports.HttpRequest = exports.ACCEPT_HEADER_VALUE = exports.JSON_CONTENT_TYPE = exports.TEXT_CONTENT_TYPE = exports.X_REQUEST_URL_HEADER = exports.ACCEPT_HEADER = exports.CONTENT_TYPE_HEADER = void 0;
 ...
 */
exports.X_REQUEST_URL_HEADER = 'X-Request-URL';
/**
 ...
 */
exports.ACCEPT_HEADER_VALUE = `${exports.JSON_CONTENT_TYPE}, ${exports.TEXT_CONTENT_TYPE}, */*`;
/**
...
class HttpRequest {
    constructor(method, url, third, fourth) {
        ...
        (_a = this.headers) !== null && _a !== void 0 ? _a : (this.headers = new headers_1.HttpHeaders());
        // If no context have been passed in, construct a new HttpContext instance.
        (_b = this.context) !== null && _b !== void 0 ? _b : (this.context = new context_1.HttpContext());
    ...
    detectContentTypeHeader() {
        ...
        if (typeof this.body === 'string') {
            return exports.TEXT_CONTENT_TYPE;
        }
        ...
        if (typeof this.body === 'object' ||
            ...
            typeof this.body === 'boolean') {
            return exports.JSON_CONTENT_TYPE;
        }
    ...
    clone(update = {}) {
        ...
        const keepalive = (_a = update.keepalive) !== null && _a !== void 0 ? _a : this.keepalive;
        // Carefully handle the transferCache to differentiate between
        // `false` and `undefined` in the update args.
        const transferCache = (_b = update.transferCache) !== null && _b !== void 0 ? _b : this.transferCache;
        ...
        // `false` and `undefined` in the update args.
        const withCredentials = (_c = update.withCredentials) !== null && _c !== void 0 ? _c : this.withCredentials;
        const reportProgress = (_d = update.reportProgress) !== null && _d !== void 0 ? _d : this.reportProgress;
        // Headers and params may be appended to if `setHeaders` or
        // `setParams` are used.
        let headers = update.headers || this.headers;
        let params = update.params || this.params;
        // Pass on context if needed
        const context = (_e = update.context) !== null && _e !== void 0 ? _e : this.context;
