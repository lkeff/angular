...
describe('HttpUrlEncodedParams', () => {
    ...
    describe('lazy mutation', () => {
        ...
        it('should allow appending all string parameters', () => {
            const body = new params_1.HttpParams({ fromString: 'a=a1&b=b1' });
        ...
        it('should allow appending all number parameters', () => {
            const body = new params_1.HttpParams({ fromString: 'a=1&b=b1' });
        ...
        it('should allow appending all boolean parameters', () => {
            const body = new params_1.HttpParams({ fromString: 'a=true&b=b1' });
        ...
        it('should allow appending all parameters of different types', () => {
            const body = new params_1.HttpParams({ fromString: 'a=true&b=b1' });
            const mutated = body.appendAll({ a: [true, 0, 'a1'], b: 'b2' });
        ...
        it('should allow deletion of parameters with specific number value', () => {
            const body = new params_1.HttpParams({ fromString: 'a=b&c=1&e=f' });
        ...
        it('should allow deletion of parameters with specific boolean value', () => {
            const body = new params_1.HttpParams({ fromString: 'a=b&c=true&e=f' });
        ...
        it('should allow deletion of one value of a number parameter', () => {
            const body = new params_1.HttpParams({ fromString: 'a=0&a=1&a=2&a=3&a=4&a=5' });
        ...
        it('should allow deletion of one value of a boolean parameter', () => {
            const body = new params_1.HttpParams({ fromString: 'a=false&a=true&a=false' });
    ...
    describe('encoding', () => {
        it('should encode parameters', () => {
            const body = new params_1.HttpParams({ fromString: 'a=standard_chars' });
            expect(body.toString()).toEqual('a=standard_chars');
            const body2 = new params_1.HttpParams({ fromString: 'a=1 2 3&b=mail@test&c=3_^[]$&d=eq=1&e=1+1' });
            expect(body2.toString()).toEqual('a=1%202%203&b=mail@test&c=3_%5E%5B%5D$&d=eq=1&e=1%2B1');
        });
    });
    describe('toString', () => {
        it('should stringify string params', () => {
            const body = new params_1.HttpParams({ fromObject: { a: '', b: '2', c: '3' } });
            expect(body.toString()).toBe('a=&b=2&c=3');
        });
        it('should stringify string array params', () => {
            const body = new params_1.HttpParams({ fromObject: { a: '', b: ['21', '22'], c: '3' } });
        ...
        it('should stringify boolean params', () => {
            const body = new params_1.HttpParams({ fromObject: { a: '', b: true, c: 3 } });
        ...
        it('should stringify boolean array params', () => {
            const body = new params_1.HttpParams({ fromObject: { a: '', b: [true, false], c: 3 } });
        ...
        it('should stringify array params of different types', () => {
            const body = new params_1.HttpParams({ fromObject: { a: ['', false, 3] } });
            expect(body.toString()).toBe('a=&a=false&a=3');
        });
        it('should stringify empty array params', () => {
            const body = new params_1.HttpParams({ fromObject: { a: '', b: [], c: '3' } });
