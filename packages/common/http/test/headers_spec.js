...
describe('HttpHeaders', () => {
    describe('initialization', () => {
        ...
        it('should keep all values when initialized from a Headers object with duplicate headers', () => {
            ...
            const headers = new headers_1.HttpHeaders(standardHeaders);
        ...
        it('should throw an error when null is passed as header', () => {
            ...
            const headers = new headers_1.HttpHeaders({ foo: null });
            expect(() => headers.get('foo')).toThrowError('Unexpected value of the `foo` header provided. ' +
        ...
        it('should throw an error when undefined is passed as header', () => {
            ...
            // valid value within the headers object, thus this test verifies this scenario.
            const headers = new headers_1.HttpHeaders({ bar: undefined });
            expect(() => headers.get('bar')).toThrowError('Unexpected value of the `bar` header provided. ' +
    ...
    describe('.get()', () => {
        it('should be case insensitive', () => {
            const headers = new headers_1.HttpHeaders({ 'foo': 'baz' });
            expect(headers.get('foo')).toEqual('baz');
            expect(headers.get('FOO')).toEqual('baz');
        });
        it('should return null if the header is not present', () => {
            const headers = new headers_1.HttpHeaders({ bar: [] });
    ...
    describe('.getAll()', () => {
        it('should be case insensitive', () => {
            const headers = new headers_1.HttpHeaders({ foo: ['bar', 'baz'] });
    ...
    describe('response header strings', () => {
        it('should be parsed by the constructor', () => {
            ...
            const headers = new headers_1.HttpHeaders(response);
