...
let HttpClientTestingModule = (() => {
    let _classDecorators = [(0, core_1.NgModule)({
            imports: [index_1.HttpClientModule],
            providers: [(0, provider_1.provideHttpClientTesting)()],
        })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var HttpClientTestingModule = _classThis = class {
    };
    __setFunctionName(_classThis, "HttpClientTestingModule");
    (() => {
