...
describe('HttpClient TestRequest', () => {
    it('accepts a null body', () => {
        ...
        const client = new index_1.HttpClient(mock);
        let resp;
    ...
    it('throws if no request matches', () => {
        ...
        try {
            ...
            expect(error.message).toBe('Expected one matching request for criteria "Match URL: /some-url", found none.' +
    ...
    it('throws if no request matches the exact parameters', () => {
        ...
        try {
            ...
            expect(error.message).toBe('Expected one matching request for criteria "Match URL: /some-url?query=world", found none.' +
    ...
    it('throws if there are open requests when verify is called', () => {
        ...
        try {
            ...
            expect(error.message).toBe('Expected no open requests, found 2:' +
