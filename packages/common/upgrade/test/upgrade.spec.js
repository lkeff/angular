...
exports.$rootScopeMock = exports.MockUpgradeModule = void 0;
...
exports.MockUpgradeModule = MockUpgradeModule;
...
describe('LocationProvider', () => {
    ...
    beforeEach(() => {
        testing_1.TestBed.configureTestingModule({
            imports: [upgrade_location_test_module_1.LocationUpgradeTestModule.config()],
            providers: [static_1.UpgradeModule],
        });
        upgradeModule = testing_1.TestBed.inject(static_1.UpgradeModule);
        upgradeModule.$injector = { get: injectorFactory() };
    });
    it('should instantiate LocationProvider', (0, testing_1.inject)([location_shim_1.$locationShim], ($location) => {
        expect($location).toBeDefined();
        expect($location instanceof location_shim_1.$locationShim).toBe(true);
    }));
});
describe('LocationHtml5Url', function () {
    ...
    beforeEach((0, testing_1.inject)([location_shim_1.$locationShim], (loc) => {
        $location = loc;
    }));
...
describe('NewUrl', function () {
    ...
    beforeEach(() => {
        testing_1.TestBed.configureTestingModule({
            imports: [
                index_1.CommonModule,
                upgrade_location_test_module_1.LocationUpgradeTestModule.config({ useHash: false, startUrl: 'http://www.domain.com:9877' }),
            ],
            providers: [static_1.UpgradeModule],
        });
        upgradeModule = testing_1.TestBed.inject(static_1.UpgradeModule);
    ...
    describe('encoding', function () {
        it('should encode special characters', function () {
            ...
            expect($location.hash()).toBe('<>#');
            expect($location.absUrl()).toBe('http://www.domain.com:9877/a%20%3C%3E%23?i%20j=%3C%3E%23#%3C%3E%23');
        });
...
describe('New URL Parsing', () => {
    ...
    beforeEach(() => {
        testing_1.TestBed.configureTestingModule({
            imports: [
                index_1.CommonModule,
                upgrade_location_test_module_1.LocationUpgradeTestModule.config({ useHash: false, startUrl: 'http://host.com/' }),
            ],
            providers: [static_1.UpgradeModule],
        });
        upgradeModule = testing_1.TestBed.inject(static_1.UpgradeModule);
    ...
    it('should throw error when invalid server url given', function () {
        ...
        }).toThrowError('Invalid url "http://other.server.org/path#/path", missing path prefix "http://host.com/".');
    });
    describe('state', function () {
        let mock$rootScope;
        beforeEach((0, testing_1.inject)([static_1.UpgradeModule], (ngUpgrade) => {
...
describe('$location.onChange()', () => {
    ...
    it('should add registered functions to changeListeners', () => {
        ...
        expect($location.$$changeListeners.length).toBe(0);
        $location.onChange(changeListener, errorHandler);
        expect($location.$$changeListeners.length).toBe(1);
        expect($location.$$changeListeners[0][0]).toEqual(changeListener);
        expect($location.$$changeListeners[0][1]).toEqual(errorHandler);
    });
    it('should call changeListeners when URL is updated', () => {
        ...
        function changeListener(url, state, oldUrl, oldState) {
...
function parseLinkAndReturn(location, toUrl, relHref) {
