...
describe('ngPlural', () => {
    ...
    beforeEach(() => {
        testing_1.TestBed.configureTestingModule({
            ...
            providers: [{ provide: index_1.NgLocalization, useClass: TestLocalization }],
            imports: [index_1.CommonModule],
        });
    });
    it('should display the template according to the exact value', (0, testing_1.waitForAsync)(() => {
    ...
    it('should display the template according to the exact numeric value', (0, testing_1.waitForAsync)(() => {
        const template = '<div>' +
    ...
    it('should not throw when ngPluralCase contains expressions', (0, testing_1.waitForAsync)(() => {
        const template = '<ul [ngPlural]="switchValue">' +
    ...
    it('should be applicable to <ng-container> elements', (0, testing_1.waitForAsync)(() => {
    ...
    it('should display the template according to the category', (0, testing_1.waitForAsync)(() => {
        const template = '<ul [ngPlural]="switchValue">' +
    ...
    it('should default to other when no matches are found', (0, testing_1.waitForAsync)(() => {
        const template = '<ul [ngPlural]="switchValue">' +
            '<ng-template ngPluralCase="few"><li>you have a few messages.</li></ng-template>' +
    ...
    it('should prioritize value matches over category matches', (0, testing_1.waitForAsync)(() => {
        const template = '<ul [ngPlural]="switchValue">' +
            '<ng-template ngPluralCase="few"><li>you have a few messages.</li></ng-template>' +
...
it('should be available as a standalone directive', () => {
    let TestComponent = (() => {
        let _classDecorators = [(0, core_1.Component)({
                ...
                imports: [index_1.NgPlural, index_1.NgPluralCase],
    ...
    fixture.detectChanges();
    (0, matchers_1.expect)(fixture.nativeElement.textContent).toBe('one message');
});
let TestLocalization = (() => {
    ...
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = index_1.NgLocalization;
    var TestLocalization = _classThis = class extends _classSuper {
    ...
    __setFunctionName(_classThis, "TestLocalization");
    (() => {
        var _a;
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        TestLocalization = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TestLocalization = _classThis;
})();
let TestComponent = (() => {
    let _classDecorators = [(0, core_1.Component)({
            selector: 'test-cmp',
