...
const viewport_scroller_1 = require("../src/viewport_scroller");
describe('BrowserViewportScroller', () => {
    describe('setHistoryScrollRestoration', () => {
        ...
        beforeEach(() => {
            ...
            scroller = new viewport_scroller_1.BrowserViewportScroller(document, windowSpy);
        });
        ...
        it('should not allow overwriting position with options', () => {
            scroller.scrollToPosition([10, 10], { top: 0, left: 0 });
    ...
    describe('scrollToAnchor', () => {
        ...
        let scroller;
        beforeEach(() => {
            scroller = new viewport_scroller_1.BrowserViewportScroller(document, window);
        ...
        it('should not allow overwriting position with options', () => {
            const { anchorNode, cleanup } = createTallElementWithShadowRoot();
            anchorNode.name = anchor;
            scroller.scrollToAnchor(anchor, { top: 0, left: 0 });
            expect(scroller.getScrollPosition()[1]).not.toEqual(0);
            cleanup();
        });
