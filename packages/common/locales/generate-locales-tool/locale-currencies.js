...
exports.generateLocaleCurrencies = generateLocaleCurrencies;
 ...
 */
function getCurrencySettings(localeName, localeData) {
    const currencyInfo = localeData.main(`numbers/currencies`);
    let currentCurrency = '';
    // find the currency currently used in this country
    const currencies = localeData.get(`supplemental/currencyData/region/${localeData.attributes.territory}`) ||
