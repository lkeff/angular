...
exports.UpperCasePipe = exports.TitleCasePipe = exports.LowerCasePipe = void 0;
...
let LowerCasePipe = (() => {
    ...
    let _classThis;
    var LowerCasePipe = _classThis = class {
        transform(value) {
            if (value == null)
                return null;
            if (typeof value !== 'string') {
                throw (0, invalid_pipe_argument_error_1.invalidPipeArgumentError)(LowerCasePipe, value);
            }
            return value.toLowerCase();
        }
    };
    __setFunctionName(_classThis, "LowerCasePipe");
    (() => {
...
let TitleCasePipe = (() => {
    ...
    let _classExtraInitializers = [];
    let _classThis;
    var TitleCasePipe = _classThis = class {
        transform(value) {
            if (value == null)
                return null;
            if (typeof value !== 'string') {
                throw (0, invalid_pipe_argument_error_1.invalidPipeArgumentError)(TitleCasePipe, value);
            }
            return value.replace(unicodeWordMatch, (txt) => txt[0].toUpperCase() + txt.slice(1).toLowerCase());
        }
    };
    __setFunctionName(_classThis, "TitleCasePipe");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
    ...
    var UpperCasePipe = _classThis = class {
        transform(value) {
            if (value == null)
                return null;
            if (typeof value !== 'string') {
                throw (0, invalid_pipe_argument_error_1.invalidPipeArgumentError)(UpperCasePipe, value);
            }
