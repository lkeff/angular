...
exports.ISO8601_DATE_REGEX = void 0;
exports.formatDate = formatDate;
exports.getThursdayThisIsoWeek = getThursdayThisIsoWeek;
...
function assertValidDateFormat(parts) {
    if (parts.some((part) => /^Y+$/.test(part)) && !parts.some((part) => /^w+$/.test(part))) {
        ...
        if (parts.length === 1) {
            ...
            console.error((0, core_1.ɵformatRuntimeError)(2300 /* RuntimeErrorCode.SUSPICIOUS_DATE_FORMAT */, message));
        }
        else {
            throw new core_1.ɵRuntimeError(2300 /* RuntimeErrorCode.SUSPICIOUS_DATE_FORMAT */, message);
        }
    }
}
/**
...
function getNamedFormat(locale, format) {
    ...
    (_a = NAMED_FORMATS[localeId]) !== null && _a !== void 0 ? _a : (NAMED_FORMATS[localeId] = {});
    ...
    switch (format) {
        ...
        case 'short':
            ...
            formatValue = formatDateTime((0, locale_data_api_1.getLocaleDateTimeFormat)(locale, locale_data_api_1.FormatWidth.Short), [
                shortTime,
                shortDate,
            ]);
            break;
        case 'medium':
            ...
            formatValue = formatDateTime((0, locale_data_api_1.getLocaleDateTimeFormat)(locale, locale_data_api_1.FormatWidth.Medium), [
                mediumTime,
                mediumDate,
            ]);
            break;
        case 'long':
            ...
            formatValue = formatDateTime((0, locale_data_api_1.getLocaleDateTimeFormat)(locale, locale_data_api_1.FormatWidth.Long), [
                longTime,
                longDate,
            ]);
            break;
        case 'full':
            ...
            formatValue = formatDateTime((0, locale_data_api_1.getLocaleDateTimeFormat)(locale, locale_data_api_1.FormatWidth.Full), [
                fullTime,
                fullDate,
            ]);
            break;
...
function getDatePart(part, date) {
    switch (part) {
        ...
        case 7 /* DateType.Day */:
            return date.getDay();
        default:
            throw new core_1.ɵRuntimeError(2301 /* RuntimeErrorCode.UNKNOWN_DATE_TYPE_VALUE */, ngDevMode && `Unknown DateType value "${part}".`);
    }
}
/**
...
function getDateTranslation(date, locale, name, width, form, extended) {
    switch (name) {
        ...
        default:
            ...
            throw new core_1.ɵRuntimeError(2302 /* RuntimeErrorCode.UNEXPECTED_TRANSLATION_TYPE */, ngDevMode && `unexpected translation type ${unexpected}`);
    }
}
/**
...
function timeZoneGetter(width) {
    return function (date, locale, offset) {
        ...
        switch (width) {
            ...
            default:
                throw new core_1.ɵRuntimeError(2302 /* RuntimeErrorCode.UNKNOWN_ZONE_WIDTH */, ngDevMode && `Unknown zone width "${width}"`);
        }
    };
}
const JANUARY = 0;
...
function getDateFormatter(format) {
    ...
    switch (format) {
        ...
        case 'GG':
        case 'GGG':
            formatter = dateStrGetter(3 /* TranslationType.Eras */, locale_data_api_1.TranslationWidth.Abbreviated);
            break;
        case 'GGGG':
            formatter = dateStrGetter(3 /* TranslationType.Eras */, locale_data_api_1.TranslationWidth.Wide);
            break;
        case 'GGGGG':
            formatter = dateStrGetter(3 /* TranslationType.Eras */, locale_data_api_1.TranslationWidth.Narrow);
            break;
        ...
        case 'MMM':
            formatter = dateStrGetter(2 /* TranslationType.Months */, locale_data_api_1.TranslationWidth.Abbreviated);
            break;
        case 'MMMM':
            formatter = dateStrGetter(2 /* TranslationType.Months */, locale_data_api_1.TranslationWidth.Wide);
            break;
        case 'MMMMM':
            formatter = dateStrGetter(2 /* TranslationType.Months */, locale_data_api_1.TranslationWidth.Narrow);
            break;
        // Month of the year (January, ...), string, standalone
        case 'LLL':
            formatter = dateStrGetter(2 /* TranslationType.Months */, locale_data_api_1.TranslationWidth.Abbreviated, locale_data_api_1.FormStyle.Standalone);
            break;
        case 'LLLL':
            formatter = dateStrGetter(2 /* TranslationType.Months */, locale_data_api_1.TranslationWidth.Wide, locale_data_api_1.FormStyle.Standalone);
            break;
        case 'LLLLL':
            formatter = dateStrGetter(2 /* TranslationType.Months */, locale_data_api_1.TranslationWidth.Narrow, locale_data_api_1.FormStyle.Standalone);
            break;
        ...
        case 'cc':
            ...
            break;
        case 'ccc':
            formatter = dateStrGetter(1 /* TranslationType.Days */, locale_data_api_1.TranslationWidth.Abbreviated, locale_data_api_1.FormStyle.Standalone);
            break;
        case 'cccc':
            formatter = dateStrGetter(1 /* TranslationType.Days */, locale_data_api_1.TranslationWidth.Wide, locale_data_api_1.FormStyle.Standalone);
            break;
        case 'ccccc':
            formatter = dateStrGetter(1 /* TranslationType.Days */, locale_data_api_1.TranslationWidth.Narrow, locale_data_api_1.FormStyle.Standalone);
            break;
        case 'cccccc':
            formatter = dateStrGetter(1 /* TranslationType.Days */, locale_data_api_1.TranslationWidth.Short, locale_data_api_1.FormStyle.Standalone);
            break;
        // Day of the Week
        case 'E':
        case 'EE':
        case 'EEE':
            formatter = dateStrGetter(1 /* TranslationType.Days */, locale_data_api_1.TranslationWidth.Abbreviated);
            break;
        case 'EEEE':
            formatter = dateStrGetter(1 /* TranslationType.Days */, locale_data_api_1.TranslationWidth.Wide);
            break;
        case 'EEEEE':
            formatter = dateStrGetter(1 /* TranslationType.Days */, locale_data_api_1.TranslationWidth.Narrow);
            break;
        case 'EEEEEE':
            formatter = dateStrGetter(1 /* TranslationType.Days */, locale_data_api_1.TranslationWidth.Short);
            break;
        // Generic period of the day (am-pm)
        case 'a':
        case 'aa':
        case 'aaa':
            formatter = dateStrGetter(0 /* TranslationType.DayPeriods */, locale_data_api_1.TranslationWidth.Abbreviated);
            break;
        case 'aaaa':
            formatter = dateStrGetter(0 /* TranslationType.DayPeriods */, locale_data_api_1.TranslationWidth.Wide);
            break;
        case 'aaaaa':
            formatter = dateStrGetter(0 /* TranslationType.DayPeriods */, locale_data_api_1.TranslationWidth.Narrow);
            break;
        // Extended period of the day (midnight, at night, ...), standalone
        case 'b':
        case 'bb':
        case 'bbb':
            formatter = dateStrGetter(0 /* TranslationType.DayPeriods */, locale_data_api_1.TranslationWidth.Abbreviated, locale_data_api_1.FormStyle.Standalone, true);
            break;
        case 'bbbb':
            formatter = dateStrGetter(0 /* TranslationType.DayPeriods */, locale_data_api_1.TranslationWidth.Wide, locale_data_api_1.FormStyle.Standalone, true);
            break;
        case 'bbbbb':
            formatter = dateStrGetter(0 /* TranslationType.DayPeriods */, locale_data_api_1.TranslationWidth.Narrow, locale_data_api_1.FormStyle.Standalone, true);
            break;
        // Extended period of the day (midnight, night, ...), standalone
        case 'B':
        case 'BB':
        case 'BBB':
            formatter = dateStrGetter(0 /* TranslationType.DayPeriods */, locale_data_api_1.TranslationWidth.Abbreviated, locale_data_api_1.FormStyle.Format, true);
            break;
        case 'BBBB':
            formatter = dateStrGetter(0 /* TranslationType.DayPeriods */, locale_data_api_1.TranslationWidth.Wide, locale_data_api_1.FormStyle.Format, true);
            break;
        case 'BBBBB':
            formatter = dateStrGetter(0 /* TranslationType.DayPeriods */, locale_data_api_1.TranslationWidth.Narrow, locale_data_api_1.FormStyle.Format, true);
            break;
        // Hour in AM/PM, (1-12)
        case 'h':
...
function toDate(value) {
    ...
    if (!isDate(date)) {
        throw new core_1.ɵRuntimeError(2302 /* RuntimeErrorCode.INVALID_TO_DATE_CONVERSION */, ngDevMode && `Unable to convert "${value}" into a date`);
    }
    return date;
}
/**
