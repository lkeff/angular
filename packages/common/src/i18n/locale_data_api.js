...
exports.getLocalePluralCase = exports.WeekDay = exports.NumberSymbol = exports.FormatWidth = exports.TranslationWidth = exports.FormStyle = exports.Plural = exports.NumberFormatStyle = void 0;
...
function getLocaleId(locale) {
    return (0, core_1.ɵfindLocaleData)(locale)[core_1.ɵLocaleDataIndex.LocaleId];
}
/**
...
function getLocaleDayPeriods(locale, formStyle, width) {
    const data = (0, core_1.ɵfindLocaleData)(locale);
    const amPmData = [
        data[core_1.ɵLocaleDataIndex.DayPeriodsFormat],
        data[core_1.ɵLocaleDataIndex.DayPeriodsStandalone],
    ];
...
function getLocaleDayNames(locale, formStyle, width) {
    const data = (0, core_1.ɵfindLocaleData)(locale);
    const daysData = [
        data[core_1.ɵLocaleDataIndex.DaysFormat],
        data[core_1.ɵLocaleDataIndex.DaysStandalone],
    ];
...
function getLocaleMonthNames(locale, formStyle, width) {
    const data = (0, core_1.ɵfindLocaleData)(locale);
    const monthsData = [
        data[core_1.ɵLocaleDataIndex.MonthsFormat],
        data[core_1.ɵLocaleDataIndex.MonthsStandalone],
    ];
...
function getLocaleEraNames(locale, width) {
    const data = (0, core_1.ɵfindLocaleData)(locale);
    const erasData = data[core_1.ɵLocaleDataIndex.Eras];
...
function getLocaleFirstDayOfWeek(locale) {
    const data = (0, core_1.ɵfindLocaleData)(locale);
    return data[core_1.ɵLocaleDataIndex.FirstDayOfWeek];
}
/**
...
function getLocaleWeekEndRange(locale) {
    const data = (0, core_1.ɵfindLocaleData)(locale);
    return data[core_1.ɵLocaleDataIndex.WeekendRange];
}
/**
...
function getLocaleDateFormat(locale, width) {
    const data = (0, core_1.ɵfindLocaleData)(locale);
    return getLastDefinedValue(data[core_1.ɵLocaleDataIndex.DateFormat], width);
}
/**
...
function getLocaleTimeFormat(locale, width) {
    const data = (0, core_1.ɵfindLocaleData)(locale);
    return getLastDefinedValue(data[core_1.ɵLocaleDataIndex.TimeFormat], width);
}
/**
...
function getLocaleDateTimeFormat(locale, width) {
    const data = (0, core_1.ɵfindLocaleData)(locale);
    const dateTimeFormatData = data[core_1.ɵLocaleDataIndex.DateTimeFormat];
...
function getLocaleNumberSymbol(locale, symbol) {
    const data = (0, core_1.ɵfindLocaleData)(locale);
    const res = data[core_1.ɵLocaleDataIndex.NumberSymbols][symbol];
    if (typeof res === 'undefined') {
        if (symbol === exports.NumberSymbol.CurrencyDecimal) {
            return data[core_1.ɵLocaleDataIndex.NumberSymbols][exports.NumberSymbol.Decimal];
        }
        else if (symbol === exports.NumberSymbol.CurrencyGroup) {
            return data[core_1.ɵLocaleDataIndex.NumberSymbols][exports.NumberSymbol.Group];
        }
    }
    return res;
}
...
function getLocaleNumberFormat(locale, type) {
    const data = (0, core_1.ɵfindLocaleData)(locale);
    return data[core_1.ɵLocaleDataIndex.NumberFormats][type];
}
/**
...
function getLocaleCurrencySymbol(locale) {
    const data = (0, core_1.ɵfindLocaleData)(locale);
    return data[core_1.ɵLocaleDataIndex.CurrencySymbol] || null;
}
/**
...
function getLocaleCurrencyName(locale) {
    const data = (0, core_1.ɵfindLocaleData)(locale);
    return data[core_1.ɵLocaleDataIndex.CurrencyName] || null;
}
/**
...
function getLocaleCurrencyCode(locale) {
    return (0, core_1.ɵgetLocaleCurrencyCode)(locale);
}
/**
...
function getLocaleCurrencies(locale) {
    const data = (0, core_1.ɵfindLocaleData)(locale);
    return data[core_1.ɵLocaleDataIndex.Currencies];
}
/**
 * @publicApi
 *
 ...
 */
exports.getLocalePluralCase = core_1.ɵgetLocalePluralCase;
function checkFullData(data) {
    if (!data[core_1.ɵLocaleDataIndex.ExtraData]) {
        throw new core_1.ɵRuntimeError(2303 /* RuntimeErrorCode.MISSING_EXTRA_LOCALE_DATA_FOR_LOCALE */, ngDevMode &&
            `Missing extra locale data for the locale "${data[core_1.ɵLocaleDataIndex.LocaleId]}". Use "registerLocaleData" to load new data. See the "I18n guide" on angular.io to know more.`);
    }
}
/**
...
function getLocaleExtraDayPeriodRules(locale) {
    const data = (0, core_1.ɵfindLocaleData)(locale);
    checkFullData(data);
    const rules = data[core_1.ɵLocaleDataIndex.ExtraData][core_1.ɵExtraLocaleDataIndex.ExtraDayPeriodsRules] || [];
...
function getLocaleExtraDayPeriods(locale, formStyle, width) {
    ...
    const dayPeriodsData = [
        data[core_1.ɵLocaleDataIndex.ExtraData][core_1.ɵExtraLocaleDataIndex.ExtraDayPeriodFormats],
        data[core_1.ɵLocaleDataIndex.ExtraData][core_1.ɵExtraLocaleDataIndex.ExtraDayPeriodStandalone],
    ];
...
function getLocaleDirection(locale) {
    const data = (0, core_1.ɵfindLocaleData)(locale);
    return data[core_1.ɵLocaleDataIndex.Directionality];
}
/**
...
function getLastDefinedValue(data, index) {
    ...
    throw new core_1.ɵRuntimeError(2304 /* RuntimeErrorCode.LOCALE_DATA_UNDEFINED */, ngDevMode && 'Locale data API: locale data undefined');
}
/**
...
function getCurrencySymbol(code, format, locale = 'en') {
    const currency = getLocaleCurrencies(locale)[code] || currencies_1.CURRENCIES_EN[code] || [];
    const symbolNarrow = currency[core_1.ɵCurrencyIndex.SymbolNarrow];
    if (format === 'narrow' && typeof symbolNarrow === 'string') {
        return symbolNarrow;
    }
    return currency[core_1.ɵCurrencyIndex.Symbol] || code;
}
...
function getNumberOfCurrencyDigits(code) {
    let digits;
    const currency = currencies_1.CURRENCIES_EN[code];
    if (currency) {
        digits = currency[core_1.ɵCurrencyIndex.NbOfDigits];
    }
