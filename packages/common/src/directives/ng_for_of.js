...
exports.NgFor = exports.NgForOf = exports.NgForOfContext = void 0;
...
let NgForOf = (() => {
                ...
                if (!this._differ && value) {
                    if (typeof ngDevMode === 'undefined' || ngDevMode) {
                        try {
                            ...
                            throw new core_1.ɵRuntimeError(-2200 /* RuntimeErrorCode.NG_FOR_MISSING_DIFFER */, errorMessage);
                        }
                    }
                    else {
    ...
    __setFunctionName(_classThis, "NgForOf");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _set_ngForOf_decorators = [(0, core_1.Input)()];
        _set_ngForTrackBy_decorators = [(0, core_1.Input)()];
        _set_ngForTemplate_decorators = [(0, core_1.Input)()];
        __esDecorate(_classThis, null, _set_ngForOf_decorators, { kind: "setter", name: "ngForOf", static: false, private: false, access: { has: obj => "ngForOf" in obj, set: (obj, value) => { obj.ngForOf = value; } }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _set_ngForTrackBy_decorators, { kind: "setter", name: "ngForTrackBy", static: false, private: false, access: { has: obj => "ngForTrackBy" in obj, set: (obj, value) => { obj.ngForTrackBy = value; } }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _set_ngForTemplate_decorators, { kind: "setter", name: "ngForTemplate", static: false, private: false, access: { has: obj => "ngForTemplate" in obj, set: (obj, value) => { obj.ngForTemplate = value; } }, metadata: _metadata }, null, _instanceExtraInitializers);
