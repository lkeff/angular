...
const extraction_1 = require("../../src/extract/extraction");
...
(0, helpers_1.runInNativeFileSystem)(() => {
    describe('extractMessages', () => {
        it('should extract a message for each $localize template tag', () => {
            ...
            const logger = new testing_1.MockLogger();
            const basePath = (0, file_system_1.absoluteFrom)('/root/path/');
            const filename = 'relative/path.js';
            const file = fs.resolve(basePath, filename);
            const extractor = new extraction_1.MessageExtractor(fs, logger, { basePath });
