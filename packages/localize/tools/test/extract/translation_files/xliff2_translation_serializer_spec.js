...
const xliff2_translation_serializer_1 = require("../../../src/extract/translation_files/xliff2_translation_serializer");
const mock_message_1 = require("./mock_message");
const utils_1 = require("./utils");
(0, testing_1.runInEachFileSystem)(() => {
    describe('Xliff2TranslationSerializer', () => {
        [{}, { 'xml:space': 'preserve' }].forEach((options) => {
                ...
                describe(`renderFile() [using ${useLegacyIds ? 'legacy' : 'canonical'} ids]`, () => {
                    it('should convert a set of parsed messages into an XML string', () => {
                        ...
                        const messages = [
                            ...
                            (0, mock_message_1.mockMessage)('location-only', ['a', '', 'c'], ['START_TAG_SPAN', 'CLOSE_TAG_SPAN'], {
                                location: {
                                    file: (0, file_system_1.absoluteFrom)('/project/file.ts'),
                                    start: { line: 2, column: 7 },
                                    end: { line: 3, column: 2 },
                            ...
                            (0, mock_message_1.mockMessage)('100000', ['pre-ICU ', ' post-ICU'], ['ICU'], {
                                associatedMessageIds: { ICU: 'SOME_ICU_ID' },
                            }),
                            (0, mock_message_1.mockMessage)('SOME_ICU_ID', ['{VAR_SELECT, select, a {a} b {{INTERPOLATION}} c {pre {INTERPOLATION_1} post}}'], [], {}),
                        ...
                        const serializer = new xliff2_translation_serializer_1.Xliff2TranslationSerializer('xx', (0, file_system_1.absoluteFrom)('/project'), useLegacyIds, options);
                        const output = serializer.serialize(messages);
                        expect(output.split(/\r?\n/)).toEqual([
                            `<?xml version="1.0" encoding="UTF-8" ?>`,
                            `<xliff version="2.0" xmlns="urn:oasis:names:tc:xliff:document:2.0" srcLang="xx">`,
                            `  <file id="ngi18n" original="ng.template"${(0, utils_1.toAttributes)(options)}>`,
                            `    <unit id="someId">`,
                            `      <segment>`,
                    ...
                    it('should convert a set of parsed messages into an XML string', () => {
                        const messageLocation1 = {
                            start: { line: 0, column: 5 },
                            end: { line: 0, column: 10 },
                            file: (0, file_system_1.absoluteFrom)('/project/file-1.ts'),
                            text: 'message text',
                        };
                        const messageLocation2 = {
                            start: { line: 3, column: 2 },
                            end: { line: 4, column: 7 },
                            file: (0, file_system_1.absoluteFrom)('/project/file-2.ts'),
                            text: 'message text',
                        };
                        const messageLocation3 = {
                            start: { line: 0, column: 5 },
                            end: { line: 0, column: 10 },
                            file: (0, file_system_1.absoluteFrom)('/project/file-3.ts'),
                            text: 'message text',
                        };
                        const messageLocation4 = {
                            start: { line: 3, column: 2 },
                            end: { line: 4, column: 7 },
                            file: (0, file_system_1.absoluteFrom)('/project/file-4.ts'),
                            text: 'message text',
                        };
                        const messages = [
                            (0, mock_message_1.mockMessage)('1234', ['message text'], [], { location: messageLocation1 }),
                            (0, mock_message_1.mockMessage)('1234', ['message text'], [], { location: messageLocation2 }),
                            (0, mock_message_1.mockMessage)('1234', ['message text'], [], {
                    ...
                    it('should render the "type" for line breaks', () => {
                        const serializer = new xliff2_translation_serializer_1.Xliff2TranslationSerializer('xx', (0, file_system_1.absoluteFrom)('/project'), useLegacyIds, options);
                        const output = serializer.serialize([(0, mock_message_1.mockMessage)('1', ['a', 'b'], ['LINE_BREAK'], {})]);
                        expect(output).toContain('<source>a<ph id="0" equiv="LINE_BREAK" type="fmt"/>b</source>');
                    });
                    it('should render the "type" for images', () => {
                        const serializer = new xliff2_translation_serializer_1.Xliff2TranslationSerializer('xx', (0, file_system_1.absoluteFrom)('/project'), useLegacyIds, options);
                        const output = serializer.serialize([(0, mock_message_1.mockMessage)('2', ['a', 'b'], ['TAG_IMG'], {})]);
                        expect(output).toContain('<source>a<ph id="0" equiv="TAG_IMG" type="image"/>b</source>');
                    });
                    it('should render the "type" for bold elements', () => {
                        const serializer = new xliff2_translation_serializer_1.Xliff2TranslationSerializer('xx', (0, file_system_1.absoluteFrom)('/project'), useLegacyIds, options);
                        const output = serializer.serialize([
                            (0, mock_message_1.mockMessage)('3', ['a', 'b', 'c'], ['START_BOLD_TEXT', 'CLOSE_BOLD_TEXT'], {}),
                        ]);
                        expect(output).toContain('<source>a<pc id="0" equivStart="START_BOLD_TEXT" equivEnd="CLOSE_BOLD_TEXT" type="fmt">b</pc>c</source>');
                    });
                    it('should render the "type" for heading elements', () => {
                        const serializer = new xliff2_translation_serializer_1.Xliff2TranslationSerializer('xx', (0, file_system_1.absoluteFrom)('/project'), useLegacyIds, options);
                        const output = serializer.serialize([
                            (0, mock_message_1.mockMessage)('4', ['a', 'b', 'c'], ['START_HEADING_LEVEL1', 'CLOSE_HEADING_LEVEL1'], {}),
                        ]);
                        expect(output).toContain('<source>a<pc id="0" equivStart="START_HEADING_LEVEL1" equivEnd="CLOSE_HEADING_LEVEL1" type="other">b</pc>c</source>');
                    });
                    it('should render the "type" for span elements', () => {
                        const serializer = new xliff2_translation_serializer_1.Xliff2TranslationSerializer('xx', (0, file_system_1.absoluteFrom)('/project'), useLegacyIds, options);
                        const output = serializer.serialize([
                            (0, mock_message_1.mockMessage)('5', ['a', 'b', 'c'], ['START_TAG_SPAN', 'CLOSE_TAG_SPAN'], {}),
                        ]);
                        expect(output).toContain('<source>a<pc id="0" equivStart="START_TAG_SPAN" equivEnd="CLOSE_TAG_SPAN" type="other">b</pc>c</source>');
                    });
                    it('should render the "type" for div elements', () => {
                        const serializer = new xliff2_translation_serializer_1.Xliff2TranslationSerializer('xx', (0, file_system_1.absoluteFrom)('/project'), useLegacyIds, options);
                        const output = serializer.serialize([
                            (0, mock_message_1.mockMessage)('6', ['a', 'b', 'c'], ['START_TAG_DIV', 'CLOSE_TAG_DIV'], {}),
                        ]);
                        expect(output).toContain('<source>a<pc id="0" equivStart="START_TAG_DIV" equivEnd="CLOSE_TAG_DIV" type="other">b</pc>c</source>');
                    });
                    it('should render the "type" for link elements', () => {
                        const serializer = new xliff2_translation_serializer_1.Xliff2TranslationSerializer('xx', (0, file_system_1.absoluteFrom)('/project'), useLegacyIds, options);
                        const output = serializer.serialize([
                            (0, mock_message_1.mockMessage)('6', ['a', 'b', 'c'], ['START_LINK', 'CLOSE_LINK'], {}),
                        ]);
                        expect(output).toContain('<source>a<pc id="0" equivStart="START_LINK" equivEnd="CLOSE_LINK" type="link">b</pc>c</source>');
                    });
                    it('should render generic close tag placeholders for additional elements', () => {
                        const serializer = new xliff2_translation_serializer_1.Xliff2TranslationSerializer('xx', (0, file_system_1.absoluteFrom)('/project'), useLegacyIds, options);
                        const output = serializer.serialize([
                            (0, mock_message_1.mockMessage)('6', ['a', 'b', 'c', 'd', 'e'], ['START_LINK', 'CLOSE_LINK', 'START_LINK_1', 'CLOSE_LINK'], {}),
                        ]);
                        expect(output).toContain('<source>a<pc id="0" equivStart="START_LINK" equivEnd="CLOSE_LINK" type="link">b</pc>c<pc id="1" equivStart="START_LINK_1" equivEnd="CLOSE_LINK" type="link">d</pc>e</source>');
                    });
                });
            });
        });
        describe('renderFile()', () => {
            it('should consistently order serialized messages by location', () => {
                ...
                const serializer = new xliff2_translation_serializer_1.Xliff2TranslationSerializer('xx', (0, file_system_1.absoluteFrom)('/root'), false, {});
                const output = serializer.serialize(messages);
                expect(output.split('\n')).toEqual([
                    '<?xml version="1.0" encoding="UTF-8" ?>',
                    '<xliff version="2.0" xmlns="urn:oasis:names:tc:xliff:document:2.0" srcLang="xx">',
