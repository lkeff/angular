...
const xliff1_translation_serializer_1 = require("../../../src/extract/translation_files/xliff1_translation_serializer");
    ...
    describe('Xliff1TranslationSerializer', () => {
                ...
                describe(`renderFile() [using ${useLegacyIds ? 'legacy' : 'canonical'} ids]`, () => {
                    it('should convert a set of parsed messages into an XML string', () => {
                        ...
                        const messages = [
                            ...
                            (0, mock_message_1.mockMessage)('38705', ['a', '', 'c'], ['START_TAG_SPAN', 'CLOSE_TAG_SPAN'], {
                                location: {
                                    file: (0, file_system_1.absoluteFrom)('/project/file.ts'),
                        ...
                        const serializer = new xliff1_translation_serializer_1.Xliff1TranslationSerializer('xx', (0, file_system_1.absoluteFrom)('/project'), useLegacyIds, options);
                        const output = serializer.serialize(messages);
                        expect(output).toEqual([
                            `<?xml version="1.0" encoding="UTF-8" ?>`,
                            `<xliff version="1.2" xmlns="urn:oasis:names:tc:xliff:document:1.2">`,
                            `  <file source-language="xx" datatype="plaintext" original="ng2.template"${(0, utils_1.toAttributes)(options)}>`,
                            `    <body>`,
                            ...
                            `        </context-group>`,
                            `      </trans-unit>`,
                            `      <trans-unit id="${useLegacyIds ? '1234567890ABCDEF1234567890ABCDEF12345678' : '12345'}" datatype="html">`,
                    ...
                    it('should render the "ctype" for bold elements', () => {
                        ...
                        expect(output).toContain('<source>a<x id="START_BOLD_TEXT" ctype="x-b"/>b<x id="CLOSE_BOLD_TEXT" ctype="x-b"/>c</source>');
                    });
                    it('should render the "ctype" for headings', () => {
                        ...
                        expect(output).toContain('<source>a<x id="START_HEADING_LEVEL1" ctype="x-h1"/>b<x id="CLOSE_HEADING_LEVEL1" ctype="x-h1"/>c</source>');
                    });
                    it('should render the "ctype" for span elements', () => {
                        ...
                        expect(output).toContain('<source>a<x id="START_TAG_SPAN" ctype="x-span"/>b<x id="CLOSE_TAG_SPAN" ctype="x-span"/>c</source>');
                    });
                    it('should render the "ctype" for div elements', () => {
                        ...
                        expect(output).toContain('<source>a<x id="START_TAG_DIV" ctype="x-div"/>b<x id="CLOSE_TAG_DIV" ctype="x-div"/>c</source>');
                    });
                });
            });
        });
        describe('renderFile()', () => {
            it('should consistently order serialized messages by location', () => {
                ...
                const serializer = new xliff1_translation_serializer_1.Xliff1TranslationSerializer('xx', (0, file_system_1.absoluteFrom)('/root'), false, {});
                const output = serializer.serialize(messages);
                expect(output.split('\n')).toEqual([
                    '<?xml version="1.0" encoding="UTF-8" ?>',
                    '<xliff version="1.2" xmlns="urn:oasis:names:tc:xliff:document:1.2">',
