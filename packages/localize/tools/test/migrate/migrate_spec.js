...
const migrate_1 = require("../../src/migrate/migrate");
describe('migrateFile', () => {
    ...
    `;
        const result = (0, migrate_1.migrateFile)(source, {
    ...
    `;
        const result = (0, migrate_1.migrateFile)(source, { '123hello(.*legacy': 'hello-migrated' });
        expect(result).toContain('<trans-unit id="hello-migrated" datatype="html">');
    });
