...
const locale_plugin_1 = require("../../../src/translate/source_files/locale_plugin");
describe('makeLocalePlugin', () => {
    it('should replace $localize.locale with the locale string', () => {
        const input = '$localize.locale;';
        const output = (0, core_1.transformSync)(input, { plugins: [(0, locale_plugin_1.makeLocalePlugin)('fr')] });
    ...
    it('should remove reference to `$localize` if used in a longer logical expression to guard the locale', () => {
        ...
        const output1 = (0, core_1.transformSync)(input1, { plugins: [(0, locale_plugin_1.makeLocalePlugin)('fr')] });
        expect(output1.code).toEqual('x || y && "fr";');
        const input2 = 'x || y && "undefined" !== typeof $localize && $localize.locale;';
        const output2 = (0, core_1.transformSync)(input2, { plugins: [(0, locale_plugin_1.makeLocalePlugin)('fr')] });
        expect(output2.code).toEqual('x || y && "fr";');
        const input3 = 'x || y && typeof $localize != "undefined" && $localize.locale;';
        const output3 = (0, core_1.transformSync)(input3, { plugins: [(0, locale_plugin_1.makeLocalePlugin)('fr')] });
        expect(output3.code).toEqual('x || y && "fr";');
        const input4 = 'x || y && "undefined" != typeof $localize && $localize.locale;';
        const output4 = (0, core_1.transformSync)(input4, { plugins: [(0, locale_plugin_1.makeLocalePlugin)('fr')] });
