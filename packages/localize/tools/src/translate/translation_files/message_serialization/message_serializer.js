...
class MessageSerializer extends base_visitor_1.BaseVisitor {
    ...
    visitElement(element) {
        if (this.config.placeholder && element.name === this.config.placeholder.elementName) {
            const name = (0, translation_utils_1.getAttrOrThrow)(element, this.config.placeholder.nameAttribute);
            ...
            const start = (0, translation_utils_1.getAttrOrThrow)(element, this.config.placeholderContainer.startAttribute);
            const end = (0, translation_utils_1.getAttrOrThrow)(element, this.config.placeholderContainer.endAttribute);
