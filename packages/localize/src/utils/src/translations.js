...
exports.isMissingTranslationError = isMissingTranslationError;
...
function translate(translations, messageParts, substitutions) {
    const message = (0, messages_1.parseMessage)(messageParts, substitutions);
...
function parseTranslation(messageString) {
    ...
    const rawMessageParts = messageParts.map((part) => part.charAt(0) === constants_1.BLOCK_MARKER ? '\\' + part : part);
    return {
        text: messageString,
