...
const r3_identifiers_1 = require("@angular/compiler/src/render3/r3_identifiers");
const environment_1 = require("../../src/render3/jit/environment");
const INTERFACE_EXCEPTIONS = new Set([
...
describe('r3 jit environment', () => {
    ...
    it('should support all r3 symbols', () => {
        Object
            ...
            .values(r3_identifiers_1.Identifiers)
            ...
            expect(environment_1.angularCoreEnv.hasOwnProperty(sym.name)).toBe(true, `Missing symbol ${sym.name} in render3/jit/environment`);
        });
    });
});
