...
const compiler_facade_1 = require("../../src/compiler/compiler_facade");
...
describe('getCompilerFacade', () => {
    describe('errors', () => {
        ...
        it('reports an error when requested for a decorator', () => {
            try {
                (0, compiler_facade_1.getCompilerFacade)({ usage: 0 /* JitCompilerUsage.Decorator */, kind: 'directive', type: TestClass });
                fail('Error expected as compiler facade is not available');
            }
            catch (e) {
                expect(e.message).toEqual(`The directive 'TestClass' needs to be compiled using the JIT compiler, but '@angular/compiler' is not available.
...
or manually provide the compiler with 'import "@angular/compiler";' before bootstrapping.`);
        ...
        it('reports an error when requested for a partial declaration', () => {
            try {
                (0, compiler_facade_1.getCompilerFacade)({
...
let ɵcompilerFacade = null;
function clearCompilerFacade() {
    const ng = global_1.global.ng;
