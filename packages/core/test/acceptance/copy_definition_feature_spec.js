...
describe('CopyDefinitionFeature', () => {
    it('should copy the template function of a component definition from parent to child', () => {
        ...
        BaseComponent.ɵcmp = (0, core_1.ɵɵdefineComponent)({
            type: BaseComponent,
            selectors: [['some-cmp']],
            decls: 0,
            vars: 0,
        ...
        ChildComponent.ɵcmp = (0, core_1.ɵɵdefineComponent)({
            type: ChildComponent,
            selectors: [['some-cmp']],
            standalone: false,
            features: [core_1.ɵɵInheritDefinitionFeature, core_1.ɵɵCopyDefinitionFeature],
            decls: 0,
            vars: 0,
        ...
        const child = fixture.debugElement.children[0].componentInstance;
