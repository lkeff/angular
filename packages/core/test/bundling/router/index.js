...
let ListComponent = (() => {
  ...
  `,
    ...
    let _classThis;
    var ListComponent = _classThis = class {
    };
    __setFunctionName(_classThis, "ListComponent");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ListComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ListComponent = _classThis;
})();
let ItemComponent = (() => {
    let _classDecorators = [(0, core_1.Component)({
            selector: 'app-item',
...
window.waitForApp = (0, platform_browser_1.bootstrapApplication)(RootComponent, {
    providers: [(0, router_1.provideRouter)(ROUTES), { provide: common_1.APP_BASE_HREF, useValue: '' }],
});
