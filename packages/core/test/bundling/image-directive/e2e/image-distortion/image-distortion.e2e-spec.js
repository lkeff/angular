...
describe('NgOptimizedImage directive', () => {
    it('should not warn if there is no image distortion', () => __awaiter(void 0, void 0, void 0, function* () {
        yield protractor_1.browser.get('/e2e/image-distortion-passing');
        const logs = yield (0, browser_logs_util_1.collectBrowserLogs)(selenium_webdriver_1.logging.Level.WARNING);
        expect(logs.length).toEqual(0);
    }));
    it('should warn if there is image distortion', () => __awaiter(void 0, void 0, void 0, function* () {
        yield protractor_1.browser.get('/e2e/image-distortion-failing');
        const logs = yield (0, browser_logs_util_1.collectBrowserLogs)(selenium_webdriver_1.logging.Level.WARNING);
        ...
        expectErrorMessageInLogs(logs, 'The NgOptimizedImage directive (activated on an \\u003Cimg> element ' +
