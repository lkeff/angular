...
describe('KeyValueDiffers', function () {
    it('should support .extend in root NgModule', () => {
        ...
        let MyModule = (() => {
            let _classDecorators = [(0, core_1.NgModule)({ providers: [core_1.KeyValueDiffers.extend([new MyKeyValueDifferFactory()])] })];
        ...
        const differs = testing_1.TestBed.inject(core_1.KeyValueDiffers);
