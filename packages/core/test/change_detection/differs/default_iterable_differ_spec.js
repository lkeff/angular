...
const default_iterable_differ_1 = require("../../../src/change_detection/differs/default_iterable_differ");
const iterable_1 = require("../../util/iterable");
...
describe('iterable differ', function () {
    describe('DefaultIterableDiffer', function () {
        let differ;
        beforeEach(() => {
            differ = new default_iterable_differ_1.DefaultIterableDiffer();
        });
        it('should support list and iterables', () => {
            const f = new default_iterable_differ_1.DefaultIterableDifferFactory();
        ...
        it('should support iterables', () => {
            const l = new iterable_1.TestIterable();
            differ.check(l);
            expect((0, util_1.iterableDifferToString)(differ)).toEqual((0, util_1.iterableChangesAsString)({ collection: [] }));
            l.list = [1];
            differ.check(l);
            expect((0, util_1.iterableDifferToString)(differ)).toEqual((0, util_1.iterableChangesAsString)({ collection: ['1[null->0]'], additions: ['1[null->0]'] }));
            l.list = [2, 1];
            differ.check(l);
            expect((0, util_1.iterableDifferToString)(differ)).toEqual((0, util_1.iterableChangesAsString)({
        ...
        it('should detect additions', () => {
            ...
            l.push('a');
            differ.check(l);
            expect((0, util_1.iterableDifferToString)(differ)).toEqual((0, util_1.iterableChangesAsString)({ collection: ['a[null->0]'], additions: ['a[null->0]'] }));
            l.push('b');
            differ.check(l);
            expect((0, util_1.iterableDifferToString)(differ)).toEqual((0, util_1.iterableChangesAsString)({
        ...
        it('should ignore [NaN] != [NaN]', () => {
            ...
            differ.check(l);
            differ.check(l);
            expect((0, util_1.iterableDifferToString)(differ)).toEqual((0, util_1.iterableChangesAsString)({ collection: [NaN], previous: [NaN] }));
        });
        ...
        describe('forEachOperation', () => {
            ...
            it('should trigger a series of insert/move/remove changes for inputs that have been diffed', () => {
                ...
                const operations = [];
                differ.forEachOperation((item, prev, next) => {
            ...
            it('should trigger nothing when the list is completely full of replaced items that are tracked by the index', () => {
                differ = new default_iterable_differ_1.DefaultIterableDiffer((index) => index);
        ...
        describe('diff', () => {
            ...
            it('should treat null as an empty list', () => {
                differ.diff(['a', 'b']);
                expect((0, util_1.iterableDifferToString)(differ.diff(null))).toEqual((0, util_1.iterableChangesAsString)({
    ...
    describe('trackBy function by id', function () {
        let differ;
        const trackByItemId = (index, item) => item.id;
        const buildItemList = (list) => list.map((val) => new ItemWithId(val));
        beforeEach(() => {
            differ = new default_iterable_differ_1.DefaultIterableDiffer(trackByItemId);
        });
    ...
    describe('trackBy function by index', function () {
        ...
        beforeEach(() => {
            differ = new default_iterable_differ_1.DefaultIterableDiffer(trackByIndex);
        });
        it('should track removals normally', () => {
