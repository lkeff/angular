...
const default_keyvalue_differ_1 = require("../../../src/change_detection/differs/default_keyvalue_differ");
...
describe('keyvalue differ', function () {
    describe('DefaultKeyValueDiffer', function () {
        ...
        it('should detect additions', () => {
            ...
            m.set('a', 1);
            differ.check(m);
            expect((0, util_1.kvChangesAsString)(differ)).toEqual((0, util_1.testChangesAsString)({ map: ['a[null->1]'], additions: ['a[null->1]'] }));
            m.set('b', 2);
            differ.check(m);
            expect((0, util_1.kvChangesAsString)(differ)).toEqual((0, util_1.testChangesAsString)({ map: ['a', 'b[null->2]'], previous: ['a'], additions: ['b[null->2]'] }));
        });
        it('should handle changing key/values correctly', () => {
            ...
            m.set(1, 20);
            differ.check(m);
            expect((0, util_1.kvChangesAsString)(differ)).toEqual((0, util_1.testChangesAsString)({
                map: ['1[10->20]', '2[20->10]'],
        ...
        it('should do basic map watching', () => {
            ...
            m.set('a', 'A');
            differ.check(m);
            expect((0, util_1.kvChangesAsString)(differ)).toEqual((0, util_1.testChangesAsString)({ map: ['a[null->A]'], additions: ['a[null->A]'] }));
            m.set('b', 'B');
            differ.check(m);
            expect((0, util_1.kvChangesAsString)(differ)).toEqual((0, util_1.testChangesAsString)({ map: ['a', 'b[null->B]'], previous: ['a'], additions: ['b[null->B]'] }));
            m.set('b', 'BB');
            m.set('d', 'D');
            differ.check(m);
            expect((0, util_1.kvChangesAsString)(differ)).toEqual((0, util_1.testChangesAsString)({
        ...
        it('should not see a NaN value as a change', () => {
            ...
            differ.check(m);
            differ.check(m);
            expect((0, util_1.kvChangesAsString)(differ)).toEqual((0, util_1.testChangesAsString)({ map: ['foo'], previous: ['foo'] }));
        });
        ...
        describe('JsObject changes', () => {
            it('should support JS Object', () => {
                const f = new default_keyvalue_differ_1.DefaultKeyValueDifferFactory();
        ...
        describe('diff', () => {
            ...
            it('should treat null as an empty list', () => {
                m.set('a', 'A');
                differ.diff(m);
                expect((0, util_1.kvChangesAsString)(differ.diff(null))).toEqual((0, util_1.testChangesAsString)({ previous: ['a[A->null]'], removals: ['a[A->null]'] }));
            });
