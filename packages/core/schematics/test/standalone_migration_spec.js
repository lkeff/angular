...
describe('standalone migration', () => {
    ...
    `);
        ...
        writeFile('/node_modules/some_internal_path/angular/testing/catalyst/fake_async/index.d.ts', fakeCatalyst);
        writeFile('/node_modules/some_internal_path/angular/testing/catalyst/async/index.d.ts', fakeCatalyst);
    ...
    `);
        try {
            yield runMigration('convert-to-standalone', './foo');
        }
        catch (e) {
            error = e.message;
        }
        expect(error).toMatch(/Could not find any files to migrate under the path .*\/foo\. Cannot run the standalone migration/);
    }));
    ...
    it('should throw an error if the passed in path is a file', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        writeFile('dir.ts', '');
        try {
            yield runMigration('convert-to-standalone', './dir.ts');
        }
        catch (e) {
            error = e.message;
        }
        expect(error).toMatch(/Migration path .*\/dir\.ts has to be a directory\. Cannot run the standalone migration/);
    }));
    it('should create an `imports` array if the module does not have one already', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
      ...
      export class Mod {}
    `);
        yield runMigration('convert-to-standalone');
        expect(stripWhitespace(tree.readContent('module.ts'))).toContain(stripWhitespace(`@NgModule({imports: [MyDir]})`));
    }));
    it('should combine the `declarations` array with a static `imports` array', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
      import {NgModule, Directive} from '@angular/core';
    ...
    `);
        yield runMigration('convert-to-standalone');
        expect(stripWhitespace(tree.readContent('module.ts'))).toContain(stripWhitespace(`@NgModule({imports: [CommonModule, MyDir]})`));
    }));
    it('should combine a `declarations` array with a spread expression into the `imports`', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
        import {NgModule, Directive} from '@angular/core';
        import {CommonModule} from '@angular/common';
      ...
      `);
        yield runMigration('convert-to-standalone');
        expect(stripWhitespace(tree.readContent('module.ts'))).toContain(stripWhitespace(`@NgModule({imports: [CommonModule, MyDir, ...extraDeclarations]})`));
    }));
    it('should combine a `declarations` array with an `imports` array that has a spread expression', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
        import {NgModule, Directive} from '@angular/core';
        import {CommonModule} from '@angular/common';
      ...
      `);
        yield runMigration('convert-to-standalone');
        expect(stripWhitespace(tree.readContent('module.ts'))).toContain(stripWhitespace(`@NgModule({imports: [CommonModule, ...extraImports, MyDir]})`));
    }));
    it('should use a spread expression if the `declarations` is an expression when combining with the `imports`', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
        import {NgModule, Directive} from '@angular/core';
        import {CommonModule} from '@angular/common';
      ...
      `);
        yield runMigration('convert-to-standalone');
        expect(stripWhitespace(tree.readContent('module.ts'))).toContain(stripWhitespace(`@NgModule({imports: [CommonModule, ...DECLARATIONS]})`));
    }));
    it('should use a spread expression if the `imports` is an expression when combining with the `declarations`', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
        import {NgModule, Directive} from '@angular/core';
        import {CommonModule} from '@angular/common';
      ...
      `);
        yield runMigration('convert-to-standalone');
        expect(stripWhitespace(tree.readContent('module.ts'))).toContain(stripWhitespace(`@NgModule({imports: [...IMPORTS, MyDir]})`));
    }));
    it('should use a spread expression if both the `declarations` and the `imports` are not static arrays', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
        import {NgModule, Directive} from '@angular/core';
        import {CommonModule} from '@angular/common';
      ...
      `);
        yield runMigration('convert-to-standalone');
        expect(stripWhitespace(tree.readContent('module.ts'))).toContain(stripWhitespace(`@NgModule({imports: [...IMPORTS, ...DECLARATIONS]})`));
    }));
    it('should convert a directive in the same file as its module to standalone', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
      import {NgModule, Directive} from '@angular/core';
    ...
    `);
        ...
        expect(stripWhitespace(result)).toContain(stripWhitespace(`@NgModule({imports: [MyDir], exports: [MyDir]})`));
    }));
    it('should convert a pipe in the same file as its module to standalone', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
    ...
    `);
        ...
        expect(stripWhitespace(result)).toContain(stripWhitespace(`@NgModule({imports: [MyPipe], exports: [MyPipe]})`));
    }));
    it('should only migrate declarations under a specific path', () => __awaiter(void 0, void 0, void 0, function* () {
        const content = `
      import {NgModule, Directive} from '@angular/core';
    ...
    `;
        ...
        yield runMigration('convert-to-standalone', './apps/app-2');
    ...
    it('should convert a directive in a different file from its module to standalone', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
    ...
    `);
        yield runMigration('convert-to-standalone');
        expect(stripWhitespace(tree.readContent('module.ts'))).toContain(stripWhitespace(`@NgModule({imports: [MyDir], exports: [MyDir]})`));
        expect(stripWhitespace(tree.readContent('dir.ts'))).toContain(stripWhitespace(`@Directive({selector: '[dir]'})`));
    }));
    it('should convert a component with no template dependencies to standalone', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
      import {NgModule} from '@angular/core';
    ...
    `);
        yield runMigration('convert-to-standalone');
        expect(stripWhitespace(tree.readContent('module.ts'))).toContain(stripWhitespace(`@NgModule({imports: [MyComp], exports: [MyComp]})`));
    ...
    it('should add imports to dependencies within the same module', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
      import {NgModule} from '@angular/core';
      import {MyComp} from './comp';
    ...
    `));
        expect(stripWhitespace(tree.readContent('module.ts'))).toContain(stripWhitespace(`@NgModule({imports: [MyComp, MyButton, MyTooltip], exports: [MyComp]})`));
        expect(stripWhitespace(tree.readContent('button.ts'))).toContain(stripWhitespace(`@Component({selector: 'my-button', template: '<ng-content></ng-content>'})`));
        expect(stripWhitespace(tree.readContent('tooltip.ts'))).toContain(stripWhitespace(`@Directive({selector: '[tooltip]'})`));
    }));
    it('should reuse existing import statements when adding imports to a component', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
      import {NgModule} from '@angular/core';
      import {MyComp} from './comp';
      import {MyButton} from './button';
    ...
    it('should refer to pre-existing standalone dependencies directly when adding to the `imports`', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
        import {NgModule} from '@angular/core';
        import {MyComp} from './comp';
        import {MyButton} from './button';
      ...
      `);
       ...
       `));
        expect(stripWhitespace(tree.readContent('module.ts'))).toContain(stripWhitespace('@NgModule({imports: [MyButton, MyComp], exports: [MyComp]})'));
    }));
    it('should refer to dependencies being handled in the same migration directly', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
      import {NgModule} from '@angular/core';
      import {MyComp} from './comp';
    ...
    it('should refer to dependencies by their module if they have been excluded from the migration', () => __awaiter(void 0, void 0, void 0, function* () {
      ...
      `);
        ...
        export class MyButton {}
      `);
        yield runMigration('convert-to-standalone', './should-migrate');
        const myCompContent = tree.readContent('./should-migrate/comp.ts');
        expect(myCompContent).toContain(`import { ButtonModule } from '../do-not-migrate/button.module';`);
        expect(stripWhitespace(myCompContent)).toContain(stripWhitespace(`
        @Component({
          selector: 'my-comp',
          template: '<my-button>Hello</my-button>',
      ...
      `));
        expect(stripWhitespace(tree.readContent('./should-migrate/module.ts'))).toContain(stripWhitespace(`@NgModule({imports: [ButtonModule, MyComp], exports: [MyComp]})`));
        expect(tree.readContent('./do-not-migrate/button.ts')).toContain('standalone: false');
        expect(stripWhitespace(tree.readContent('./do-not-migrate/button.module.ts'))).toContain(stripWhitespace(`@NgModule({declarations: [MyButton], exports: [MyButton]})`));
    }));
    it('should add imports to dependencies within the same module', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
        import {NgModule} from '@angular/core';
    ...
    it('should add imports to external dependencies', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
      import {NgModule} from '@angular/core';
      import {CommonModule} from '@angular/common';
    ...
    `));
        expect(stripWhitespace(tree.readContent('module.ts'))).toContain(stripWhitespace(`@NgModule({imports: [CommonModule, MyComp, MyOtherComp], exports: [MyComp]})`));
    }));
    it('should add imports to pipes that are used in the template', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
      import {NgModule} from '@angular/core';
      import {MyComp} from './comp';
    ...
    `));
        expect(stripWhitespace(tree.readContent('module.ts'))).toContain(stripWhitespace(`@NgModule({imports: [MyComp, MyPipe], exports: [MyComp]})`));
        expect(stripWhitespace(tree.readContent('pipe.ts'))).toContain(stripWhitespace(`@Pipe({name: 'myPipe'})`));
    }));
    it('should migrate tests with an inline NgModule', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should migrate tests where the declaration is already standalone', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('comp.ts', `
      import {Component} from '@angular/core';
    ...
    it('should import the module that declares a template dependency', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('./should-migrate/module.ts', `
      import {NgModule} from '@angular/core';
      import {MyComp} from './comp';
      import {ButtonModule} from '../do-not-migrate/button.module';
    ...
    it('should not reference internal modules', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('./should-migrate/module.ts', `
      import {NgModule} from '@angular/core';
      import {MyComp} from './comp';
    ...
    `);
        yield runMigration('convert-to-standalone', './should-migrate');
        const myCompContent = tree.readContent('./should-migrate/comp.ts');
        expect(myCompContent).toContain(`import { ExporterModule } from '../do-not-migrate/button.module';`);
        expect(myCompContent).toContain('imports: [ExporterModule]');
    }));
    it('should migrate tests with a component declared through TestBed', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('app.spec.ts', `
      import {NgModule, Component} from '@angular/core';
      import {TestBed} from '@angular/core/testing';
      import {ButtonModule} from './button.module';
    ...
    it('should not add ModuleWithProviders imports to the `imports` in a test', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('app.spec.ts', `
      import {NgModule, Component} from '@angular/core';
      import {TestBed} from '@angular/core/testing';
      import {MatCardModule} from '@angular/material/card';
    ...
    it('should not change testing objects with no declarations', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    [
        ...
        it(`[${name}] should migrate tests with a component declared through Catalyst`, () => __awaiter(void 0, void 0, void 0, function* () {
            writeFile('app.spec.ts', `
        import {NgModule, Component} from '@angular/core';
    ...
    it('should not copy over the NoopAnimationsModule into the imports of a test component', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('app.spec.ts', `
          import {NgModule, Component} from '@angular/core';
          import {TestBed} from '@angular/core/testing';
          import {MatCardModule} from '@angular/material/card';
    ...
    it('should not copy over the BrowserAnimationsModule into the imports of a test component', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('app.spec.ts', `
          import {NgModule, Component} from '@angular/core';
          import {TestBed} from '@angular/core/testing';
          import {MatCardModule} from '@angular/material/card';
    ...
    it('should not move declarations that are not being migrated out of the declarations array', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should not migrate `configureTestingModule` with a non-array expression in the `declarations` field', () => __awaiter(void 0, void 0, void 0, function* () {
        const initialContent = `
          import {NgModule, Component} from '@angular/core';
          import {TestBed} from '@angular/core/testing';
          import {ButtonModule} from './button.module';
    ...
    it('should not migrate modules with a `bootstrap` array', () => __awaiter(void 0, void 0, void 0, function* () {
        const initialModule = `
      import {NgModule, Component} from '@angular/core';
    ...
    it('should migrate a module with an empty `bootstrap` array', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
      import {NgModule, Component} from '@angular/core';
    ...
    it('should migrate declarations that are not being bootstrapped in a root module', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('dir.ts', `
      import {Directive} from '@angular/core';
    ...
    it('should generate a forwardRef for forward reference within the same file', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('decls.ts', `
    ...
    it('should not generate a forwardRef for a self import', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('decls.ts', `
      import {Component} from '@angular/core';
    ...
    it('should not generate a forwardRef when adding an imported module dependency', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('./comp.ts', `
    ...
    it('should not duplicate doc strings', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
      import {NgModule, Directive} from '@angular/core';
    ...
    it('should use the generated alias if a conflicting symbol already exists', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
      import {NgModule} from '@angular/core';
      import {MyComp} from './comp';
      import {MyButton} from './button';
    ...
    it('should preserve the trailing comma when adding an `imports` array', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
      import {NgModule, Directive} from '@angular/core';
    ...
    it('should preserve the trailing comma when adding to an existing `imports` array', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
      import {NgModule, Directive} from '@angular/core';
      import {CommonModule} from '@angular/common';
      import {RouterModule} from '@angular/router';
    ...
    it('should preserve the trailing comma when marking a directive as standalone', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
      import {NgModule, Directive} from '@angular/core';
    ...
    it('should add a trailing comma when generating an imports array in a component', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
    ...
    it('should handle a directive that is explicitly standalone: false', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('module.ts', `
      import {NgModule, Directive} from '@angular/core';
    ...
    it('should remove a module that only has imports and exports', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    `);
      ...
      export class MyButton {}
    `);
        yield runMigration('prune-ng-modules');
    ...
    it('should not remove a module that has declarations', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should not remove a module that bootstraps a component', () => __awaiter(void 0, void 0, void 0, function* () {
        const initialAppModule = `
      import {NgModule} from '@angular/core';
      import {MyComp} from './comp';
      import {ButtonModule} from './button.module';
    ...
    it('should not remove a module that has providers', () => __awaiter(void 0, void 0, void 0, function* () {
        const initialAppModule = `
    ...
    it('should not remove a module that imports a ModuleWithProviders', () => __awaiter(void 0, void 0, void 0, function* () {
        const initialAppModule = `
      import {NgModule} from '@angular/core';
      import {RouterModule} from '@angular/router';
    ...
    it('should not remove a module that has class members', () => __awaiter(void 0, void 0, void 0, function* () {
        const initialAppModule = `
      import {NgModule} from '@angular/core';
      import {ButtonModule} from './button.module';
    ...
    it('should remove a module that only has an empty constructor', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('app.module.ts', `
      import {NgModule} from '@angular/core';
      import {ButtonModule} from './button.module';
    ...
    it('should remove a module with no arguments passed into NgModule', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('app.module.ts', `
      import {NgModule} from '@angular/core';
    ...
    it('should remove a module file where there is unexported code', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('app.module.ts', `
      import {NgModule} from '@angular/core';
    ...
    it('should remove a module that passes empty arrays into `declarations`, `providers` and `bootstrap`', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('app.module.ts', `
          import {NgModule} from '@angular/core';
          import {ButtonModule} from './button.module';
    ...
    it('should remove a chain of modules that all depend on each other', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should not remove a chain of modules if a module in the chain cannot be removed because it has providers', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should not remove a chain of modules if a module in the chain cannot be removed because it is importing a ModuleWithProviders', () => __awaiter(void 0, void 0, void 0, function* () {
        const moduleAContent = `
          import {NgModule} from '@angular/core';
    ...
    it('should not remove the module file if it contains other exported code', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('app.module.ts', `
      import {NgModule} from '@angular/core';
      import {MyComp} from './comp';
    ...
    it('should delete a file that contains multiple modules that are being deleted', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('app.module.ts', `
      import {NgModule} from '@angular/core';
      import {MyComp} from './comp';
    ...
    it('should preserve an import that has one NgModule that is being deleted, in addition to a named import', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('app.module.ts', `
          import {NgModule} from '@angular/core';
          import {MyComp} from './comp';
    ...
    it('should remove module references from export expressions', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('app.module.ts', `
      import {NgModule} from '@angular/core';
      import {MyComp} from './comp';
    ...
    it('should remove barrel export if the corresponding file is deleted', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('app.module.ts', `
      import {NgModule} from '@angular/core';
      import {MyComp} from './comp';
    ...
    it('should remove barrel files referring to other barrel files that were deleted', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('app.module.ts', `
      import {NgModule} from '@angular/core';
      import {MyDir} from './dir';
    ...
    it('should not delete dependent barrel files if they have some barrel exports that will not be removed', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('app.module.ts', `
        import {NgModule} from '@angular/core';
        import {MyDir} from './dir';
      ...
      `);
        ...
        yield runMigration('prune-ng-modules');
        expect(tree.exists('index.ts')).toBe(false);
        expect(stripWhitespace(tree.readContent('index-2.ts'))).toBe(stripWhitespace(`export * from './utils';`));
        expect(stripWhitespace(tree.readContent('index-3.ts'))).toBe(stripWhitespace(`export * from './index-2';`));
    }));
    it('should add a comment to locations that cannot be removed automatically', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('app.module.ts', `
      import {NgModule} from '@angular/core';
      import {MyComp} from './comp';
      import {ButtonModule} from './button.module';
    ...
    it('should preserve the trailing comma when deleting a module', () => __awaiter(void 0, void 0, void 0, function* () {
        const initialAppModule = `
      import {NgModule, InjectionToken} from '@angular/core';
      import {CommonModule} from '@angular/common';
      import {RouterModule} from '@angular/router';
    ...
    it('should replace any leftover NgModule classes in imports arrays with the exports used in the template', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('button.module.ts', `
      import {NgModule, Directive} from '@angular/core';
    ...
    it('should replace any leftover NgModule classes in testing module imports arrays with the module exports', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('button.module.ts', `
      import {NgModule, Directive} from '@angular/core';
    ...
    `);
        yield runMigration('prune-ng-modules');
        expect(tree.exists('button.module.ts')).toBe(false);
        expect(stripWhitespace(tree.readContent('test.ts'))).toBe(stripWhitespace(`
        import {bootstrapTemplate, setupModule} from 'some_internal_path/angular/testing/catalyst/fake_async';
    ...
    it('should remove leftover NgModule that does not have any exports', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('button.module.ts', `
      import {NgModule, Directive} from '@angular/core';
    ...
    it('should not duplicate imports when replacing leftover module with its imports', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('button.module.ts', `
      import {NgModule, Directive} from '@angular/core';
    ...
    it('should switch a platformBrowser().bootstrapModule call to bootstrapApplication', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
    ...
    `);
      ...
      export class AppModule {}
    `);
        yield runMigration('standalone-bootstrap');
    ...
    it('should switch a platformBrowserDynamic().bootstrapModule call to bootstrapApplication', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
          import {AppModule} from './app/app.module';
    ...
    it('should switch a PlatformRef.bootstrapModule call to bootstrapApplication', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
      import {AppModule} from './app/app.module';
      import {PlatformRef} from '@angular/core';
    ...
    it('should convert the root module declarations to standalone', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
      import {AppModule} from './app/app.module';
      import {platformBrowser} from '@angular/platform-browser';
    ...
    it('should migrate the root component tests when converting to standalone', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
      import {AppModule} from './app/app.module';
      import {platformBrowser} from '@angular/platform-browser';
    ...
    it('should copy providers and the symbols they depend on to the main file', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
      import {AppModule} from './app/app.module';
      import {platformBrowser} from '@angular/platform-browser';
    ...
    it('should not copy over non-declaration references to the main file', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
      import {AppModule} from './app/app.module';
      import {platformBrowser} from '@angular/platform-browser';
    ...
    it('should update dynamic imports from the `providers` that are copied to the main file', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
          import {AppModule} from './app/app.module';
          import {platformBrowser} from '@angular/platform-browser';
    ...
    it('should copy modules from the `imports` array to the `providers` and wrap them in `importProvidersFrom`', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
        import {AppModule} from './app/app.module';
        import {platformBrowser} from '@angular/platform-browser';
    ...
    it('should switch RouterModule.forRoot calls with one argument to provideRouter', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
      import {AppModule} from './app/app.module';
      import {platformBrowser} from '@angular/platform-browser';
    ...
    it('should migrate a RouterModule.forRoot call with an empty config', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
      import {AppModule} from './app/app.module';
      import {platformBrowser} from '@angular/platform-browser';
    ...
    it('should migrate a router config with a preloadingStrategy to withPreloading', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
      import {AppModule} from './app/app.module';
      import {platformBrowser} from '@angular/platform-browser';
    ...
    it('should migrate a router config with enableTracing to withDebugTracing', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
      import {AppModule} from './app/app.module';
      import {platformBrowser} from '@angular/platform-browser';
    ...
    it('should migrate a router config with `initialNavigation: "enabledBlocking"` to withEnabledBlockingInitialNavigation', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
          import {AppModule} from './app/app.module';
          import {platformBrowser} from '@angular/platform-browser';
    ...
    it('should migrate a router config with `initialNavigation: "enabled"` to withEnabledBlockingInitialNavigation', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
          import {AppModule} from './app/app.module';
          import {platformBrowser} from '@angular/platform-browser';
    ...
    it('should migrate a router config with `initialNavigation: "disabled"` to withDisabledInitialNavigation', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
          import {AppModule} from './app/app.module';
          import {platformBrowser} from '@angular/platform-browser';
    ...
    it('should migrate a router config with useHash to withHashLocation', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
      import {AppModule} from './app/app.module';
      import {platformBrowser} from '@angular/platform-browser';
    ...
    it('should migrate a router config with errorHandler to withNavigationErrorHandler', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
          import {AppModule} from './app/app.module';
          import {platformBrowser} from '@angular/platform-browser';
    ...
    it('should combine the anchorScrolling and scrollPositionRestoration of a router config into withInMemoryScrolling', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
          import {AppModule} from './app/app.module';
          import {platformBrowser} from '@angular/platform-browser';
    ...
    it('should copy properties that do not map to a feature into withRouterConfig', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
      import {AppModule} from './app/app.module';
      import {platformBrowser} from '@angular/platform-browser';
    ...
    it('should preserve a RouterModule.forRoot where the config cannot be statically analyzed', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
        import {AppModule} from './app/app.module';
        import {platformBrowser} from '@angular/platform-browser';
    ...
    it('should convert BrowserAnimationsModule references to provideAnimations', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
      import {AppModule} from './app/app.module';
      import {platformBrowser} from '@angular/platform-browser';
    ...
    it('should preserve BrowserAnimationsModule.withConfig calls', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
      import {AppModule} from './app/app.module';
      import {platformBrowser} from '@angular/platform-browser';
    ...
    it('should convert NoopAnimationsModule references to provideNoopAnimations', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
      import {AppModule} from './app/app.module';
      import {platformBrowser} from '@angular/platform-browser';
    ...
    it('should convert HttpClientModule references to provideHttpClient(withInterceptorsFromDi())', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
      import {AppModule} from './app/app.module';
      import {platformBrowser} from '@angular/platform-browser';
    ...
    it('should omit standalone directives from the imports array from the importProvidersFrom call', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
        import {AppModule} from './app/app.module';
        import {platformBrowser} from '@angular/platform-browser';
    ...
    it('should be able to migrate a bootstrapModule call where the root component does not belong to the bootstrapped component', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
        import {AppModule} from './app/app.module';
        import {platformBrowser} from '@angular/platform-browser';
    ...
    it('should add Protractor support if any tests are detected', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
      import {AppModule} from './app/app.module';
      import {platformBrowser} from '@angular/platform-browser';
    ...
    it('should add Protractor support if any tests with deep imports are detected', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('main.ts', `
      import {AppModule} from './app/app.module';
      import {platformBrowser} from '@angular/platform-browser';
