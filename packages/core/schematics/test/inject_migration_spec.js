...
describe('inject migration', () => {
    ...
    ['Directive', 'Component', 'Pipe', 'NgModule'].forEach((decorator) => {
        it(`should migrate a @${decorator} to use inject()`, () => __awaiter(void 0, void 0, void 0, function* () {
            writeFile('/dir.ts', [
    ...
    it('should take the injected type from @Inject()', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
    ...
    it('should account for string tokens in @Inject()', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive, Inject } from '@angular/core';`,
            ``,
            `@Directive()`,
    ...
    it('should account for injected generic parameters', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
    ...
    it('should transform @Attribute() to HostAttributeToken', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
    ...
    it('should generate the options object if additional decorators are used', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
    ...
    it('should preserve parameter decorators if they are used outside of the migrated class', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
    ...
    it('should migrate an aliased decorator to use inject()', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
    ...
    it('should only migrate classes in the specified directory', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/should-migrate/dir.ts', [
        ...
        writeFile('/should-not-migrate/other-dir.ts', [
            `import { Directive } from '@angular/core';`,
            `import { Foo } from 'foo';`,
            ``,
            `@Directive()`,
        ...
        yield runMigration({ path: '/should-migrate' });
    ...
    it('should not migrate classes decorated with a non-Angular decorator', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
    ...
    it('should preserve the constructor if it has other expressions', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive } from '@angular/core';`,
            `import { Foo } from 'foo';`,
            ``,
    ...
    it('should declare a variable if an injected parameter without modifiers is referenced in the constructor', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive } from '@angular/core';`,
            `import { Foo } from 'foo';`,
            ``,
    ...
    it('should declare a variable if an injected parameter with modifiers is referenced in the constructor', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive } from '@angular/core';`,
            `import { Foo } from 'foo';`,
            ``,
    ...
    it('should declare a variable if an injected parameter with modifiers is referenced in the constructor via shorthand assignment', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
    ...
    it('should not declare a variable in the constructor if the only references to the parameter are shadowed', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive } from '@angular/core';`,
            `import { Foo } from 'foo';`,
            ``,
    ...
    it('should remove all constructor signatures when deleting its implementation', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive } from '@angular/core';`,
            `import { Foo } from 'foo';`,
            `import { Bar } from 'bar';`,
    ...
    it('should remove constructor overloads when preserving its implementation', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive } from '@angular/core';`,
            `import { Foo } from 'foo';`,
            `import { Bar } from 'bar';`,
    ...
    it('should handle multi-line constructor parameters', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive } from '@angular/core';`,
            `import { Foo } from 'foo';`,
            `import { Bar } from 'bar';`,
    ...
    it('should handle multi-line constructor parameters with a trailing comma', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive } from '@angular/core';`,
            `import { Foo } from 'foo';`,
            `import { Bar } from 'bar';`,
    ...
    it('should insert the new class members before any pre-existing ones', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive } from '@angular/core';`,
            `import { Foo } from 'foo';`,
            ``,
    ...
    it('should exclude the public modifier from newly-created members', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive } from '@angular/core';`,
            `import { Foo } from 'foo';`,
            ``,
    ...
    it('should account for super() calls', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive } from '@angular/core';`,
    ...
    it('should remove the constructor if it only has a super() call after the migration', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive } from '@angular/core';`,
            `import { Parent } from './parent';`,
    ...
    it('should be able to opt into generating backwards-compatible constructors for a class with existing members', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive } from '@angular/core';`,
            `import { Foo } from 'foo';`,
            ``,
        ...
        yield runMigration({ backwardsCompatibleConstructors: true });
        expect(tree.readContent('/dir.ts').split('\n')).toEqual([
            `import { Directive, inject } from '@angular/core';`,
            `import { Foo } from 'foo';`,
            ``,
    ...
    it('should be able to opt into generating backwards-compatible constructors for a class that only has a constructor', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive } from '@angular/core';`,
            `import { Foo } from 'foo';`,
            ``,
    ...
    it('should not remove the constructor, even if it only has a super call, if backwards compatible constructors are enabled', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive } from '@angular/core';`,
            `import { Parent } from './parent';`,
            `import { SomeService } from './service';`,
    ...
    it('should not migrate abstract classes by default', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should be able to opt into migrating abstract classes', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive } from '@angular/core';`,
            `import { Foo } from 'foo';`,
            ``,
        ...
        yield runMigration({ migrateAbstractClasses: true });
        expect(tree.readContent('/dir.ts').split('\n')).toEqual([
            `import { Directive, inject } from '@angular/core';`,
            `import { Foo } from 'foo';`,
            ``,
    ...
    it('should migrate a file that uses tabs for indentation', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should migrate a file that uses CRLF line endings', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive } from '@angular/core';`,
            `import { Foo } from 'foo';`,
            `import { Bar } from './bar';`,
    ...
    it('should allow users to opt into generating non-nullable optional calls', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
        ...
        yield runMigration({ nonNullableOptional: true });
        expect(tree.readContent('/dir.ts').split('\n')).toEqual([
            `import { Directive, inject } from '@angular/core';`,
            `import { Foo } from 'foo';`,
            ``,
    ...
    it('should not add non-null assertions around sites that were nullable before the migration', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive, Inject, Optional } from '@angular/core';`,
    ...
    it('should add non-null assertion for @Attribute injections when enabled', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
    ...
    it('should pick up the first non-literal type if a parameter has a union type', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive, Optional } from '@angular/core';`,
            `import { Foo } from 'foo';`,
            ``,
    ...
    it('should preserve type literals in @Inject parameter', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive, Inject } from '@angular/core';`,
    ...
    it('should preserve tuple types in @Inject parameter', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive, Inject } from '@angular/core';`,
            `import { FOO_TOKEN } from 'foo';`,
            ``,
    ...
    it('should not migrate class that has un-injectable parameters', () => __awaiter(void 0, void 0, void 0, function* () {
        const initialText = [
            `import { Directive, Inject } from '@angular/core';`,
    ...
    it('should unwrap forwardRef with an implicit return', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
    ...
    it('should unwrap forwardRef with an explicit return', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive, Inject, forwardRef } from '@angular/core';`,
            ``,
            `@Directive()`,
    ...
    it('should unwrap an aliased forwardRef', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
    ...
    it('should preserve the forwardRef import if it is used outside of the constructor', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive, Inject, forwardRef } from '@angular/core';`,
            ``,
            `@Directive({`,
    ...
    it('should mark optional members if they correspond to optional parameters', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive, Optional } from '@angular/core';`,
            `import { Foo } from 'foo';`,
            ``,
    ...
    it('should not mark private members as optional', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive, Optional } from '@angular/core';`,
            `import { Foo } from 'foo';`,
            ``,
    ...
    it('should insert generated variables on top of statements that appear before the `super` call', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive } from '@angular/core';`,
            `import { Parent } from './parent';`,
            `import { SomeService } from './service';`,
    ...
    it('should preserve initializers', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive, Optional } from '@angular/core';`,
            `import { Foo } from './foo';`,
            ``,
    ...
    it('should handle initializers referencing other parameters', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive, Optional } from '@angular/core';`,
    ...
    it('should handle initializers referencing other parameters through "this"', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive, Optional } from '@angular/core';`,
            `import { Foo, Bar } from './providers';`,
            ``,
    ...
    it('should handle parameters with initializers referenced inside super()', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive, Optional } from '@angular/core';`,
            `import { Foo, Bar } from './providers';`,
            `import { Parent } from './parent';`,
    ...
    it('should handle removing parameters surrounded by comments', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive } from '@angular/core';`,
            `import { Foo } from 'foo';`,
            `import { Bar } from 'bar';`,
    ...
    it('should not remove decorator imports if unmigrated classes are still using them', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive, Optional } from '@angular/core';`,
            `import { Foo } from 'foo';`,
            `import { Bar } from 'bar';`,
    ...
    it('should handle parameter referenced through `this` inside a callback within super()', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive } from '@angular/core';`,
    ...
    it('should handle super parameter used in shorthand assignment', () => __awaiter(void 0, void 0, void 0, function* () {
        writeFile('/dir.ts', [
            `import { Directive } from '@angular/core';`,
            `import { Service } from './service';`,
            `import { Parent } from './parent';`,
    ...
    describe('internal-only behavior', () => {
        function runInternalMigration({ replaceParameterReferences } = { replaceParameterReferences: true }) {
            return runMigration({
                _internalCombineMemberInitializers: true,
                _internalReplaceParameterReferencesInInitializers: replaceParameterReferences,
            });
        }
        it('should inline initializers that depend on DI', () => __awaiter(void 0, void 0, void 0, function* () {
            writeFile('/dir.ts', [
                `import { Directive, Inject } from '@angular/core';`,
                `import { Foo } from 'foo';`,
        ...
        it('should inline initializers that access injected parameters without `this` if possible', () => __awaiter(void 0, void 0, void 0, function* () {
            writeFile('/dir.ts', [
                `import { Directive, Inject } from '@angular/core';`,
                `import { Foo } from 'foo';`,
                `import { BAR_TOKEN, Bar } from './bar';`,
        ...
        it('should not inline initializers that depend on local symbols from the constructor', () => __awaiter(void 0, void 0, void 0, function* () {
            writeFile('/dir.ts', [
                `import { Directive } from '@angular/core';`,
                `import { Foo } from 'foo';`,
                ``,
        ...
        it('should inline initializers that depend on local symbols defined outside of the constructor', () => __awaiter(void 0, void 0, void 0, function* () {
            writeFile('/dir.ts', [
                `import { Directive } from '@angular/core';`,
                `import { Foo } from 'foo';`,
                ``,
        ...
        it('should inline initializers defined through an element access', () => __awaiter(void 0, void 0, void 0, function* () {
            writeFile('/dir.ts', [
                `import { Directive, Inject } from '@angular/core';`,
                `import { Foo } from 'foo';`,
                `import { BAR_TOKEN, Bar } from './bar';`,
        ...
        it('should take the first initializer for properties initialized multiple times', () => __awaiter(void 0, void 0, void 0, function* () {
            writeFile('/dir.ts', [
                `import { Directive } from '@angular/core';`,
                `import { Foo } from 'foo';`,
                ``,
        ...
        it('should not inline initializers that are not at the top level', () => __awaiter(void 0, void 0, void 0, function* () {
            writeFile('/dir.ts', [
                `import { Directive, Optional } from '@angular/core';`,
                `import { Foo } from 'foo';`,
                ``,
        ...
        it('should inline initializers that have expressions using local parameters', () => __awaiter(void 0, void 0, void 0, function* () {
            writeFile('/dir.ts', [
                `import { Directive } from '@angular/core';`,
                `import { Foo } from 'foo';`,
                ``,
        ...
        it('should inline initializers that have expressions using local variables', () => __awaiter(void 0, void 0, void 0, function* () {
            writeFile('/dir.ts', [
                `import { Directive } from '@angular/core';`,
                `import { Foo } from 'foo';`,
                ``,
        ...
        it('should account for doc strings when inlining initializers', () => __awaiter(void 0, void 0, void 0, function* () {
            writeFile('/dir.ts', [
                `import { Directive } from '@angular/core';`,
                `import { Foo } from 'foo';`,
                ``,
        ...
        it('should account for doc strings when inlining initializers and combining in initialization order', () => __awaiter(void 0, void 0, void 0, function* () {
            writeFile('/dir.ts', [
                `import { Directive } from '@angular/core';`,
                `import { Foo } from 'foo';`,
                ``,
        ...
        it('should hoist property declarations that were not combined above the inject() calls', () => __awaiter(void 0, void 0, void 0, function* () {
            writeFile('/dir.ts', [
        ...
        it('should handle re-ordering when all fields are removed or hoisted', () => __awaiter(void 0, void 0, void 0, function* () {
            writeFile('/dir.ts', [
                `import { Injectable } from '@angular/core';`,
        ...
        it('should be able to insert statements after the `super` call when running in internal migration mode', () => __awaiter(void 0, void 0, void 0, function* () {
            writeFile('/dir.ts', [
                `import { Directive, Inject, ElementRef } from '@angular/core';`,
                `import { Foo } from 'foo';`,
                `import { Parent } from './parent';`,
        ...
        it('should not inline properties initialized to identifiers referring to constructor parameters', () => __awaiter(void 0, void 0, void 0, function* () {
            writeFile('/dir.ts', [
                `import { Injectable } from '@angular/core';`,
        ...
        it('should not migrate abstract classes by default in the internal migration', () => __awaiter(void 0, void 0, void 0, function* () {
            const initialContent = [
                `import { Directive } from '@angular/core';`,
                `import { Foo } from 'foo';`,
                ``,
        ...
        it('should combine the members in their initialization order, if they only have references to each other or constructor parameters', () => __awaiter(void 0, void 0, void 0, function* () {
            writeFile('/dir.ts', [
        ...
        it('should leave combined the members in their declaration order if at least one of them refers to a class member not part of the migration', () => __awaiter(void 0, void 0, void 0, function* () {
            writeFile('/dir.ts', [
                `import { Directive, Injector } from '@angular/core';`,
                `import { Service } from './service';`,
                ``,
        ...
        it('should leave combined the members in their declaration order if none of them refer to each other', () => __awaiter(void 0, void 0, void 0, function* () {
            writeFile('/dir.ts', [
        ...
        it('should handle properties being migrated both before and after the constructor', () => __awaiter(void 0, void 0, void 0, function* () {
            writeFile('/dir.ts', [
                `import { Directive } from '@angular/core';`,
                `import { Foo } from 'foo';`,
                ``,
        ...
        it('should be able to insert statements after the `super` call when all subsequent statements have been deleted', () => __awaiter(void 0, void 0, void 0, function* () {
            writeFile('/dir.ts', [
                `import { Directive } from '@angular/core';`,
        ...
        it('should replace parameter references with property references when possible.', () => __awaiter(void 0, void 0, void 0, function* () {
            writeFile('/dir.ts', [
                `import { Directive } from '@angular/core';`,
                `import { Foo } from 'foo';`,
                ``,
        ...
        it('should respect the replace parameter references flag', () => __awaiter(void 0, void 0, void 0, function* () {
            writeFile('/dir.ts', [
                `import { Directive } from '@angular/core';`,
                `import { Foo } from 'foo';`,
                ``,
            ...
            yield runInternalMigration({ replaceParameterReferences: false });
            expect(tree.readContent('/dir.ts').split('\n')).toEqual([
                `import { Directive, inject } from '@angular/core';`,
                `import { Foo } from 'foo';`,
                ``,
        ...
        it('should not replace parameter references with property references in nested contexts where `this` is different', () => __awaiter(void 0, void 0, void 0, function* () {
            writeFile('/dir.ts', [
                `import { Directive } from '@angular/core';`,
                `import { Foo } from 'foo';`,
                ``,
