...
let WithSafePropertyReads = (() => {
  ...
  `,
    ...
    var WithSafePropertyReads = _classThis = class {
        constructor() {
            this.myInput = __runInitializers(this, _myInput_initializers, 0);
            this.bla = (__runInitializers(this, _myInput_extraInitializers), this);
        }
    };
    __setFunctionName(_classThis, "WithSafePropertyReads");
    (() => {
        ...
        WithSafePropertyReads = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return WithSafePropertyReads = _classThis;
})();
