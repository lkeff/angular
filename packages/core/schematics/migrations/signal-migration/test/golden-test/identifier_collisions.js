...
let MyComp = (() => {
    ...
    let _complex_decorators;
    let _complex_initializers = [];
    let _complex_extraInitializers = [];
    var MyComp = _classThis = class {
        ...
        constructor() {
            ...
            this.complex = (__runInitializers(this, _name_extraInitializers), __runInitializers(this, _complex_initializers, null));
            __runInitializers(this, _complex_extraInitializers);
        }
    };
    ...
    (() => {
        ...
        _complex_decorators = [(0, core_1.Input)()];
        __esDecorate(null, null, _name_decorators, { kind: "field", name: "name", static: false, private: false, access: { has: obj => "name" in obj, get: obj => obj.name, set: (obj, value) => { obj.name = value; } }, metadata: _metadata }, _name_initializers, _name_extraInitializers);
        __esDecorate(null, null, _complex_decorators, { kind: "field", name: "complex", static: false, private: false, access: { has: obj => "complex" in obj, get: obj => obj.complex, set: (obj, value) => { obj.complex = value; } }, metadata: _metadata }, _complex_initializers, _complex_extraInitializers);
