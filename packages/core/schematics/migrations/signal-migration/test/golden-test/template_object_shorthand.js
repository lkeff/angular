...
exports.TemplateObjectShorthand = void 0;
const core_1 = require("@angular/core");
let TemplateObjectShorthand = (() => {
  ...
  `,
    ...
    var TemplateObjectShorthand = _classThis = class {
        constructor() {
            this.myInput = __runInitializers(this, _myInput_initializers, true);
            __runInitializers(this, _myInput_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "TemplateObjectShorthand");
    (() => {
        ...
        TemplateObjectShorthand = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TemplateObjectShorthand = _classThis;
})();
exports.TemplateObjectShorthand = TemplateObjectShorthand;
