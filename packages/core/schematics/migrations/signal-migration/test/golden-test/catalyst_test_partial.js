...
function renderComponent(inputs = {}) { }
let TestableSecondaryRangePicker = (() => {
    ...
    var TestableSecondaryRangePicker = _classThis = class {
        constructor() {
            this.bla = __runInitializers(this, _bla_initializers, true);
            this.incompatible = (__runInitializers(this, _bla_extraInitializers), __runInitializers(this, _incompatible_initializers, true));
            __runInitializers(this, _incompatible_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "TestableSecondaryRangePicker");
    (() => {
        ...
        TestableSecondaryRangePicker = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TestableSecondaryRangePicker = _classThis;
})();
