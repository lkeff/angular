...
let TransformIncompatibleTypes = (() => {
    ...
    var TransformIncompatibleTypes = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "TransformIncompatibleTypes");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _disabled_decorators = [(0, core_1.Input)({ transform: (v) => (v === null ? undefined : !!v) })];
        ...
        TransformIncompatibleTypes = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TransformIncompatibleTypes = _classThis;
})();
