...
let IndexAccessInput = (() => {
    ...
    var IndexAccessInput = _classThis = class {
        bla() {
            const { items } = this;
            items[0].charAt(0);
        }
    ...
    __setFunctionName(_classThis, "IndexAccessInput");
    (() => {
        ...
        IndexAccessInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return IndexAccessInput = _classThis;
})();
