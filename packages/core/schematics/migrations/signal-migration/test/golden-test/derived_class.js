...
exports.Base3 = exports.Base2 = void 0;
...
let Base2 = (() => {
    ...
    let _bla_initializers = [];
    let _bla_extraInitializers = [];
    var Base2 = _classThis = class {
        constructor() {
            this.bla = __runInitializers(this, _bla_initializers, true);
            __runInitializers(this, _bla_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "Base2");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _bla_decorators = [(0, core_1.Input)()];
        __esDecorate(null, null, _bla_decorators, { kind: "field", name: "bla", static: false, private: false, access: { has: obj => "bla" in obj, get: obj => obj.bla, set: (obj, value) => { obj.bla = value; } }, metadata: _metadata }, _bla_initializers, _bla_extraInitializers);
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        Base2 = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Base2 = _classThis;
})();
exports.Base2 = Base2;
// overridden in separate file
let Base3 = (() => {
    ...
    __setFunctionName(_classThis, "Base3");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _bla_decorators = [(0, core_1.Input)()];
        __esDecorate(null, null, _bla_decorators, { kind: "field", name: "bla", static: false, private: false, access: { has: obj => "bla" in obj, get: obj => obj.bla, set: (obj, value) => { obj.bla = value; } }, metadata: _metadata }, _bla_initializers, _bla_extraInitializers);
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        Base3 = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Base3 = _classThis;
})();
exports.Base3 = Base3;
