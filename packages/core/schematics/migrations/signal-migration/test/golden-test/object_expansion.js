...
exports.ObjectExpansion = void 0;
...
let ObjectExpansion = (() => {
    ...
    var ObjectExpansion = _classThis = class {
        expansion() {
            const { bla } = this;
            bla.charAt(0);
        }
        deeperExpansion() {
            const { bla: { charAt }, } = this;
            charAt(0);
        }
    ...
    __setFunctionName(_classThis, "ObjectExpansion");
    (() => {
        ...
        ObjectExpansion = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ObjectExpansion = _classThis;
})();
