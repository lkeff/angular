...
const derived_class_separate_file_1 = require("./derived_class_separate_file");
let Derived = (() => {
    var _a;
    let _classSuper = derived_class_separate_file_1.DerivedExternalWithInput;
    let _bla_decorators;
    let _bla_initializers = [];
    let _bla_extraInitializers = [];
    return _a = class Derived extends _classSuper {
            constructor() {
                super(...arguments);
                ...
                this.bla = __runInitializers(this, _bla_initializers, false);
