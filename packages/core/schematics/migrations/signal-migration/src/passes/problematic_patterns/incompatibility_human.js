...
function getMessageForFieldIncompatibility(reason, fieldName) {
    switch (reason) {
        case incompatibility_1.FieldIncompatibilityReason.Accessor:
            return {
        ...
        case incompatibility_1.FieldIncompatibilityReason.OverriddenByDerivedClass:
            return {
        ...
        case incompatibility_1.FieldIncompatibilityReason.ParentIsIncompatible:
            return {
        ...
        case incompatibility_1.FieldIncompatibilityReason.DerivedIsIncompatible:
            return {
        ...
        case incompatibility_1.FieldIncompatibilityReason.SignalIncompatibleWithHostBinding:
            return {
        ...
        case incompatibility_1.FieldIncompatibilityReason.PotentiallyNarrowedInTemplateButNoSupportYet:
            return {
        ...
        case incompatibility_1.FieldIncompatibilityReason.RedeclaredViaDerivedClassInputsArray:
            return {
        ...
        case incompatibility_1.FieldIncompatibilityReason.SignalInput__RequiredButNoGoodExplicitTypeExtractable:
            return {
        ...
        case incompatibility_1.FieldIncompatibilityReason.SignalInput__QuestionMarkButNoGoodExplicitTypeExtractable:
            return {
        ...
        case incompatibility_1.FieldIncompatibilityReason.SignalQueries__QueryListProblematicFieldAccessed:
            return {
        ...
        case incompatibility_1.FieldIncompatibilityReason.SignalQueries__IncompatibleMultiUnionType:
            return {
        ...
        case incompatibility_1.FieldIncompatibilityReason.SkippedViaConfigFilter:
            return {
                short: `This ${fieldName.single} is not part of the current migration scope.`,
                extra: 'Skipped via migration config.',
            };
        case incompatibility_1.FieldIncompatibilityReason.SpyOnThatOverwritesField:
            return {
        ...
        case incompatibility_1.FieldIncompatibilityReason.TypeConflictWithBaseClass:
            return {
        ...
        case incompatibility_1.FieldIncompatibilityReason.WriteAssignment:
            return {
        ...
        case incompatibility_1.FieldIncompatibilityReason.OutsideOfMigrationScope:
            return {
...
function getMessageForClassIncompatibility(reason, fieldName) {
    switch (reason) {
        case incompatibility_1.ClassIncompatibilityReason.OwningClassReferencedInClassProperty:
            return {
        ...
        case incompatibility_1.ClassIncompatibilityReason.ClassManuallyInstantiated:
            return {
