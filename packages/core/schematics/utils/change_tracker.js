...
class ChangeTracker {
    constructor(_printer, _importRemapper) {
        ...
        this._quotesCache = new WeakMap();
        this._importManager = new migrations_1.ImportManager({
     ...
     * without it.
     */
    replaceNode(oldNode, newNode, emitHint = typescript_1.default.EmitHint.Unspecified, sourceFileWhenPrinting) {
    ...
    _recordImports() {
        ...
        for (const [sourceFile] of this._changes) {
            ...
            for (const decl of importsToAdd) {
                importLines.push(this._printer.printNode(typescript_1.default.EmitHint.Unspecified, decl, sourceFile));
            }
