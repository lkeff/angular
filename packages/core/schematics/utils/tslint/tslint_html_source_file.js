...
exports.createHtmlSourceFile = createHtmlSourceFile;
 ...
 */
function createHtmlSourceFile(filePath, content) {
    const sourceFile = typescript_1.default.createSourceFile(filePath, `\`${content}\``, typescript_1.default.ScriptTarget.ES5);
