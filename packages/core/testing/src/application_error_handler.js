...
exports.TestBedApplicationErrorHandler = exports.RETHROW_APPLICATION_ERRORS_DEFAULT = void 0;
const core_1 = require("../../src/core");
exports.RETHROW_APPLICATION_ERRORS_DEFAULT = true;
let TestBedApplicationErrorHandler = (() => {
    let _classDecorators = [(0, core_1.Injectable)()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var TestBedApplicationErrorHandler = _classThis = class {
        constructor() {
        ...
        handleError(e) {
            try {
                this.zone.runOutsideAngular(() => {
                    var _a;
                    (_a = this.userErrorHandler) !== null && _a !== void 0 ? _a : (this.userErrorHandler = this.injector.get(core_1.ErrorHandler));
    ...
    __setFunctionName(_classThis, "TestBedApplicationErrorHandler");
    (() => {
...
exports.TestBedApplicationErrorHandler = TestBedApplicationErrorHandler;
