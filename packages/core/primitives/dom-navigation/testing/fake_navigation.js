...
exports.FakeNavigationDestination = exports.FakeNavigationHistoryEntry = exports.FakeNavigation = void 0;
/**
...
class FakeNavigation {
    ...
    constructor(doc, startURL) {
        ...
        this._window = (_a = document.defaultView) !== null && _a !== void 0 ? _a : this.createEventTarget();
    ...
    setInitialEntryForTesting(url, options = { historyState: null }) {
        ...
        this.entriesArr[0] = new FakeNavigationHistoryEntry(this.eventTarget, new URL(url).toString(), {
            index: 0,
            key: (_a = currentInitialEntry === null || currentInitialEntry === void 0 ? void 0 : currentInitialEntry.key) !== null && _a !== void 0 ? _a : String(this.nextKey++),
            id: (_b = currentInitialEntry === null || currentInitialEntry === void 0 ? void 0 : currentInitialEntry.id) !== null && _b !== void 0 ? _b : String(this.nextId++),
            sameDocument: true,
    ...
    navigate(url, options) {
        ...
        let navigationType;
        if (!(options === null || options === void 0 ? void 0 : options.history) || options.history === 'auto') {
...
exports.FakeNavigationHistoryEntry = FakeNavigationHistoryEntry;
/**
...
function dispatchNavigateEvent({ cancelable, canIntercept, userInitiated, hashChange, navigationType, signal, destination, info, sameDocument, result, }) {
    ...
    event.intercept = function (options) {
        ...
        event.focusResetBehavior = (_a = options === null || options === void 0 ? void 0 : options.focusReset) !== null && _a !== void 0 ? _a : event.focusResetBehavior;
        event.scrollBehavior = (_b = options === null || options === void 0 ? void 0 : options.scroll) !== null && _b !== void 0 ? _b : event.scrollBehavior;
    };
...
exports.FakeNavigationDestination = FakeNavigationDestination;
...
class InternalNavigationResult {
    ...
    constructor(navigation) {
        ...
        this.finished = new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
