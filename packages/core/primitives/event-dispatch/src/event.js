...
exports.testing = exports.IDENTIFIER_TO_KEY_TRIGGER_MAPPING = exports.isGecko = exports.isIe = exports.isWebKit = void 0;
exports.getBrowserEventType = getBrowserEventType;
exports.addEventListener = addEventListener;
exports.removeEventListener = removeEventListener;
exports.stopPropagation = stopPropagation;
exports.preventDefault = preventDefault;
exports.getTarget = getTarget;
exports.isModifiedClickEvent = isModifiedClickEvent;
exports.isValidActionKeyTarget = isValidActionKeyTarget;
exports.shouldCallPreventDefaultOnNativeHtmlControl = shouldCallPreventDefaultOnNativeHtmlControl;
exports.isActionKeyEvent = isActionKeyEvent;
exports.isSpaceKeyEvent = isSpaceKeyEvent;
exports.isMouseSpecialEvent = isMouseSpecialEvent;
exports.createMouseSpecialEvent = createMouseSpecialEvent;
exports.getTouchData = getTouchData;
exports.recreateTouchEventAsClick = recreateTouchEventAsClick;
exports.isNativeHTMLControl = isNativeHTMLControl;
const event_type_1 = require("./event_type");
const key_code_1 = require("./key_code");
/**
...
function getBrowserEventType(eventType) {
    ...
    if (eventType === event_type_1.EventType.MOUSEENTER) {
        return event_type_1.EventType.MOUSEOVER;
    }
    else if (eventType === event_type_1.EventType.MOUSELEAVE) {
        return event_type_1.EventType.MOUSEOUT;
    }
    else if (eventType === event_type_1.EventType.POINTERENTER) {
        return event_type_1.EventType.POINTEROVER;
    }
    else if (eventType === event_type_1.EventType.POINTERLEAVE) {
        return event_type_1.EventType.POINTEROUT;
    }
    return eventType;
}
/**
...
function addEventListener(element, eventType, handler, passive) {
    ...
    let capture = false;
    if ((0, event_type_1.isCaptureEventType)(eventType)) {
        capture = true;
    }
...
function isActionKeyEvent(e) {
    ...
    if (exports.isWebKit && key === key_code_1.KeyCode.MAC_ENTER) {
        key = key_code_1.KeyCode.ENTER;
    }
    if (key !== key_code_1.KeyCode.ENTER && key !== key_code_1.KeyCode.SPACE) {
        return false;
    }
    const el = getTarget(e);
    if (e.type !== event_type_1.EventType.KEYDOWN || !isValidActionKeyTarget(el) || hasModifierKey(e)) {
        return false;
    }
    // For <input type="checkbox">, we must only handle the browser's native click
    // event, so that the browser can toggle the checkbox.
    if (processSpace(el) && key === key_code_1.KeyCode.SPACE) {
        return false;
    }
    ...
    const isSpecificTriggerKey = exports.IDENTIFIER_TO_KEY_TRIGGER_MAPPING[type] % key === 0;
    const isDefaultTriggerKey = !(type in exports.IDENTIFIER_TO_KEY_TRIGGER_MAPPING) && key === key_code_1.KeyCode.ENTER;
...
function isSpaceKeyEvent(e) {
    ...
    return key === key_code_1.KeyCode.SPACE && elementName !== 'CHECKBOX';
}
/**
...
function isMouseSpecialEvent(e, type, element) {
    ...
    return (((e.type === event_type_1.EventType.MOUSEOVER && type === event_type_1.EventType.MOUSEENTER) ||
        (e.type === event_type_1.EventType.MOUSEOUT && type === event_type_1.EventType.MOUSELEAVE) ||
        (e.type === event_type_1.EventType.POINTEROVER && type === event_type_1.EventType.POINTERENTER) ||
        (e.type === event_type_1.EventType.POINTEROUT && type === event_type_1.EventType.POINTERLEAVE)) &&
...
function createMouseSpecialEvent(e, target) {
    ...
    if (e.type === event_type_1.EventType.MOUSEOVER) {
        copy['type'] = event_type_1.EventType.MOUSEENTER;
    }
    else if (e.type === event_type_1.EventType.MOUSEOUT) {
        copy['type'] = event_type_1.EventType.MOUSELEAVE;
    }
    else if (e.type === event_type_1.EventType.POINTEROVER) {
        copy['type'] = event_type_1.EventType.POINTERENTER;
    }
    else {
        copy['type'] = event_type_1.EventType.POINTERLEAVE;
    }
...
function recreateTouchEventAsClick(event) {
    ...
    click['type'] = event_type_1.EventType.CLICK;
...
const ACTION_KEY_TO_KEYCODE = {
    'Enter': key_code_1.KeyCode.ENTER,
    ' ': key_code_1.KeyCode.SPACE,
};
/**
 ...
 */
exports.IDENTIFIER_TO_KEY_TRIGGER_MAPPING = {
    'A': key_code_1.KeyCode.ENTER,
    'BUTTON': 0,
    'CHECKBOX': key_code_1.KeyCode.SPACE,
    'COMBOBOX': key_code_1.KeyCode.ENTER,
    'FILE': 0,
    'GRIDCELL': key_code_1.KeyCode.ENTER,
    'LINK': key_code_1.KeyCode.ENTER,
    'LISTBOX': key_code_1.KeyCode.ENTER,
    'MENU': 0,
    'MENUBAR': 0,
    'MENUITEM': 0,
    'MENUITEMCHECKBOX': 0,
    'MENUITEMRADIO': 0,
    'OPTION': 0,
    'RADIO': key_code_1.KeyCode.SPACE,
    'RADIOGROUP': key_code_1.KeyCode.SPACE,
    'RESET': 0,
    'SUBMIT': 0,
    'SWITCH': key_code_1.KeyCode.SPACE,
    'TAB': 0,
    'TREE': key_code_1.KeyCode.ENTER,
    'TREEITEM': key_code_1.KeyCode.ENTER,
};
/**
