...
exports.EventDispatcher = exports.EventPhase = exports.PROPAGATION_STOPPED_SYMBOL = void 0;
exports.registerDispatcher = registerDispatcher;
const action_resolver_1 = require("./action_resolver");
const dispatcher_1 = require("./dispatcher");
const event_type_1 = require("./event_type");
const restriction_1 = require("./restriction");
/** An internal symbol used to indicate whether propagation should be stopped or not. */
exports.PROPAGATION_STOPPED_SYMBOL = Symbol.for('propagationStopped');
...
class EventDispatcher {
    constructor(dispatchDelegate, clickModSupport = true) {
        ...
        this.actionResolver = new action_resolver_1.ActionResolver({ clickModSupport });
        this.dispatcher = new dispatcher_1.Dispatcher((eventInfoWrapper) => {
    ...
    dispatchToDelegate(eventInfoWrapper) {
        ...
        while (eventInfoWrapper.getAction()) {
            ...
            if ((0, event_type_1.isCaptureEventType)(eventInfoWrapper.getEventType()) &&
...
function prepareEventForBubbling(eventInfoWrapper) {
    ...
    const stopPropagation = () => {
        event[exports.PROPAGATION_STOPPED_SYMBOL] = true;
...
function propagationStopped(eventInfoWrapper) {
    const event = eventInfoWrapper.getEvent();
    return !!event[exports.PROPAGATION_STOPPED_SYMBOL];
}
function prepareEventForReplay(eventInfoWrapper) {
    ...
    patchEventInstance(event, 'eventPhase', exports.EventPhase.REPLAY);
...
function prepareEventForDispatch(eventInfoWrapper) {
    var _a;
    const event = eventInfoWrapper.getEvent();
    const currentTarget = (_a = eventInfoWrapper.getAction()) === null || _a === void 0 ? void 0 : _a.element;
    if (currentTarget) {
