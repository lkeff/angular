...
const event_contract_defines_1 = require("./event_contract_defines");
...
class EventContract {
    ...
    handleEventInfo(eventInfo) {
        ...
        if (!this.dispatcher) {
            ...
            (_a = this.queuedEventInfos) === null || _a === void 0 ? void 0 : _a.push(eventInfo);
            return;
        }
    ...
    addEvent(eventType, prefixedEventType, passive) {
        ...
        if (!EventContract.MOUSE_SPECIAL_SUPPORT && event_type_1.MOUSE_SPECIAL_EVENT_TYPES.indexOf(eventType) >= 0) {
            return;
        }
    ...
    replayEarlyEvents(earlyJsactionData = window._ejsa) {
        ...
        (0, earlyeventcontract_1.removeAllEventListeners)(earlyJsactionData);
        delete window._ejsa;
    }
    /**
    ...
    cleanUp() {
        var _a;
        (_a = this.containerManager) === null || _a === void 0 ? void 0 : _a.cleanUp();
    ...
    ecrd(dispatcher, restriction) {
        ...
        if ((_a = this.queuedEventInfos) === null || _a === void 0 ? void 0 : _a.length) {
...
EventContract.MOUSE_SPECIAL_SUPPORT = event_contract_defines_1.MOUSE_SPECIAL_SUPPORT;
