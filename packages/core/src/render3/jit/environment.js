...
const iframe_attrs_validation = __importStar(require("../../sanitization/iframe_attrs_validation"));
const sanitization = __importStar(require("../../sanitization/sanitization"));
const r3 = __importStar(require("../index"));
/**
...
exports.angularCoreEnv = (() => ({
    ...
    'ɵɵregisterNgModuleType': ng_module_registration_1.registerNgModuleType,
    ...
    'forwardRef': forward_ref_1.forwardRef,
