...
exports.addTNodeAndUpdateInsertBeforeIndex = addTNodeAndUpdateInsertBeforeIndex;
...
function addTNodeAndUpdateInsertBeforeIndex(previousTNodes, newTNode) {
    // Start with Rule1
    ngDevMode &&
        (0, assert_1.assertEqual)(newTNode.insertBeforeIndex, null, 'We expect that insertBeforeIndex is not set');
