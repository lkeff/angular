...
exports.TEST_ONLY = exports.depsTracker = exports.USE_RUNTIME_DEPS_TRACKER_FOR_JIT = void 0;
 ...
 */
exports.USE_RUNTIME_DEPS_TRACKER_FOR_JIT = true;
/**
...
class DepsTracker {
    ...
    resolveNgModulesDecls() {
        ...
        for (const moduleType of this.ngModulesWithSomeUnresolvedDecls) {
            const def = (0, def_getters_1.getNgModuleDef)(moduleType);
            if (def === null || def === void 0 ? void 0 : def.declarations) {
                for (const decl of (0, misc_utils_1.maybeUnwrapFn)(def.declarations)) {
                    if ((0, util_1.isComponent)(decl)) {
    ...
    computeNgModuleScope(type) {
        ...
        // Analyzing imports
        for (const imported of (0, misc_utils_1.maybeUnwrapFn)(def.imports)) {
            if ((0, util_1.isNgModule)(imported)) {
            ...
            else if ((0, def_getters_1.isStandalone)(imported)) {
                if ((0, util_1.isDirective)(imported) || (0, util_1.isComponent)(imported)) {
                    scope.compilation.directives.add(imported);
                }
                else if ((0, util_1.isPipe)(imported)) {
                    scope.compilation.pipes.add(imported);
                }
                else {
                    // The standalone thing is neither a component nor a directive nor a pipe ... (what?)
                    throw new errors_1.RuntimeError(980 /* RuntimeErrorCode.RUNTIME_DEPS_INVALID_IMPORTED_TYPE */, 'The standalone imported type is neither a component nor a directive nor a pipe');
                }
            }
            else {
        ...
        if (!scope.compilation.isPoisoned) {
            for (const decl of (0, misc_utils_1.maybeUnwrapFn)(def.declarations)) {
                ...
                if ((0, util_1.isNgModule)(decl) || (0, def_getters_1.isStandalone)(decl)) {
                    scope.compilation.isPoisoned = true;
                    break;
                }
                if ((0, util_1.isPipe)(decl)) {
        ...
        // Analyzing exports
        for (const exported of (0, misc_utils_1.maybeUnwrapFn)(def.exports)) {
            if ((0, util_1.isNgModule)(exported)) {
            ...
            else if ((0, util_1.isPipe)(exported)) {
    ...
    computeStandaloneComponentScope(type, rawImports) {
        ...
        for (const rawImport of (0, array_utils_1.flatten)(rawImports !== null && rawImports !== void 0 ? rawImports : [])) {
            const imported = (0, di_1.resolveForwardRef)(rawImport);
            try {
                (0, util_1.verifyStandaloneImport)(imported, type);
            }
            catch (e) {
            ...
            else if ((0, util_1.isDirective)(imported) || (0, util_1.isComponent)(imported)) {
    ...
    isOrphanComponent(cmp) {
        const def = (0, def_getters_1.getComponentDef)(cmp);
...
exports.depsTracker = new DepsTracker();
exports.TEST_ONLY = { DepsTracker };
