...
exports.getLastParsedKey = getLastParsedKey;
exports.getLastParsedValue = getLastParsedValue;
exports.parseClassName = parseClassName;
exports.parseClassNameNext = parseClassNameNext;
exports.parseStyle = parseStyle;
exports.parseStyleNext = parseStyleNext;
exports.resetParserState = resetParserState;
exports.consumeWhitespace = consumeWhitespace;
exports.consumeClassToken = consumeClassToken;
exports.consumeStyleKey = consumeStyleKey;
exports.consumeSeparator = consumeSeparator;
exports.consumeStyleValue = consumeStyleValue;
exports.consumeQuotedText = consumeQuotedText;
...
function malformedStyleError(text, expecting, index) {
    ngDevMode && (0, assert_1.assertEqual)(typeof text === 'string', true, 'String expected here');
    throw (0, assert_1.throwError)(`Malformed style at location ${index} in string '` +
