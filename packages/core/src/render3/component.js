...
function createComponent(component, options) {
    ngDevMode && (0, errors_1.assertComponentDef)(component);
    const componentDef = (0, def_getters_1.getComponentDef)(component);
    const elementInjector = options.elementInjector || (0, r3_injector_1.getNullInjector)();
    const factory = new component_ref_1.ComponentFactory(componentDef);
