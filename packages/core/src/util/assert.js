...
exports.assertNumberInRange = assertNumberInRange;
...
exports.assertDomNode = assertDomNode;
exports.assertElement = assertElement;
exports.assertIndexInRange = assertIndexInRange;
exports.assertOneOf = assertOneOf;
exports.assertNotReactive = assertNotReactive;
...
function assertDomNode(node) {
    if (!(node instanceof Node)) {
        throwError(`The provided value must be an instance of a DOM Node but got ${(0, stringify_1.stringify)(node)}`);
    }
}
function assertElement(node) {
    if (!(node instanceof Element)) {
        throwError(`The provided value must be an element but got ${(0, stringify_1.stringify)(node)}`);
    }
}
