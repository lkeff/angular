...
exports.setIsI18nHydrationSupportEnabled = setIsI18nHydrationSupportEnabled;
exports.isI18nHydrationSupportEnabled = isI18nHydrationSupportEnabled;
exports.prepareI18nBlockForHydration = prepareI18nBlockForHydration;
exports.enablePrepareI18nBlockForHydrationImpl = enablePrepareI18nBlockForHydrationImpl;
exports.isI18nHydrationEnabled = isI18nHydrationEnabled;
exports.getOrComputeI18nChildren = getOrComputeI18nChildren;
exports.trySerializeI18nBlock = trySerializeI18nBlock;
exports.claimDehydratedIcuCase = claimDehydratedIcuCase;
exports.enableClaimDehydratedIcuCaseImpl = enableClaimDehydratedIcuCaseImpl;
exports.cleanupI18nHydrationData = cleanupI18nHydrationData;
const di_1 = require("../di");
const i18n_util_1 = require("../render3/i18n/i18n_util");
const i18n_icu_container_visitor_1 = require("../render3/instructions/i18n_icu_container_visitor");
...
function isI18nHydrationEnabled(injector) {
    injector = injector !== null && injector !== void 0 ? injector : (0, di_1.inject)(di_1.Injector);
    return injector.get(tokens_1.IS_I18N_HYDRATION_ENABLED, false);
}
/**
...
function trySerializeI18nBlock(lView, index, context) {
    ...
    if (parentTNode && (0, skip_hydration_1.isI18nInSkipHydrationBlock)(parentTNode)) {
        return null;
    }
    ...
    for (const node of nodes) {
        ...
        if (nextRNode) {
            if (isDisjointNode(prevRNode, nextRNode)) {
                serializedI18nBlock.disjointNodes.add(node.index - view_1.HEADER_OFFSET);
            }
            prevRNode = nextRNode;
        }
    }
...
function serializeI18nNode(lView, serializedI18nBlock, context, node) {
    const maybeRNode = (0, view_utils_1.unwrapRNode)(lView[node.index]);
    if (!maybeRNode || (0, node_lookup_utils_1.isDisconnectedRNode)(maybeRNode)) {
        serializedI18nBlock.disconnectedNodes.add(node.index - view_1.HEADER_OFFSET);
        return null;
    }
    const rNode = maybeRNode;
    switch (node.kind) {
        case 0 /* I18nNodeKind.TEXT */: {
            (0, utils_1.processTextNodeBeforeSerialization)(context, rNode);
            break;
        }
        case 1 /* I18nNodeKind.ELEMENT */:
        case 2 /* I18nNodeKind.PLACEHOLDER */: {
...
function getFirstNativeNodeForI18nNode(lView, node) {
    ...
    if ((0, node_1.isTNodeShape)(maybeTNode)) {
        // If the node is backed by an actual TNode, we can simply delegate.
        return (0, node_manipulation_1.getFirstNativeNode)(lView, maybeTNode);
    }
        ...
        const icuIterator = (0, i18n_icu_container_visitor_1.createIcuIterator)(maybeTNode, lView);
        let rNode = icuIterator();
        // If the ICU container has no nodes, then we use the ICU anchor as the node.
        return rNode !== null && rNode !== void 0 ? rNode : (0, view_utils_1.unwrapRNode)(lView[node.index]);
    }
    else {
        // Otherwise, the node is a text or trivial element in an ICU container,
        // and we can just use the RNode directly.
        return (_a = (0, view_utils_1.unwrapRNode)(lView[node.index])) !== null && _a !== void 0 ? _a : null;
    }
}
...
function appendI18nNodeToCollection(context, state, astNode) {
    const noOffsetIndex = astNode.index - view_1.HEADER_OFFSET;
...
function skipSiblingNodes(state, skip) {
    ...
    for (let i = 0; i < skip; i++) {
        ...
        currentNode = (_a = currentNode === null || currentNode === void 0 ? void 0 : currentNode.nextSibling) !== null && _a !== void 0 ? _a : null;
    }
    return currentNode;
}
/**
...
function prepareI18nBlockForHydrationImpl(lView, index, parentTNode, subTemplateIndex) {
    ...
    if (!isI18nHydrationSupportEnabled() ||
        (parentTNode &&
            ((0, skip_hydration_1.isI18nInSkipHydrationBlock)(parentTNode) ||
                (0, utils_1.isDisconnectedNode)(hydrationInfo, parentTNode.index - view_1.HEADER_OFFSET)))) {
        return;
    }
    const tView = lView[view_1.TVIEW];
    const tI18n = tView.data[index];
    ngDevMode &&
        (0, assert_1.assertDefined)(tI18n, 'Expected i18n data to be present in a given TView slot during hydration');
    function findHydrationRoot() {
        if ((0, i18n_util_1.isRootTemplateMessage)(subTemplateIndex)) {
            ...
            // in the DOM.
            ngDevMode && (0, assert_1.assertDefined)(parentTNode, 'Expected parent TNode while hydrating i18n root');
            const rootNode = (0, node_lookup_utils_1.locateNextRNode)(hydrationInfo, tView, lView, parentTNode);
    ...
    ngDevMode && (0, assert_1.assertDefined)(currentNode, 'Expected root i18n node during hydration');
    const disconnectedNodes = (_a = (0, utils_1.initDisconnectedNodes)(hydrationInfo)) !== null && _a !== void 0 ? _a : new Set();
    const i18nNodes = ((_b = hydrationInfo.i18nNodes) !== null && _b !== void 0 ? _b : (hydrationInfo.i18nNodes = new Map()));
    const caseQueue = (_d = (_c = hydrationInfo.data[interfaces_1.I18N_DATA]) === null || _c === void 0 ? void 0 : _c[index - view_1.HEADER_OFFSET]) !== null && _d !== void 0 ? _d : [];
    const dehydratedIcuData = ((_e = hydrationInfo.dehydratedIcuData) !== null && _e !== void 0 ? _e : (hydrationInfo.dehydratedIcuData = new Map()));
...
function collectI18nNodesFromDom(context, state, nodeOrNodes) {
    ...
    if (Array.isArray(nodeOrNodes)) {
        ...
        for (const node of nodeOrNodes) {
            ...
            const targetNode = (0, node_lookup_utils_1.tryLocateRNodeByPath)(context.hydrationInfo, context.lView, node.index - view_1.HEADER_OFFSET);
            if (targetNode) {
        ...
        if (context.disconnectedNodes.has(nodeOrNodes.index - view_1.HEADER_OFFSET)) {
        ...
        switch (nodeOrNodes.kind) {
            case 0 /* I18nNodeKind.TEXT */: {
                ...
                setCurrentNode(state, (_a = currentNode === null || currentNode === void 0 ? void 0 : currentNode.nextSibling) !== null && _a !== void 0 ? _a : null);
                break;
            }
            case 1 /* I18nNodeKind.ELEMENT */: {
                // Recurse into the current element's children...
                collectI18nNodesFromDom(context, forkHydrationState(state, (_c = (_b = state.currentNode) === null || _b === void 0 ? void 0 : _b.firstChild) !== null && _c !== void 0 ? _c : null), nodeOrNodes.children);
                // And claim the parent element itself.
                const currentNode = appendI18nNodeToCollection(context, state, nodeOrNodes);
                setCurrentNode(state, (_d = currentNode === null || currentNode === void 0 ? void 0 : currentNode.nextSibling) !== null && _d !== void 0 ? _d : null);
                break;
            }
            case 2 /* I18nNodeKind.PLACEHOLDER */: {
                const noOffsetIndex = nodeOrNodes.index - view_1.HEADER_OFFSET;
                const { hydrationInfo } = context;
                const containerSize = (0, utils_1.getNgContainerSize)(hydrationInfo, noOffsetIndex);
                switch (nodeOrNodes.type) {
                    case 0 /* I18nPlaceholderType.ELEMENT */: {
                        ...
                        if ((0, utils_1.isSerializedElementContainer)(hydrationInfo, noOffsetIndex)) {
                            ...
                            collectI18nNodesFromDom(context, forkHydrationState(state, (_f = (_e = state.currentNode) === null || _e === void 0 ? void 0 : _e.firstChild) !== null && _f !== void 0 ? _f : null), nodeOrNodes.children);
                            setCurrentNode(state, (_g = currentNode === null || currentNode === void 0 ? void 0 : currentNode.nextSibling) !== null && _g !== void 0 ? _g : null);
                    ...
                    case 1 /* I18nPlaceholderType.SUBTEMPLATE */: {
                        ngDevMode &&
                            (0, assert_1.assertNotEqual)(containerSize, null, 'Expected a container size while hydrating i18n subtemplate');
            ...
            case 3 /* I18nNodeKind.ICU */: {
                ...
                const currentNode = appendI18nNodeToCollection(context, state, nodeOrNodes);
                setCurrentNode(state, (_h = currentNode === null || currentNode === void 0 ? void 0 : currentNode.nextSibling) !== null && _h !== void 0 ? _h : null);
                break;
            }
        }
    }
...
function claimDehydratedIcuCaseImpl(lView, icuIndex, caseIndex) {
    var _a;
    const dehydratedIcuDataMap = (_a = lView[view_1.HYDRATION]) === null || _a === void 0 ? void 0 : _a.dehydratedIcuData;
    if (dehydratedIcuDataMap) {
        const dehydratedIcuData = dehydratedIcuDataMap.get(icuIndex);
        if ((dehydratedIcuData === null || dehydratedIcuData === void 0 ? void 0 : dehydratedIcuData.case) === caseIndex) {
...
function cleanupDehydratedIcuData(renderer, i18nNodes, dehydratedIcuData) {
    for (const node of dehydratedIcuData.node.cases[dehydratedIcuData.case]) {
        const rNode = i18nNodes.get(node.index - view_1.HEADER_OFFSET);
        if (rNode) {
            (0, dom_node_manipulation_1.nativeRemoveNode)(renderer, rNode, false);
        }
    }
}
