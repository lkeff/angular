...
exports.compressNodeLocation = compressNodeLocation;
exports.decompressNodeLocation = decompressNodeLocation;
 ...
 */
const REF_EXTRACTOR_REGEXP = /* @__PURE__ */ new RegExp(`^(\\d+)*(${interfaces_1.REFERENCE_NODE_BODY}|${interfaces_1.REFERENCE_NODE_HOST})*(.*)`);
/**
