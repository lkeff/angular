...
exports.NodeInjectorDestroyRef = exports.DestroyRef = void 0;
...
class NodeInjectorDestroyRef extends DestroyRef {
    ...
    onDestroy(callback) {
        ...
        (0, view_utils_1.storeLViewOnDestroy)(lView, callback);
        return () => (0, view_utils_1.removeLViewOnDestroy)(lView, callback);
    }
}
exports.NodeInjectorDestroyRef = NodeInjectorDestroyRef;
function injectDestroyRef() {
    return new NodeInjectorDestroyRef((0, state_1.getLView)());
}
