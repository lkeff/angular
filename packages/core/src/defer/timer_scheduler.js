...
exports.TimerScheduler = void 0;
exports.onTimer = onTimer;
exports.scheduleTimerTrigger = scheduleTimerTrigger;
...
class TimerScheduler {
    ...
    addToQueue(target, invokeAt, callback) {
        ...
        (0, array_utils_1.arrayInsert2)(target, insertAtIndex, invokeAt, callback);
    }
    removeFromQueue(target, callback) {
        ...
        if (index > -1) {
            ...
            (0, array_utils_1.arraySplice)(target, index, 2);
        }
        return index;
    }
    scheduleTimer(ngZone) {
        const callback = () => {
            ...
            if (lastCallbackIndex >= 0) {
                (0, array_utils_1.arraySplice)(this.current, 0, lastCallbackIndex + 1);
            }
            this.executingCallbacks = false;
...
/** @nocollapse */
TimerScheduler.ɵprov = (0, di_1.ɵɵdefineInjectable)({
