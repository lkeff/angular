...
exports.VALID_ATTRS = exports.URI_ATTRS = exports.VALID_ELEMENTS = void 0;
...
const inert_body_1 = require("./inert_body");
...
exports.VALID_ELEMENTS = merge(VOID_ELEMENTS, BLOCK_ELEMENTS, INLINE_ELEMENTS, OPTIONAL_END_TAG_ELEMENTS);
// Attributes that have href and hence need to be sanitized
exports.URI_ATTRS = tagSet('background,cite,href,itemtype,longdesc,poster,src,xlink:href');
...
// are left out here.
exports.VALID_ATTRS = merge(exports.URI_ATTRS, HTML_ATTRS, ARIA_ATTRS);
...
class SanitizingHtmlSerializer {
    ...
    startElement(element) {
        ...
        if (!exports.VALID_ELEMENTS.hasOwnProperty(tagName)) {
            this.sanitizedSomething = true;
        ...
        for (let i = 0; i < elAttrs.length; i++) {
            ...
            if (!exports.VALID_ATTRS.hasOwnProperty(lower)) {
                this.sanitizedSomething = true;
                continue;
            }
            let value = elAttr.value;
            // TODO(martinprobst): Special case image URIs for data:image/...
            if (exports.URI_ATTRS[lower])
                value = (0, url_sanitizer_1._sanitizeUrl)(value);
    ...
    endElement(current) {
        ...
        if (exports.VALID_ELEMENTS.hasOwnProperty(tagName) && !VOID_ELEMENTS.hasOwnProperty(tagName)) {
            this.buf.push('</');
            this.buf.push(tagName);
            this.buf.push('>');
        }
...
function _sanitizeHtml(defaultDoc, unsafeHtmlInput) {
    ...
    try {
        inertBodyHelper = inertBodyHelper || (0, inert_body_1.getInertBodyHelper)(defaultDoc);
        ...
        if ((typeof ngDevMode === 'undefined' || ngDevMode) && sanitizer.sanitizedSomething) {
            console.warn(`WARNING: sanitizing HTML stripped some content, see ${error_details_base_url_1.XSS_SECURITY_URL}`);
        }
        return (0, trusted_types_1.trustedHTMLFromString)(safeHtml);
    }
    finally {
