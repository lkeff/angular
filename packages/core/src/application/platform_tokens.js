...
exports.REQUEST_CONTEXT = exports.RESPONSE_INIT = exports.REQUEST = void 0;
 ...
 * @publicApi
 */
exports.REQUEST = new injection_token_1.InjectionToken(typeof ngDevMode === 'undefined' || ngDevMode ? 'REQUEST' : '', {
    providedIn: 'platform',
    factory: () => null,
});
/**
 ...
 * @publicApi
 */
exports.RESPONSE_INIT = new injection_token_1.InjectionToken(typeof ngDevMode === 'undefined' || ngDevMode ? 'RESPONSE_INIT' : '', {
    providedIn: 'platform',
    factory: () => null,
});
/**
 ...
 * @publicApi
 */
exports.REQUEST_CONTEXT = new injection_token_1.InjectionToken(typeof ngDevMode === 'undefined' || ngDevMode ? 'REQUEST_CONTEXT' : '', {
    providedIn: 'platform',
    factory: () => null,
});
