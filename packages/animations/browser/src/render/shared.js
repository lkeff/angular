...
exports.getOrSetDefaultValue = getOrSetDefaultValue;
...
exports.validateWebAnimatableStyleProperty = validateWebAnimatableStyleProperty;
exports.getBodyNode = getBodyNode;
exports.containsElement = containsElement;
exports.invokeQuery = invokeQuery;
exports.hypenatePropsKeys = hypenatePropsKeys;
/**
 * @license
...
const animatable_props_set_1 = require("./web_animations/animatable_props_set");
...
function normalizeKeyframes(normalizer, keyframes, preStyles = new Map(), postStyles = new Map()) {
    const errors = [];
    ...
    if (errors.length) {
        throw (0, error_helpers_1.animationFailed)(errors);
    }
...
function validateWebAnimatableStyleProperty(prop) {
    return animatable_props_set_1.ANIMATABLE_PROP_SET.has(prop);
}
