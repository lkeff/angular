 ...
 */
const web_animations_style_normalizer_1 = require("../../../src/dsl/style_normalization/web_animations_style_normalizer");
describe('WebAnimationsStyleNormalizer', () => {
    const normalizer = new web_animations_style_normalizer_1.WebAnimationsStyleNormalizer();
