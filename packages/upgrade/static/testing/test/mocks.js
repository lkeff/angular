...
exports.shoppingCartInstance = exports.serverRequestInstance = exports.AppModule = exports.Inventory = exports.Logger = void 0;
exports.serverRequestFactory = serverRequestFactory;
exports.defineAppModule = defineAppModule;
const core_1 = require("@angular/core");
const static_1 = require("../../../static");
const ng = __importStar(require("../../../src/common/src/angular1"));
/*
...
function serverRequestFactory(i) {
...
exports.serverRequestInstance = {};
exports.shoppingCartInstance = {};
function defineAppModule() {
    ng.module_('app', [])
        .factory('logger', (0, static_1.downgradeInjectable)(Logger))
        .factory('inventory', (0, static_1.downgradeInjectable)(Inventory))
        .factory('serverRequest', [
        'logger',
        function (logger) {
            exports.serverRequestInstance.logger = logger;
            return exports.serverRequestInstance;
        },
    ])
        .factory('shoppingCart', [
        'inventory',
        function (inventory) {
            exports.shoppingCartInstance.inventory = inventory;
            return exports.shoppingCartInstance;
        },
    ]);
}
/* END: AngularJS bits */
