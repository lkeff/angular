...
function createAngularJSTestingModule(angularModules) {
    return static_1.ɵangular1
        .module_('$$angularJSTestingModule', [])
        .constant(static_1.ɵconstants.UPGRADE_APP_TYPE_KEY, 2 /* UpgradeAppType.Static */)
        .factory(static_1.ɵconstants.INJECTOR_KEY, [
        static_1.ɵconstants.$INJECTOR,
        ($injector) => {
            testing_1.TestBed.configureTestingModule({
                imports: angularModules,
                providers: [{ provide: static_1.ɵconstants.$INJECTOR, useValue: $injector }],
            });
            return testing_1.TestBed.inject(core_1.Injector);
        },
    ]).name;
}
