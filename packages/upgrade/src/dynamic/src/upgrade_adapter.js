...
exports.UpgradeAdapterRef = exports.UpgradeAdapter = void 0;
const core_1 = require("@angular/core");
const platform_browser_dynamic_1 = require("@angular/platform-browser-dynamic");
const angular1_1 = require("../../common/src/angular1");
const constants_1 = require("../../common/src/constants");
const downgrade_component_1 = require("../../common/src/downgrade_component");
const downgrade_injectable_1 = require("../../common/src/downgrade_injectable");
const util_1 = require("../../common/src/util");
const upgrade_ng1_adapter_1 = require("./upgrade_ng1_adapter");
let upgradeCount = 0;
/**
...
class UpgradeAdapter {
    ...
    downgradeNg2Component(component) {
        ...
        return (0, downgrade_component_1.downgradeComponent)({ component });
    }
    /**
    ...
    bootstrap(element, modules, config) {
        ...
        ngZone.run(() => {
            (0, angular1_1.bootstrap)(element, [ng1Module.name], config);
        });
        ...
        Promise.all([ng2BootstrapDeferred.promise, ng1BootstrapPromise]).then(([ng1Injector]) => {
            (0, angular1_1.element)(element).data((0, util_1.controllerKey)(constants_1.INJECTOR_KEY), this.moduleRef.injector);
            this.moduleRef.injector.get(core_1.NgZone).run(() => {
                // @ts-expect-error
                upgrade._bootstrapDone(this.moduleRef, ng1Injector);
            });
        }, util_1.onError);
    ...
    downgradeNg2Provider(token) {
        return (0, downgrade_injectable_1.downgradeInjectable)(token);
    }
    /**
    ...
    declareNg1Module(modules = []) {
        ...
        const ng1Module = (0, angular1_1.module_)(this.idPrefix, modules);
        const platformRef = (0, platform_browser_dynamic_1.platformBrowserDynamic)();
        const ngZone = new core_1.NgZone({
            enableLongStackTrace: Zone.hasOwnProperty('longStackTraceZoneSpec'),
        });
        const ng2BootstrapDeferred = new util_1.Deferred();
        ng1Module
            .constant(constants_1.UPGRADE_APP_TYPE_KEY, 1 /* UpgradeAppType.Dynamic */)
            .factory(constants_1.INJECTOR_KEY, () => this.moduleRef.injector.get(core_1.Injector))
            .factory(constants_1.LAZY_MODULE_REF, [
            constants_1.INJECTOR_KEY,
            (injector) => ({ injector }),
        ])
            .constant(constants_1.NG_ZONE_KEY, ngZone)
            .factory(constants_1.COMPILER_KEY, () => this.moduleRef.injector.get(core_1.Compiler))
            .config([
            '$provide',
            '$injector',
            (provide, ng1Injector) => {
                        ...
                        function (testabilityDelegate) {
                            ...
                            const newWhenStable = function (callback) {
                                originalWhenStable.call(this, function () {
                                    const ng2Testability = upgradeAdapter.moduleRef.injector.get(core_1.Testability);
        ...
        ng1Module.run([
            ...
            (ng1Injector, rootScope) => {
                upgrade_ng1_adapter_1.UpgradeNg1ComponentAdapterBuilder.resolve(this.ng1ComponentsToBeUpgraded, ng1Injector)
                    .then(() => {
                    // At this point we have ng1 injector and we have prepared
                    // ng1 components to be upgraded, we now can bootstrap ng2.
                    let DynamicNgUpgradeModule = (() => {
                        let _classDecorators = [(0, core_1.NgModule)({
                                jit: true,
                                providers: [
                                    { provide: constants_1.$INJECTOR, useFactory: () => ng1Injector },
                                    { provide: constants_1.$COMPILE, useFactory: () => ng1Injector.get(constants_1.$COMPILE) },
                                    this.upgradedProviders,
                                ],
                                imports: [(0, core_1.resolveForwardRef)(this.ng2AppModule)],
                            })];
                        let _classDescriptor;
                        let _classExtraInitializers = [];
                        let _classThis;
                        var DynamicNgUpgradeModule = _classThis = class {
                            ngDoBootstrap() { }
                        };
                        __setFunctionName(_classThis, "DynamicNgUpgradeModule");
                        (() => {
                            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
                            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
                            DynamicNgUpgradeModule = _classThis = _classDescriptor.value;
                            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
                            __runInitializers(_classThis, _classExtraInitializers);
                        })();
                        return DynamicNgUpgradeModule = _classThis;
                    })();
                    platformRef
                        ...
                        .then(() => ng2BootstrapDeferred.resolve(ng1Injector), util_1.onError)
                        .then(() => {
                        ...
                        platformRef.onDestroy(() => (0, util_1.destroyApp)(ng1Injector));
                    });
                })
