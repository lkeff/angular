...
const component_info_1 = require("../src/component_info");
describe('PropertyBinding', () => {
    it('should process a simple binding', () => {
        const binding = new component_info_1.PropertyBinding('someBinding', 'someBinding');
    ...
    it('should process a two-part binding', () => {
        const binding = new component_info_1.PropertyBinding('someProp', 'someAttr');
