...
exports.withEachNg1Version = void 0;
 ...
 */
const angular1_1 = require("../../src/angular1");
...
function createWithEachNg1VersionFn(setNg1) {
    return (specSuite) => ng1Versions.forEach(({ label, files }) => {
        describe(`[AngularJS v${label}]`, () => {
            ...
            const methodCallbacks = methodsToPatch.reduce((aggr, method) => (Object.assign(Object.assign({}, aggr), { [method]: [] })), {});
            const win = window;
            function patchJasmineMethods() {
                const originalMethods = {};
                methodsToPatch.forEach((method) => {
                    originalMethods[method] = win[method];
                    win[method] = (cb) => methodCallbacks[method].push(cb);
                });
                return () => methodsToPatch.forEach((method) => (win[method] = originalMethods[method]));
            }
            function loadScript(scriptUrl, retry = 0) {
...
function multiTrim(text, allSpace = false) {
