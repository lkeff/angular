...
describe('Generator', () => {
    ...
    it('generates a correct config', () => __awaiter(void 0, void 0, void 0, function* () {
        const fs = new mock_1.MockFilesystem({
        ...
        const gen = new generator_1.Generator(fs, '/test');
        const config = yield gen.process({
            appData: {
                test: true,
            },
            index: '/index.html',
    ...
    it('assigns files to the first matching asset-group (unaffected by file-system access delays)', () => __awaiter(void 0, void 0, void 0, function* () {
        const fs = new mock_1.MockFilesystem({
            '/index.html': 'This is a test',
        ...
        const allFiles = yield fs.list('/');
        spyOn(fs, 'list').and.returnValues(new Promise((resolve) => setTimeout(resolve, 2000, allFiles.slice())), new Promise((resolve) => setTimeout(resolve, 3000, allFiles.slice())), new Promise((resolve) => setTimeout(resolve, 1000, allFiles.slice())));
        const gen = new generator_1.Generator(fs, '');
        const config = yield gen.process({
            index: '/index.html',
            assetGroups: [
                {
    ...
    it('uses default `navigationUrls` if not provided', () => __awaiter(void 0, void 0, void 0, function* () {
        const fs = new mock_1.MockFilesystem({
            '/index.html': 'This is a test',
        });
        const gen = new generator_1.Generator(fs, '/test');
    ...
    it('throws if the obsolete `versionedFiles` is used', () => __awaiter(void 0, void 0, void 0, function* () {
        const fs = new mock_1.MockFilesystem({
            '/index.html': 'This is a test',
            '/main.js': 'This is a JS file',
        });
        ...
        try {
            ...
            expect(err).toEqual(new Error("Asset-group 'test' in 'ngsw-config.json' uses the 'versionedFiles' option, " +
                "which is no longer supported. Use 'files' instead."));
        }
    }));
    it('generates a correct config with `cacheOpaqueResponses`', () => __awaiter(void 0, void 0, void 0, function* () {
        const fs = new mock_1.MockFilesystem({
            '/index.html': 'This is a test',
        });
        const gen = new generator_1.Generator(fs, '/');
    ...
    it('generates a correct config with `cacheQueryOptions`', () => __awaiter(void 0, void 0, void 0, function* () {
        const fs = new mock_1.MockFilesystem({
            '/index.html': 'This is a test',
            '/main.js': 'This is a JS file',
        });
    ...
    it("doesn't exceed concurrency limit", () => __awaiter(void 0, void 0, void 0, function* () {
        const fileCount = 600;
        const files = [...Array(fileCount).keys()].reduce((acc, _, i) => {
            acc[`/test${i}.js`] = `This is a test ${i}`;
            return acc;
        }, { '/index.html': 'This is a test' });
        const fs = new mock_1.HashTrackingMockFilesystem(files);
        const gen = new generator_1.Generator(fs, '/');
        const config = yield gen.process({
            index: '/index.html',
            assetGroups: [
        ...
        expect(Object.keys(config.hashTable).length).toBe(fileCount);
    }));
    describe('processNavigationUrls()', () => {
        ...
        it('uses the default `navigationUrls` if not provided', () => {
            expect((0, generator_1.processNavigationUrls)('/')).toEqual([
                { positive: true, regex: '^\\/.*$' },
                { positive: false, regex: '^\\/(?:.+\\/)?[^/]*\\.[^/]*$' },
                { positive: false, regex: '^\\/(?:.+\\/)?[^/]*__[^/]*$' },
                { positive: false, regex: '^\\/(?:.+\\/)?[^/]*__[^/]*\\/.*$' },
        ...
        it('prepends `baseHref` to relative URL patterns only', () => {
            expect((0, generator_1.processNavigationUrls)('/base/href/', customNavigationUrls)).toEqual([
        ...
        it('strips a leading single `.` from a relative `baseHref`', () => {
            expect((0, generator_1.processNavigationUrls)('./relative/base/href/', customNavigationUrls)).toEqual([
                { positive: true, regex: '^https:\\/\\/host\\/positive\\/external\\/.*$' },
                { positive: false, regex: '^https:\\/\\/host\\/negative\\/external\\/.*$' },
                { positive: true, regex: '^\\/positive\\/absolute\\/.*$' },
                { positive: false, regex: '^\\/negative\\/absolute\\/.*$' },
            ...
            expect((0, generator_1.processNavigationUrls)('../double/dots/', customNavigationUrls)).toEqual([
                { positive: true, regex: '^https:\\/\\/host\\/positive\\/external\\/.*$' },
                { positive: false, regex: '^https:\\/\\/host\\/negative\\/external\\/.*$' },
                { positive: true, regex: '^\\/positive\\/absolute\\/.*$' },
                { positive: false, regex: '^\\/negative\\/absolute\\/.*$' },
