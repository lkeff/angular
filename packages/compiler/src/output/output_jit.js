...
const abstract_js_emitter_1 = require("./abstract_js_emitter");
const o = __importStar(require("./output_ast"));
const output_jit_trusted_types_1 = require("./output_jit_trusted_types");
/**
...
class JitEvaluator {
    ...
    evaluateCode(sourceUrl, ctx, vars, createSourceMap) {
        ...
        if (createSourceMap) {
            ...
            const emptyFn = (0, output_jit_trusted_types_1.newTrustedFunctionForJIT)(...fnArgNames.concat('return null;')).toString();
            const headerLines = emptyFn.slice(0, emptyFn.indexOf('return null;')).split('\n').length - 1;
            fnBody += `\n${ctx.toSourceMapGenerator(sourceUrl, headerLines).toJsComment()}`;
        }
        const fn = (0, output_jit_trusted_types_1.newTrustedFunctionForJIT)(...fnArgNames.concat(fnBody));
...
class JitEmitterVisitor extends abstract_js_emitter_1.AbstractJsEmitterVisitor {
    ...
    _emitReferenceToExternal(ast, value, ctx) {
        ...
        if (id === -1) {
            ...
            const name = (0, parse_util_1.identifierName)({ reference: value }) || 'val';
