...
exports.AbstractEmitterVisitor = exports.EmitterVisitorContext = void 0;
exports.escapeIdentifier = escapeIdentifier;
const o = __importStar(require("./output_ast"));
const source_map_1 = require("./source_map");
...
class EmitterVisitorContext {
    ...
    toSourceMapGenerator(genFilePath, startsAtLine = 0) {
        const map = new source_map_1.SourceMapGenerator(genFilePath);
