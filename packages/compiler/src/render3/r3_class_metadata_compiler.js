...
exports.compileOpaqueAsyncClassMetadata = compileOpaqueAsyncClassMetadata;
exports.compileComponentMetadataAsyncResolver = compileComponentMetadataAsyncResolver;
/**
 * @license
...
function compileClassMetadata(metadata) {
    ...
    return o.arrowFn([], [(0, util_1.devOnlyGuardedExpression)(fnCall).toStmt()]).callFn([]);
}
/** Compiles only the `setClassMetadata` call without any additional wrappers. */
function internalCompileClassMetadata(metadata) {
    var _a, _b;
    return o
        .importExpr(r3_identifiers_1.Identifiers.setClassMetadata)
        .callFn([
        metadata.type,
        metadata.decorators,
...
function internalCompileSetClassMetadataAsync(metadata, wrapperParams, dependencyResolverFn) {
    ...
    const setClassMetaAsync = o
        .importExpr(r3_identifiers_1.Identifiers.setClassMetadataAsync)
        .callFn([metadata.type, dependencyResolverFn, setClassMetaWrapper]);
    return o.arrowFn([], [(0, util_1.devOnlyGuardedExpression)(setClassMetaAsync).toStmt()]).callFn([]);
}
/**
