...
exports.I18nMetaVisitor = void 0;
...
const i18n_parser_1 = require("../../../i18n/i18n_parser");
const parse_util_1 = require("../../../i18n/parse_util");
...
const trusted_types_sinks_1 = require("../../../schema/trusted_types_sinks");
...
const setI18nRefs = (originalNodeMap) => {
    return (trimmedNode, i18nNode) => {
        ...
        const originalNode = (_a = originalNodeMap.get(trimmedNode)) !== null && _a !== void 0 ? _a : trimmedNode;
...
class I18nMetaVisitor {
    constructor(interpolationConfig = defaults_1.DEFAULT_INTERPOLATION_CONFIG, keepI18nAttrs = false, enableI18nLegacyMessageIdFormat = false, containerBlocks = defaults_1.DEFAULT_CONTAINER_BLOCKS, preserveSignificantWhitespace = true, 
    ...
    _generateI18nMessage(nodes, meta = '', visitNodeFn) {
        ...
        const createI18nMessage = (0, i18n_parser_1.createI18nMessageFactory)(this.interpolationConfig, this.containerBlocks, this.retainEmptyTokens, 
    ...
    visitExpansion(expansion, currentMessage) {
        ...
        if (meta instanceof i18n.IcuPlaceholder) {
            ...
            const icu = (0, util_1.icuFromI18nMessage)(message);
            icu.name = name;
            ...
            for (const attr of node.attrs) {
                if (attr.name === util_1.I18N_ATTR) {
                    ...
                    const trimmedNodes = this.preserveSignificantWhitespace
                        ? node.children
                        : (0, html_whitespaces_1.visitAllWithSiblings)(new html_whitespaces_1.WhitespaceVisitor(false /* preserveSignificantWhitespace */, originalNodeMap), node.children);
                    ...
                    // 'i18n-*' attributes
                    const name = attr.name.slice(util_1.I18N_ATTR_PREFIX.length);
                    let isTrustedType;
                    if (node instanceof html.Component) {
                        isTrustedType = node.tagName === null ? false : (0, trusted_types_sinks_1.isTrustedTypesSink)(node.tagName, name);
                    }
                    else {
                        isTrustedType = (0, trusted_types_sinks_1.isTrustedTypesSink)(node.name, name);
                    }
                    if (isTrustedType) {
