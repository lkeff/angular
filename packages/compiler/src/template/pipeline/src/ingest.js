...
exports.ingestDomProperty = ingestDomProperty;
exports.ingestHostAttribute = ingestHostAttribute;
exports.ingestHostEvent = ingestHostEvent;
const core_1 = require("../../../core");
const e = __importStar(require("../../../expression_parser/ast"));
const i18n = __importStar(require("../../../i18n/i18n_ast"));
...
const util_1 = require("../../../render3/view/i18n/util");
...
const domSchema = new dom_element_schema_registry_1.DomElementSchemaRegistry();
...
function ingestComponent(componentName, template, constantPool, relativeContextFilePath, i18nUseExternalIds, deferMeta, allDeferrableDepsFn, relativeTemplatePath, enableDebugLocations) {
    const job = new compilation_1.ComponentCompilationJob(componentName, constantPool, compatibilityMode, relativeContextFilePath, i18nUseExternalIds, deferMeta, allDeferrableDepsFn, relativeTemplatePath, enableDebugLocations);
...
function ingestHostBinding(input, bindingParser, constantPool) {
    var _a, _b, _c;
    const job = new compilation_1.HostBindingCompilationJob(input.componentName, constantPool, compatibilityMode);
    for (const property of (_a = input.properties) !== null && _a !== void 0 ? _a : []) {
        ...
        const securityContexts = bindingParser
            ...
            .filter((context) => context !== core_1.SecurityContext.NONE);
        ingestDomProperty(job, property, bindingKind, securityContexts);
    }
    for (const [name, expr] of (_b = Object.entries(input.attributes)) !== null && _b !== void 0 ? _b : []) {
        const securityContexts = bindingParser
            .calcPossibleSecurityContexts(input.componentSelector, name, true)
            .filter((context) => context !== core_1.SecurityContext.NONE);
        ingestHostAttribute(job, name, expr, securityContexts);
    }
    for (const event of (_c = input.events) !== null && _c !== void 0 ? _c : []) {
...
function ingestElement(unit, element) {
    ...
    const [namespaceKey, elementName] = (0, tags_1.splitNsName)(element.name);
    const startOp = ir.createElementStartOp(elementName, id, (0, conversion_1.namespaceForKey)(namespaceKey), element.i18n instanceof i18n.TagPlaceholder ? element.i18n : undefined, element.startSourceSpan, element.sourceSpan);
    ...
    const endOp = ir.createElementEndOp(id, (_a = element.endSourceSpan) !== null && _a !== void 0 ? _a : element.startSourceSpan);
    unit.create.push(endOp);
    // If there is an i18n message associated with this element, insert i18n start and end ops.
    if (i18nBlockId !== null) {
        ir.OpList.insertBefore(ir.createI18nEndOp(i18nBlockId, (_b = element.endSourceSpan) !== null && _b !== void 0 ? _b : element.startSourceSpan), endOp);
    }
}
/**
...
function ingestTemplate(unit, tmpl) {
    ...
    let namespacePrefix = '';
    if (tmpl.tagName) {
        [namespacePrefix, tagNameWithoutNamespace] = (0, tags_1.splitNsName)(tmpl.tagName);
    }
    const i18nPlaceholder = tmpl.i18n instanceof i18n.TagPlaceholder ? tmpl.i18n : undefined;
    const namespace = (0, conversion_1.namespaceForKey)(namespacePrefix);
    const functionNameSuffix = tagNameWithoutNamespace === null ? '' : (0, conversion_1.prefixWithNamespace)(tagNameWithoutNamespace, namespace);
    ...
    if (templateKind === ir.TemplateKind.NgTemplate && tmpl.i18n instanceof i18n.Message) {
        ...
        ir.OpList.insertBefore(ir.createI18nEndOp(id, (_a = tmpl.endSourceSpan) !== null && _a !== void 0 ? _a : tmpl.startSourceSpan), childView.create.tail);
    }
}
/**
...
function ingestContent(unit, content) {
    ...
    const id = unit.job.allocateXrefId();
    const op = ir.createProjectionOp(id, content.selector, content.i18n, (_a = fallbackView === null || fallbackView === void 0 ? void 0 : fallbackView.xref) !== null && _a !== void 0 ? _a : null, content.sourceSpan);
...
function ingestBoundText(unit, text, icuPlaceholder) {
    ...
    if (text.i18n !== undefined && !(text.i18n instanceof i18n.Container)) {
        throw Error(`Unhandled i18n metadata type for text interpolation: ${(_a = text.i18n) === null || _a === void 0 ? void 0 : _a.constructor.name}`);
    }
    ...
    for (let i = 0; i < ifBlock.branches.length; i++) {
        ...
        if (ifCase.i18n !== undefined) {
            if (!(ifCase.i18n instanceof i18n.BlockPlaceholder)) {
                throw Error(`Unhandled i18n metadata type for if block: ${(_a = ifCase.i18n) === null || _a === void 0 ? void 0 : _a.constructor.name}`);
            }
            ifCaseI18nMeta = ifCase.i18n;
        }
        const createOp = i === 0 ? ir.createConditionalCreateOp : ir.createConditionalBranchCreateOp;
        const conditionalCreateOp = createOp(cView.xref, ir.TemplateKind.Block, tagName, 'Conditional', ir.Namespace.HTML, ifCaseI18nMeta, ifCase.startSourceSpan, ifCase.sourceSpan);
        unit.create.push(conditionalCreateOp);
        if (firstXref === null) {
            firstXref = cView.xref;
        }
        const caseExpr = ifCase.expression ? convertAst(ifCase.expression, unit.job, null) : null;
        const conditionalCaseExpr = new ir.ConditionalCaseExpr(caseExpr, conditionalCreateOp.xref, conditionalCreateOp.handle, ifCase.expressionAlias);
    ...
    for (let i = 0; i < switchBlock.cases.length; i++) {
        ...
        if (switchCase.i18n !== undefined) {
            if (!(switchCase.i18n instanceof i18n.BlockPlaceholder)) {
                throw Error(`Unhandled i18n metadata type for switch block: ${(_a = switchCase.i18n) === null || _a === void 0 ? void 0 : _a.constructor.name}`);
            }
            switchCaseI18nMeta = switchCase.i18n;
        }
        const createOp = i === 0 ? ir.createConditionalCreateOp : ir.createConditionalBranchCreateOp;
        const conditionalCreateOp = createOp(cView.xref, ir.TemplateKind.Block, tagName, 'Case', ir.Namespace.HTML, switchCaseI18nMeta, switchCase.startSourceSpan, switchCase.sourceSpan);
        unit.create.push(conditionalCreateOp);
        if (firstXref === null) {
            firstXref = cView.xref;
        }
        const caseExpr = switchCase.expression
            ...
            : null;
        const conditionalCaseExpr = new ir.ConditionalCaseExpr(caseExpr, conditionalCreateOp.xref, conditionalCreateOp.handle);
        conditions.push(conditionalCaseExpr);
...
function ingestDeferBlock(unit, deferBlock) {
    ...
    if (unit.job.deferMeta.mode === 0 /* DeferBlockDepsEmitMode.PerBlock */) {
        ...
        ownResolverFn = (_a = unit.job.deferMeta.blocks.get(deferBlock)) !== null && _a !== void 0 ? _a : null;
    }
    // Generate the defer main view and all secondary views.
    const main = ingestDeferView(unit, '', deferBlock.i18n, deferBlock.children, deferBlock.sourceSpan);
    const loading = ingestDeferView(unit, 'Loading', (_b = deferBlock.loading) === null || _b === void 0 ? void 0 : _b.i18n, (_c = deferBlock.loading) === null || _c === void 0 ? void 0 : _c.children, (_d = deferBlock.loading) === null || _d === void 0 ? void 0 : _d.sourceSpan);
    const placeholder = ingestDeferView(unit, 'Placeholder', (_e = deferBlock.placeholder) === null || _e === void 0 ? void 0 : _e.i18n, (_f = deferBlock.placeholder) === null || _f === void 0 ? void 0 : _f.children, (_g = deferBlock.placeholder) === null || _g === void 0 ? void 0 : _g.sourceSpan);
    const error = ingestDeferView(unit, 'Error', (_h = deferBlock.error) === null || _h === void 0 ? void 0 : _h.i18n, (_j = deferBlock.error) === null || _j === void 0 ? void 0 : _j.children, (_k = deferBlock.error) === null || _k === void 0 ? void 0 : _k.sourceSpan);
    ...
    deferOp.placeholderView = (_l = placeholder === null || placeholder === void 0 ? void 0 : placeholder.xref) !== null && _l !== void 0 ? _l : null;
    deferOp.placeholderSlot = (_m = placeholder === null || placeholder === void 0 ? void 0 : placeholder.handle) !== null && _m !== void 0 ? _m : null;
    deferOp.loadingSlot = (_o = loading === null || loading === void 0 ? void 0 : loading.handle) !== null && _o !== void 0 ? _o : null;
    deferOp.errorSlot = (_p = error === null || error === void 0 ? void 0 : error.handle) !== null && _p !== void 0 ? _p : null;
    deferOp.placeholderMinimumTime = (_r = (_q = deferBlock.placeholder) === null || _q === void 0 ? void 0 : _q.minimumTime) !== null && _r !== void 0 ? _r : null;
    deferOp.loadingMinimumTime = (_t = (_s = deferBlock.loading) === null || _s === void 0 ? void 0 : _s.minimumTime) !== null && _t !== void 0 ? _t : null;
    deferOp.loadingAfterTime = (_v = (_u = deferBlock.loading) === null || _u === void 0 ? void 0 : _u.afterTime) !== null && _v !== void 0 ? _v : null;
    ...
    if (!hasConcreteTrigger) {
        deferOnOps.push(ir.createDeferOnOp(deferXref, { kind: ir.DeferTriggerKind.Idle }, "none" /* ir.DeferOpModifierKind.NONE */, null));
    }
...
function ingestDeferTriggers(modifier, triggers, onOps, whenOps, unit, deferXref) {
    if (triggers.idle !== undefined) {
        const deferOnOp = ir.createDeferOnOp(deferXref, { kind: ir.DeferTriggerKind.Idle }, modifier, triggers.idle.sourceSpan);
        onOps.push(deferOnOp);
    }
    if (triggers.immediate !== undefined) {
        const deferOnOp = ir.createDeferOnOp(deferXref, { kind: ir.DeferTriggerKind.Immediate }, modifier, triggers.immediate.sourceSpan);
        onOps.push(deferOnOp);
    }
    if (triggers.timer !== undefined) {
        const deferOnOp = ir.createDeferOnOp(deferXref, { kind: ir.DeferTriggerKind.Timer, delay: triggers.timer.delay }, modifier, triggers.timer.sourceSpan);
        onOps.push(deferOnOp);
    }
    ...
    if (triggers.never !== undefined) {
        const deferOnOp = ir.createDeferOnOp(deferXref, { kind: ir.DeferTriggerKind.Never }, modifier, triggers.never.sourceSpan);
        onOps.push(deferOnOp);
    }
    if (triggers.when !== undefined) {
        ...
        const deferOnOp = ir.createDeferWhenOp(deferXref, convertAst(triggers.when.value, unit.job, triggers.when.sourceSpan), modifier, triggers.when.sourceSpan);
...
function ingestIcu(unit, icu) {
    ...
    if (icu.i18n instanceof i18n.Message && isSingleI18nIcu(icu.i18n)) {
        ...
        unit.create.push(ir.createIcuStartOp(xref, icu.i18n, (0, util_1.icuFromI18nMessage)(icu.i18n).name, null));
        for (const [placeholder, text] of Object.entries(Object.assign(Object.assign({}, icu.vars), icu.placeholders))) {
        ...
        throw Error(`Unhandled i18n metadata type for ICU: ${(_a = icu.i18n) === null || _a === void 0 ? void 0 : _a.constructor.name}`);
    }
}
/**
...
function ingestForBlock(unit, forBlock) {
    ...
    if (((_a = forBlock.empty) === null || _a === void 0 ? void 0 : _a.i18n) !== undefined &&
        !(forBlock.empty.i18n instanceof i18n.BlockPlaceholder)) {
        throw Error('AssertionError: Unhandled i18n metadata type or @empty');
    }
    const i18nPlaceholder = forBlock.i18n;
    const emptyI18nPlaceholder = (_b = forBlock.empty) === null || _b === void 0 ? void 0 : _b.i18n;
    const tagName = ingestControlFlowInsertionPoint(unit, repeaterView.xref, forBlock);
    const repeaterCreate = ir.createRepeaterCreateOp(repeaterView.xref, (_c = emptyView === null || emptyView === void 0 ? void 0 : emptyView.xref) !== null && _c !== void 0 ? _c : null, tagName, track, varNames, emptyTagName, i18nPlaceholder, emptyI18nPlaceholder, forBlock.startSourceSpan, forBlock.sourceSpan);
...
function convertAst(ast, job, baseSourceSpan) {
    if (ast instanceof e.ASTWithSource) {
        ...
        const operator = conversion_1.BINARY_OPERATORS.get(ast.operation);
        ...
        return new o.VoidExpr(convertAst(ast.expression, job, baseSourceSpan), undefined, convertSourceSpan(ast.span, baseSourceSpan));
    }
        ...
        return new o.TaggedTemplateLiteralExpr(convertAst(ast.tag, job, baseSourceSpan), convertTemplateLiteral(ast.template, job, baseSourceSpan), undefined, convertSourceSpan(ast.span, baseSourceSpan));
    }
    else if (ast instanceof e.ParenthesizedExpression) {
        return new o.ParenthesizedExpr(convertAst(ast.expression, job, baseSourceSpan), undefined, convertSourceSpan(ast.span, baseSourceSpan));
    }
    else {
        throw new Error(`Unhandled expression type "${ast.constructor.name}" in file "${baseSourceSpan === null || baseSourceSpan === void 0 ? void 0 : baseSourceSpan.start.file.url}"`);
    }
}
function convertTemplateLiteral(ast, job, baseSourceSpan) {
    return new o.TemplateLiteralExpr(ast.elements.map((el) => {
...
function convertAstWithInterpolation(job, value, i18nMeta, sourceSpan) {
    ...
    let expression;
    if (value instanceof e.Interpolation) {
        expression = new ir.Interpolation(value.strings, value.expressions.map((e) => convertAst(e, job, sourceSpan !== null && sourceSpan !== void 0 ? sourceSpan : null)), Object.keys((_b = (_a = asMessage(i18nMeta)) === null || _a === void 0 ? void 0 : _a.placeholders) !== null && _b !== void 0 ? _b : {}));
    }
    else if (value instanceof e.AST) {
        expression = convertAst(value, job, sourceSpan !== null && sourceSpan !== void 0 ? sourceSpan : null);
    }
    else {
...
function isPlainTemplate(tmpl) {
    var _a;
    return (0, tags_1.splitNsName)((_a = tmpl.tagName) !== null && _a !== void 0 ? _a : '')[1] === NG_TEMPLATE_TAG_NAME;
}
/**
...
function ingestElementBindings(unit, op, element) {
    ...
    for (const input of element.inputs) {
        ...
        bindings.push(ir.createBindingOp(op.xref, BINDING_KINDS.get(input.type), input.name, convertAstWithInterpolation(unit.job, astOf(input.value), input.i18n), input.unit, input.securityContext, false, false, null, (_a = asMessage(input.i18n)) !== null && _a !== void 0 ? _a : null, input.sourceSpan));
    }
    unit.create.push(bindings.filter((b) => (b === null || b === void 0 ? void 0 : b.kind) === ir.OpKind.ExtractedAttribute));
    unit.update.push(bindings.filter((b) => (b === null || b === void 0 ? void 0 : b.kind) === ir.OpKind.Binding));
    ...
    // op is also required.
    if (bindings.some((b) => b === null || b === void 0 ? void 0 : b.i18nMessage) !== null) {
