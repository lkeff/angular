...
exports.expandSafeReads = expandSafeReads;
...
function ternaryTransform(e) {
    ...
    return new o.ParenthesizedExpr(new o.ConditionalExpr(new o.BinaryOperatorExpr(o.BinaryOperator.Equals, e.guard, o.NULL_EXPR), o.NULL_EXPR, e.expr));
}
