...
exports.optimizeTrackFns = optimizeTrackFns;
    ...
    for (const unit of job.units) {
        for (const op of unit.create) {
            ...
            if (op.track instanceof o.ReadVarExpr && op.track.name === '$index') {
                ...
                op.trackByFn = o.importExpr(r3_identifiers_1.Identifiers.repeaterTrackByIndex);
            }
            else if (op.track instanceof o.ReadVarExpr && op.track.name === '$item') {
                // Top-level access of the item uses the built in `repeaterTrackByIdentity`.
                op.trackByFn = o.importExpr(r3_identifiers_1.Identifiers.repeaterTrackByIdentity);
            }
                ...
                if (op.track.receiver.receiver.view === unit.xref) {
                    ...
                    op.trackByFn = o
                        .importExpr(r3_identifiers_1.Identifiers.componentInstance)
                        .callFn([])
                ...
                const trackOpList = new ir.OpList();
