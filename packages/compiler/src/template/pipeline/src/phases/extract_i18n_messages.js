...
function createI18nMessage(job, context, messagePlaceholder) {
    ...
    return ir.createI18nMessageOp(job.allocateXrefId(), context.xref, context.i18nBlock, context.message, messagePlaceholder !== null && messagePlaceholder !== void 0 ? messagePlaceholder : null, formattedParams, formattedPostprocessingParams, needsPostprocessing);
}
/**
...
function formatValue(value) {
    ...
    if (value.flags & ir.I18nParamValueFlags.ElementTag &&
        ...
        const elementValue = formatValue(Object.assign(Object.assign({}, value), { value: value.value.element, flags: value.flags & ~ir.I18nParamValueFlags.TemplateTag }));
        const templateValue = formatValue(Object.assign(Object.assign({}, value), { value: value.value.template, flags: value.flags & ~ir.I18nParamValueFlags.ElementTag }));
    ...
    if (value.flags & ir.I18nParamValueFlags.OpenTag &&
        value.flags & ir.I18nParamValueFlags.CloseTag) {
        return `${formatValue(Object.assign(Object.assign({}, value), { flags: value.flags & ~ir.I18nParamValueFlags.CloseTag }))}${formatValue(Object.assign(Object.assign({}, value), { flags: value.flags & ~ir.I18nParamValueFlags.OpenTag }))}`;
    }
