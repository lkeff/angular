...
const get_msg_utils_1 = require("../../../../render3/view/i18n/get_msg_utils");
const localize_utils_1 = require("../../../../render3/view/i18n/localize_utils");
    ...
    for (const unit of job.units) {
        for (const op of unit.ops()) {
            if (op.kind === ir.OpKind.ExtractedAttribute && op.i18nContext !== null) {
                const attributes = (_a = extractedAttributesByI18nContext.get(op.i18nContext)) !== null && _a !== void 0 ? _a : [];
                attributes.push(op);
                ...
                const expressions = (_b = i18nExpressionsByElement.get(op.target)) !== null && _b !== void 0 ? _b : [];
                expressions.push(op);
...
function collectMessage(job, fileBasedI18nSuffix, messages, messageOp) {
    ...
    for (const subMessageId of messageOp.subMessages) {
        ...
        const subMessages = (_a = subMessagePlaceholders.get(subMessage.messagePlaceholder)) !== null && _a !== void 0 ? _a : [];
    ...
    if (messageOp.needsPostprocessing || messageOp.postprocessingParams.size > 0) {
        ...
        const formattedPostprocessingParams = (0, util_1.formatI18nPlaceholderNamesInMap)(postprocessingParams, 
        /* useCamelCase */ false);
        const extraTransformFnParams = [];
        if (messageOp.postprocessingParams.size > 0) {
            extraTransformFnParams.push((0, map_util_1.mapLiteral)(formattedPostprocessingParams, /* quoted */ true));
        }
        transformFn = (expr) => o.importExpr(r3_identifiers_1.Identifiers.i18nPostprocess).callFn([expr, ...extraTransformFnParams]);
    }
...
function addSubMessageParams(messageOp, subMessagePlaceholders) {
    for (const [placeholder, subMessages] of subMessagePlaceholders) {
        if (subMessages.length === 1) {
            ...
            messageOp.params.set(placeholder, o.literal(`${ESCAPE}${exports.I18N_ICU_MAPPING_PREFIX}${placeholder}${ESCAPE}`));
...
function getTranslationDeclStmts(message, variable, closureVar, params, transformFn) {
    ...
    const statements = [
        ...
        o.ifStmt(createClosureModeGuard(), (0, get_msg_utils_1.createGoogleGetMsgStatements)(variable, message, closureVar, paramsObject), (0, localize_utils_1.createLocalizeStatements)(variable, message, (0, util_1.formatI18nPlaceholderNamesInMap)(paramsObject, /* useCamelCase */ false))),
    ];
    if (transformFn) {
