...
exports.CursorError = exports.TokenizeResult = exports.TokenError = void 0;
...
function tokenize(source, url, getTagDefinition, options = {}) {
    const tokenizer = new _Tokenizer(new parse_util_1.ParseSourceFile(source, url), getTagDefinition, options);
    tokenizer.tokenize();
...
class _Tokenizer {
    ...
    constructor(_file, _getTagDefinition, options) {
        ...
        this._interpolationConfig = options.interpolationConfig || defaults_1.DEFAULT_INTERPOLATION_CONFIG;
        ...
        this._tokenizeBlocks = (_a = options.tokenizeBlocks) !== null && _a !== void 0 ? _a : true;
        this._tokenizeLet = (_b = options.tokenizeLet) !== null && _b !== void 0 ? _b : true;
        this._selectorlessEnabled = (_c = options.selectorlessEnabled) !== null && _c !== void 0 ? _c : false;
        try {
            this._cursor.init();
        }
        catch (e) {
    ...
    _consumeEntity(textTokenType) {
        ...
        if (this._attemptCharCode(chars.$HASH)) {
            ...
            if (this._cursor.peek() != chars.$SEMICOLON) {
                ...
                this._cursor.advance();
                const char = entities_1.NAMED_ENTITIES.hasOwnProperty(name) && entities_1.NAMED_ENTITIES[name];
                if (!char) {
