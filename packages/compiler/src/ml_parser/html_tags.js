...
exports.HtmlTagDefinition = void 0;
exports.getHtmlTagDefinition = getHtmlTagDefinition;
const dom_element_schema_registry_1 = require("../schema/dom_element_schema_registry");
const tags_1 = require("./tags");
class HtmlTagDefinition {
    constructor({ closedByChildren, implicitNamespacePrefix, contentType = tags_1.TagContentType.PARSABLE_DATA, closedByParent = false, isVoid = false, ignoreFirstLf = false, preventNamespaceInheritance = false, canSelfClose = false, } = {}) {
...
function getHtmlTagDefinition(tagName) {
    ...
    if (!TAG_DEFINITIONS) {
        ...
        new dom_element_schema_registry_1.DomElementSchemaRegistry().allKnownElementNames().forEach((knownTagName) => {
            if (!TAG_DEFINITIONS[knownTagName] && (0, tags_1.getNsPrefix)(knownTagName) === null) {
