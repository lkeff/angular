...
class ConstantPool {
    ...
    getSharedFunctionReference(fn, prefix, useUniqueName = true) {
        ...
        for (const current of this.statements) {
            ...
            if (isArrow && current instanceof o.DeclareVarStmt && ((_a = current.value) === null || _a === void 0 ? void 0 : _a.isEquivalent(fn))) {
    ...
    uniqueName(name, alwaysIncludeSuffix = true) {
        var _a;
        const count = (_a = this._claimedNames.get(name)) !== null && _a !== void 0 ? _a : 0;
...
exports.GenericKeyFn = GenericKeyFn;
