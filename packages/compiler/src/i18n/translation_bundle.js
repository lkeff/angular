...
const xml_helper_1 = require("./serializers/xml_helper");
/**
 * A container for translated messages
 */
class TranslationBundle {
    constructor(_i18nNodesByMsgId = {}, locale, digest, mapperFactory, missingTranslationStrategy = core_1.MissingTranslationStrategy.Warning, console) {
...
class I18nToHtmlVisitor {
    ...
    convert(srcMsg) {
        ...
        const html = new html_parser_1.HtmlParser().parse(text, url, { tokenizeExpansionForms: true });
        return {
