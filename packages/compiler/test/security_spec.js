...
const dom_security_schema_1 = require("../src/schema/dom_security_schema");
describe('security-related tests', () => {
    it('should have no overlap between `IFRAME_SECURITY_SENSITIVE_ATTRS` and `SECURITY_SCHEMA`', () => {
        ...
        Object.keys((0, dom_security_schema_1.SECURITY_SCHEMA)()).forEach((key) => schema.add(key.toLowerCase()));
        let hasOverlap = false;
        dom_security_schema_1.IFRAME_SECURITY_SENSITIVE_ATTRS.forEach((attr) => {
