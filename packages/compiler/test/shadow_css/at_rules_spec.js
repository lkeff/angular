...
describe('ShadowCss, at-rules', () => {
    describe('@media', () => {
        it('should handle media rules with simple rules', () => {
            ...
            const expected = '@media screen and (max-width:800px) {div[contenta] {font-size:50px;}} div[contenta] {}';
        ...
        it('should handle media rules with both width and height', () => {
            ...
            const expected = '@media screen and (max-width:800px, max-height:100%) {div[contenta] {font-size:50px;}}';
            expect((0, utils_1.shim)(css, 'contenta')).toEqualCss(expected);
        });
    });
    describe('@page', () => {
      ...
      `;
            const result = (0, utils_1.shim)(css, contentAttr);
        ...
        it('should strip ::ng-deep and :host from within @page rules', () => {
            expect((0, utils_1.shim)('@page { margin-right: 4in; }', 'contenta', 'h')).toEqualCss('@page { margin-right:4in;}');
            expect((0, utils_1.shim)('@page { ::ng-deep @top-left { content: "Hamlet";}}', 'contenta', 'h')).toEqualCss('@page { @top-left { content:"Hamlet";}}');
            expect((0, utils_1.shim)('@page { :host ::ng-deep @top-left { content:"Hamlet";}}', 'contenta', 'h')).toEqualCss('@page { @top-left { content:"Hamlet";}}');
        });
    });
    describe('@supports', () => {
        ...
        it('should strip ::ng-deep and :host from within @supports', () => {
            expect((0, utils_1.shim)('@supports (display: flex) { @font-face { :host ::ng-deep font-family{} } }', 'contenta', 'h')).toEqualCss('@supports (display:flex) { @font-face { font-family{}}}');
        });
    });
    describe('@font-face', () => {
        it('should strip ::ng-deep and :host from within @font-face', () => {
            expect((0, utils_1.shim)('@font-face { font-family {} }', 'contenta', 'h')).toEqualCss('@font-face { font-family {}}');
            expect((0, utils_1.shim)('@font-face { ::ng-deep font-family{} }', 'contenta', 'h')).toEqualCss('@font-face { font-family{}}');
            expect((0, utils_1.shim)('@font-face { :host ::ng-deep font-family{} }', 'contenta', 'h')).toEqualCss('@font-face { font-family{}}');
        });
    });
    describe('@import', () => {
        ...
        it('should shim rules with quoted content after @import', () => {
            ...
            const css = (0, utils_1.shim)(styleStr, 'contenta');
            expect(css).toEqualCss('@import url("a"); div[contenta] {background-image:url("a.jpg"); color:red;}');
        });
        it('should pass through @import directives whose URL contains colons and semicolons', () => {
            const styleStr = '@import url("https://fonts.googleapis.com/css2?family=Roboto:wght@400;500&display=swap");';
            const css = (0, utils_1.shim)(styleStr, 'contenta');
            expect(css).toEqualCss(styleStr);
        });
        it('should shim rules after @import with colons and semicolons', () => {
            const styleStr = '@import url("https://fonts.googleapis.com/css2?family=Roboto:wght@400;500&display=swap"); div {}';
            const css = (0, utils_1.shim)(styleStr, 'contenta');
            expect(css).toEqualCss('@import url("https://fonts.googleapis.com/css2?family=Roboto:wght@400;500&display=swap"); div[contenta] {}');
        });
    });
    describe('@container', () => {
        it('should scope normal selectors inside an unnamed container rules', () => {
            ...
            const result = (0, utils_1.shim)(css, 'host-a');
