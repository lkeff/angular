    ...
    <body>
      <trans-unit id="deadbeef" datatype="html">
        ...
        <target><b>msg should contain only ph tags</b></target>
                ...
                expect(() => {
                    loadAsMap(XLIFF);
                }).toThrowError(new RegExp((0, util_1.escapeRegExp)(`[ERROR ->]<b>msg should contain only ph tags</b>`)));
            });
    ...
    <body>
      <trans-unit id="deadbeef" datatype="html">
        ...
        <target><x/></target>
                ...
                expect(() => {
                    loadAsMap(XLIFF);
                }).toThrowError(new RegExp((0, util_1.escapeRegExp)(`<x> misses the "id" attribute`)));
            });
        });
    });
});
