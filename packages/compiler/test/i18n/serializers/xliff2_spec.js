...
describe('XLIFF 2.0 serializer', () => {
    ...
    function toXliff(html, locale = null) {
        const catalog = new message_bundle_1.MessageBundle(new html_parser_1.HtmlParser(), [], {}, locale);
    ...
    function loadAsMap(xliff) {
        ...
        const msgMap = {};
        Object.keys(i18nNodesByMsgId).forEach((id) => (msgMap[id] = (0, digest_1.serializeNodes)(i18nNodesByMsgId[id]).join('')));
        return msgMap;
    }
    describe('write', () => {
    ...
    <unit id="deadbeef">
      <segment>
        ...
        <target><b>msg should contain only ph and pc tags</b></target>
            ...
            expect(() => {
                loadAsMap(XLIFF);
            }).toThrowError(new RegExp((0, util_1.escapeRegExp)(`[ERROR ->]<b>msg should contain only ph and pc tags</b>`)));
        });
    ...
    <unit id="deadbeef">
      <segment>
        ...
        <target><ph/></target>
            ...
            expect(() => {
                loadAsMap(XLIFF);
            }).toThrowError(new RegExp((0, util_1.escapeRegExp)(`<ph> misses the "equiv" attribute`)));
        });
    });
});
