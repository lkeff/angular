...
const xliff2_1 = require("../../src/i18n/serializers/xliff2");
const testing_1 = require("@angular/core/testing");
const matchers_1 = require("@angular/platform-browser/testing/src/matchers");
const integration_common_1 = require("./integration_common");
// TODO(alxhub): figure out if this test is still relevant.
xdescribe('i18n XLIFF integration spec', () => {
    describe('(with LF line endings)', () => {
        beforeEach((0, testing_1.waitForAsync)(() => (0, integration_common_1.configureCompiler)(XLIFF2_TOMERGE + LF_LINE_ENDING_XLIFF2_TOMERGE, 'xlf2')));
        it('should extract from templates', () => {
            const serializer = new xliff2_1.Xliff2();
            const serializedXliff2 = (0, integration_common_1.serializeTranslations)(integration_common_1.HTML, serializer);
            XLIFF2_EXTRACTED.forEach((x) => {
                (0, matchers_1.expect)(serializedXliff2).toContain(x);
            });
            (0, matchers_1.expect)(serializedXliff2).toContain(LF_LINE_ENDING_XLIFF2_EXTRACTED);
        });
        it('should translate templates', () => {
            const { tb, cmp, el } = (0, integration_common_1.createComponent)(integration_common_1.HTML);
            (0, integration_common_1.validateHtml)(tb, cmp, el);
        });
    });
    describe('(with CRLF line endings', () => {
        beforeEach((0, testing_1.waitForAsync)(() => (0, integration_common_1.configureCompiler)(XLIFF2_TOMERGE + CRLF_LINE_ENDING_XLIFF2_TOMERGE, 'xlf2')));
        it('should extract from templates (with CRLF line endings)', () => {
            const serializer = new xliff2_1.Xliff2();
            const serializedXliff = (0, integration_common_1.serializeTranslations)(integration_common_1.HTML.replace(/\n/g, '\r\n'), serializer);
            XLIFF2_EXTRACTED.forEach((x) => {
                (0, matchers_1.expect)(serializedXliff).toContain(x);
            });
            (0, matchers_1.expect)(serializedXliff).toContain(CRLF_LINE_ENDING_XLIFF2_EXTRACTED);
        });
        it('should translate templates (with CRLF line endings)', () => {
            const { tb, cmp, el } = (0, integration_common_1.createComponent)(integration_common_1.HTML.replace(/\n/g, '\r\n'));
            (0, integration_common_1.validateHtml)(tb, cmp, el);
        });
    });
});
