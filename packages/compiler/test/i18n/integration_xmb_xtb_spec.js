...
xdescribe('i18n XMB/XTB integration spec', () => {
    describe('(with LF line endings)', () => {
        beforeEach((0, testing_1.waitForAsync)(() => (0, integration_common_1.configureCompiler)(XTB + LF_LINE_ENDING_XTB, 'xtb')));
        it('should extract from templates', () => {
            const serializer = new xmb_1.Xmb();
            const serializedXmb = (0, integration_common_1.serializeTranslations)(integration_common_1.HTML, serializer);
            XMB.forEach((x) => {
                (0, matchers_1.expect)(serializedXmb).toContain(x);
            });
            (0, matchers_1.expect)(serializedXmb).toContain(LF_LINE_ENDING_XMB);
        });
    ...
    describe('(with CRLF line endings', () => {
        beforeEach((0, testing_1.waitForAsync)(() => (0, integration_common_1.configureCompiler)(XTB + CRLF_LINE_ENDING_XTB, 'xtb')));
        it('should extract from templates (with CRLF line endings)', () => {
            const serializer = new xmb_1.Xmb();
            const serializedXmb = (0, integration_common_1.serializeTranslations)(integration_common_1.HTML.replace(/\n/g, '\r\n'), serializer);
            XMB.forEach((x) => {
                (0, matchers_1.expect)(serializedXmb).toContain(x);
            });
            (0, matchers_1.expect)(serializedXmb).toContain(CRLF_LINE_ENDING_XMB);
        });
