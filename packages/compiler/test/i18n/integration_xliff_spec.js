...
const xliff_1 = require("../../src/i18n/serializers/xliff");
...
xdescribe('i18n XLIFF integration spec', () => {
    describe('(with LF line endings)', () => {
        beforeEach((0, testing_1.waitForAsync)(() => (0, integration_common_1.configureCompiler)(XLIFF_TOMERGE + LF_LINE_ENDING_XLIFF_TOMERGE, 'xlf')));
        it('should extract from templates', () => {
            const serializer = new xliff_1.Xliff();
            const serializedXliff = (0, integration_common_1.serializeTranslations)(integration_common_1.HTML, serializer);
            XLIFF_EXTRACTED.forEach((x) => {
                (0, matchers_1.expect)(serializedXliff).toContain(x);
            });
            (0, matchers_1.expect)(serializedXliff).toContain(LF_LINE_ENDING_XLIFF_EXTRACTED);
        });
    ...
    describe('(with CRLF line endings', () => {
        beforeEach((0, testing_1.waitForAsync)(() => (0, integration_common_1.configureCompiler)(XLIFF_TOMERGE + CRLF_LINE_ENDING_XLIFF_TOMERGE, 'xlf')));
        it('should extract from templates (with CRLF line endings)', () => {
            ...
            (0, matchers_1.expect)(serializedXliff).toContain(CRLF_LINE_ENDING_XLIFF_EXTRACTED);
        });
