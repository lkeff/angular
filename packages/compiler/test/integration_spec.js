...
describe('integration tests', () => {
    let fixture;
    describe('directives', () => {
        it('should support dotted selectors', (0, testing_1.waitForAsync)(() => {
            let MyDir = (() => {
                ...
                (() => {
                    ...
                    _value_decorators = [(0, core_1.Input)('dot.name')];
            ...
            const myDir = fixture.debugElement.query(by_1.By.directive(MyDir)).injector.get(MyDir);
            (0, matchers_1.expect)(myDir.value).toEqual('foo');
        }));
    });
    describe('ng-container', () => {
        it('should work regardless the namespace', (0, testing_1.waitForAsync)(() => {
            let MyCmp = (() => {
            ...
            f.detectChanges();
            (0, matchers_1.expect)(f.nativeElement.children[0].children[0].tagName).toEqual('rect');
        }));
    });
});
let TestComponent = (() => {
