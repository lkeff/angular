...
const source_map_1 = require("../../src/output/source_map");
describe('source map generation', () => {
    describe('generation', () => {
        it('should generate a valid source map', () => {
            const map = new source_map_1.SourceMapGenerator('out.js')
                .addSource('a.js', null)
                .addLine()
            ...
            expect(map.toJSON().mappings).toEqual('AAAA,IAAM,CAAC,GAAe,CAAC,CAAC;AACxB,IAAM,CAAC,GAAG,CAAC,CAAC;AAEZ,EAAE,CAAC,OAAO,CAAC,UAAA,CAAC;IACR,OAAO,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC;AACvB,CAAC,CAAC,CAAA');
        });
        ...
        it('should not generate source maps when there is no mapping', () => {
            const smg = new source_map_1.SourceMapGenerator('out.js').addSource('inline.ts', 'inline').addLine();
    ...
    describe('encodeB64String', () => {
        it('should return the b64 encoded value', () => {
            [
                ...
                ['Foo12', 'Rm9vMTI='],
                ['Foo123', 'Rm9vMTIz'],
            ].forEach(([src, b64]) => expect((0, source_map_1.toBase64String)(src)).toEqual(b64));
        });
    });
    describe('errors', () => {
