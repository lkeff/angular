...
exports.RouterUpgradeInitializer = void 0;
...
function setUpLocationSync(ngUpgrade, urlType = 'path') {
    ...
    const router = ngUpgrade.injector.get(index_1.Router);
    const location = ngUpgrade.injector.get(common_1.Location);
    ngUpgrade.$injector
        .get('$rootScope')
...
function resolveUrl(url) {
    anchor !== null && anchor !== void 0 ? anchor : (anchor = document.createElement('a'));
