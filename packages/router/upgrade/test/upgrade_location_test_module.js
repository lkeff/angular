...
let LocationUpgradeTestModule = (() => {
    let _classDecorators = [(0, core_1.NgModule)({ imports: [common_1.CommonModule] })];
            ...
            return {
                ...
                providers: [
                    { provide: exports.LOC_UPGRADE_TEST_CONFIG, useValue: config || {} },
                    {
                        ...
                        deps: [[new core_1.Inject(common_1.APP_BASE_HREF), new core_1.Optional()]],
                    },
                    {
                        provide: upgrade_1.$locationShim,
                    ...
                    upgrade_1.LocationUpgradeModule.config({
...
function provide$location(ngUpgrade, location, platformLocation, urlCodec, locationStrategy, config) {
    const $locationProvider = new upgrade_1.$locationShimProvider(ngUpgrade, location, platformLocation, urlCodec, locationStrategy);
