...
exports.ɵEmptyOutletComponent = exports.EmptyOutletComponent = void 0;
...
let ɵEmptyOutletComponent = (() => {
    let _classDecorators = [(0, core_1.Component)({
            ...
            imports: [router_outlet_1.RouterOutlet],
    ...
    let _classThis;
    var ɵEmptyOutletComponent = _classThis = class {
    };
    __setFunctionName(_classThis, "\u0275EmptyOutletComponent");
    (() => {
...
exports.EmptyOutletComponent = ɵEmptyOutletComponent;
...
function standardizeConfig(r) {
    ...
    if (!c.component &&
        ...
        c.outlet &&
        c.outlet !== shared_1.PRIMARY_OUTLET) {
