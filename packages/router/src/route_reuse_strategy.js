...
exports.DefaultRouteReuseStrategy = exports.BaseRouteReuseStrategy = exports.RouteReuseStrategy = void 0;
...
let RouteReuseStrategy = (() => {
    let _classDecorators = [(0, core_1.Injectable)({ providedIn: 'root', useFactory: () => (0, core_1.inject)(DefaultRouteReuseStrategy) })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var RouteReuseStrategy = _classThis = class {
    };
    __setFunctionName(_classThis, "RouteReuseStrategy");
    (() => {
...
let DefaultRouteReuseStrategy = (() => {
    ...
    var DefaultRouteReuseStrategy = _classThis = class extends _classSuper {
    };
    __setFunctionName(_classThis, "DefaultRouteReuseStrategy");
    (() => {
        var _a;
