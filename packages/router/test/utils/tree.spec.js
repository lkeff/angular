...
describe('tree', () => {
    it('should return the root of the tree', () => {
        const t = new tree_1.Tree(new tree_1.TreeNode(1, []));
        expect(t.root).toEqual(1);
    });
    it('should return the parent of a node', () => {
        const t = new tree_1.Tree(new tree_1.TreeNode(1, [new tree_1.TreeNode(2, [])]));
        expect(t.parent(1)).toEqual(null);
        expect(t.parent(2)).toEqual(1);
    });
    it('should return the parent of a node (second child)', () => {
        const t = new tree_1.Tree(new tree_1.TreeNode(1, [new tree_1.TreeNode(2, []), new tree_1.TreeNode(3, [])]));
        expect(t.parent(1)).toEqual(null);
