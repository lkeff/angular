...
describe('RouterLinkActive', () => {
    it('removes initial active class even if never active', () => __awaiter(void 0, void 0, void 0, function* () {
        let MyCmp = (() => {
            let _classDecorators = [(0, core_1.Component)({
                    imports: [index_1.RouterLinkActive, index_1.RouterLink],
        ...
        testing_1.TestBed.configureTestingModule({ providers: [(0, index_1.provideRouter)([{ path: '**', children: [] }])] });
