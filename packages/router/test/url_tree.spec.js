...
describe('UrlTree', () => {
    ...
    describe('DefaultUrlSerializer', () => {
        let serializer;
        beforeEach(() => {
            serializer = new url_tree_1.DefaultUrlSerializer();
        });
    ...
    describe('containsTree', () => {
        describe('exact = true', () => {
            it('should return true when two tree are the same', () => {
                ...
                expect((0, url_tree_1.containsTree)(t1, t2, router_1.exactMatchOptions)).toBe(true);
                expect((0, url_tree_1.containsTree)(t2, t1, router_1.exactMatchOptions)).toBe(true);
            });
            ...
            it('should return false when queryParams contains array params but are not the same', () => {
                ...
                expect((0, url_tree_1.containsTree)(t1, t2, router_1.subsetMatchOptions)).toBe(false);
            });
            it('should return false when queryParams are not the same', () => {
                const t1 = serializer.parse('/one/two?test=1&page=5');
                const t2 = serializer.parse('/one/two?test=1');
                expect((0, url_tree_1.containsTree)(t1, t2, router_1.exactMatchOptions)).toBe(false);
            });
            it('should return false when queryParams are not the same', () => {
            ...
            it('should return true when queryParams are the same in different order', () => {
                ...
                expect((0, url_tree_1.containsTree)(t1, t2, router_1.subsetMatchOptions)).toBe(true);
            });
            it('should return true when queryParams are the same in different order', () => {
        ...
        describe('ignored query params', () => {
            it('should return true when queryParams differ but are ignored', () => {
                ...
                expect((0, url_tree_1.containsTree)(t1, t2, Object.assign(Object.assign({}, router_1.exactMatchOptions), { queryParams: 'ignored' }))).toBe(true);
            });
        });
        describe('fragment', () => {
            it('should return false when fragments differ but options require exact match', () => {
                ...
                expect((0, url_tree_1.containsTree)(t1, t2, Object.assign(Object.assign({}, router_1.exactMatchOptions), { fragment: 'exact' }))).toBe(false);
            });
            it('should return true when fragments differ but options ignore the fragment', () => {
                const t1 = serializer.parse('/#fragment1');
                const t2 = serializer.parse('/#fragment2');
                expect((0, url_tree_1.containsTree)(t1, t2, Object.assign(Object.assign({}, router_1.exactMatchOptions), { fragment: 'ignored' }))).toBe(true);
            });
        });
        describe('matrix params', () => {
            describe('ignored', () => {
                it('returns true when matrix params differ but are ignored', () => {
                    ...
                    expect((0, url_tree_1.containsTree)(t1, t2, Object.assign(Object.assign({}, router_1.exactMatchOptions), { matrixParams: 'ignored' }))).toBe(true);
                });
            });
            describe('exact match', () => {
                ...
                it('returns true when matrix params match', () => {
                    ...
                    expect((0, url_tree_1.containsTree)(t1, t2, Object.assign(Object.assign({}, router_1.exactMatchOptions), { matrixParams }))).toBe(true);
                });
                it('returns false when matrix params differ', () => {
                    const t1 = serializer.parse('/a;id=15;foo=foo');
                    const t2 = serializer.parse('/a;abc=123');
                    expect((0, url_tree_1.containsTree)(t1, t2, Object.assign(Object.assign({}, router_1.exactMatchOptions), { matrixParams }))).toBe(false);
                });
                it('returns true when matrix params match on the subset of the matched url tree', () => {
                    ...
                    expect((0, url_tree_1.containsTree)(t1, t2, Object.assign(Object.assign({}, router_1.subsetMatchOptions), { matrixParams }))).toBe(true);
                });
