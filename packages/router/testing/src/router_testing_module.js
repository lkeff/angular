...
exports.RouterTestingModule = void 0;
...
let RouterTestingModule = (() => {
    let _classDecorators = [(0, core_1.NgModule)({
            exports: [index_1.RouterModule],
            providers: [
                index_1.ɵROUTER_PROVIDERS,
                (0, testing_1.provideLocationMocks)(),
                (0, index_1.withPreloading)(index_1.NoPreloading).ɵproviders,
                { provide: index_1.ROUTES, multi: true, useValue: [] },
            ],
        })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var RouterTestingModule = _classThis = class {
        static withRoutes(routes, config) {
            return {
                ngModule: RouterTestingModule,
                providers: [
                    { provide: index_1.ROUTES, multi: true, useValue: routes },
                    { provide: index_1.ROUTER_CONFIGURATION, useValue: config ? config : {} },
                ],
            };
        }
    };
    __setFunctionName(_classThis, "RouterTestingModule");
    (() => {
