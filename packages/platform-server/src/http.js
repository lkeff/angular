...
exports.SERVER_HTTP_PROVIDERS = exports.ServerXhr = void 0;
...
let ServerXhr = (() => {
    ...
    let _classThis;
    var ServerXhr = _classThis = class {
        ...
        ɵloadImpl() {
            return __awaiter(this, void 0, void 0, function* () {
                if (!this.xhrImpl) {
                    const { default: xhr } = yield Promise.resolve().then(() => __importStar(require('xhr2')));
                    this.xhrImpl = xhr;
                }
            });
        }
    ...
    __setFunctionName(_classThis, "ServerXhr");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ServerXhr = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ServerXhr = _classThis;
})();
exports.ServerXhr = ServerXhr;
function relativeUrlsTransformerInterceptorFn(request, next) {
    const platformLocation = (0, core_1.inject)(common_1.PlatformLocation);
...
exports.SERVER_HTTP_PROVIDERS = [
    { provide: common_1.XhrFactory, useClass: ServerXhr },
    {
        provide: http_1.ɵHTTP_ROOT_INTERCEPTOR_FNS,
