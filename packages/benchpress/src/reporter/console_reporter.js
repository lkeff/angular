...
let ConsoleReporter = (() => {
    ...
    var ConsoleReporter = _classThis = class extends _classSuper {
        constructor(_columnWidth, _sampleDescription, _print) {
            super();
            this._columnWidth = _columnWidth;
            this._sampleDescription = _sampleDescription;
            this._print = _print;
            this.textReporter = new text_reporter_base_1.TextReporterBase(this._columnWidth, this._sampleDescription);
        ...
        reportSample(_completeSample, validSamples) {
            this._print(this.textReporter.separator());
            this._print(this.textReporter.sampleStats(validSamples));
            return Promise.resolve(null);
        }
    };
    __setFunctionName(_classThis, "ConsoleReporter");
    (() => {
        var _a;
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ConsoleReporter = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
    })();
    _classThis.PRINT = new core_1.InjectionToken('ConsoleReporter.print');
    _classThis.PROVIDERS = [
        { provide: ConsoleReporter, deps: [text_reporter_base_1.COLUMN_WIDTH, sample_description_1.SampleDescription, ConsoleReporter.PRINT] },
    ...
    return ConsoleReporter = _classThis;
})();
