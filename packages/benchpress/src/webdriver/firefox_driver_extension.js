...
let FirefoxDriverExtension = (() => {
    ...
    var FirefoxDriverExtension = _classThis = class extends _classSuper {
        ...
        perfLogFeatures() {
            return new web_driver_extension_1.PerfLogFeatures({ render: true, gc: true });
        }
        supports(capabilities) {
            return capabilities['browserName'].toLowerCase() === 'firefox';
        }
    };
    __setFunctionName(_classThis, "FirefoxDriverExtension");
    (() => {
        var _a;
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        FirefoxDriverExtension = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
    })();
    _classThis.PROVIDERS = [{ provide: FirefoxDriverExtension, deps: [web_driver_adapter_1.WebDriverAdapter] }];
    (() => {
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FirefoxDriverExtension = _classThis;
})();
