...
const sample_description_providers_1 = require("./sample_description_providers");
...
class Runner {
    ...
    sample({ id, execute, prepare, microMetrics, providers, userMetrics, }) {
        const sampleProviders = [
            ...
            { provide: common_options_1.Options.SAMPLE_ID, useValue: id },
        ...
        const inj = core_1.Injector.create({ providers: sampleProviders });
        ...
        return Promise.all([
            ...
            const injector = core_1.Injector.create({
                providers: [
                    sampleProviders,
                    { provide: common_options_1.Options.CAPABILITIES, useValue: capabilities },
...
const _DEFAULT_PROVIDERS = [
    ...
    sample_description_providers_1.sampleDescriptionProviders,
    ...
    web_driver_extension_1.WebDriverExtension.provideFirstSupported([
        chrome_driver_extension_1.ChromeDriverExtension,
        firefox_driver_extension_1.FirefoxDriverExtension,
        ios_driver_extension_1.IOsDriverExtension,
    ]),
