...
// #docregion registration-options
let AppModule = (() => {
    let _classDecorators = [(0, core_2.NgModule)({
            // #enddocregion registration-options
            bootstrap: [AppComponent],
            declarations: [AppComponent],
            // #docregion registration-options
            imports: [platform_browser_1.BrowserModule, service_worker_1.ServiceWorkerModule.register('ngsw-worker.js')],
            providers: [
                {
                    provide: service_worker_1.SwRegistrationOptions,
