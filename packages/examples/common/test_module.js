...
const locationExample = __importStar(require("./location/ts/module"));
const ngComponentOutletExample = __importStar(require("./ngComponentOutlet/ts/module"));
const ngIfExample = __importStar(require("./ngIf/ts/module"));
const ngTemplateOutletExample = __importStar(require("./ngTemplateOutlet/ts/module"));
const pipesExample = __importStar(require("./pipes/ts/module"));
