...
exports.AppModule = exports.AppComponent = exports.NgTemplateOutletExample = void 0;
const core_1 = require("@angular/core");
const platform_browser_1 = require("@angular/platform-browser");
// #docregion NgTemplateOutlet
let NgTemplateOutletExample = (() => {
  ...
  `,
    ...
    let _classThis;
    var NgTemplateOutletExample = _classThis = class {
        constructor() {
            this.myContext = { $implicit: 'World', localSk: 'Svet' };
        }
    };
    __setFunctionName(_classThis, "NgTemplateOutletExample");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        NgTemplateOutletExample = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return NgTemplateOutletExample = _classThis;
})();
exports.NgTemplateOutletExample = NgTemplateOutletExample;
// #enddocregion
let AppComponent = (() => {
    let _classDecorators = [(0, core_1.Component)({
