...
let SomeCmp = (() => {
    ...
    var SomeCmp = _classThis = class {
        ...
        constructor() {
            this.viewChildren = __runInitializers(this, _viewChildren_initializers, void 0);
            __runInitializers(this, _viewChildren_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "SomeCmp");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _viewChildren_decorators = [(0, core_1.ViewChildren)(ChildDirective)];
