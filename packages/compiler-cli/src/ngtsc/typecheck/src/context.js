...
const type_check_file_1 = require("./type_check_file");
...
})(InliningMode || (exports.InliningMode = InliningMode = {}));
/**
...
class TypeCheckContextImpl {
    ...
    addDirective(ref, binder, schemas, templateContext, hostBindingContext, isStandalone) {
        ...
        const boundTarget = binder.bind({
            template: templateContext === null || templateContext === void 0 ? void 0 : templateContext.nodes,
            host: hostBindingContext === null || hostBindingContext === void 0 ? void 0 : hostBindingContext.node,
        });
        if (this.inlining === InliningMode.InlineOps) {
            ...
            for (const dir of boundTarget.getUsedDirectives()) {
                ...
                if (!dir.isGeneric || !(0, type_constructor_1.requiresInlineTypeCtor)(dirNode, this.reflector, shimData.file)) {
        ...
        shimData.data.set(id, {
            template: (templateContext === null || templateContext === void 0 ? void 0 : templateContext.nodes) || null,
            boundTarget,
            templateParsingDiagnostics,
            hostElement: (_a = hostBindingContext === null || hostBindingContext === void 0 ? void 0 : hostBindingContext.node) !== null && _a !== void 0 ? _a : null,
        });
        const usedPipes = [];
        ...
        const inliningRequirement = (0, tcb_util_1.requiresInlineTypeCheckBlock)(ref, shimData.file, usedPipes, this.reflector);
        ...
        if (hostBindingContext !== null) {
            ...
            new compiler_1.ParseSourceFile(sourceFile.text, sourceFile.fileName));
        }
        const meta = {
            id,
            boundTarget,
            pipes: (templateContext === null || templateContext === void 0 ? void 0 : templateContext.pipes) || null,
            schemas,
            isStandalone,
            preserveWhitespaces: (_b = templateContext === null || templateContext === void 0 ? void 0 : templateContext.preserveWhitespaces) !== null && _b !== void 0 ? _b : false,
        };
    ...
    transform(sf) {
        ...
        const printer = typescript_1.default.createPrinter({ omitTrailingSemicolon: true });
        ...
        if (newImports.has(sf.fileName)) {
            newImports.get(sf.fileName).forEach((newImport) => {
                updates.push({
                    pos: 0,
                    text: printer.printNode(typescript_1.default.EmitHint.Unspecified, newImport, sf),
                });
            });
        }
        ...
        for (const [oldBindings, newBindings] of updatedImports.entries()) {
            ...
            updates.push({
                ...
                text: printer.printNode(typescript_1.default.EmitHint.Unspecified, newBindings, sf),
            });
        }
        const result = new magic_string_1.default(sf.text, { filename: sf.fileName });
    ...
    pendingShimForClass(node) {
        ...
        const shimPath = shim_1.TypeCheckShimGenerator.shimFor((0, file_system_1.absoluteFromSourceFile)(node.getSourceFile()));
...
function getTemplateDiagnostics(parseErrors, templateId, sourceMapping) {
    return parseErrors.map((error) => {
        ...
        return (0, diagnostics_2.makeTemplateDiagnostic)(templateId, sourceMapping, span, typescript_1.default.DiagnosticCategory.Error, (0, diagnostics_1.ngErrorCode)(diagnostics_1.ErrorCode.TEMPLATE_PARSE_ERROR), error.msg);
    });
}
/**
...
class InlineTcbOp {
    ...
    execute(im, sf, refEmitter, printer) {
        const env = new environment_1.Environment(this.config, im, refEmitter, this.reflector, sf);
        const fnName = typescript_1.default.factory.createIdentifier(`_tcb_${this.ref.node.pos}`);
        ...
        const fn = (0, type_check_block_1.generateTypeCheckBlock)(env, this.ref, fnName, this.meta, this.domSchemaChecker, this.oobRecorder, type_check_block_1.TcbGenericContextBehavior.CopyClassNodes);
        return printer.printNode(typescript_1.default.EmitHint.Unspecified, fn, sf);
    }
}
/**
...
class TypeCtorOp {
    ...
    execute(im, sf, refEmitter, printer) {
        const emitEnv = new reference_emit_environment_1.ReferenceEmitEnvironment(im, refEmitter, this.reflector, sf);
        const tcb = (0, type_constructor_1.generateInlineTypeCtor)(emitEnv, this.ref.node, this.meta);
        return printer.printNode(typescript_1.default.EmitHint.Unspecified, tcb, sf);
    }
}
/**
