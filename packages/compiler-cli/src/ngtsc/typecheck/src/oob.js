...
class OutOfBandDiagnosticRecorderImpl {
    ...
    missingReferenceTarget(id, ref) {
        ...
        this._diagnostics.push((0, diagnostics_2.makeTemplateDiagnostic)(id, mapping, ref.valueSpan || ref.sourceSpan, typescript_1.default.DiagnosticCategory.Error, (0, diagnostics_1.ngErrorCode)(diagnostics_1.ErrorCode.MISSING_REFERENCE_TARGET), errorMsg));
    }
    missingPipe(id, ast) {
        ...
        this._diagnostics.push((0, diagnostics_2.makeTemplateDiagnostic)(id, mapping, sourceSpan, typescript_1.default.DiagnosticCategory.Error, (0, diagnostics_1.ngErrorCode)(diagnostics_1.ErrorCode.MISSING_PIPE), errorMsg));
    ...
    deferredPipeUsedEagerly(id, ast) {
        ...
        this._diagnostics.push((0, diagnostics_2.makeTemplateDiagnostic)(id, mapping, sourceSpan, typescript_1.default.DiagnosticCategory.Error, (0, diagnostics_1.ngErrorCode)(diagnostics_1.ErrorCode.DEFERRED_PIPE_USED_EAGERLY), errorMsg));
        this.recordedPipes.add(ast);
    }
    deferredComponentUsedEagerly(id, element) {
        ...
        const absoluteSourceSpan = new compiler_1.AbsoluteSourceSpan(start.offset, end.offset);
        ...
        this._diagnostics.push((0, diagnostics_2.makeTemplateDiagnostic)(id, mapping, sourceSpan, typescript_1.default.DiagnosticCategory.Error, (0, diagnostics_1.ngErrorCode)(diagnostics_1.ErrorCode.DEFERRED_DIRECTIVE_USED_EAGERLY), errorMsg));
    }
    duplicateTemplateVar(id, variable, firstDecl) {
        ...
        this._diagnostics.push((0, diagnostics_2.makeTemplateDiagnostic)(id, mapping, variable.sourceSpan, typescript_1.default.DiagnosticCategory.Error, (0, diagnostics_1.ngErrorCode)(diagnostics_1.ErrorCode.DUPLICATE_VARIABLE_DECLARATION), errorMsg, [
            {
    ...
    requiresInlineTcb(id, node) {
        this._diagnostics.push(makeInlineDiagnostic(id, diagnostics_1.ErrorCode.INLINE_TCB_REQUIRED, node.name, `This component requires inline template type-checking, which is not supported by the current environment.`));
    }
    requiresInlineTypeConstructors(id, node, directives) {
        ...
        this._diagnostics.push(makeInlineDiagnostic(id, diagnostics_1.ErrorCode.INLINE_TYPE_CTOR_REQUIRED, node.name, message, directives.map((dir) => (0, diagnostics_1.makeRelatedInformation)(dir.name, `Requires an inline type constructor.`))));
    }
    suboptimalTypeInference(id, variables) {
        ...
        this._diagnostics.push((0, diagnostics_2.makeTemplateDiagnostic)(id, mapping, diagnosticVar.keySpan, typescript_1.default.DiagnosticCategory.Suggestion, (0, diagnostics_1.ngErrorCode)(diagnostics_1.ErrorCode.SUGGEST_SUBOPTIMAL_TYPE_INFERENCE), message));
    }
    splitTwoWayBinding(id, input, output, inputConsumer, outputConsumer) {
        ...
        this._diagnostics.push((0, diagnostics_2.makeTemplateDiagnostic)(id, mapping, input.keySpan, typescript_1.default.DiagnosticCategory.Error, (0, diagnostics_1.ngErrorCode)(diagnostics_1.ErrorCode.SPLIT_TWO_WAY_BINDING), errorMsg, relatedMessages));
    }
    missingRequiredInputs(id, element, directiveName, isComponent, inputAliases) {
        ...
        this._diagnostics.push((0, diagnostics_2.makeTemplateDiagnostic)(id, this.resolver.getTemplateSourceMapping(id), element.startSourceSpan, typescript_1.default.DiagnosticCategory.Error, (0, diagnostics_1.ngErrorCode)(diagnostics_1.ErrorCode.MISSING_REQUIRED_INPUTS), message));
    }
    illegalForLoopTrackAccess(id, block, access) {
        ...
        this._diagnostics.push((0, diagnostics_2.makeTemplateDiagnostic)(id, this.resolver.getTemplateSourceMapping(id), sourceSpan, typescript_1.default.DiagnosticCategory.Error, (0, diagnostics_1.ngErrorCode)(diagnostics_1.ErrorCode.ILLEGAL_FOR_LOOP_TRACK_ACCESS), message));
    }
    inaccessibleDeferredTriggerElement(id, trigger) {
        ...
        this._diagnostics.push((0, diagnostics_2.makeTemplateDiagnostic)(id, this.resolver.getTemplateSourceMapping(id), trigger.sourceSpan, typescript_1.default.DiagnosticCategory.Error, (0, diagnostics_1.ngErrorCode)(diagnostics_1.ErrorCode.INACCESSIBLE_DEFERRED_TRIGGER_ELEMENT), message));
    }
    controlFlowPreventingContentProjection(id, category, projectionNode, componentName, slotSelector, controlFlowNode, preservesWhitespaces) {
        ...
        this._diagnostics.push((0, diagnostics_2.makeTemplateDiagnostic)(id, this.resolver.getTemplateSourceMapping(id), projectionNode.startSourceSpan, category, (0, diagnostics_1.ngErrorCode)(diagnostics_1.ErrorCode.CONTROL_FLOW_PREVENTING_CONTENT_PROJECTION), lines.join('\n')));
    }
    illegalWriteToLetDeclaration(id, node, target) {
        ...
        this._diagnostics.push((0, diagnostics_2.makeTemplateDiagnostic)(id, this.resolver.getTemplateSourceMapping(id), sourceSpan, typescript_1.default.DiagnosticCategory.Error, (0, diagnostics_1.ngErrorCode)(diagnostics_1.ErrorCode.ILLEGAL_LET_WRITE), `Cannot assign to @let declaration '${target.name}'.`));
    }
    letUsedBeforeDefinition(id, node, target) {
        ...
        this._diagnostics.push((0, diagnostics_2.makeTemplateDiagnostic)(id, this.resolver.getTemplateSourceMapping(id), sourceSpan, typescript_1.default.DiagnosticCategory.Error, (0, diagnostics_1.ngErrorCode)(diagnostics_1.ErrorCode.LET_USED_BEFORE_DEFINITION), `Cannot read @let declaration '${target.name}' before it has been defined.`));
    }
    conflictingDeclaration(id, decl) {
        ...
        this._diagnostics.push((0, diagnostics_2.makeTemplateDiagnostic)(id, mapping, decl.sourceSpan, typescript_1.default.DiagnosticCategory.Error, (0, diagnostics_1.ngErrorCode)(diagnostics_1.ErrorCode.CONFLICTING_LET_DECLARATION), errorMsg));
    }
    missingNamedTemplateDependency(id, node) {
        this._diagnostics.push((0, diagnostics_2.makeTemplateDiagnostic)(id, this.resolver.getTemplateSourceMapping(id), node.startSourceSpan, typescript_1.default.DiagnosticCategory.Error, (0, diagnostics_1.ngErrorCode)(diagnostics_1.ErrorCode.MISSING_NAMED_TEMPLATE_DEPENDENCY), 
        // Wording is meant to mimic the wording TS uses in their diagnostic for missing symbols.
        `Cannot find name "${node instanceof compiler_1.TmplAstDirective ? node.name : node.componentName}". ` +
    ...
    incorrectTemplateDependencyType(id, node) {
        this._diagnostics.push((0, diagnostics_2.makeTemplateDiagnostic)(id, this.resolver.getTemplateSourceMapping(id), node.startSourceSpan, typescript_1.default.DiagnosticCategory.Error, (0, diagnostics_1.ngErrorCode)(diagnostics_1.ErrorCode.INCORRECT_NAMED_TEMPLATE_DEPENDENCY_TYPE), `Incorrect reference type. Type must be a standalone ${node instanceof compiler_1.TmplAstComponent ? '@Component' : '@Directive'}.`));
    }
    unclaimedDirectiveBinding(id, directive, node) {
        const errorMsg = `Directive ${directive.name} does not have an ` +
            `${node instanceof compiler_1.TmplAstBoundEvent ? 'output' : 'input'} named "${node.name}". ` +
            `Bindings to directives must target existing inputs or outputs.`;
        this._diagnostics.push((0, diagnostics_2.makeTemplateDiagnostic)(id, this.resolver.getTemplateSourceMapping(id), node.keySpan || node.sourceSpan, typescript_1.default.DiagnosticCategory.Error, (0, diagnostics_1.ngErrorCode)(diagnostics_1.ErrorCode.UNCLAIMED_DIRECTIVE_BINDING), errorMsg));
    }
}
...
function makeInlineDiagnostic(id, code, node, messageText, relatedInformation) {
    return Object.assign(Object.assign({}, (0, diagnostics_1.makeDiagnostic)(code, node, messageText, relatedInformation)), { sourceFile: node.getSourceFile(), typeCheckId: id });
}
