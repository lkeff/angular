...
describe('type check blocks', () => {
    beforeEach(() => (0, testing_1.initMockFileSystem)('Native'));
    it('should generate a basic block for a binding', () => {
        expect((0, testing_2.tcb)('{{hello}} {{world}}')).toContain('"" + (((this).hello)) + (((this).world));');
    });
    it('should generate literal map expressions', () => {
        const TEMPLATE = '{{ method({foo: a, bar: b}) }}';
        expect((0, testing_2.tcb)(TEMPLATE)).toContain('(this).method({ "foo": ((this).a), "bar": ((this).b) })');
    });
    it('should generate literal array expressions', () => {
        const TEMPLATE = '{{ method([a, b]) }}';
        expect((0, testing_2.tcb)(TEMPLATE)).toContain('(this).method([((this).a), ((this).b)])');
    });
    it('should handle non-null assertions', () => {
        const TEMPLATE = `{{a!}}`;
        expect((0, testing_2.tcb)(TEMPLATE)).toContain('((((this).a))!)');
    });
    it('should handle unary - operator', () => {
        const TEMPLATE = `{{-1}}`;
        expect((0, testing_2.tcb)(TEMPLATE)).toContain('(-1)');
    });
    it('should handle keyed property access', () => {
        const TEMPLATE = `{{a[b]}}`;
        expect((0, testing_2.tcb)(TEMPLATE)).toContain('(((this).a))[((this).b)]');
    });
    it('should handle nested ternary expressions', () => {
        const TEMPLATE = `{{a ? b : c ? d : e}}`;
        expect((0, testing_2.tcb)(TEMPLATE)).toContain('(((this).a) ? ((this).b) : ((((this).c) ? ((this).d) : (((this).e)))))');
    });
    it('should handle nullish coalescing operator', () => {
        expect((0, testing_2.tcb)('{{ a ?? b }}')).toContain('((((this).a)) ?? (((this).b)))');
        expect((0, testing_2.tcb)('{{ a ?? b ?? c }}')).toContain('(((((this).a)) ?? (((this).b))) ?? (((this).c)))');
        expect((0, testing_2.tcb)('{{ (a ?? b) + (c ?? e) }}')).toContain('((((((this).a)) ?? (((this).b)))) + (((((this).c)) ?? (((this).e)))))');
    });
    it('should handle typeof expressions', () => {
        expect((0, testing_2.tcb)('{{typeof a}}')).toContain('typeof (((this).a))');
        expect((0, testing_2.tcb)('{{!(typeof a)}}')).toContain('!((typeof (((this).a))))');
        expect((0, testing_2.tcb)('{{!(typeof a === "object")}}')).toContain('!(((typeof (((this).a))) === ("object")))');
    });
    it('should handle void expressions', () => {
        expect((0, testing_2.tcb)('{{void a}}')).toContain('void (((this).a))');
        expect((0, testing_2.tcb)('{{!(void a)}}')).toContain('!((void (((this).a))))');
        expect((0, testing_2.tcb)('{{!(void a === "object")}}')).toContain('!(((void (((this).a))) === ("object")))');
    });
    it('should handle exponentiation expressions', () => {
        expect((0, testing_2.tcb)('{{a * b ** c + d}}')).toContain('(((((this).a)) * ((((this).b)) ** (((this).c)))) + (((this).d)))');
        expect((0, testing_2.tcb)('{{a ** b ** c}}')).toContain('((((this).a)) ** ((((this).b)) ** (((this).c))))');
    });
    it('should handle "in" expressions', () => {
        expect((0, testing_2.tcb)(`{{'bar' in {bar: 'bar'} }}`)).toContain(`(("bar") in ({ "bar": "bar" }))`);
        expect((0, testing_2.tcb)(`{{!('bar' in {bar: 'bar'}) }}`)).toContain(`!((("bar") in ({ "bar": "bar" })))`);
    });
    it('should handle attribute values for directive inputs', () => {
        ...
        expect((0, testing_2.tcb)(TEMPLATE, DIRECTIVES)).toContain('_t1 = null! as i0.DirA; _t1.inputA = ("value");');
    });
    it('should handle multiple bindings to the same property', () => {
        ...
        const block = (0, testing_2.tcb)(TEMPLATE, DIRECTIVES);
    ...
    it('should handle empty bindings', () => {
        ...
        expect((0, testing_2.tcb)(TEMPLATE, DIRECTIVES)).toContain('_t1.inputA = (undefined);');
    });
    ...
    it('should handle implicit vars on ng-template', () => {
        ...
        expect((0, testing_2.tcb)(TEMPLATE)).toContain('var _t2 = _t1.$implicit;');
    });
    it('should handle method calls of template variables', () => {
        const TEMPLATE = `<ng-template let-a>{{a(1)}}</ng-template>`;
        expect((0, testing_2.tcb)(TEMPLATE)).toContain('var _t2 = _t1.$implicit;');
        expect((0, testing_2.tcb)(TEMPLATE)).toContain('_t2(1)');
    });
    ...
    it('should handle template literals', () => {
        expect((0, testing_2.tcb)('{{ `hello world` }}')).toContain('"" + (`hello world`);');
        expect((0, testing_2.tcb)('{{ `hello \\${name}!!!` }}')).toContain('"" + (`hello \\${name}!!!`);');
        expect((0, testing_2.tcb)('{{ `${a} - ${b} - ${c}` }}')).toContain('"" + (`${((this).a)} - ${((this).b)} - ${((this).c)}`);');
    });
    it('should handle tagged template literals', () => {
        expect((0, testing_2.tcb)('{{ tag`hello world` }}')).toContain('"" + (((this).tag) `hello world`);');
        expect((0, testing_2.tcb)('{{ tag`hello \\${name}!!!` }}')).toContain('"" + (((this).tag) `hello \\${name}!!!`);');
        expect((0, testing_2.tcb)('{{ tag`${a} - ${b} - ${c}` }}')).toContain('"" + (((this).tag) `${((this).a)} - ${((this).b)} - ${((this).c)}`);');
    });
    describe('type constructors', () => {
        it('should handle missing property bindings', () => {
            ...
            const actual = (0, testing_2.tcb)(TEMPLATE, DIRECTIVES);
            expect(actual).toContain('const _ctor1: <T extends string = any>(init: Pick<i0.Dir<T>, "fieldA" | "fieldB">) => i0.Dir<T> = null!;');
            expect(actual).toContain('var _t1 = _ctor1({ "fieldA": (((this).foo)), "fieldB": 0 as any });');
        });
        it('should handle multiple bindings to the same property', () => {
    ...
    `;
            ...
            const actual = (0, testing_2.tcb)(TEMPLATE, DIRECTIVES);
            expect(actual).toContain('const _ctor1: <T extends string = any>(init: Pick<i0.Dir<T>, "input">) => i0.Dir<T> = null!;');
            expect(actual).toContain('var _t2 = _ctor1({ "input": (null!) }); ' + 'var _t1 = _t2; ' + '_t2.input = (_t1);');
        });
...
`;
            ...
            const actual = (0, testing_2.tcb)(TEMPLATE, DIRECTIVES);
            expect(actual).toContain('const _ctor1: <T extends string = any>(init: Pick<i0.DirA<T>, "inputA">) => i0.DirA<T> = null!; const _ctor2: <T extends string = any>(init: Pick<i0.DirB<T>, "inputB">) => i0.DirB<T> = null!;');
            expect(actual).toContain('var _t4 = _ctor1({ "inputA": (null!) }); ' +
                'var _t3 = _t4; ' +
        ...
        it('should handle empty bindings', () => {
            ...
            expect((0, testing_2.tcb)(TEMPLATE, DIRECTIVES)).toContain('"inputA": (undefined)');
        });
        it('should handle bindings without value', () => {
            const TEMPLATE = `<div dir-a [inputA]></div>`;
            const DIRECTIVES = [
        ...
        it('should use coercion types if declared', () => {
            ...
            expect((0, testing_2.tcb)(TEMPLATE, DIRECTIVES)).toContain('var _t1 = null! as typeof i0.Dir.ngAcceptInputType_fieldA; ' + '_t1 = (((this).foo));');
        });
    });
    ...
    `;
        const block = (0, testing_2.tcb)(TEMPLATE);
        expect(block).not.toContain('"div"');
        expect(block).toContain('var _t2 = document.createElement("button"); ' + 'var _t1 = _t2; ' + '_t2.addEventListener');
    });
    it('should generate code for event targeting `window`', () => {
        const block = (0, testing_2.tcb)(`<button (window:scroll)="handle()"></button>`);
        expect(block).toContain('window.addEventListener("scroll", ($event): any => { (this).handle(); });');
    });
    it('should generate code for event targeting `document`', () => {
        const block = (0, testing_2.tcb)(`<button (document:click)="handle()"></button>`);
        expect(block).toContain('document.addEventListener("click", ($event): any => { (this).handle(); });');
    });
    ...
    it('should generate a forward element reference correctly', () => {
      ...
      <input #i>
    `;
        expect((0, testing_2.tcb)(TEMPLATE)).toContain('var _t2 = document.createElement("input"); var _t1 = _t2; "" + (((_t1).value));');
    });
    ...
    `;
        ...
        expect((0, testing_2.tcb)(TEMPLATE, DIRECTIVES)).toContain('var _t2 = null! as i0.Dir; ' + 'var _t1 = _t2; ' + '"" + (((_t1).value));');
    });
    ...
    `;
        ...
        expect((0, testing_2.tcb)(TEMPLATE, DIRECTIVES)).toContain('var _t2 = null! as i0.Dir; ' + 'var _t1 = _t2; ' + '_t2.input = (_t1);');
    });
    it('should generate circular references between two directives correctly', () => {
        const TEMPLATE = `
    <div #a="dirA" dir-a [inputA]="b">A</div>
...
`;
        ...
        expect((0, testing_2.tcb)(TEMPLATE, DIRECTIVES)).toContain('var _t2 = null! as i0.DirB; ' +
            'var _t1 = _t2; ' +
    ...
    it('should assign restricted properties to temp variables by default', () => {
        ...
        expect((0, testing_2.tcb)(TEMPLATE, DIRECTIVES)).toContain('var _t1 = null! as i0.Dir; ' +
    ...
    it('should assign properties via element access for field names that are not JS identifiers', () => {
        ...
        const block = (0, testing_2.tcb)(TEMPLATE, DIRECTIVES);
        expect(block).toContain('var _t1 = null! as i0.Dir; ' + '_t1["some-input.xs"] = (((this).foo)); ');
    });
    it('should handle a single property bound to multiple fields', () => {
        ...
        expect((0, testing_2.tcb)(TEMPLATE, DIRECTIVES)).toContain('var _t1 = null! as i0.Dir; ' + '_t1.field2 = _t1.field1 = (((this).foo));');
    });
    it('should handle a single property bound to multiple fields, where one of them is coerced', () => {
        ...
        expect((0, testing_2.tcb)(TEMPLATE, DIRECTIVES)).toContain('var _t1 = null! as typeof i0.Dir.ngAcceptInputType_field1; ' +
    ...
    it('should handle a single property bound to multiple fields, where one of them is undeclared', () => {
        ...
        expect((0, testing_2.tcb)(TEMPLATE, DIRECTIVES)).toContain('var _t1 = null! as i0.Dir; ' + '_t1.field2 = (((this).foo));');
    });
    it('should use coercion types if declared', () => {
        const TEMPLATE = `<div dir [inputA]="foo"></div>`;
        const DIRECTIVES = [
        ...
        const block = (0, testing_2.tcb)(TEMPLATE, DIRECTIVES);
        expect(block).not.toContain('var _t1 = null! as Dir;');
        expect(block).toContain('var _t1 = null! as typeof i0.Dir.ngAcceptInputType_fieldA; ' + '_t1 = (((this).foo));');
    });
    ...
    describe('experimental DOM checking via lib.dom.d.ts', () => {
        it('should translate unclaimed bindings to their property equivalent', () => {
            ...
            const CONFIG = Object.assign(Object.assign({}, testing_2.ALL_ENABLED_CONFIG), { checkTypeOfDomBindings: true });
            expect((0, testing_2.tcb)(TEMPLATE, /* declarations */ undefined, CONFIG)).toContain('_t1["htmlFor"] = ("test");');
        });
    });
    ...
    describe('outputs', () => {
        it('should emit subscribe calls for directive outputs', () => {
            ...
            const block = (0, testing_2.tcb)(TEMPLATE, DIRECTIVES);
            expect(block).toContain('_t1["outputField"].subscribe(($event): any => { (this).foo($event); });');
        });
        ...
        it('should emit addEventListener calls for unclaimed outputs', () => {
            ...
            const block = (0, testing_2.tcb)(TEMPLATE);
            expect(block).toContain('_t1.addEventListener("event", ($event): any => { (this).foo($event); });');
        });
        it('should allow to cast $event using $any', () => {
            const TEMPLATE = `<div (event)="foo($any($event))"></div>`;
            const block = (0, testing_2.tcb)(TEMPLATE);
            expect(block).toContain('_t1.addEventListener("event", ($event): any => { (this).foo(($event as any)); });');
        });
        ...
        it('should ignore accesses to $event through `this`', () => {
            ...
            const block = (0, testing_2.tcb)(TEMPLATE);
            expect(block).toContain('_t1.addEventListener("event", ($event): any => { (this).foo(((this).$event)); });');
        });
    });
    describe('config', () => {
        const DIRECTIVES = [
        ...
        describe('config.applyTemplateContextGuards', () => {
            ...
            it('should not apply template context guards when disabled', () => {
                const DISABLED_CONFIG = Object.assign(Object.assign({}, BASE_CONFIG), { applyTemplateContextGuards: false });
                const block = (0, testing_2.tcb)(TEMPLATE, DIRECTIVES, DISABLED_CONFIG);
        ...
        describe('config.checkTemplateBodies', () => {
            ...
            it('should not descend into template bodies when disabled', () => {
                const DISABLED_CONFIG = Object.assign(Object.assign({}, BASE_CONFIG), { checkTemplateBodies: false });
                const block = (0, testing_2.tcb)(TEMPLATE, DIRECTIVES, DISABLED_CONFIG);
        ...
        describe('config.strictNullInputBindings', () => {
            ...
            it('should use the non-null assertion operator when disabled', () => {
                const DISABLED_CONFIG = Object.assign(Object.assign({}, BASE_CONFIG), { strictNullInputBindings: false });
                const block = (0, testing_2.tcb)(TEMPLATE, DIRECTIVES, DISABLED_CONFIG);
                expect(block).toContain('_t1.dirInput = (((this).a)!);');
                expect(block).toContain('((this).b)!;');
            });
        ...
        describe('config.checkTypeOfBindings', () => {
            ...
            it('should not check types of bindings when disabled', () => {
                const TEMPLATE = `<div dir [dirInput]="a" [nonDirInput]="b"></div>`;
                const DISABLED_CONFIG = Object.assign(Object.assign({}, BASE_CONFIG), { checkTypeOfInputBindings: false });
                const block = (0, testing_2.tcb)(TEMPLATE, DIRECTIVES, DISABLED_CONFIG);
        ...
        describe('config.checkTypeOfOutputEvents', () => {
            ...
            it('should check types of directive outputs when enabled', () => {
                const block = (0, testing_2.tcb)(TEMPLATE, DIRECTIVES);
                expect(block).toContain('_t1["outputField"].subscribe(($event): any => { (this).foo($event); });');
                expect(block).toContain('_t2.addEventListener("nonDirOutput", ($event): any => { (this).foo($event); });');
            });
            it('should not check types of directive outputs when disabled', () => {
                const DISABLED_CONFIG = Object.assign(Object.assign({}, BASE_CONFIG), { checkTypeOfOutputEvents: false });
                const block = (0, testing_2.tcb)(TEMPLATE, DIRECTIVES, DISABLED_CONFIG);
                ...
                expect(block).toContain('addEventListener("nonDirOutput", ($event): any => { (this).foo($event); });');
            });
        });
        describe('config.checkTypeOfAnimationEvents', () => {
            ...
            it('should not check types of animation events when disabled', () => {
                const DISABLED_CONFIG = Object.assign(Object.assign({}, BASE_CONFIG), { checkTypeOfAnimationEvents: false });
                const block = (0, testing_2.tcb)(TEMPLATE, DIRECTIVES, DISABLED_CONFIG);
                expect(block).toContain('($event: any): any => { (this).foo($event); }');
            });
        });
        describe('config.checkTypeOfDomEvents', () => {
            ...
            it('should not check types of DOM events when disabled', () => {
                const DISABLED_CONFIG = Object.assign(Object.assign({}, BASE_CONFIG), { checkTypeOfDomEvents: false });
                const block = (0, testing_2.tcb)(TEMPLATE, DIRECTIVES, DISABLED_CONFIG);
        ...
        describe('config.checkTypeOfDomReferences', () => {
            ...
            it('should use any for reference types when disabled', () => {
                const DISABLED_CONFIG = Object.assign(Object.assign({}, BASE_CONFIG), { checkTypeOfDomReferences: false });
                const block = (0, testing_2.tcb)(TEMPLATE, [], DISABLED_CONFIG);
        ...
        describe('config.checkTypeOfNonDomReferences', () => {
            ...
            it('should trace references to an <ng-template> when enabled', () => {
                const block = (0, testing_2.tcb)(TEMPLATE, DIRECTIVES);
                expect(block).toContain('var _t3 = (_t4 as any as i1.TemplateRef<any>); ' + '"" + (((_t3).value2));');
            });
            it('should use any for reference types when disabled', () => {
                const DISABLED_CONFIG = Object.assign(Object.assign({}, BASE_CONFIG), { checkTypeOfNonDomReferences: false });
                const block = (0, testing_2.tcb)(TEMPLATE, DIRECTIVES, DISABLED_CONFIG);
                expect(block).toContain('var _t1 = _t2 as any; ' + '"" + (((_t1).value));');
            });
        });
        describe('config.checkTypeOfAttributes', () => {
            ...
            it('should use any for attributes but still check bound attributes when disabled', () => {
                const DISABLED_CONFIG = Object.assign(Object.assign({}, BASE_CONFIG), { checkTypeOfAttributes: false });
                const block = (0, testing_2.tcb)(TEMPLATE, DIRECTIVES, DISABLED_CONFIG);
        ...
        describe('config.checkTypeOfPipes', () => {
            ...
            it('should check types of pipes when enabled', () => {
                const block = (0, testing_2.tcb)(TEMPLATE, PIPES);
            ...
            it('should not check types of pipes when disabled', () => {
                const DISABLED_CONFIG = Object.assign(Object.assign({}, BASE_CONFIG), { checkTypeOfPipes: false });
                const block = (0, testing_2.tcb)(TEMPLATE, PIPES, DISABLED_CONFIG);
                expect(block).toContain('var _pipe1 = null! as i0.TestPipe;');
        ...
        describe('config.strictSafeNavigationTypes', () => {
            ...
            it('should use undefined for safe navigation operations when enabled', () => {
                const block = (0, testing_2.tcb)(TEMPLATE, DIRECTIVES);
                expect(block).toContain('(0 as any ? (0 as any ? (((this).a))!.method : undefined)!() : undefined)');
            ...
            it("should use an 'any' type for safe navigation operations when disabled", () => {
                const DISABLED_CONFIG = Object.assign(Object.assign({}, BASE_CONFIG), { strictSafeNavigationTypes: false });
                const block = (0, testing_2.tcb)(TEMPLATE, DIRECTIVES, DISABLED_CONFIG);
        ...
        describe('config.strictSafeNavigationTypes (View Engine bug emulation)', () => {
            ...
            it('should check the presence of a property/method on the receiver when enabled', () => {
                ...
                expect(block).toContain('(0 as any ? ((0 as any ? ((((this).a)).method())!.otherMethod : undefined))!() : undefined)');
            });
        ...
        describe('config.strictContextGenerics', () => {
            ...
            it('should use any for the context generic type when disabled', () => {
                const DISABLED_CONFIG = Object.assign(Object.assign({}, BASE_CONFIG), { useContextGenericType: false });
                const block = (0, testing_2.tcb)(TEMPLATE, undefined, DISABLED_CONFIG);
        ...
        describe('config.checkAccessModifiersForInputBindings', () => {
            ...
            it('should assign restricted properties via element access for field names that are not JS identifiers', () => {
                ...
                const enableChecks = Object.assign(Object.assign({}, BASE_CONFIG), { honorAccessModifiersForInputBindings: true });
                const block = (0, testing_2.tcb)(TEMPLATE, DIRECTIVES, enableChecks);
                expect(block).toContain('var _t1 = null! as i0.Dir; ' + '_t1["some-input.xs"] = (((this).foo)); ');
            });
        ...
        describe('config.allowSignalsInTwoWayBindings', () => {
            it('should not unwrap signals in two-way binding expressions', () => {
                ...
                const block = (0, testing_2.tcb)(TEMPLATE, DIRECTIVES, Object.assign(Object.assign({}, BASE_CONFIG), { allowSignalsInTwoWayBindings: false }));
    ...
    `;
        ...
        const renderedTcb = (0, testing_2.tcb)(template, declarations, { useInlineTypeConstructors: false });
    ...
    describe('deferred blocks', () => {
      ...
      `;
            expect((0, testing_2.tcb)(TEMPLATE)).toContain('"" + ((this).main()); "" + ((this).placeholder()); "" + ((this).loading()); "" + ((this).error());');
        });
      ...
      `;
            expect((0, testing_2.tcb)(TEMPLATE)).toContain('((this).shouldShow()) && (((this).isVisible));');
        });
    ...
    describe('conditional blocks', () => {
      ...
      `;
            expect((0, testing_2.tcb)(TEMPLATE)).toContain('if ((((this).expr)) === (0)) { "" + ((this).main()); } ' +
      ...
      `;
            const result = (0, testing_2.tcb)(TEMPLATE);
            expect(result).toContain(`if ((((this).expr)) === (0)) { (this).zero(); }`);
            expect(result).toContain(`if (!((((this).expr)) === (0)) && (((this).expr)) === (1)) { (this).one(); }`);
            expect(result).toContain(`if (!((((this).expr)) === (0)) && !((((this).expr)) === (1)) && (((this).expr)) === (2)) { (this).two(); }`);
            expect(result).toContain(`if (!((((this).expr)) === (0)) && !((((this).expr)) === (1)) && !((((this).expr)) === (2))) { (this).otherwise(); }`);
        });
        it('should generate an if block with an `as` expression', () => {
            const TEMPLATE = `@if (expr === 1; as alias) {
        {{alias}}
      }`;
            expect((0, testing_2.tcb)(TEMPLATE)).toContain('var _t1 = ((((this).expr)) === (1)); if (((((this).expr)) === (1)) && _t1) { "" + (_t1); } } }');
        });
        ...
        `;
            expect((0, testing_2.tcb)(TEMPLATE, undefined, { checkControlFlowBodies: false })).toContain('if ((((this).expr)) === (0)) { } ' +
      ...
      `;
            expect((0, testing_2.tcb)(TEMPLATE)).toContain('switch (((this).expr)) { ' +
      ...
      `;
            expect((0, testing_2.tcb)(TEMPLATE)).toContain('switch (((this).expr)) { default: "" + ((this).default()); break; }');
        });
      ...
      `;
            expect((0, testing_2.tcb)(TEMPLATE)).toContain('var _t1 = null! as any; { var _t2 = (_t1.exp); switch (_t2()) { ' +
                'case "one": "" + ((this).one()); break; ' +
                'case "two": "" + ((this).two()); break; ' +
                'default: "" + ((this).default()); break; } }');
        });
        it('should handle an empty switch block', () => {
            expect((0, testing_2.tcb)('@switch (expr) {}')).toContain('if (true) { switch (((this).expr)) { } }');
        });
        ...
        `;
            expect((0, testing_2.tcb)(TEMPLATE, undefined, { checkControlFlowBodies: false })).toContain('switch (((this).expr)) { ' + 'case 1: break; ' + 'case 2: break; ' + 'default: break; }');
        });
    });
    describe('for loop blocks', () => {
      ...
      `;
        ...
        it('should generate the tracking expression of a for loop', () => {
            const result = (0, testing_2.tcb)(`@for (item of items; track trackingFn($index, item, prop)) {}`);
            expect(result).toContain('for (const _t1 of ((this).items)!) { var _t2 = null! as number;');
        ...
        it('should not generate the body of a for block when checkControlFlowBodies is disabled', () => {
          ...
          `;
            const result = (0, testing_2.tcb)(TEMPLATE, undefined, { checkControlFlowBodies: false });
            expect(result).toContain('for (const _t1 of ((this).items)!) {');
    ...
    describe('let declarations', () => {
      ...
      `);
            ...
            expect(result).toContain('_t2.addEventListener("click", ($event): any => { (this).doStuff(_t1); });');
        });
    });
    describe('import generation', () => {
        ...
        it('should prefer namespace imports in type check files for new imports', () => {
            const result = (0, testing_2.tcb)(TEMPLATE, [DIRECTIVE]);
        ...
        it('should re-use existing imports from original source files', () => {
            ...
            const { templateTypeChecker, program, programStrategy } = (0, testing_2.setup)([
                {
                    fileName: (0, file_system_1.absoluteFrom)('/test.ts'),
        ...
        `,
            ...
            templateTypeChecker.getDiagnosticsForFile((0, file_system_1.getSourceFileOrError)(program, (0, file_system_1.absoluteFrom)('/test.ts')), api_1.OptimizeFor.SingleFile);
            const testSf = (0, file_system_1.getSourceFileOrError)(programStrategy.getProgram(), (0, file_system_1.absoluteFrom)('/test.ts'));
            expect(testSf.text).toContain(`import { Component, ɵINPUT_SIGNAL_BRAND_WRITE_TYPE } from '@angular/core'; // should be re-used`);
            expect(testSf.text).toContain(`[ɵINPUT_SIGNAL_BRAND_WRITE_TYPE]`);
        });
    });
    describe('selectorless', () => {
        function selectorlessTcb(template, declarations) {
            return (0, testing_2.tcb)(template, declarations, undefined, undefined, { enableSelectorless: true });
        }
        ...
        it('should generate component output bindings', () => {
            ...
            const block = selectorlessTcb(TEMPLATE, DIRECTIVES);
            expect(block).toContain('var _t1 = null! as i0.Comp;');
            expect(block).toContain('_t1["someEvent"].subscribe(($event): any => { (this).handleEvent($event); });');
        });
        ...
        it('should generate unclaimed component output bindings for a node without a tag name', () => {
            ...
            expect(block).toContain('_t1.addEventListener("click", ($event): any => { (this).handleEvent($event); });');
        });
        ...
        it('should generate input binding for generic component', () => {
            ...
            const block = selectorlessTcb(TEMPLATE, DIRECTIVES);
            expect(block).toContain('const _ctor1: <T extends string = any>(init: Pick<i0.Comp<T>, "input">) => i0.Comp<T> = null!;');
        ...
        it('should generate input binding for generic directive', () => {
            ...
            const block = selectorlessTcb(TEMPLATE, DIRECTIVES);
            expect(block).toContain('const _ctor1: <T extends string = any>(init: Pick<i0.Dir<T>, "input">) => i0.Dir<T> = null!;');
            expect(block).toContain('var _t1 = _ctor1({ "input": (((this).value)) });');
            expect(block).toContain('_t1.input = (((this).value));');
        });
    });
