...
const content_origin_1 = require("../src/content_origin");
const source_file_1 = require("../src/source_file");
    ...
    describe('SourceFile and utilities', () => {
        ...
        describe('parseMappings()', () => {
            it('should be an empty array for source files with no source map', () => {
                const mappings = (0, source_file_1.parseMappings)(null, [], []);
                expect(mappings).toEqual([]);
            });
            it('should be empty array for source files with no source map mappings', () => {
                const rawSourceMap = { mappings: '', names: [], sources: [], version: 3 };
                const mappings = (0, source_file_1.parseMappings)(rawSourceMap, [], []);
                expect(mappings).toEqual([]);
            });
            it('should parse the mappings from the raw source map', () => {
                const rawSourceMap = {
                    mappings: (0, sourcemap_codec_1.encode)([
                        [
                            [0, 0, 0, 0],
                            [6, 0, 0, 3],
                        ],
                ...
                const originalSource = new source_file_1.SourceFile(_('/foo/src/a.js'), 'abcdefg', null, [], fs);
                const mappings = (0, source_file_1.parseMappings)(rawSourceMap, [originalSource], [0, 8]);
                expect(mappings).toEqual([
                    {
        ...
        describe('extractOriginalSegments()', () => {
            it('should return an empty Map for source files with no source map', () => {
                expect((0, source_file_1.extractOriginalSegments)((0, source_file_1.parseMappings)(null, [], []))).toEqual(new Map());
            });
            it('should be empty Map for source files with no source map mappings', () => {
                const rawSourceMap = { mappings: '', names: [], sources: [], version: 3 };
                expect((0, source_file_1.extractOriginalSegments)((0, source_file_1.parseMappings)(rawSourceMap, [], []))).toEqual(new Map());
            });
            it('should parse the segments in ascending order of original position from the raw source map', () => {
                ...
                const originalSegments = (0, source_file_1.extractOriginalSegments)((0, source_file_1.parseMappings)(rawSourceMap, [originalSource], [0, 8]));
            ...
            it('should create separate arrays for each original source file', () => {
                const sourceA = new source_file_1.SourceFile(_('/foo/src/a.js'), 'abcdefg', null, [], fs);
                const sourceB = new source_file_1.SourceFile(_('/foo/src/b.js'), '1234567', null, [], fs);
                const rawSourceMap = {
                    mappings: (0, sourcemap_codec_1.encode)([
                        [
                            [0, 0, 0, 0],
                ...
                const originalSegments = (0, source_file_1.extractOriginalSegments)((0, source_file_1.parseMappings)(rawSourceMap, [sourceA, sourceB], [0, 8]));
        ...
        describe('findLastMappingIndexBefore', () => {
            it('should find the highest mapping index that has a segment marker below the given one if there is not an exact match', () => {
                const marker5 = { line: 0, column: 50, position: 50, next: undefined };
                const marker4 = { line: 0, column: 40, position: 40, next: marker5 };
                const marker3 = { line: 0, column: 30, position: 30, next: marker4 };
                const marker2 = { line: 0, column: 20, position: 20, next: marker3 };
                const marker1 = { line: 0, column: 10, position: 10, next: marker2 };
                const mappings = [marker1, marker2, marker3, marker4, marker5].map((marker) => ({ generatedSegment: marker }));
                const marker = { line: 0, column: 35, position: 35, next: undefined };
                const index = (0, source_file_1.findLastMappingIndexBefore)(mappings, marker, /* exclusive */ false, 0);
            ...
            it('should find the highest mapping index that has a segment marker (when there are duplicates) below the given one if there is not an exact match', () => {
                const marker5 = { line: 0, column: 50, position: 50, next: undefined };
                const marker4 = { line: 0, column: 30, position: 30, next: marker5 };
                const marker3 = { line: 0, column: 30, position: 30, next: marker4 };
                const marker2 = { line: 0, column: 20, position: 20, next: marker3 };
                const marker1 = { line: 0, column: 10, position: 10, next: marker2 };
                const mappings = [marker1, marker2, marker3, marker4, marker5].map((marker) => ({ generatedSegment: marker }));
            ...
            it('should find the last mapping if the segment marker is higher than all of them', () => {
                ...
                const marker1 = { line: 0, column: 10, position: 10, next: marker2 };
                const mappings = [marker1, marker2, marker3, marker4, marker5].map((marker) => ({ generatedSegment: marker }));
                const marker = { line: 0, column: 60, position: 60, next: undefined };
                const index = (0, source_file_1.findLastMappingIndexBefore)(mappings, marker, /* exclusive */ false, 0);
            ...
            it('should return -1 if the segment marker is lower than all of them', () => {
                ...
                const marker1 = { line: 0, column: 10, position: 10, next: marker2 };
                const mappings = [marker1, marker2, marker3, marker4, marker5].map((marker) => ({ generatedSegment: marker }));
                const marker = { line: 0, column: 5, position: 5, next: undefined };
                const index = (0, source_file_1.findLastMappingIndexBefore)(mappings, marker, /* exclusive */ false, 0);
            ...
            describe('[exact match inclusive]', () => {
                it('should find the matching segment marker mapping index if there is only one of them', () => {
                    ...
                    const marker1 = { line: 0, column: 10, position: 10, next: marker2 };
                    const mappings = [marker1, marker2, marker3, marker4, marker5].map((marker) => ({ generatedSegment: marker }));
                    const index = (0, source_file_1.findLastMappingIndexBefore)(mappings, marker3, /* exclusive */ false, 0);
                    expect(index).toEqual(2);
                });
            ...
            describe('[exact match exclusive]', () => {
                it('should find the preceding mapping index if there is a matching segment marker', () => {
                    ...
                    const marker1 = { line: 0, column: 10, position: 10, next: marker2 };
                    const mappings = [marker1, marker2, marker3, marker4, marker5].map((marker) => ({ generatedSegment: marker }));
                    const index = (0, source_file_1.findLastMappingIndexBefore)(mappings, marker3, /* exclusive */ true, 0);
                    expect(index).toEqual(1);
                });
            ...
            describe('[with lowerIndex hint', () => {
                it('should find the highest mapping index above the lowerIndex hint that has a segment marker below the given one if there is not an exact match', () => {
                    ...
                    const mappings = [marker1, marker2, marker3, marker4, marker5].map((marker) => ({ generatedSegment: marker }));
                    const marker = { line: 0, column: 35, position: 35, next: undefined };
                    const index = (0, source_file_1.findLastMappingIndexBefore)(mappings, marker, /* exclusive */ false, 1);
                    expect(index).toEqual(2);
                });
                it('should return the lowerIndex mapping index if there is a single exact match and we are not exclusive', () => {
                    ...
                    const marker1 = { line: 0, column: 10, position: 10, next: marker2 };
                    const mappings = [marker1, marker2, marker3, marker4, marker5].map((marker) => ({ generatedSegment: marker }));
                    const marker = { line: 0, column: 30, position: 30, next: undefined };
                    const index = (0, source_file_1.findLastMappingIndexBefore)(mappings, marker, /* exclusive */ false, 2);
                    expect(index).toEqual(2);
                });
                it('should return the lowerIndex mapping index if there are multiple exact matches and we are not exclusive', () => {
                    ...
                    const mappings = [marker1, marker2, marker3, marker4, marker5].map((marker) => ({ generatedSegment: marker }));
                    const marker = { line: 0, column: 30, position: 30, next: undefined };
                    const index = (0, source_file_1.findLastMappingIndexBefore)(mappings, marker, /* exclusive */ false, 3);
                    expect(index).toEqual(3);
                });
                it('should return -1 if the segment marker is lower than the lowerIndex hint', () => {
                    ...
                    const marker1 = { line: 0, column: 10, position: 10, next: marker2 };
                    const mappings = [marker1, marker2, marker3, marker4, marker5].map((marker) => ({ generatedSegment: marker }));
                    const marker = { line: 0, column: 25, position: 25, next: undefined };
                    const index = (0, source_file_1.findLastMappingIndexBefore)(mappings, marker, /* exclusive */ false, 2);
                    expect(index).toEqual(-1);
                });
                it('should return -1 if the segment marker is equal to the lowerIndex hint and we are exclusive', () => {
                    ...
                    const mappings = [marker1, marker2, marker3, marker4, marker5].map((marker) => ({ generatedSegment: marker }));
                    const marker = { line: 0, column: 30, position: 30, next: undefined };
                    const index = (0, source_file_1.findLastMappingIndexBefore)(mappings, marker, /* exclusive */ true, 2);
                    expect(index).toEqual(-1);
                });
            });
        });
        describe('ensureOriginalSegmentLinks', () => {
            it('should add `next` properties to each segment that point to the next segment in the same source file', () => {
                ...
                const mappings = (0, source_file_1.parseMappings)(rawSourceMap, [sourceA, sourceB], [0, 8]);
                (0, source_file_1.ensureOriginalSegmentLinks)(mappings);
        ...
        describe('SourceFile', () => {
            describe('flattenedMappings', () => {
                it('should be an empty array for source files with no source map', () => {
                    const sourceFile = new source_file_1.SourceFile(_('/foo/src/index.js'), 'index contents', null, [], fs);
                ...
                it('should be empty array for source files with no source map mappings', () => {
                    const rawSourceMap = {
                        ...
                        mapPath: null,
                        origin: content_origin_1.ContentOrigin.Provided,
                    };
                    const sourceFile = new source_file_1.SourceFile(_('/foo/src/index.js'), 'index contents', rawSourceMap, [], fs);
                    expect(sourceFile.flattenedMappings).toEqual([]);
                });
                it('should be the same as non-flat mappings if there is only one level of source map', () => {
                    ...
                    const originalSource = new source_file_1.SourceFile(_('/foo/src/a.js'), 'abcdefg', null, [], fs);
                    const sourceFile = new source_file_1.SourceFile(_('/foo/src/index.js'), 'abc123defg', rawSourceMap, [originalSource], fs);
                    expect(removeOriginalSegmentLinks(sourceFile.flattenedMappings)).toEqual((0, source_file_1.parseMappings)(rawSourceMap.map, [originalSource], [0, 11]));
                });
                it('should merge mappings from flattened original source files', () => {
                    const cSource = new source_file_1.SourceFile(_('/foo/src/c.js'), 'bcd123', null, [], fs);
                    const dSource = new source_file_1.SourceFile(_('/foo/src/d.js'), 'aef', null, [], fs);
                    const bSourceMap = {
                        mapPath: null,
                        map: {
                            mappings: (0, sourcemap_codec_1.encode)([
                    ...
                    const bSource = new source_file_1.SourceFile(_('/foo/src/b.js'), 'abcdef', bSourceMap, [cSource, dSource], fs);
                    const aSourceMap = {
                        mapPath: null,
                        map: {
                            mappings: (0, sourcemap_codec_1.encode)([
                    ...
                    const aSource = new source_file_1.SourceFile(_('/foo/src/a.js'), 'abdecf', aSourceMap, [bSource], fs);
                ...
                it('should ignore mappings to missing source files', () => {
                    ...
                    const bSource = new source_file_1.SourceFile(_('/foo/src/b.js'), 'abcdef', bSourceMap, [null], fs);
                    const aSourceMap = {
                        mapPath: null,
                        map: {
                            mappings: (0, sourcemap_codec_1.encode)([
                    ...
                    // to.)
                    expect(removeOriginalSegmentLinks(aSource.flattenedMappings)).toEqual((0, source_file_1.parseMappings)(aSourceMap.map, [bSource], [0, 7]));
                });
                /**
                 ...
                 */
                function removeOriginalSegmentLinks(mappings) {
            ...
            describe('renderFlattenedSourceMap()', () => {
                it('should convert the flattenedMappings into a raw source-map object', () => {
                    const cSource = new source_file_1.SourceFile(_('/foo/src/c.js'), 'bcd123e', null, [], fs);
                    const bToCSourceMap = {
                        mapPath: null,
                        map: {
                            mappings: (0, sourcemap_codec_1.encode)([
                    ...
                    const bSource = new source_file_1.SourceFile(_('/foo/src/b.js'), 'abcdef', bToCSourceMap, [cSource], fs);
                    const aToBSourceMap = {
                        mapPath: null,
                        map: {
                            mappings: (0, sourcemap_codec_1.encode)([
                    ...
                    const aSource = new source_file_1.SourceFile(_('/foo/src/a.js'), 'abdecf', aToBSourceMap, [bSource], fs);
                    ...
                    expect(aTocSourceMap.mappings).toEqual((0, sourcemap_codec_1.encode)([
                        [
                            [1, 0, 0, 0],
                            [2, 0, 0, 2],
                            [3, 0, 0, 3],
                ...
                it('should handle mappings that map from lines outside of the actual content lines', () => {
                    const bSource = new source_file_1.SourceFile(_('/foo/src/b.js'), 'abcdef', null, [], fs);
                    const aToBSourceMap = {
                        mapPath: null,
                        map: {
                            mappings: (0, sourcemap_codec_1.encode)([
                ...
                it('should consolidate source-files with the same relative path', () => {
                    const cSource1 = new source_file_1.SourceFile(_('/foo/src/lib/c.js'), 'bcd123e', null, [], fs);
                    const cSource2 = new source_file_1.SourceFile(_('/foo/src/lib/c.js'), 'bcd123e', null, [], fs);
                    const bToCSourceMap = {
                        mapPath: null,
                        map: {
                            mappings: (0, sourcemap_codec_1.encode)([
                    ...
                    const bSource = new source_file_1.SourceFile(_('/foo/src/lib/b.js'), 'abcdef', bToCSourceMap, [cSource1], fs);
                    const aToBCSourceMap = {
                        mapPath: null,
                        map: {
                            mappings: (0, sourcemap_codec_1.encode)([
                                [
                    ...
                    const aSource = new source_file_1.SourceFile(_('/foo/src/a.js'), 'abdecf123', aToBCSourceMap, [bSource, cSource2], fs);
                    const aTocSourceMap = aSource.renderFlattenedSourceMap();
                    expect(aTocSourceMap.version).toEqual(3);
                    expect(aTocSourceMap.file).toEqual('a.js');
                    expect(aTocSourceMap.names).toEqual([]);
            ...
            describe('getOriginalLocation()', () => {
                ...
                it('should return offset locations in multiple flattened original source files', () => {
                    ...
                    const aSource = new source_file_1.SourceFile(_('/foo/src/a.js'), 'abde\n    cf', aSourceMap, [bSource], fs);
                    // Line 0
                ...
                it('should return offset locations across multiple lines', () => {
                    const originalSource = new source_file_1.SourceFile(_('/foo/src/original.js'), 'abcdef\nghijk\nlmnop', null, [], fs);
                    ...
                    const generatedSource = new source_file_1.SourceFile(_('/foo/src/generated.js'), 'ABC\nGHIJDEFK\nLMNOP', generatedSourceMap, [originalSource], fs);
                    // Line 0
        ...
        describe('computeStartOfLinePositions()', () => {
            it('should compute the cumulative length of each line in the given string', () => {
                expect((0, source_file_1.computeStartOfLinePositions)('')).toEqual([0]);
                expect((0, source_file_1.computeStartOfLinePositions)('abc')).toEqual([0]);
                expect((0, source_file_1.computeStartOfLinePositions)('\n')).toEqual([0, 1]);
                expect((0, source_file_1.computeStartOfLinePositions)('\n\n')).toEqual([0, 1, 2]);
                expect((0, source_file_1.computeStartOfLinePositions)('abc\n')).toEqual([0, 4]);
                expect((0, source_file_1.computeStartOfLinePositions)('\nabc')).toEqual([0, 1]);
                expect((0, source_file_1.computeStartOfLinePositions)('abc\ndefg')).toEqual([0, 4]);
                expect((0, source_file_1.computeStartOfLinePositions)('abc\r\n')).toEqual([0, 5]);
                expect((0, source_file_1.computeStartOfLinePositions)('abc\r\ndefg')).toEqual([0, 5]);
