...
function typeToValue(typeNode, checker, isLocalCompilation) {
    ...
    if (firstDecl !== undefined) {
        if (typescript_1.default.isImportClause(firstDecl) && firstDecl.name !== undefined) {
            ...
            if (!typescript_1.default.isImportDeclaration(firstDecl.parent)) {
                return unsupportedType(typeNode);
            }
            return {
            ...
            return {
                ...
                valueDeclaration: (_a = decl.valueDeclaration) !== null && _a !== void 0 ? _a : null,
                moduleName,
                importedName,
                nestedPath,
            };
            ...
            return {
                kind: 1 /* TypeValueReferenceKind.IMPORTED */,
                valueDeclaration: (_b = decl.valueDeclaration) !== null && _b !== void 0 ? _b : null,
                moduleName,
                importedName,
                nestedPath,
            };
