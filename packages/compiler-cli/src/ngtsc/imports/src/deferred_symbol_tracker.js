...
exports.DeferredSymbolTracker = void 0;
...
class DeferredSymbolTracker {
    ...
    getNonRemovableDeferredImports(sourceFile, classDecl) {
        ...
        const importDecls = (_a = this.explicitlyDeferredImports.get(classDecl)) !== null && _a !== void 0 ? _a : [];
    ...
    lookupIdentifiersInSourceFile(name, importDecl) {
        ...
        const visit = (node) => {
            ...
            if (node === importDecl || typescript_1.default.isTypeNode(node)) {
                return;
            }
...
exports.DeferredSymbolTracker = DeferredSymbolTracker;
