...
exports.DefaultImportTracker = void 0;
...
class DefaultImportTracker {
    ...
    recordUsedImport(importDecl) {
        if (importDecl.importClause) {
            const sf = (0, typescript_1.getSourceFile)(importDecl);
                ...
                if (clausesForFile !== undefined) {
                    for (const clause of clausesForFile) {
                        ...
                        if (clausesToPreserve === null) {
                            clausesToPreserve = (0, patch_alias_reference_resolution_1.loadIsReferencedAliasDeclarationPatch)(context);
                        }
                        clausesToPreserve === null || clausesToPreserve === void 0 ? void 0 : clausesToPreserve.add(clause);
                    }
                }
                return sourceFile;
            };
