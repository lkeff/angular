...
exports.attemptToReuseExistingSourceFileImports = attemptToReuseExistingSourceFileImports;
...
function attemptToReuseExistingSourceFileImports(tracker, sourceFile, request) {
    ...
    for (let i = sourceFile.statements.length - 1; i >= 0; i--) {
        ...
        if (statement.importClause.namedBindings) {
            ...
            if (typescript_1.default.isNamespaceImport(namedBindings)) {
                ...
                return [namedBindings.name, typescript_1.default.factory.createIdentifier(request.exportSymbolName)];
            }
            // Named imports can be re-used if a specific symbol is requested.
            if (typescript_1.default.isNamedImports(namedBindings) && request.exportSymbolName !== null) {
                const existingElement = namedBindings.elements.find((e) => {
                    ...
                    if (request.unsafeAliasOverride) {
                        ...
                        nameMatches =
                            ((_a = e.propertyName) === null || _a === void 0 ? void 0 : _a.text) === request.exportSymbolName &&
    ...
    const propertyName = typescript_1.default.factory.createIdentifier(request.exportSymbolName);
    const fileUniqueAlias = request.unsafeAliasOverride
        ? typescript_1.default.factory.createIdentifier(request.unsafeAliasOverride)
    ...
    return fileUniqueAlias !== null && fileUniqueAlias !== void 0 ? fileUniqueAlias : propertyName;
}
