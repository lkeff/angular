...
exports.ExportedProviderStatusResolver = void 0;
/**
    ...
    mayExportProviders(ref, dependencyCallback) {
        ...
        try {
            ...
            if (dirMeta !== null) {
                ...
                return ((_a = dirMeta.imports) !== null && _a !== void 0 ? _a : []).some((importRef) => this.mayExportProviders(importRef, dependencyCallback));
            }
...
exports.ExportedProviderStatusResolver = ExportedProviderStatusResolver;
