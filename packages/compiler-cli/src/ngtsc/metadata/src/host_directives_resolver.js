...
exports.HostDirectivesResolver = void 0;
const api_1 = require("../../metadata/src/api");
const property_mapping_1 = require("../src/property_mapping");
...
class HostDirectivesResolver {
    ...
    walkHostDirectives(directives, results) {
        for (const current of directives) {
            if (!(0, util_1.isHostDirectiveMetaForGlobalMode)(current)) {
                throw new Error('Impossible state: resolving code path in local compilation mode');
            }
            const hostMeta = (0, inheritance_1.flattenInheritedDirectiveMetadata)(this.metaReader, current.directive);
            ...
            results.push(Object.assign(Object.assign({}, hostMeta), { matchSource: api_1.MatchSource.HostDirective, inputs: property_mapping_1.ClassPropertyMapping.fromMappedObject(this.filterMappings(hostMeta.inputs, current.inputs, resolveInput)), outputs: property_mapping_1.ClassPropertyMapping.fromMappedObject(this.filterMappings(hostMeta.outputs, current.outputs, resolveOutput)) }));
        }
        return results;
    }
    /**
...
exports.HostDirectivesResolver = HostDirectivesResolver;
