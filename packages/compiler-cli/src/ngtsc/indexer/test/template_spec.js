...
function bind(template, enableSelectorless = false) {
...
function getTemplateIdentifiers(boundTemplate) {
    return (0, template_1.getTemplateIdentifiers)(boundTemplate).identifiers;
}
(0, testing_1.runInEachFileSystem)(() => {
    describe('getTemplateIdentifiers', () => {
        it('should handle svg elements', () => {
            ...
            expect(ref).toEqual({
                kind: __1.IdentifierKind.Element,
                name: 'svg',
                span: new __1.AbsoluteSourceSpan(1, 4),
        ...
        it('should handle svg elements on templates', () => {
            ...
            const [ref] = Array.from(refs);
            expect(ref).toEqual({
                kind: __1.IdentifierKind.Template,
                name: 'svg',
                span: new __1.AbsoluteSourceSpan(1, 4),
                usedDirectives: new Set(),
                attributes: new Set(),
        ...
        it('should handle comments in interpolations', () => {
            ...
            expect(ref).toEqual({
                name: 'foo',
                kind: __1.IdentifierKind.Property,
                span: new __1.AbsoluteSourceSpan(2, 5),
                target: null,
            });
        });
        it('should handle whitespace and comments in interpolations', () => {
            ...
            expect(ref).toEqual({
                name: 'foo',
                kind: __1.IdentifierKind.Property,
                span: new __1.AbsoluteSourceSpan(5, 8),
                target: null,
            });
        });
        it('works when structural directives are on templates', () => {
            ...
            expect(ref).toEqual({
                kind: __1.IdentifierKind.Template,
                name: 'ng-template',
                span: new __1.AbsoluteSourceSpan(1, 12),
                usedDirectives: new Set(),
                attributes: new Set(),
            });
        });
        ...
        it('should handle arbitrary whitespace', () => {
            ...
            expect(ref).toEqual({
                name: 'foo',
                kind: __1.IdentifierKind.Property,
                span: new __1.AbsoluteSourceSpan(7, 10),
                target: null,
            });
        });
            ...
            expect(refArr).toEqual(jasmine.arrayContaining([
                {
                    name: 'bar',
                    kind: __1.IdentifierKind.Property,
                    span: new __1.AbsoluteSourceSpan(12, 15),
                    target: null,
                },
                {
                    name: 'bar',
                    kind: __1.IdentifierKind.Property,
                    span: new __1.AbsoluteSourceSpan(18, 21),
                    target: null,
                },
                {
                    name: 'bar',
                    kind: __1.IdentifierKind.Property,
                    span: new __1.AbsoluteSourceSpan(24, 27),
                    target: null,
                },
            ]));
        });
        describe('generates identifiers for PropertyReads', () => {
            ...
            it('should discover nested properties', () => {
                ...
                expect(refArr).toContain({
                    name: 'foo',
                    kind: __1.IdentifierKind.Property,
                    span: new __1.AbsoluteSourceSpan(13, 16),
                    target: null,
                });
            });
            ...
            it('should discover variables in bound attributes', () => {
                ...
                const reference = {
                    name: 'div',
                    kind: __1.IdentifierKind.Reference,
                    span: new __1.AbsoluteSourceSpan(6, 9),
                ...
                expect(refArr).toContain({
                    name: 'div',
                    kind: __1.IdentifierKind.Property,
                    span: new __1.AbsoluteSourceSpan(19, 22),
                    target: reference,
                });
            });
            it('should discover properties in template expressions', () => {
                ...
                expect(refArr).toEqual(jasmine.arrayContaining([
                    ...
                    },
                    {
                        name: 'bar1',
                        kind: __1.IdentifierKind.Property,
                        span: new __1.AbsoluteSourceSpan(18, 22),
                        target: null,
                    },
                    {
                        name: 'bar2',
                        kind: __1.IdentifierKind.Property,
                        span: new __1.AbsoluteSourceSpan(25, 29),
                        target: null,
                    },
                ]));
            });
            it('should discover properties in template expressions', () => {
                ...
                expect(refArr).toContain({
                    name: 'foos',
                    kind: __1.IdentifierKind.Property,
                    span: new __1.AbsoluteSourceSpan(24, 28),
                    target: null,
                });
            });
            it('should discover properties in template expressions and resist collisions', () => {
                ...
                expect(refArr).toEqual(jasmine.arrayContaining([
                    ...
                    },
                    {
                        name: 'foos',
                        kind: __1.IdentifierKind.Property,
                        span: new __1.AbsoluteSourceSpan(32, 36),
                        target: null,
                    },
                    {
                        name: 'foos',
                        kind: __1.IdentifierKind.Property,
                        span: new __1.AbsoluteSourceSpan(39, 43),
                        target: null,
                    },
                ]));
            });
                ...
                expect(refArr).toEqual(jasmine.arrayContaining([
                    {
                        name: 'foo',
                        kind: __1.IdentifierKind.Property,
                        span: new __1.AbsoluteSourceSpan(14, 17),
                        target: null,
                    },
                    {
                        name: 'bar',
                ...
                expect(refArr).toEqual(jasmine.arrayContaining([
                    {
                        name: 'foo',
                        kind: __1.IdentifierKind.Property,
                        span: new __1.AbsoluteSourceSpan(20, 23),
                        target: null,
                    },
                ]));
            });
    ...
    describe('generates identifiers for template reference variables', () => {
        ...
        it('should discover nested references', () => {
            ...
            const elementReference = {
                name: 'span',
                kind: __1.IdentifierKind.Element,
                span: new __1.AbsoluteSourceSpan(6, 10),
                attributes: new Set(),
                usedDirectives: new Set(),
            };
            const refArray = Array.from(refs);
        ...
        it('should discover forward references', () => {
            ...
            const elementIdentifier = {
                name: 'div',
                kind: __1.IdentifierKind.Element,
                span: new __1.AbsoluteSourceSpan(8, 11),
                attributes: new Set(),
                usedDirectives: new Set(),
            };
            const referenceIdentifier = {
        ...
        it('should generate information directive targets', () => {
            ...
            expect(fooRef.kind).toBe(__1.IdentifierKind.Reference);
            fooRef = fooRef;
            expect(fooRef.target).toBeDefined();
            expect(fooRef.target.node.kind).toBe(__1.IdentifierKind.Element);
            expect(fooRef.target.node.name).toBe('div');
            expect(fooRef.target.node.span).toEqual(new __1.AbsoluteSourceSpan(1, 4));
        ...
        it('should discover references to references', () => {
            ...
            expect(refArr).toEqual(jasmine.arrayContaining([
                ...
                referenceIdentifier,
                {
                    name: 'foo',
                    kind: __1.IdentifierKind.Property,
                    span: new __1.AbsoluteSourceSpan(25, 28),
                    target: referenceIdentifier,
                },
            ]));
        });
    ...
    describe('generates identifiers for template variables', () => {
        it('should discover variables', () => {
            ...
            expect(refArray).toEqual(jasmine.arrayContaining([
                {
                    name: 'foo',
                    kind: __1.IdentifierKind.Variable,
                    span: new __1.AbsoluteSourceSpan(17, 20),
                },
            ]));
        });
            ...
            expect(refArray).toEqual(jasmine.arrayContaining([
                {
                    name: 'foo',
                    kind: __1.IdentifierKind.Variable,
                    span: new __1.AbsoluteSourceSpan(23, 26),
                },
            ]));
        });
        it('should discover references to variables', () => {
            ...
            const iIdentifier = {
                name: 'i',
                kind: __1.IdentifierKind.Variable,
                span: new __1.AbsoluteSourceSpan(34, 35),
            };
            const refArr = Array.from(refs);
            expect(refArr).toEqual(jasmine.arrayContaining([
                fooIdentifier,
                {
                    name: 'foo',
                    kind: __1.IdentifierKind.Property,
                    span: new __1.AbsoluteSourceSpan(47, 50),
                ...
                iIdentifier,
                {
                    name: 'i',
                    kind: __1.IdentifierKind.Property,
                    span: new __1.AbsoluteSourceSpan(53, 54),
                    target: iIdentifier,
                },
            ]));
        });
        it('should discover references to variables', () => {
            ...
            expect(refArr).toEqual(jasmine.arrayContaining([
                variableIdentifier,
                {
                    name: 'foo',
                    kind: __1.IdentifierKind.Property,
                    span: new __1.AbsoluteSourceSpan(42, 45),
    ...
    describe('let declarations', () => {
        it('should discover references to let declaration', () => {
            ...
            const letIdentifier = {
                name: 'foo',
                kind: __1.IdentifierKind.LetDeclaration,
                span: new __1.AbsoluteSourceSpan(5, 8),
            };
            expect(Array.from(refs)).toEqual(jasmine.arrayContaining([
                letIdentifier,
                {
                    name: 'foo',
                    kind: __1.IdentifierKind.Property,
                    span: new __1.AbsoluteSourceSpan(34, 37),
    ...
    describe('generates identifiers for elements', () => {
        it('should record elements as ElementIdentifiers', () => {
            ...
            expect(refs.size).toBe(1);
            const [ref] = Array.from(refs);
            expect(ref.kind).toBe(__1.IdentifierKind.Element);
        });
        it('should record element names as their selector', () => {
            ...
            expect(ref).toEqual({
                name: 'test-selector',
                kind: __1.IdentifierKind.Element,
                span: new __1.AbsoluteSourceSpan(1, 14),
                attributes: new Set(),
                usedDirectives: new Set(),
            });
        });
        ...
        it('should generate information about attributes', () => {
            ...
            expect(attrs).toEqual(new Set([
                {
                    name: 'attrA',
                    kind: __1.IdentifierKind.Attribute,
                    span: new __1.AbsoluteSourceSpan(5, 10),
                },
                {
                    name: 'attrB',
                    kind: __1.IdentifierKind.Attribute,
                    span: new __1.AbsoluteSourceSpan(11, 22),
                },
            ]));
        });
        it('should generate information about used directives', () => {
            ...
            const refs = getTemplateIdentifiers(boundTemplate);
            const [ref] = Array.from(refs);
            const usedDirectives = ref.usedDirectives;
    ...
    describe('generates identifiers for templates', () => {
        it('should record templates as TemplateNodeIdentifiers', () => {
            ...
            expect(refs.size).toBe(1);
            const [ref] = Array.from(refs);
            expect(ref.kind).toBe(__1.IdentifierKind.Template);
        });
        ...
        it('should discover nested templates', () => {
            ...
            expect(refArr).toContain({
                name: 'ng-template',
                kind: __1.IdentifierKind.Template,
                span: new __1.AbsoluteSourceSpan(6, 17),
                attributes: new Set(),
                usedDirectives: new Set(),
            });
        });
            ...
            expect(attrs).toEqual(new Set([
                {
                    name: 'attrA',
                    kind: __1.IdentifierKind.Attribute,
                    span: new __1.AbsoluteSourceSpan(13, 18),
                },
                {
                    name: 'attrB',
                    kind: __1.IdentifierKind.Attribute,
                    span: new __1.AbsoluteSourceSpan(19, 30),
                },
            ]));
        });
        it('should generate information about used directives', () => {
    ...
    describe('selectorless', () => {
        it('should generate information about selectorless component nodes', () => {
            ...
            expect(Array.from(refs)).toEqual([
                {
                    name: 'Comp',
                    span: new __1.AbsoluteSourceSpan(1, 5),
                    kind: __1.IdentifierKind.Component,
                    attributes: new Set(),
                    usedDirectives: new Set([
                        {
                            node: compDecl,
                ...
                },
                {
                    name: 'Foo',
                    span: new __1.AbsoluteSourceSpan(7, 10),
                    kind: __1.IdentifierKind.Directive,
                    attributes: new Set(),
                    usedDirectives: new Set([
                        {
                            node: fooDecl,
                ...
                {
                    name: 'value',
                    span: new __1.AbsoluteSourceSpan(25, 30),
                    kind: __1.IdentifierKind.Property,
                    target: null,
                },
            ]);
        ...
        it('should generate information about selectorless directives used on a plain element', () => {
            ...
            expect(Array.from(refs)).toEqual([
                ...
                {
                    name: 'Bar',
                    span: new __1.AbsoluteSourceSpan(11, 14),
                    kind: __1.IdentifierKind.Directive,
                    attributes: new Set(),
                    usedDirectives: new Set([
                        {
                ...
                {
                    name: 'value',
                    span: new __1.AbsoluteSourceSpan(24, 29),
                    kind: __1.IdentifierKind.Property,
                    target: null,
                },
            ]);
        ...
        it('should discover references to selectorless components and directives', () => {
            ...
            expect(refs).toEqual([
                ...
                {
                    name: 'comp',
                    span: new __1.AbsoluteSourceSpan(7, 11),
                    kind: __1.IdentifierKind.Reference,
                    target: {
                        node: compRef,
                        directive: compDecl,
