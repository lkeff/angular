...
(0, testing_1.runInEachFileSystem)(() => {
  ...
  The file ${(0, file_system_1.absoluteFrom)('/lib/dir.ts')} is outside of the configured 'rootDir'.`);
            expect(diags[0].file.fileName).toEqual((0, file_system_1.absoluteFrom)('/app/module.ts'));
  ...
  The symbol is not exported from ${(0, file_system_1.absoluteFrom)('/node_modules/lib/index.d.ts')} (module 'lib').`);
            expect(diags[0].file.fileName).toEqual((0, file_system_1.absoluteFrom)('/app/comp.ts'));
