...
exports.writeTwoComponentSystem = writeTwoComponentSystem;
exports.writeRandomFile = writeRandomFile;
...
(0, testing_1.runInEachFileSystem)(() => {
    describe('ngtsc incremental compilation with errors', () => {
      ...
      `);
        ...
        function expectToHaveWritten(files) {
      ...
      `);
            ...
            expect(diags[0].file.fileName).toBe((0, file_system_1.absoluteFrom)('/other.ts'));
            expectToHaveWritten([]);
 ...
 */
function writeTwoComponentSystem(env) {
...
function writeRandomFile(env, name, options = {}) {
    env.write(name, `
