...
(0, testing_1.runInEachFileSystem)(() => {
    describe('ngtsc host directives compilation', () => {
      ...
      `);
            ...
            expect(jsContents).toContain('features: [i0.ɵɵHostDirectivesFeature([DirectiveA, DirectiveB])]');
            expect(dtsContents).toContain('ɵɵComponentDeclaration<MyComp, "my-comp", never, {}, {}, never, never, false, ' +
      ...
      `);
            ...
            expect(dtsContents).toContain('ɵɵComponentDeclaration<MyComp, "my-comp", never, {}, ' +
      ...
      `);
            ...
            expect(jsContents).toContain('ɵɵdefineDirective({ type: DirectiveC, ' +
                'features: [i0.ɵɵHostDirectivesFeature([DirectiveB])] });');
            expect(jsContents).toContain('ɵɵdefineComponent({ type: MyComp, selectors: [["my-comp"]], standalone: false,' +
                ' features: [i0.ɵɵHostDirectivesFeature([DirectiveC])]');
            expect(dtsContents).toContain('ɵɵDirectiveDeclaration<DirectiveA, never, never, {}, ' + '{}, never, never, true, never>;');
            expect(dtsContents).toContain('ɵɵDirectiveDeclaration<DirectiveB, never, never, {}, ' +
                '{}, never, never, true, [{ directive: typeof DirectiveA; ' +
                'inputs: {}; outputs: {}; }]>;');
            expect(dtsContents).toContain('ɵɵDirectiveDeclaration<DirectiveC, never, never, {}, ' +
      ...
      `);
            ...
            expect(jsContents).toContain('ɵɵdefineDirective({ type: DirectiveA, ' + 'inputs: { value: "value" } });');
            expect(dtsContents).toContain('ɵɵComponentDeclaration<MyComponent, "my-component", ' +
                'never, {}, {}, never, never, false, [{ directive: typeof DirectiveB; ' +
                'inputs: {}; outputs: {}; }]>;');
            expect(dtsContents).toContain('ɵɵDirectiveDeclaration<DirectiveB, never, never, {}, ' +
                '{}, never, never, true, [{ directive: typeof DirectiveA; ' +
                'inputs: { "value": "value"; }; outputs: {}; }]>;');
            expect(dtsContents).toContain('ɵɵDirectiveDeclaration<DirectiveA, never, never, ' +
      ...
      `);
            ...
            expect(jsContents).toContain('features: [i0.ɵɵHostDirectivesFeature(function () { ' +
      ...
      `);
            ...
            expect(jsContents).toContain('features: [i0.ɵɵHostDirectivesFeature([{ directive: i1.ExternalDir, ' +
                'inputs: ["input", "inputAlias"], outputs: ["output", "outputAlias"] }])]');
            expect(dtsContents).toContain('import * as i1 from "external";');
            expect(dtsContents).toContain('ɵɵComponentDeclaration<MyComp, "ng-component", never, {}, ' +
