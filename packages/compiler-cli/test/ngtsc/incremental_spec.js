...
(0, testing_1.runInEachFileSystem)(() => {
    ...
    `);
      ...
      `);
        ...
        `);
          ...
          `);
                    let diags = env.driveDiagnostics();
                    expect(diags.length).toBe(1);
                    expect(diags[0].messageText).toContain(`Type '"gamma"' is not assignable to type 'keyof Keys'.`);
      ...
      `);
                ...
                expect(firstDiagnostics[0].code).toBe((0, diagnostics_1.ngErrorCode)(diagnostics_1.ErrorCode.COMPONENT_RESOURCE_NOT_FOUND));
    ...
    function setupFooBarProgram(env) {
