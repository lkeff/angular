...
(0, testing_1.runInEachFileSystem)(() => {
    ...
    describe('ngtsc decorator docs extraction', () => {
      ...
      `);
            ...
            const decoratorEntry = docs[0];
            expect(decoratorEntry.name).toBe('Component');
            expect(decoratorEntry.description).toBe('The description.');
            expect(decoratorEntry.entryType).toBe(entities_1.EntryType.Decorator);
            expect(decoratorEntry.decoratorType).toBe(entities_1.DecoratorType.Class);
      ...
      `);
            ...
            expect(decoratorEntry.description).toBe('The description.');
            expect(decoratorEntry.entryType).toBe(entities_1.EntryType.Decorator);
            expect(decoratorEntry.decoratorType).toBe(entities_1.DecoratorType.Member);
            expect(decoratorEntry.members.length).toBe(1);
      ...
      `);
            ...
            expect(decoratorEntry.description).toBe('The description.');
            expect(decoratorEntry.entryType).toBe(entities_1.EntryType.Decorator);
            expect(decoratorEntry.decoratorType).toBe(entities_1.DecoratorType.Parameter);
            expect(decoratorEntry.members.length).toBe(1);
