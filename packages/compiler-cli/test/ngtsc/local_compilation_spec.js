    ...
    describe('local compilation', () => {
        ...
        function tsconfig(extraOpts = {}) {
            const tsconfig = {
                ...
                angularCompilerOptions: Object.assign({ compilationMode: 'experimental-local' }, extraOpts),
            };
        ...
        `);
                ...
                expect(Comp1Contents)
                    .withContext('External import which is not an NgModule import should not be included in the global import')
        ...
        `);
                ...
                expect(env.getContents('comp1.js'))
                    .withContext('Global imports should be generated when a component has its NgModule in a different file')
                    .toContain('import "/some_external_file"');
                ...
                expect(env.getContents('module_and_comp.js'))
                    .withContext('Global imports should not be generated when components and their NgModules are in the same file')
                    .not.toContain('import "/some_external_file"');
        ...
        `);
                env.driveMain();
                const jsContents = env.getContents('test.js');
                expect(jsContents).toContain('MainModule.ɵinj = /*@__PURE__*/ i0.ɵɵdefineInjector({ imports: [SubModule1, forwardRef(() => SubModule2), LocalModule1, forwardRef(() => LocalModule2)] })');
            });
        ...
        `);
                env.driveMain();
                const jsContents = env.getContents('test.js');
                expect(jsContents).toContain('MainModule.ɵinj = /*@__PURE__*/ i0.ɵɵdefineInjector({ imports: [NG_IMPORTS] })');
            });
        ...
        `);
                env.driveMain();
                const jsContents = env.getContents('test.js');
                expect(jsContents).toContain('MainModule.ɵinj = /*@__PURE__*/ i0.ɵɵdefineInjector({ imports: [NG_EXPORTS] })');
            });
        ...
        `);
                env.driveMain();
                const jsContents = env.getContents('test.js');
                expect(jsContents).toContain('MainModule.ɵinj = /*@__PURE__*/ i0.ɵɵdefineInjector({ imports: [SubModule1, forwardRef(() => SubModule2), SubModule3, forwardRef(() => SubModule4)] })');
            });
        ...
        describe('component dependencies', () => {
          ...
          `);
                env.driveMain();
                const jsContents = env.getContents('test.js');
                expect(jsContents).toContain('dependencies: i0.ɵɵgetComponentDepsFactory(MainComponent, [SomeThing, forwardRef(() => SomeThing2)])');
            });
          ...
          `);
                env.driveMain();
                const jsContents = env.getContents('test.js');
                expect(jsContents).toContain('dependencies: i0.ɵɵgetComponentDepsFactory(MainComponent, NG_IMPORTS)');
            });
      ...
      `);
        ...
        describe('constructor injection', () => {
          ...
          `);
                env.driveMain();
                const jsContents = env.getContents('test.js');
                expect(jsContents).toContain(`MainService.ɵfac = function MainService_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || MainService)(i0.ɵɵinject(i1.SomeService1), i0.ɵɵinject(SomeService2), i0.ɵɵinject(i2.SomeService3), i0.ɵɵinject(i3.nested.SomeService4), i0.ɵɵinjectAttribute('title'), i0.ɵɵinject(MESSAGE_TOKEN)); };`);
            });
          ...
          `);
                env.driveMain();
                const jsContents = env.getContents('test.js');
                expect(jsContents).toContain(`MainModule.ɵfac = function MainModule_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || MainModule)(i0.ɵɵinject(i1.SomeService1), i0.ɵɵinject(SomeService2), i0.ɵɵinject(i2.SomeService3), i0.ɵɵinject(i3.nested.SomeService4), i0.ɵɵinjectAttribute('title'), i0.ɵɵinject(MESSAGE_TOKEN)); };`);
            });
          ...
          `);
                env.driveMain();
                const jsContents = env.getContents('test.js');
                expect(jsContents).toContain(`MainService.ɵfac = function MainService_Factory(__ngFactoryType__) { i0.ɵɵinvalidFactory(); };`);
            });
          ...
          `);
                env.driveMain();
                const jsContents = env.getContents('test.js');
                expect(jsContents).toContain(`MyDirective.ɵfac = function MyDirective_Factory(__ngFactoryType__) { i0.ɵɵinvalidFactory(); };`);
            });
        ...
        describe('LOCAL_COMPILATION_UNRESOLVED_CONST errors', () => {
          ...
          `);
                ...
                expect(code).toBe((0, diagnostics_1.ngErrorCode)(diagnostics_1.ErrorCode.LOCAL_COMPILATION_UNRESOLVED_CONST));
        ...
        `);
                env.driveMain();
                const jsContents = env.getContents('test.js');
                expect(jsContents).toContain('AppModule.ɵmod = /*@__PURE__*/ i0.ɵɵdefineNgModule({ type: AppModule });');
                expect(jsContents).toContain('ɵɵsetNgModuleScope(AppModule, { declarations: [App], bootstrap: [App] }); })();');
            });
        ...
        `);
                ...
                const jsContents = env.getContents('test.js');
                expect(jsContents).toContain('AppModule.ɵmod = /*@__PURE__*/ i0.ɵɵdefineNgModule({ type: AppModule });');
                expect(jsContents).toContain('ɵɵsetNgModuleScope(AppModule, { declarations: [App] }); })();');
            });
        });
        ...
        `);
                env.driveMain();
                const jsContents = env.getContents('test.js');
                expect(jsContents).toContain('features: [i0.ɵɵHostDirectivesFeature([ExternalDirective, n.ExternalDirective, LocalDirective])]');
            });
        ...
        `);
                env.driveMain();
                const jsContents = env.getContents('test.js');
                expect(jsContents).toContain('features: [i0.ɵɵHostDirectivesFeature([{ directive: HostDir, ' +
        ...
        `);
                env.driveMain();
                const jsContents = env.getContents('test.js');
                expect(jsContents).toContain('features: [i0.ɵɵHostDirectivesFeature([{ directive: LocalDirective, ' +
                    'inputs: ["value", "value", "color", "colorAlias"], ' +
                    'outputs: ["opened", "opened", "closed", "closedAlias"] }])]');
            });
        ...
        `);
                env.driveMain();
                const jsContents = env.getContents('test.js');
                expect(jsContents).toContain('ɵɵdefineDirective({ type: LocalDirective, ' +
                    'features: [i0.ɵɵHostDirectivesFeature([ExternalDirective])] });');
                expect(jsContents).toContain('ɵɵdefineDirective({ type: LocalDirective2, ' +
        ...
        `);
                env.driveMain();
                const jsContents = env.getContents('test.js');
                expect(jsContents).toContain('features: [i0.ɵɵHostDirectivesFeature(function () { return [DirectiveB]; })]');
                expect(jsContents).toContain('features: [i0.ɵɵHostDirectivesFeature(function () { return [{ directive: DirectiveA, inputs: ["value", "value"] }]; })]');
            });
        ...
        `);
                ...
                expect(messages[0].code).toBe((0, diagnostics_1.ngErrorCode)(diagnostics_1.ErrorCode.LOCAL_COMPILATION_UNSUPPORTED_EXPRESSION));
                expect(messages[0].messageText).toEqual('In local compilation mode, host directive cannot be an expression. Use an identifier instead');
            });
        });
     ...
     `);
        ...
        `);
                ...
                expect(jsContents).toContain('const AppCmp_DeferFn = () => [' +
                ...
                expect(jsContents).toContain('ɵsetClassMetadataAsync(AppCmp, () => [' +
                    'import("./deferred-a").then(m => m.DeferredCmpA), ' +
                    'import("./deferred-b").then(m => m.DeferredCmpB)], ' +
        ...
        `);
            ...
            `);
                ...
                expect(jsContents).toContain('const AppCmpA_DeferFn = () => [' +
                    'import("./deferred-deps").then(m => m.DeferredCmpA)]');
                expect(jsContents).toContain('const AppCmpB_DeferFn = () => [' +
                ...
                // Expect `ɵsetClassMetadataAsync` to contain dynamic imports too.
                expect(jsContents).toContain('ɵsetClassMetadataAsync(AppCmpA, () => [' +
                    'import("./deferred-deps").then(m => m.DeferredCmpA)]');
                expect(jsContents).toContain('ɵsetClassMetadataAsync(AppCmpB, () => [' +
                    'import("./deferred-deps").then(m => m.DeferredCmpB)]');
            });
            ...
            `);
                ...
                for (let i = 0; i < 2; i++) {
                    ...
                    expect(code).toBe((0, diagnostics_1.ngErrorCode)(diagnostics_1.ErrorCode.DEFERRED_DEPENDENCY_IMPORTED_EAGERLY));
                    expect(messageText).toContain('This import contains symbols that are used both inside and outside ' +
        ...
        describe('custom decorator', () => {
          ...
          `);
                ...
                const text1 = typescript_1.default.flattenDiagnosticMessageText(errors[0].messageText, '\n');
                const text2 = typescript_1.default.flattenDiagnosticMessageText(errors[1].messageText, '\n');
                expect(errors[0].code).toBe((0, diagnostics_1.ngErrorCode)(diagnostics_1.ErrorCode.DECORATOR_UNEXPECTED));
                expect(errors[1].code).toBe((0, diagnostics_1.ngErrorCode)(diagnostics_1.ErrorCode.DECORATOR_UNEXPECTED));
                expect(text1).toContain('In local compilation mode, Angular does not support custom decorators');
                expect(text2).toContain('In local compilation mode, Angular does not support custom decorators');
            });
        });
        describe('template diagnostics', () => {
          ...
          `);
                ...
                expect(code).toBe((0, diagnostics_1.ngErrorCode)(diagnostics_1.ErrorCode.TEMPLATE_PARSE_ERROR));
                const text = typescript_1.default.flattenDiagnosticMessageText(messageText, '\n');
