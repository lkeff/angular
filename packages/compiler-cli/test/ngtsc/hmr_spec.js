...
(0, testing_1.runInEachFileSystem)(() => {
    describe('HMR code generation', () => {
        ...
        function enableHmr(additionalAngularOptions = {}, additionalCompilerOptions = {}) {
            env.write('tsconfig.json', JSON.stringify(Object.assign(Object.assign({ extends: './tsconfig-base.json' }, additionalCompilerOptions), { angularCompilerOptions: Object.assign({ _enableHmr: true }, additionalAngularOptions) })));
        }
        ...
        `);
            ...
            expect(jsContents).toContain('import(/* @vite-ignore */\nnew URL("./@ng/component?c=" + id + "&t=" + encodeURIComponent(t), import.meta.url).href)');
            expect(jsContents).toContain(').then(m => m.default && i0.ɵɵreplaceMetadata(Cmp, m.default, [i0], ' +
                '[Dep, transformValue, TOKEN, Component, Inject, ViewChild, Input], import.meta, id));');
            expect(jsContents).toContain('Cmp_HmrLoad(Date.now());');
            expect(jsContents).toContain('import.meta.hot && import.meta.hot.on("angular:component-update", ' +
                'd => d.id === id && Cmp_HmrLoad(d.timestamp)');
            expect(hmrContents).toContain('export default function Cmp_UpdateMetadata(Cmp, ɵɵnamespaces, Dep, transformValue, TOKEN, Component, Inject, ViewChild, Input) {');
        ...
        `);
            ...
            expect(jsContents).toContain('function Cmp_HmrLoad(t) {');
            expect(jsContents).toContain('import(/* @vite-ignore */\nnew URL("./@ng/component?c=" + id + "&t=" + encodeURIComponent(t), import.meta.url).href)');
            expect(jsContents).toContain(').then(m => m.default && i0.ɵɵreplaceMetadata(Cmp, m.default, [i0, i1], ' +
                '[DepModule, Component], import.meta, id));');
            expect(jsContents).toContain('Cmp_HmrLoad(Date.now());');
            expect(jsContents).toContain('import.meta.hot && import.meta.hot.on("angular:component-update", ' +
                'd => d.id === id && Cmp_HmrLoad(d.timestamp)');
            expect(hmrContents).toContain('export default function Cmp_UpdateMetadata(Cmp, ɵɵnamespaces, DepModule, Component) {');
            expect(hmrContents).toContain(`const ɵhmr0 = ɵɵnamespaces[0];`);
        ...
        `);
            const hmrContents = env.driveHmr('test.ts', 'Cmp');
            expect(hmrContents).toContain('export default function Cmp_UpdateMetadata(Cmp, ɵɵnamespaces, Component) {');
            expect(hmrContents).toContain('function Cmp_Conditional_0_Template(rf, ctx) {');
            expect(hmrContents).toContain('ɵhmr0.ɵɵconditionalCreate(0, Cmp_Conditional_0_Template, 1, 0);');
        });
        ...
        `);
            ...
            expect(hmrContents).toContain('export default function Cmp_UpdateMetadata(Cmp, ɵɵnamespaces, Dep, Component) {');
        ...
        `);
            ...
            expect(jsContents).toContain('function Cmp_Defer_0_Template(rf, ctx) { if (rf & 1) {');
            expect(jsContents).toContain('i0.ɵɵdefer(1, 0, Cmp_Defer_1_DepsFn);');
            expect(jsContents).toContain('ɵɵreplaceMetadata(Cmp, m.default, [i0], [Dep], import.meta, id));');
            expect(jsContents).not.toContain('setClassMetadata');
            expect(hmrContents).toContain('export default function Cmp_UpdateMetadata(Cmp, ɵɵnamespaces, Dep) {');
            expect(hmrContents).toContain('const Cmp_Defer_1_DepsFn = () => [Dep];');
            expect(hmrContents).toContain('function Cmp_Defer_0_Template(rf, ctx) {');
            expect(hmrContents).toContain('ɵhmr0.ɵɵdefer(1, 0, Cmp_Defer_1_DepsFn);');
            expect(hmrContents).not.toContain('import(');
        ...
        `);
            ...
            expect(jsContents).toContain('ɵɵreplaceMetadata(Cmp, m.default, [i0], [Component], import.meta, id));');
            expect(hmrContents).toContain('export default function Cmp_UpdateMetadata(Cmp, ɵɵnamespaces, Component) {');
        });
        ...
        `);
            ...
            const jsContents = env.getContents('test.js');
            const hmrContents = env.driveHmr('test.ts', 'Cmp');
            expect(jsContents).toContain('ɵɵreplaceMetadata(Cmp, m.default, [i0], [providers, Component], import.meta, id));');
            expect(hmrContents).toContain('export default function Cmp_UpdateMetadata(Cmp, ɵɵnamespaces, providers, Component) {');
        });
        ...
        `);
            ...
            const jsContents = env.getContents('test.js');
            const hmrContents = env.driveHmr('test.ts', 'Cmp');
            expect(jsContents).toContain('ɵɵreplaceMetadata(Cmp, m.default, [i0], [token, value, Component], import.meta, id));');
            expect(hmrContents).toContain('export default function Cmp_UpdateMetadata(Cmp, ɵɵnamespaces, token, value, Component) {');
        });
        ...
        `);
            ...
            const jsContents = env.getContents('test.js');
            const hmrContents = env.driveHmr('test.ts', 'Cmp');
            expect(jsContents).toContain('ɵɵreplaceMetadata(Cmp, m.default, [i0], [condition, providersA, providersB, Component], import.meta, id));');
            expect(hmrContents).toContain('export default function Cmp_UpdateMetadata(Cmp, ɵɵnamespaces, condition, providersA, providersB, Component) {');
        });
        ...
        `);
            ...
            const jsContents = env.getContents('test.js');
            const hmrContents = env.driveHmr('test.ts', 'Cmp');
            expect(jsContents).toContain('ɵɵreplaceMetadata(Cmp, m.default, [i0], [token, value, otherValue, Component], import.meta, id));');
            expect(jsContents).toContain('useFactory: () => [(value), ((((otherValue))))]');
            expect(hmrContents).toContain('export default function Cmp_UpdateMetadata(Cmp, ɵɵnamespaces, token, value, otherValue, Component) {');
        });
        ...
        `);
            ...
            const jsContents = env.getContents('test.js');
            const hmrContents = env.driveHmr('test.ts', 'Cmp');
            expect(jsContents).toContain('ɵɵreplaceMetadata(Cmp, m.default, [i0], [token, value, Optional, dep, Component], import.meta, id));');
            expect(hmrContents).toContain('export default function Cmp_UpdateMetadata(Cmp, ɵɵnamespaces, token, value, Optional, dep, Component) {');
        });
        ...
        `);
            ...
            expect(jsContents).toContain('ɵɵreplaceMetadata(Cmp, m.default, [i0, i1], [DepModule], import.meta, id));');
      ...
      `);
        ...
        `);
            ...
            expect(jsContents).toContain('ɵɵreplaceMetadata(Cmp, m.default, [i0, i1], [], import.meta, id));');
        ...
        `);
            ...
            const jsContents = env.getContents('test.js');
            const hmrContents = env.driveHmr('test.ts', 'Cmp');
            expect(jsContents).toContain('ɵɵreplaceMetadata(Cmp, m.default, [i0], [token, { one: 0, two: "2", three: 3 }, Component], import.meta, id));');
            expect(hmrContents).toContain('export default function Cmp_UpdateMetadata(Cmp, ɵɵnamespaces, token, Foo, Component) {');
        });
      ...
      `);
        ...
        `);
            ...
            transformers.before.unshift((ctx) => (sourceFile) => {
                const visitor = (node) => {
                    var _a;
                    if (typescript_1.default.isClassDeclaration(node) && ((_a = node.name) === null || _a === void 0 ? void 0 : _a.getText()) === 'Cmp') {
                        const newMember = ctx.factory.createPropertyDeclaration(undefined, 'newProp', undefined, undefined, ctx.factory.createNumericLiteral(123));
                        return ctx.factory.updateClassDeclaration(node, node.modifiers, node.name, node.typeParameters, node.heritageClauses, [newMember, ...node.members]);
                    }
            ...
            const declaration = (_a = program
                .getTsProgram()
                .getSourceFile('/test.ts')) === null || _a === void 0 ? void 0 : _a.statements.find((stmt) => { var _a; return typescript_1.default.isClassDeclaration(stmt) && ((_a = stmt.name) === null || _a === void 0 ? void 0 : _a.getText()) === 'Cmp'; });
            const jsContents = env.getContents('/test.js');
