...
exports.MyModule = exports.MyComponent = exports.ClassPipe = exports.StylePipe = void 0;
...
let StylePipe = (() => {
    ...
    let _classThis;
    var StylePipe = _classThis = class {
        transform(v) { }
    };
    __setFunctionName(_classThis, "StylePipe");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        StylePipe = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return StylePipe = _classThis;
})();
...
let ClassPipe = (() => {
    ...
    let _classExtraInitializers = [];
    let _classThis;
    var ClassPipe = _classThis = class {
        transform(v) { }
    };
    __setFunctionName(_classThis, "ClassPipe");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ClassPipe = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ClassPipe = _classThis;
})();
...
let MyModule = (() => {
    let _classDecorators = [(0, core_1.NgModule)({ declarations: [MyComponent, StylePipe, ClassPipe] })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
