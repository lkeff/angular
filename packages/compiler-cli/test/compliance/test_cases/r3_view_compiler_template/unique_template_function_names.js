...
exports.BModule = exports.BComponent = exports.AModule = exports.AComponent = void 0;
...
let AComponent = (() => {
  ...
  `,
    ...
    let _classThis;
    var AComponent = _classThis = class {
        constructor() {
            this.items = [4, 2];
        }
    };
    __setFunctionName(_classThis, "AComponent");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        AComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AComponent = _classThis;
})();
exports.AComponent = AComponent;
let AModule = (() => {
    let _classDecorators = [(0, core_1.NgModule)({ declarations: [AComponent] })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
...
let BComponent = (() => {
  ...
  `,
    ...
    let _classExtraInitializers = [];
    let _classThis;
    var BComponent = _classThis = class {
        constructor() {
            this.items = [
                { subitems: [1, 3] },
                { subitems: [3, 7] },
    ...
    __setFunctionName(_classThis, "BComponent");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        BComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return BComponent = _classThis;
})();
exports.BComponent = BComponent;
let BModule = (() => {
    let _classDecorators = [(0, core_1.NgModule)({ declarations: [BComponent] })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
