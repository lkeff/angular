...
exports.MyModule = exports.MyApp = exports.MyOtherPipe = exports.MyPipe = void 0;
...
let MyPipe = (() => {
    let _classDecorators = [(0, core_1.Injectable)(), (0, core_1.Pipe)({
            name: 'myPipe',
            standalone: false
        })];
    let _classDescriptor;
...
let MyOtherPipe = (() => {
    ...
    let _classExtraInitializers = [];
    let _classThis;
    var MyOtherPipe = _classThis = class {
        constructor(service) { }
        transform(value, ...args) {
            return value;
        }
    };
    __setFunctionName(_classThis, "MyOtherPipe");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        MyOtherPipe = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return MyOtherPipe = _classThis;
})();
exports.MyOtherPipe = MyOtherPipe;
let MyApp = (() => {
...
exports.MyApp = MyApp;
let MyModule = (() => {
    let _classDecorators = [(0, core_1.NgModule)({ declarations: [MyPipe, MyOtherPipe, MyApp], providers: [Service] })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
