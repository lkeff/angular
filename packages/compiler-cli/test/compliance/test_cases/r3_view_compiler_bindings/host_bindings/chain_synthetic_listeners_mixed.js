...
let MyComponent = (() => {
    ...
    (() => {
        ...
        _start_decorators = [(0, core_1.HostListener)('@animation.start')];
        _click_decorators = [(0, core_1.HostListener)('click')];
        ...
        __esDecorate(_classThis, null, _click_decorators, { kind: "method", name: "click", static: false, private: false, access: { has: obj => "click" in obj, get: obj => obj.click }, metadata: _metadata }, null, _instanceExtraInitializers);
