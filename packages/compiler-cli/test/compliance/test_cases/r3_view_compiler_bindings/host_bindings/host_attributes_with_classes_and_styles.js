...
exports.MyModule = exports.HostAttributeDir = exports.HostAttributeComp = void 0;
...
exports.HostAttributeComp = HostAttributeComp;
...
exports.HostAttributeDir = HostAttributeDir;
let MyModule = (() => {
    let _classDecorators = [(0, core_1.NgModule)({ declarations: [HostAttributeComp, HostAttributeDir] })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
