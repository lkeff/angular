...
let HostBindingDir = (() => {
    ...
    var HostBindingDir = _classThis = class {
        constructor() {
            ...
            this.other = (__runInitializers(this, _false_extraInitializers), __runInitializers(this, _other_initializers, void 0));
    ...
    (() => {
        ...
        _other_decorators = [(0, core_1.HostBinding)('class.e')];
