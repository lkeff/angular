...
exports.MyModule = exports.EmptyOutletComponent = exports.RouterOutlet = void 0;
...
let EmptyOutletComponent = (() => {
    ...
    let _classExtraInitializers = [];
    let _classThis;
    var EmptyOutletComponent = _classThis = class {
    };
    __setFunctionName(_classThis, "EmptyOutletComponent");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        EmptyOutletComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return EmptyOutletComponent = _classThis;
})();
exports.EmptyOutletComponent = EmptyOutletComponent;
let MyModule = (() => {
    let _classDecorators = [(0, core_1.NgModule)({ declarations: [EmptyOutletComponent, RouterOutlet] })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
