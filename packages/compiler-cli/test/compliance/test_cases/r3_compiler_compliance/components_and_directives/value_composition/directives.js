...
exports.MyModule = exports.MyComponent = exports.SomeDirective = exports.ChildComponent = void 0;
...
let MyModule = (() => {
    let _classDecorators = [(0, core_1.NgModule)({ declarations: [ChildComponent, SomeDirective, MyComponent] })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
