...
exports.MyModule = exports.MyApp = exports.NestedComp = void 0;
...
exports.MyApp = MyApp;
let MyModule = (() => {
    let _classDecorators = [(0, core_1.NgModule)({ declarations: [NestedComp, MyApp] })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
