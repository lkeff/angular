...
exports.MyModule = exports.MyApp = exports.ComplexComponent = exports.SimpleComponent = void 0;
...
exports.MyApp = MyApp;
let MyModule = (() => {
    let _classDecorators = [(0, core_1.NgModule)({ declarations: [SimpleComponent, ComplexComponent, MyApp] })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
