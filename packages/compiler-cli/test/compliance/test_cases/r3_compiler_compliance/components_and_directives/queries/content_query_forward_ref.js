...
exports.MyModule = exports.SomeDirective = exports.MyApp = exports.ContentQueryComponent = void 0;
...
let ContentQueryComponent = (() => {
  ...
  `,
    ...
    (() => {
        ...
        _someDir_decorators = [(0, core_1.ContentChild)((0, core_1.forwardRef)(() => SomeDirective))];
        _someDirList_decorators = [(0, core_1.ContentChildren)((0, core_1.forwardRef)(() => SomeDirective))];
...
let MyModule = (() => {
    let _classDecorators = [(0, core_1.NgModule)({ declarations: [SomeDirective, ContentQueryComponent, MyApp] })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
