  ...
  `,
    ...
    var ViewQueryComponent = _classThis = class {
        constructor() {
            ...
            this.foo = (__runInitializers(this, _someDir_extraInitializers), __runInitializers(this, _foo_initializers, void 0));
    ...
    (() => {
        ...
        _someDir_decorators = [(0, core_1.ViewChild)(some_directive_1.SomeDirective, { static: true })];
...
let MyModule = (() => {
    let _classDecorators = [(0, core_1.NgModule)({ declarations: [some_directive_1.SomeDirective, ViewQueryComponent] })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
