...
exports.MyModule = exports.SomeDirective = exports.MyApp = exports.ViewQueryComponent = void 0;
...
let ViewQueryComponent = (() => {
  ...
  `,
    ...
    (() => {
        ...
        _someDir_decorators = [(0, core_1.ViewChild)((0, core_1.forwardRef)(() => SomeDirective))];
        _someDirList_decorators = [(0, core_1.ViewChildren)((0, core_1.forwardRef)(() => SomeDirective))];
...
let MyModule = (() => {
    let _classDecorators = [(0, core_1.NgModule)({ declarations: [SomeDirective, ViewQueryComponent, MyApp] })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
