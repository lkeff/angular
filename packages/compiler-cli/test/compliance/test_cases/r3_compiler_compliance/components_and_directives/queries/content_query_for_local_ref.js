  ...
  `,
    ...
    var ContentQueryComponent = _classThis = class {
        constructor() {
            ...
            __runInitializers(this, _myRefs_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "ContentQueryComponent");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _myRef_decorators = [(0, core_1.ContentChild)('myRef')];
        _myRefs_decorators = [(0, core_1.ContentChildren)('myRef1, myRef2, myRef3')];
