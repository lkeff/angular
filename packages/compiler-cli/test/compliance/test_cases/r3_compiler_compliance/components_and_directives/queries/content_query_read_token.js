...
let ContentQueryComponent = (() => {
  ...
  `,
    ...
    (() => {
        ...
        _myRef_decorators = [(0, core_1.ContentChild)('myRef', { read: core_1.TemplateRef })];
        _myRefs_decorators = [(0, core_1.ContentChildren)('myRef1, myRef2, myRef3', { read: core_1.ElementRef })];
        _someDir_decorators = [(0, core_1.ContentChild)(some_directive_1.SomeDirective, { read: core_1.ElementRef })];
        _someDirs_decorators = [(0, core_1.ContentChildren)(some_directive_1.SomeDirective, { read: core_1.TemplateRef })];
