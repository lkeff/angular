...
exports.MyApp = exports.Binding = void 0;
const core_1 = require("@angular/core");
let Binding = (() => {
    let _classDecorators = [(0, core_1.Directive)({ selector: '[binding]' })];
    ...
    var Binding = _classThis = class {
        constructor() {
            this.binding = __runInitializers(this, _binding_initializers, 0);
            __runInitializers(this, _binding_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "Binding");
    (() => {
        ...
        Binding = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Binding = _classThis;
})();
