...
exports.MyComponent = exports.DirectiveB = exports.DirectiveA = void 0;
const core_1 = require("@angular/core");
let DirectiveA = (() => {
    let _classDecorators = [(0, core_1.Directive)({ host: { 'class': 'dir-a' } })];
...
let DirectiveB = (() => {
    let _classDecorators = [(0, core_1.Directive)({ host: { 'class': 'dir-b' } })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
