...
let TestComp = (() => {
    ...
    var TestComp = _classThis = class {
        constructor() {
            this.a = (0, core_1.output)();
            this.b = (0, core_1.output)({});
            this.c = (0, core_1.output)({ alias: 'cPublic' });
            this.d = (0, rxjs_interop_1.outputFromObservable)(new core_1.EventEmitter());
            this.e = (0, rxjs_interop_1.outputFromObservable)(new core_1.EventEmitter());
        }
    };
