...
exports.TodoModule = exports.TodoComponent = exports.MyApp = void 0;
...
let TodoComponent = (() => {
    ...
    var TodoComponent = _classThis = class {
        constructor() {
            ...
            this.myTitle = __runInitializers(this, _data_extraInitializers);
        }
    };
...
let TodoModule = (() => {
    ...
    let _classExtraInitializers = [];
    let _classThis;
    var TodoModule = _classThis = class {
    };
