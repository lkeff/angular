...
let TestDir = (() => {
    ...
    var TestDir = _classThis = class {
        constructor() {
            ...
            this.name2 = core_1.input.required({ transform: toBoolean });
            this.genericTransform = core_1.input.required({ transform: complexTransform(1) });
            this.genericTransform2 = core_1.input.required({ transform: complexTransform(null) });
        }
    };
