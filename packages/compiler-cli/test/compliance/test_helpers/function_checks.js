...
exports.verifyUniqueFunctions = verifyUniqueFunctions;
/**
 ...
 */
function verifyUniqueFunctions(output, functionNamePattern, expectedCount) {
    ...
    const expectedCountMatches = expectedCount == null
