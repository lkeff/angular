...
describe('extract_i18n command line', () => {
    ...
    beforeEach(() => {
        ...
        const support = (0, test_support_1.setup)();
    ...
    it('should extract xmb', () => {
        writeConfig();
        writeSources();
        const exitCode = (0, extract_i18n_1.mainXi18n)(['-p', basePath, '--i18nFormat=xmb', '--outFile=custom_file.xmb'], errorSpy);
    ...
    it('should extract xlf', () => {
        writeConfig();
        writeSources();
        const exitCode = (0, extract_i18n_1.mainXi18n)(['-p', basePath, '--i18nFormat=xlf', '--locale=fr'], errorSpy);
        expect(errorSpy).not.toHaveBeenCalled();
        expect(exitCode).toBe(0);
    ...
    it('should extract xlf2', () => {
        writeConfig();
        writeSources();
        const exitCode = (0, extract_i18n_1.mainXi18n)(['-p', basePath, '--i18nFormat=xlf2', '--outFile=messages.xliff2.xlf'], errorSpy);
        expect(errorSpy).not.toHaveBeenCalled();
        expect(exitCode).toBe(0);
