...
const es2015_linker_plugin_1 = require("../src/es2015_linker_plugin");
describe('createEs2015LinkerPlugin()', () => {
    it('should return a Babel plugin visitor that handles Program (enter/exit) and CallExpression nodes', () => {
        const fileSystem = new testing_1.MockFileSystemNative();
        const logger = new testing_2.MockLogger();
        const plugin = (0, es2015_linker_plugin_1.createEs2015LinkerPlugin)({ fileSystem, logger });
    ...
    it('should return a Babel plugin that calls FileLinker.isPartialDeclaration() on each call expression', () => {
        const isPartialDeclarationSpy = spyOn(linker_1.FileLinker.prototype, 'isPartialDeclaration');
        const fileSystem = new testing_1.MockFileSystemNative();
        const logger = new testing_2.MockLogger();
        const plugin = (0, es2015_linker_plugin_1.createEs2015LinkerPlugin)({ fileSystem, logger });
    ...
    it('should return a Babel plugin that calls FileLinker.linkPartialDeclaration() on each matching declaration', () => {
        const linkSpy = spyOn(linker_1.FileLinker.prototype, 'linkPartialDeclaration').and.returnValue(core_1.types.identifier('REPLACEMENT'));
        const fileSystem = new testing_1.MockFileSystemNative();
        const logger = new testing_2.MockLogger();
        core_1.default.transformSync([
            'var core;',
            ...
            plugins: [(0, es2015_linker_plugin_1.createEs2015LinkerPlugin)({ fileSystem, logger })],
            filename: '/test.js',
            parserOpts: { sourceType: 'unambiguous' },
        });
    ...
    it('should return a Babel plugin that replaces call expressions with the return value from FileLinker.linkPartialDeclaration()', () => {
        let replaceCount = 0;
        spyOn(linker_1.FileLinker.prototype, 'linkPartialDeclaration').and.callFake(() => core_1.types.identifier('REPLACEMENT_' + ++replaceCount));
        const fileSystem = new testing_1.MockFileSystemNative();
        const logger = new testing_2.MockLogger();
        const result = core_1.default.transformSync([
            'var core;',
    ...
    it('should return a Babel plugin that adds shared statements after any imports', () => {
        ...
        expect(result.code).toEqual('import*as core from\'some-module\';import{id}from\'other-module\';const _c0=[1];const _c1=[2];const _c2=[3];"REPLACEMENT";"REPLACEMENT";"REPLACEMENT";');
    });
    it('should return a Babel plugin that adds shared statements after the first group of imports', () => {
        ...
        expect(result.code).toEqual('import*as core from\'some-module\';import{id}from\'other-module\';const _c0=[1];const _c1=[2];const _c2=[3];"REPLACEMENT";"REPLACEMENT";"REPLACEMENT";import{second}from\'second-module\';');
    });
    it('should return a Babel plugin that adds shared statements at the start of the program if it is an ECMAScript Module and there are no imports', () => {
        ...
        expect(result.code).toEqual('const _c0=[1];const _c1=[2];const _c2=[3];var core;"REPLACEMENT";"REPLACEMENT";"REPLACEMENT";');
    });
    it('should return a Babel plugin that adds shared statements at the start of the function body if the ngImport is from a function parameter', () => {
        ...
        expect(result.code).toEqual('function run(core){const _c0=[1];const _c1=[2];const _c2=[3];"REPLACEMENT";"REPLACEMENT";"REPLACEMENT";}');
    });
    ...
    it('should still execute other plugins that match AST nodes inside the result of the replacement', () => {
        ...
        const result = core_1.default.transformSync([
            ...
            plugins: [
                (0, es2015_linker_plugin_1.createEs2015LinkerPlugin)({ fileSystem, logger }),
        ...
        expect(result.code).toEqual([`(function(){const x1=[1];return function BAR(){};})();BAR;`].join(''));
    });
    it('should not process call expressions within inserted functions', () => {
        spyOn(partial_directive_linker_1_1.PartialDirectiveLinkerVersion1.prototype, 'linkPartialDeclaration').and.callFake(((constantPool) => {
            ...
            constantPool.statements.push(o
                .fn(
            /* params */ [], 
            /* body */ [], 
            /* type */ undefined, 
        ...
        const isPartialDeclarationSpy = spyOn(linker_1.FileLinker.prototype, 'isPartialDeclaration').and.callThrough();
        const fileSystem = new testing_1.MockFileSystemNative();
        const logger = new testing_2.MockLogger();
        const result = core_1.default.transformSync([
            "import * as core from 'some-module';",
        ...
        expect(result.code).toEqual('import*as core from\'some-module\';(function inserted(){})();"REPLACEMENT";');
 ...
 */
function humanizeLinkerCalls(calls) {
 ...
 * called `<dest>`.
 */
function createIdentifierMapperPlugin(src, dest) {
    return {
        visitor: {
            Identifier(path) {
                if (path.node.name === src) {
                    path.replaceWith(core_1.types.identifier(dest));
                }
            },
        },
    };
