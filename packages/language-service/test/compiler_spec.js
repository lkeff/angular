...
describe('language-service/compiler integration', () => {
    ...
    it('should handle broken imports during incremental build steps', () => {
        ...
        const componentSource = (isExported) => `
      import {Component} from '@angular/core';
    ...
    `;
      ...
      `,
        ...
        const ngDiagsBefore = project.getDiagnosticsForFile('mod.ts').filter(testing_2.isNgSpecificDiagnostic);
        ...
        const ngDiagsAfter = project.getDiagnosticsForFile('mod.ts').filter(testing_2.isNgSpecificDiagnostic);
