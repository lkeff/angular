...
describe('find references and rename locations', () => {
    ...
    describe('cursor is on binding in component class', () => {
        ...
        it('gets component member references from TS file and external template', () => {
            ...
            (0, testing_2.assertFileNames)(refs, ['app.html', 'app.ts']);
            (0, testing_2.assertTextSpans)(refs, ['myProp']);
        });
        it('gets rename locations from TS file and external template', () => {
            ...
            (0, testing_2.assertFileNames)(renameLocations, ['app.html', 'app.ts']);
            (0, testing_2.assertTextSpans)(renameLocations, ['myProp']);
        });
    });
    ...
    describe('when cursor is on function call in external template', () => {
        ...
        it('gets component member reference in ts file', () => {
            const refs = getReferencesAtPosition(appFile);
            expect(refs.length).toBe(2);
            (0, testing_2.assertFileNames)(refs, ['app.ts']);
            (0, testing_2.assertTextSpans)(refs, ['setTitle']);
        });
        it('gets rename location in ts file', () => {
            const renameLocations = getRenameLocationsAtPosition(appFile);
            expect(renameLocations.length).toBe(2);
            (0, testing_2.assertFileNames)(renameLocations, ['app.ts']);
            (0, testing_2.assertTextSpans)(renameLocations, ['setTitle']);
        });
    });
    describe('when cursor in on argument to a function call in an external template', () => {
        ...
        it('gets member reference in ts file', () => {
            const refs = getReferencesAtPosition(appFile);
            expect(refs.length).toBe(2);
            (0, testing_2.assertTextSpans)(refs, ['title']);
        });
    ...
    describe('when cursor is on $event in method call arguments', () => {
        ...
        it('find references', () => {
            ...
            (0, testing_2.assertTextSpans)(refs, ['$event']);
        });
    ...
    describe('when cursor in on LHS of property write in external template', () => {
        ...
        it('gets member reference in ts file', () => {
            const refs = getReferencesAtPosition(file);
            expect(refs.length).toBe(2);
            (0, testing_2.assertFileNames)(refs, ['app.ts', 'app.html']);
            (0, testing_2.assertTextSpans)(refs, ['title']);
        });
        it('gets rename location in ts file', () => {
            const renameLocations = getRenameLocationsAtPosition(file);
            expect(renameLocations.length).toBe(2);
            (0, testing_2.assertFileNames)(renameLocations, ['app.ts', 'app.html']);
            (0, testing_2.assertTextSpans)(renameLocations, ['title']);
        });
    });
    describe('when cursor in on RHS of property write in external template', () => {
        ...
        it('get reference to member in ts file', () => {
            ...
            expect(refs.length).toBe(2);
            (0, testing_2.assertFileNames)(refs, ['app.ts']);
            (0, testing_2.assertTextSpans)(refs, ['otherTitle']);
        });
        it('finds rename location in ts file', () => {
            const renameLocations = getRenameLocationsAtPosition(file);
            expect(renameLocations.length).toBe(2);
            (0, testing_2.assertFileNames)(renameLocations, ['app.ts']);
            (0, testing_2.assertTextSpans)(renameLocations, ['otherTitle']);
        });
    });
    describe('when cursor in on a keyed read', () => {
        ...
        it('gets reference to member type definition and initialization in component class', () => {
            ...
            (0, testing_2.assertTextSpans)(refs, ['name', '"name"']);
        });
    ...
    describe('when cursor in on RHS of keyed write in a template', () => {
        ...
        it('get references in ts file', () => {
            ...
            expect(refs.length).toBe(2);
            (0, testing_2.assertFileNames)(refs, ['app.ts', 'app.html']);
            (0, testing_2.assertTextSpans)(refs, ['batman']);
        });
        it('finds rename location in ts file', () => {
            const renameLocations = getRenameLocationsAtPosition(file);
            expect(renameLocations.length).toBe(2);
            (0, testing_2.assertFileNames)(renameLocations, ['app.ts', 'app.html']);
            (0, testing_2.assertTextSpans)(renameLocations, ['batman']);
        });
    });
    describe('when cursor in on an element reference', () => {
        ...
        it('get reference to declaration in template', () => {
            const refs = getReferencesAtPosition(file);
            expect(refs.length).toBe(2);
            (0, testing_2.assertTextSpans)(refs, ['myInput']);
        });
        it('finds rename location in template', () => {
            const renameLocations = getRenameLocationsAtPosition(file);
            expect(renameLocations.length).toBe(2);
            (0, testing_2.assertTextSpans)(renameLocations, ['myInput']);
        });
    });
    describe('when cursor in on a template reference', () => {
        ...
        it('gets reference to declaration', () => {
            const refs = getReferencesAtPosition(file);
            expect(refs.length).toBe(2);
            (0, testing_2.assertTextSpans)(refs, ['myTemplate']);
            (0, testing_2.assertFileNames)(refs, ['app.html']);
        });
        it('finds rename location in template', () => {
            const renameLocations = getRenameLocationsAtPosition(file);
            expect(renameLocations.length).toBe(2);
            (0, testing_2.assertTextSpans)(renameLocations, ['myTemplate']);
            (0, testing_2.assertFileNames)(renameLocations, ['app.html']);
        });
    });
        ...
        describe('directives', () => {
            ...
            describe('when cursor is on usage of template reference', () => {
                ...
                it('should get references', () => {
                    ...
                    expect(refs.length).toBe(2);
                    (0, testing_2.assertFileNames)(refs, ['app.html']);
                    (0, testing_2.assertTextSpans)(refs, ['dirRef']);
                });
                it('should find rename locations', () => {
                    const renameLocations = getRenameLocationsAtPosition(file);
                    expect(renameLocations.length).toBe(2);
                    (0, testing_2.assertFileNames)(renameLocations, ['app.html']);
                    (0, testing_2.assertTextSpans)(renameLocations, ['dirRef']);
                });
            });
            describe('when cursor is on a property read of directive reference', () => {
                ...
                it('should get references', () => {
                    const refs = getReferencesAtPosition(file);
                    expect(refs.length).toBe(2);
                    (0, testing_2.assertFileNames)(refs, ['dir.ts', 'app.html']);
                    (0, testing_2.assertTextSpans)(refs, ['dirValue']);
                });
                it('should find rename locations', () => {
                    const renameLocations = getRenameLocationsAtPosition(file);
                    expect(renameLocations.length).toBe(2);
                    (0, testing_2.assertFileNames)(renameLocations, ['dir.ts', 'app.html']);
                    (0, testing_2.assertTextSpans)(renameLocations, ['dirValue']);
                });
            });
            ...
            describe('when cursor is on safe method call', () => {
                ...
                it('should get references', () => {
                    ...
                    expect(refs.length).toBe(2);
                    (0, testing_2.assertFileNames)(refs, ['dir.ts', 'app.html']);
                    (0, testing_2.assertTextSpans)(refs, ['doSomething']);
                });
                it('should find rename locations', () => {
                    const renameLocations = getRenameLocationsAtPosition(file);
                    expect(renameLocations.length).toBe(2);
                    (0, testing_2.assertFileNames)(renameLocations, ['dir.ts', 'app.html']);
                    (0, testing_2.assertTextSpans)(renameLocations, ['doSomething']);
                });
            });
        });
    });
    describe('template variables', () => {
        describe('when cursor is on variable which was initialized implicitly', () => {
          ...
          `,
            ...
            it('should find references', () => {
                const refs = getReferencesAtPosition(file);
                expect(refs.length).toBe(3);
                (0, testing_2.assertFileNames)(refs, ['template.ng.html']);
                (0, testing_2.assertTextSpans)(refs, ['hero']);
            });
            it('should find rename locations', () => {
                const renameLocations = getRenameLocationsAtPosition(file);
                expect(renameLocations.length).toBe(3);
                (0, testing_2.assertFileNames)(renameLocations, ['template.ng.html']);
                (0, testing_2.assertTextSpans)(renameLocations, ['hero']);
            });
        });
        describe('when cursor is on renamed variable', () => {
          ...
          export class AppCmp {
            ...
            it('should find references', () => {
                ...
                expect(refs.length).toBe(2);
                (0, testing_2.assertFileNames)(refs, ['app.ts']);
                (0, testing_2.assertTextSpans)(refs, ['iRef']);
            });
            it('should find rename locations', () => {
                const renameLocations = getRenameLocationsAtPosition(file);
                expect(renameLocations.length).toBe(2);
                (0, testing_2.assertFileNames)(renameLocations, ['app.ts']);
                (0, testing_2.assertTextSpans)(renameLocations, ['iRef']);
            });
        });
        ...
        export class AppModule {}`,
            ...
            it('should find references', () => {
                const refs = getReferencesAtPosition(file);
                expect(refs.length).toBe(2);
                (0, testing_2.assertFileNames)(refs, ['app.ts', 'example-directive.ts']);
                (0, testing_2.assertTextSpans)(refs, ['identifier']);
            });
            it('should find rename locations', () => {
                const renameLocations = getRenameLocationsAtPosition(file);
                expect(renameLocations.length).toBe(2);
                (0, testing_2.assertFileNames)(renameLocations, ['app.ts', 'example-directive.ts']);
                (0, testing_2.assertTextSpans)(renameLocations, ['identifier']);
            });
        });
        describe('when cursor is on property read of variable', () => {
            ...
            it('should find references', () => {
                ...
                expect(refs.length).toBe(2);
                (0, testing_2.assertFileNames)(refs, ['app.ts']);
                (0, testing_2.assertTextSpans)(refs, ['name']);
            });
            it('should find rename locations', () => {
                const renameLocations = getRenameLocationsAtPosition(file);
                expect(renameLocations.length).toBe(2);
                (0, testing_2.assertFileNames)(renameLocations, ['app.ts']);
                (0, testing_2.assertTextSpans)(renameLocations, ['name']);
            });
        });
        describe('when cursor is on property read of variable', () => {
            let file;
    ...
    describe('pipes', () => {
      ...
      `,
                ...
                it('should find references', () => {
                    const refs = getReferencesAtPosition(file);
                    (0, testing_2.assertFileNames)(refs, ['index.d.ts', 'prefix-pipe.ts', 'app.ts']);
                    (0, testing_2.assertTextSpans)(refs, ['transform', 'prefixPipe']);
                });
                it('should find rename locations', () => {
                    const renameLocations = getRenameLocationsAtPosition(file);
                    expect(renameLocations.length).toBe(2);
                    (0, testing_2.assertFileNames)(renameLocations, ['prefix-pipe.ts', 'app.ts']);
                    (0, testing_2.assertTextSpans)(renameLocations, ['prefixPipe']);
                });
      ...
      `,
                ...
                const renameLocations = getRenameLocationsAtPosition(file);
                expect(renameLocations.length).toBe(2);
                (0, testing_2.assertFileNames)(renameLocations, ['prefix_pipe.ts', 'app.ts']);
                (0, testing_2.assertTextSpans)(renameLocations, ['prefixPipe']);
                const result = file.getRenameInfo();
                expect(result.canRename).toEqual(true);
                expect(result.displayName).toEqual('prefixPipe');
                expect(file.contents.substring(result.triggerSpan.start, result.triggerSpan.start + result.triggerSpan.length)).toBe('prefixPipe');
            });
      ...
      `,
            ...
            it('should find references', () => {
                ...
                expect(refs.length).toBe(2);
                (0, testing_2.assertFileNames)(refs, ['app.ts']);
                (0, testing_2.assertTextSpans)(refs, ['prefix']);
            });
            it('should find rename locations', () => {
                const renameLocations = getRenameLocationsAtPosition(file);
                expect(renameLocations.length).toBe(2);
                (0, testing_2.assertFileNames)(renameLocations, ['app.ts']);
                (0, testing_2.assertTextSpans)(renameLocations, ['prefix']);
            });
        });
    });
    describe('inputs', () => {
        ...
        export class AppCmp {
          title = 'title';
            ...
            it('should find references', () => {
                ...
                (0, testing_2.assertFileNames)(refs, ['string-model.ts', 'app.ts']);
                (0, testing_2.assertTextSpans)(refs, ['model']);
            });
            it('should find rename locations', () => {
                const renameLocations = getRenameLocationsAtPosition(file);
                expect(renameLocations.length).toEqual(2);
                (0, testing_2.assertFileNames)(renameLocations, ['string-model.ts', 'app.ts']);
                (0, testing_2.assertTextSpans)(renameLocations, ['model']);
            });
        });
        ...
        export class AppCmp {
          title = 'title';
            ...
            it('should find references', () => {
                ...
                (0, testing_2.assertFileNames)(refs, ['string-model.ts', 'app.ts', 'other-dir.ts']);
                (0, testing_2.assertTextSpans)(refs, ['model', 'otherDirAliasedInput']);
            });
        ...
        export class AppCmp {
          title = 'title';
            ...
            it('should work from the TS input declaration', () => {
                const refs = getReferencesAtPosition(file);
                expect(refs.length).toEqual(2);
                (0, testing_2.assertFileNames)(refs, ['app.ts', 'string-model.ts']);
                (0, testing_2.assertTextSpans)(refs, ['model']);
            });
            it('should find rename locations', () => {
                const renameLocations = getRenameLocationsAtPosition(file);
                expect(renameLocations.length).toEqual(2);
                (0, testing_2.assertFileNames)(renameLocations, ['app.ts', 'string-model.ts']);
                (0, testing_2.assertTextSpans)(renameLocations, ['model']);
            });
        });
        ...
        export class AppCmp {
          title = 'title';
            ...
            it('should find references', () => {
                const refs = getReferencesAtPosition(file);
                expect(refs.length).toEqual(3);
                (0, testing_2.assertFileNames)(refs, ['app.ts', 'string-model.ts', 'other-dir.ts']);
                (0, testing_2.assertTextSpans)(refs, ['model']);
            });
            it('should find rename locations', () => {
                const renameLocations = getRenameLocationsAtPosition(file);
                expect(renameLocations.length).toEqual(3);
                (0, testing_2.assertFileNames)(renameLocations, ['app.ts', 'string-model.ts', 'other-dir.ts']);
                (0, testing_2.assertTextSpans)(renameLocations, ['model']);
            });
        });
        ...
        export class AppCmp {
          title = 'title';
            ...
            it('should find references', () => {
                ...
                expect(refs.length).toEqual(2);
                (0, testing_2.assertFileNames)(refs, ['string-model.ts', 'app.ts']);
                (0, testing_2.assertTextSpans)(refs, ['aliasedModel', 'alias']);
            });
            it('should find rename locations', () => {
                const renameLocations = getRenameLocationsAtPosition(file);
                expect(renameLocations).toBeUndefined();
    ...
    describe('outputs', () => {
        ...
        function generateAppFile(template) {
            return `
        import {Component, NgModule} from '@angular/core';
        import {StringModel} from './string-model';
        ...
        describe('when cursor is on output key in template', () => {
            let file;
            beforeEach(() => {
                const appFile = generateAppFile(`<div string-model (modelChange)="setTitle($event)"></div>`);
                env = testing_2.LanguageServiceTestEnv.setup();
            ...
            it('should find references', () => {
                const refs = getReferencesAtPosition(file);
                expect(refs.length).toEqual(2);
                (0, testing_2.assertTextSpans)(refs, ['modelChange']);
            });
            it('should find rename locations', () => {
                const renameLocations = getRenameLocationsAtPosition(file);
                expect(renameLocations.length).toEqual(2);
                (0, testing_2.assertTextSpans)(renameLocations, ['modelChange']);
            });
        });
        describe('when cursor is on alias output key', () => {
            ...
            it('should find references', () => {
                const refs = getReferencesAtPosition(file);
                expect(refs.length).toEqual(2);
                (0, testing_2.assertTextSpans)(refs, ['aliasedModelChange', 'alias']);
            });
            it('should find rename locations', () => {
                const renameLocations = getRenameLocationsAtPosition(file);
                expect(renameLocations).toBeUndefined();
        ...
        describe('when cursor is on the name of the declaration', () => {
          ...
          `,
            ...
            it('should find references', () => {
                ...
                expect(refs.length).toBe(3);
                (0, testing_2.assertFileNames)(refs, ['template.ng.html']);
                (0, testing_2.assertTextSpans)(refs, ['hobbit']);
            });
            it('should find rename locations', () => {
                const renameLocations = getRenameLocationsAtPosition(file);
                expect(renameLocations.length).toBe(3);
                (0, testing_2.assertFileNames)(renameLocations, ['template.ng.html']);
                (0, testing_2.assertTextSpans)(renameLocations, ['hobbit']);
            });
        });
    ...
    describe('when cursor is on symbol referenced in host bindings', () => {
        ...
        it('gets component member reference in property binding', () => {
            ...
            expect(refs.length).toBe(2);
            (0, testing_2.assertFileNames)(refs, ['app.ts']);
            (0, testing_2.assertTextSpans)(refs, ['getCompId']);
        });
        it('gets component rename location in property binding', () => {
            ...
            expect(renameLocations.length).toBe(2);
            (0, testing_2.assertFileNames)(renameLocations, ['app.ts']);
            (0, testing_2.assertTextSpans)(renameLocations, ['getCompId']);
        });
        it('gets component member reference listener', () => {
            ...
            expect(refs.length).toBe(2);
            (0, testing_2.assertFileNames)(refs, ['app.ts']);
            (0, testing_2.assertTextSpans)(refs, ['handleCompClick']);
        });
        it('gets component rename location listener', () => {
            ...
            expect(renameLocations.length).toBe(2);
            (0, testing_2.assertFileNames)(renameLocations, ['app.ts']);
            (0, testing_2.assertTextSpans)(renameLocations, ['handleCompClick']);
        });
        it('gets directive member reference in property binding', () => {
            ...
            expect(refs.length).toBe(2);
            (0, testing_2.assertFileNames)(refs, ['app.ts']);
            (0, testing_2.assertTextSpans)(refs, ['getDirTitle']);
        });
        it('gets directive rename location in property binding', () => {
            ...
            expect(renameLocations.length).toBe(2);
            (0, testing_2.assertFileNames)(renameLocations, ['app.ts']);
            (0, testing_2.assertTextSpans)(renameLocations, ['getDirTitle']);
        });
        it('gets directive member reference listener', () => {
            ...
            expect(refs.length).toBe(2);
            (0, testing_2.assertFileNames)(refs, ['app.ts']);
            (0, testing_2.assertTextSpans)(refs, ['handleDirKeydown']);
        });
        it('gets directive rename location listener', () => {
            ...
            expect(renameLocations.length).toBe(2);
            (0, testing_2.assertFileNames)(renameLocations, ['app.ts']);
            (0, testing_2.assertTextSpans)(renameLocations, ['handleDirKeydown']);
        });
    });
    it('should get references to both input and output for two-way binding', () => {
      ...
      export class AppCmp {
        ...
        const refs = getReferencesAtPosition(file);
        expect(refs.length).toEqual(3);
        (0, testing_2.assertFileNames)(refs, ['dir.ts', 'app.ts']);
        (0, testing_2.assertTextSpans)(refs, ['model', 'modelChange']);
    });
    it('should get references to model() input binding', () => {
        ...
        expect(refs.length).toBe(2);
        (0, testing_2.assertFileNames)(refs, ['dir.ts', 'app.ts']);
        (0, testing_2.assertTextSpans)(refs, ['signalModel']);
    });
    describe('directives', () => {
      ...
      `,
            ...
            it('should find references', () => {
                ...
                (0, testing_2.assertTextSpans)(refs, ['<div dir>', 'Dir']);
                (0, testing_2.assertFileNames)(refs, ['app.ts', 'dir.ts']);
            });
            it('should find rename locations', () => {
                const renameLocations = getRenameLocationsAtPosition(file);
                expect(renameLocations).toBeUndefined();
      ...
      `;
            ...
            it('gets references to all matching directives', () => {
                ...
                (0, testing_2.assertTextSpans)(refs, ['<div dir>', 'Dir', 'Dir2']);
                (0, testing_2.assertFileNames)(refs, ['app.ts', 'dir.ts', 'dir2.ts']);
            });
      ...
      `,
            ...
            it('should be able to request references', () => {
                const refs = getReferencesAtPosition(file);
                expect(refs.length).toBe(7);
                (0, testing_2.assertTextSpans)(refs, ['<div *ngFor="let item of items"></div>', 'NgForOf']);
                (0, testing_2.assertFileNames)(refs, ['index.d.ts', 'app.ts']);
            });
    ...
    describe('components', () => {
      ...
      `;
            ...
            it('finds references', () => {
                ...
                // list.
                expect(refs.length).toBe(4);
                (0, testing_2.assertTextSpans)(refs, ['<my-comp>', 'MyComp']);
                (0, testing_2.assertFileNames)(refs, ['app.ts', 'comp.ts']);
            });
            it('gets rename locations', () => {
                const renameLocations = getRenameLocationsAtPosition(file);
                expect(renameLocations).toBeUndefined();
    ...
    describe('control flow', () => {
      ...
      `;
            ...
            const refs = getReferencesAtPosition(file);
            expect(refs.length).toBe(3);
            (0, testing_2.assertTextSpans)(refs, ['aliasX']);
            (0, testing_2.assertFileNames)(refs, ['app.ts']);
            const renameLocations = getRenameLocationsAtPosition(file);
    ...
    describe('get rename info', () => {
        it('indicates inability to rename when cursor is outside template and in a string literal', () => {
            ...
            env = testing_2.LanguageServiceTestEnv.setup();
            const project = (0, testing_2.createModuleAndProjectWithDeclarations)(env, 'test', { 'my-comp.ts': comp });
            env.expectNoSourceDiagnostics();
        ...
        it('gets rename info on keyed read', () => {
            ...
            env = testing_2.LanguageServiceTestEnv.setup();
            const project = (0, testing_2.createModuleAndProjectWithDeclarations)(env, 'test', { 'my-comp.ts': text });
            env.expectNoSourceDiagnostics();
            const file = project.openFile('my-comp.ts');
            ...
            expect(result.displayName).toEqual('myProp');
            expect(result.kind).toEqual('property');
            expect(text.substring(result.triggerSpan.start, result.triggerSpan.start + result.triggerSpan.length)).toBe('myProp');
            // re-queries also work
            const { triggerSpan, displayName } = file.getRenameInfo();
            expect(displayName).toEqual('myProp');
            expect(text.substring(triggerSpan.start, triggerSpan.start + triggerSpan.length)).toBe('myProp');
        });
    ...
    function getReferencesAtPosition(file) {
        env.expectNoSourceDiagnostics();
        const result = file.getReferencesAtPosition();
        return result === null || result === void 0 ? void 0 : result.map((item) => (0, testing_2.humanizeDocumentSpanLike)(item, env));
    }
    function getRenameLocationsAtPosition(file) {
        env.expectNoSourceDiagnostics();
