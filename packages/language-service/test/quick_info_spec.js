...
describe('quick info', () => {
    ...
    describe('strict templates (happy path)', () => {
        ...
        describe('templates', () => {
            it('should return undefined for ng-templates', () => {
                ...
                expect(toText(documentation)).toContain('The `<ng-template>` is an Angular element for rendering HTML.');
            });
        });
        describe('directives', () => {
            ...
            describe('inputs', () => {
                ...
                it('should work for structural directive inputs ngForTrackBy', () => {
                    expectQuickInfo({
                        ...
                        expectedDisplayString: '(property) NgForOf<Hero, Hero[]>.ngForTrackBy: TrackByFunction<Hero>',
                    });
                });
                it('should work for structural directive inputs ngForOf', () => {
                    expectQuickInfo({
                        ...
                        expectedSpanText: 'of',
                        expectedDisplayString: '(property) NgForOf<Hero, Hero[]>.ngForOf: (Hero[] & NgIterable<Hero>) | null | undefined',
                    });
                });
                ...
                it('should work for signal-based two-way binding providers', () => {
                    expectQuickInfo({
                        ...
                        expectedDisplayString: '(property) SignalModel.signalModel: ModelSignal<string | undefined>',
                    });
                });
            });
            describe('outputs', () => {
        ...
        describe('references', () => {
            it('should work for element reference declarations', () => {
                ...
                expect(toText(documentation)).toEqual('Provides special properties (beyond the regular HTMLElement ' +
            ...
            it('should work for click output from native element', () => {
                expectQuickInfo({
                    ...
                    expectedDisplayString: '(event) HTMLDivElement.addEventListener<"click">(type: "click", listener: ' +
        ...
        describe('pipes', () => {
            it('should work for pipes', () => {
                ...
                expectQuickInfo({
                    ...
                    expectedDisplayString: '(pipe) DatePipe.transform(value: Date | string | number, format?: string, ' +
        ...
        describe('expressions', () => {
            ...
            it('should work for accessed very nested function calls', () => {
                expectQuickInfo({
                    ...
                    expectedDisplayString: '(property) helloWorld: () => {\n    nestedMethod: () => number;\n}',
                });
            });
            ...
            export class AppCmp {
              something!: {
                ...
                const project = (0, testing_2.createModuleAndProjectWithDeclarations)(env, 'test_project', files);
        ...
        describe('host bindings', () => {
            function expectHostBindingsQuickInfo({ source, moveTo, expectedDisplayString, expectedSpanText, }) {
                ...
                expect(source.substring(textSpan.start, textSpan.start + textSpan.length)).toEqual(expectedSpanText);
    ...
    describe('non-strict compiler options', () => {
       ...
       `,
            ...
            expect(diagnostics[0].messageText).toEqual(`Could not find stylesheet file './does_not_exist'.`);
            const template = project.openFile('app.html');
    ...
    function expectQuickInfo({ templateOverride, expectedSpanText, expectedDisplayString, }) {
        const text = templateOverride.replace('¦', '');
        const template = project.openFile('app.html');
        template.contents = text;
        env.expectNoSourceDiagnostics();
