...
const util_1 = require("../testing/src/util");
...
describe('signature help', () => {
    ...
    `);
        ...
        const items = main.getSignatureHelpItems();
        expect(items).toBeDefined();
        expect((0, util_1.getText)(main.contents, items.applicableSpan)).toEqual('"test"');
    ...
    `);
        ...
        const items = main.getSignatureHelpItems();
        expect(items).toBeDefined();
        expect((0, util_1.getText)(main.contents, items.applicableSpan)).toEqual('"test", 3');
    ...
    `);
        ...
        const items = main.getSignatureHelpItems();
        expect(items).toBeDefined();
        expect((0, util_1.getText)(main.contents, items.applicableSpan)).toEqual('"test", 1 + 2');
        expect(items.argumentCount).toEqual(2);
