...
let DownloadManager = (() => {
    ...
    let _classThis;
    var DownloadManager = _classThis = class {
        constructor() {
         ...
         */
        downloadCurrentStateOfTheSolution(name) {
            return __awaiter(this, void 0, void 0, function* () {
                const nodeRuntimeSandbox = yield (0, inject_node_runtime_sandbox_1.injectNodeRuntimeSandbox)(this.environmentInjector);
                const files = yield nodeRuntimeSandbox.getSolutionFiles();
                const content = yield (0, docs_1.generateZip)(files);
