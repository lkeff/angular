...
exports.EditorUiState = exports.DEFAULT_EDITOR_UI_STATE = void 0;
...
exports.DEFAULT_EDITOR_UI_STATE = {
...
let EditorUiState = (() => {
    ...
    let _classThis;
    var EditorUiState = _classThis = class {
        constructor() {
            ...
            this.uiState = (0, core_1.signal)(exports.DEFAULT_EDITOR_UI_STATE);
            this.handleTutorialChange();
        }
        patchState(patch) {
            this.uiState.update((state) => (Object.assign(Object.assign({}, state), patch)));
        ...
        handleTutorialChange() {
            (0, rxjs_1.from)((0, inject_embedded_tutorial_manager_1.injectEmbeddedTutorialManager)(this.environmentInjector))
                .pipe((0, rxjs_1.switchMap)((embeddedTutorialManager) => embeddedTutorialManager.tutorialChanged$.pipe((0, rxjs_1.map)(() => embeddedTutorialManager.type()))), (0, rxjs_1.filter)((tutorialType) => Boolean(tutorialType)), (0, rxjs_interop_1.takeUntilDestroyed)())
                .subscribe((tutorialType) => {
                if (tutorialType === docs_1.TutorialType.CLI) {
                    this.patchState({ displayOnlyInteractiveTerminal: true });
                }
                else {
                    this.patchState(exports.DEFAULT_EDITOR_UI_STATE);
                }
            });
        }
    };
    __setFunctionName(_classThis, "EditorUiState");
    (() => {
...
exports.EditorUiState = EditorUiState;
