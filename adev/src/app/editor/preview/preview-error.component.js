...
let PreviewError = (() => {
    ...
    let _classThis;
    var PreviewError = _classThis = class {
        constructor() {
            this.nodeRuntimeState = (0, core_1.inject)(node_runtime_state_service_1.NodeRuntimeState);
            this.isIos = docs_1.isIos;
            this.isFirefox = docs_1.isFirefox;
            this.error = this.nodeRuntimeState.error;
            this.ErrorType = node_runtime_state_service_1.ErrorType;
        }
    };
    __setFunctionName(_classThis, "PreviewError");
    (() => {
