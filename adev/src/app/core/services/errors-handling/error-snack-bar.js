...
let ErrorSnackBar = (() => {
  ...
  `,
            imports: [snack_bar_1.MatSnackBarAction],
            styles: `:host { display: flex; align-items: center; button { margin-left: 16px }}`,
        })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var ErrorSnackBar = _classThis = class {
        constructor(snackBarRef) {
            this.snackBarRef = snackBarRef;
            const data = (0, core_1.inject)(snack_bar_1.MAT_SNACK_BAR_DATA);
            this.message = data.message;
            this.actionText = data.actionText;
        }
    };
    __setFunctionName(_classThis, "ErrorSnackBar");
    (() => {
