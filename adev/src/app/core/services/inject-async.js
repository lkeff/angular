...
let InjectAsyncImpl = (() => {
    ...
    let _classThis;
    var InjectAsyncImpl = _classThis = class {
        constructor() {
        ...
        get(injector, providerLoader) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (!(injector instanceof core_1.EnvironmentInjector)) {
                    ...
                    const newInjector = (0, core_1.createEnvironmentInjector)([type], environmentInjector);
    ...
    __setFunctionName(_classThis, "InjectAsyncImpl");
    (() => {
    ...
    return [
        {
            ...
            multi: true,
            useValue: () => {
                (0, core_1.inject)(InjectAsyncImpl).override(type, mock);
            },
        },
    ];
}
