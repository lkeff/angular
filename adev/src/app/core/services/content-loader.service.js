...
let ContentLoader = (() => {
    ...
    let _classThis;
    var ContentLoader = _classThis = class {
        constructor() {
            this.cache = new Map();
        ...
        getContent(path) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    if (!promise) {
                        promise = (0, rxjs_1.firstValueFrom)(this.httpClient
                            .get(`assets/content/${path}`, {
                            responseType: 'text',
                        })
                            .pipe((0, operators_1.map)((contents) => ({ contents, id: path }))));
                    ...
                    if (!(e instanceof http_1.HttpErrorResponse) || errorResponse.status !== 404) {
    ...
    __setFunctionName(_classThis, "ContentLoader");
    (() => {
