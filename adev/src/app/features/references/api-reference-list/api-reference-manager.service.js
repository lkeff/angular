...
exports.ApiReferenceManager = void 0;
...
const manifest_helper_1 = require("../helpers/manifest.helper");
...
let ApiReferenceManager = (() => {
    ...
    let _classThis;
    var ApiReferenceManager = _classThis = class {
        constructor() {
            this.apiGroups = (0, core_1.signal)(this.mapManifestToApiGroups());
        }
            ...
            for (const module of manifest) {
                groups.push({
                    ...
                    items: module.entries.map((api) => {
                        const url = (0, manifest_helper_1.getApiUrl)(module, api.name);
                        const apiItem = {
                            itemType: api.type,
                            title: api.name,
    ...
    __setFunctionName(_classThis, "ApiReferenceManager");
    (() => {
...
exports.ApiReferenceManager = ApiReferenceManager;
