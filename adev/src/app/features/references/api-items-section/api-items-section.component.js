...
let ApiItemsSection = (() => {
    let _classDecorators = [(0, core_1.Component)({
            ...
            imports: [api_item_label_component_1.default, router_1.RouterLink, tooltip_1.MatTooltipModule],
    ...
    let _classThis;
    var ApiItemsSection = _classThis = class {
        constructor() {
            this.group = core_1.input.required();
        }
    };
    __setFunctionName(_classThis, "ApiItemsSection");
    (() => {
...
exports.default = ApiItemsSection;
