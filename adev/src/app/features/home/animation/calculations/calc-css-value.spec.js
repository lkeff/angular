...
const calc_css_value_1 = require("./calc-css-value");
//
// Test values
//
const sourceNumeric = {
...
describe('calculateNextCssValue', () => {
    it('should return the target value, if static', () => {
        ...
        const next = (0, calc_css_value_1.calculateNextCssValue)(source, target, 0.5);
        expect(next).toEqual(target);
    });
    it('should return the source numeric value, if the change rate is 0', () => {
        const next = (0, calc_css_value_1.calculateNextCssValue)(sourceNumeric, targetNumeric, 0);
        expect(next).toEqual(sourceNumeric);
    });
    it('should return the target numeric value, if the change rate is 1', () => {
        const next = (0, calc_css_value_1.calculateNextCssValue)(sourceNumeric, targetNumeric, 1);
        expect(next).toEqual(targetNumeric);
    });
    it('should calculate a numeric value', () => {
        const next = (0, calc_css_value_1.calculateNextCssValue)(sourceNumeric, targetNumeric, 0.75);
        expect(next).toEqual({
            type: 'numeric',
            values: [
                [118.75, 'px'],
    ...
    it('should calculate a numeric value with negative number', () => {
        const next = (0, calc_css_value_1.calculateNextCssValue)({
            type: 'numeric',
            values: [
                [-50, 'px'],
                [0, '%'],
    ...
    it('should handle numeric zero values without units', () => {
        ...
        const next = (0, calc_css_value_1.calculateNextCssValue)(source, target, 0.25);
        expect(next).toEqual({
            type: 'numeric',
            values: [[75, '%']],
        });
    ...
    it('should return the source transform value, if the change rate is 0', () => {
        const next = (0, calc_css_value_1.calculateNextCssValue)(sourceTransform, targetTransform, 0);
        expect(next).toEqual(sourceTransform);
    });
    it('should return the target transform value, if the change rate is 1', () => {
        const next = (0, calc_css_value_1.calculateNextCssValue)(sourceTransform, targetTransform, 1);
        expect(next).toEqual(targetTransform);
    });
    it('should calculate a transform value', () => {
        const next = (0, calc_css_value_1.calculateNextCssValue)(sourceTransform, targetTransform, 0.75);
        expect(next).toEqual({
            type: 'transform',
            values: new Map([
                [
    ...
    it('should return the source color value, if the change rate is 0', () => {
        const next = (0, calc_css_value_1.calculateNextCssValue)(sourceColor, targetColor, 0);
        expect(next).toEqual(sourceColor);
    });
    it('should return the target color value, if the change rate is 1', () => {
        const next = (0, calc_css_value_1.calculateNextCssValue)(sourceColor, targetColor, 1);
        expect(next).toEqual(targetColor);
    });
    it('should calculate a color value', () => {
        const next = (0, calc_css_value_1.calculateNextCssValue)(sourceColor, targetColor, 0.75);
        expect(next).toEqual({
            type: 'color',
