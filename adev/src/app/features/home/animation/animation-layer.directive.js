...
exports.AnimationLayerDirective = void 0;
...
let AnimationLayerDirective = (() => {
    ...
    let _classThis;
    var AnimationLayerDirective = _classThis = class {
        constructor() {
            this.elementRef = (0, core_1.inject)(core_1.ElementRef);
            this.id = core_1.input.required({ alias: 'layerId' });
        }
    };
    __setFunctionName(_classThis, "AnimationLayerDirective");
    (() => {
...
exports.AnimationLayerDirective = AnimationLayerDirective;
