...
exports.AnimationCreatorService = void 0;
...
let AnimationCreatorService = (() => {
    ...
    let _classThis;
    var AnimationCreatorService = _classThis = class {
        constructor() {
        ...
        createAnimation(layers, config) {
            return new animation_1.Animation(layers, this.injector, config);
        }
    };
    __setFunctionName(_classThis, "AnimationCreatorService");
    (() => {
...
exports.AnimationCreatorService = AnimationCreatorService;
