...
exports.SUB_NAVIGATION_DATA = exports.TUTORIALS_SUB_NAVIGATION_DATA = void 0;
// These 2 imports are expected to be red because they are generated a build time
const routes_json_1 = __importDefault(require("../../src/assets/tutorials/first-app/routes.json"));
const routes_json_2 = __importDefault(require("../../src/assets/tutorials/learn-angular/routes.json"));
const routes_json_3 = __importDefault(require("../../src/assets/tutorials/deferrable-views/routes.json"));
const routes_json_4 = __importDefault(require("../../src/assets/content/reference/errors/routes.json"));
const routes_json_5 = __importDefault(require("../../src/assets/content/reference/extended-diagnostics/routes.json"));
...
exports.TUTORIALS_SUB_NAVIGATION_DATA = [
    routes_json_1.default,
    routes_json_2.default,
    routes_json_3.default,
    {
        path: pages_1.DefaultPage.TUTORIALS,
...
const REFERENCE_SUB_NAVIGATION_DATA = [
    ...
    },
    {
        ...
        children: [
            ...
            ...(0, manifest_helper_1.getApiNavigationItems)(),
        ],
    },
    {
        label: 'CLI Reference',
...
exports.SUB_NAVIGATION_DATA = {
    docs: DOCS_SUB_NAVIGATION_DATA,
    reference: REFERENCE_SUB_NAVIGATION_DATA,
    tutorials: exports.TUTORIALS_SUB_NAVIGATION_DATA,
