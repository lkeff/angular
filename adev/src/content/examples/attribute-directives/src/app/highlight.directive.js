...
let HighlightDirective = (() => {
    ...
    let _defaultColor_decorators;
    let _defaultColor_initializers = [];
    let _defaultColor_extraInitializers = [];
    ...
    var HighlightDirective = _classThis = class {
        ...
        constructor() {
            ...
            this.defaultColor = __runInitializers(this, _defaultColor_initializers, '');
            // #enddocregion defaultColor
            this.appHighlight = (__runInitializers(this, _defaultColor_extraInitializers), __runInitializers(this, _appHighlight_initializers, ''));
    ...
    (() => {
        ...
        _defaultColor_decorators = [(0, core_1.Input)()];
        ...
        __esDecorate(null, null, _defaultColor_decorators, { kind: "field", name: "defaultColor", static: false, private: false, access: { has: obj => "defaultColor" in obj, get: obj => obj.defaultColor, set: (obj, value) => { obj.defaultColor = value; } }, metadata: _metadata }, _defaultColor_initializers, _defaultColor_extraInitializers);
