...
exports.HeroService = exports.SomeService = void 0;
// #docregion
...
let SomeService = (() => {
    ...
    let _classThis;
    var SomeService = _classThis = class {
    };
    __setFunctionName(_classThis, "SomeService");
    (() => {
...
let HeroService = (() => {
    ...
    var HeroService = _classThis = class {
        ...
        someMethod() {
            (0, core_1.runInInjectionContext)(this.environmentInjector, () => {
                (0, core_1.inject)(SomeService); // Do what you need with the injected service
            });
        }
    };
