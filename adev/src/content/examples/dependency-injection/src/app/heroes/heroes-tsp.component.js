...
exports.HeroesTspComponent = void 0;
...
let HeroesTspComponent = (() => {
  ...
  `,
            imports: [hero_list_component_1.HeroListComponent],
        })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var HeroesTspComponent = _classThis = class {
    };
    __setFunctionName(_classThis, "HeroesTspComponent");
    (() => {
...
exports.HeroesTspComponent = HeroesTspComponent;
