...
const car_no_di_1 = require("./car-no-di");
const car_factory_1 = require("./car-factory");
const car_creations_1 = require("./car-creations");
const car_injector_1 = require("./car-injector");
let CarComponent = (() => {
  ...
  `,
    ...
    let _classThis;
    var CarComponent = _classThis = class {
        constructor() {
            this.factoryCar = new car_factory_1.CarFactory().createCar();
            this.injectorCar = (0, car_injector_1.useInjector)();
            this.noDiCar = new car_no_di_1.Car();
            this.simpleCar = (0, car_creations_1.simpleCar)();
            this.superCar = (0, car_creations_1.superCar)();
            this.testCar = (0, car_creations_1.testCar)();
            this.car = (0, core_1.inject)(car_1.Car);
        }
    };
    __setFunctionName(_classThis, "CarComponent");
    (() => {
