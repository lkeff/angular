...
exports.ActorFormTemplateComponent = void 0;
...
let ActorFormTemplateComponent = (() => {
    let _classDecorators = [(0, core_1.Component)({
            ...
            imports: [
                unambiguous_role_directive_1.UnambiguousRoleValidatorDirective,
                forms_1.FormsModule,
                forbidden_name_directive_1.ForbiddenValidatorDirective,
                role_directive_1.UniqueRoleValidatorDirective,
            ],
        })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var ActorFormTemplateComponent = _classThis = class {
        constructor() {
            this.skills = ['Method Acting', 'Singing', 'Dancing', 'Swordfighting'];
            this.actor = { name: 'Tom Cruise', role: 'Romeo', skill: this.skills[3] };
        }
    };
    __setFunctionName(_classThis, "ActorFormTemplateComponent");
    (() => {
...
exports.ActorFormTemplateComponent = ActorFormTemplateComponent;
