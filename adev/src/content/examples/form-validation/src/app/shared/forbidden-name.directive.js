...
exports.ForbiddenValidatorDirective = void 0;
...
let ForbiddenValidatorDirective = (() => {
    ...
    let _classThis;
    var ForbiddenValidatorDirective = _classThis = class {
        constructor() {
            this.forbiddenName = (0, core_1.input)('', { alias: 'appForbiddenName' });
        }
        validate(control) {
    ...
    __setFunctionName(_classThis, "ForbiddenValidatorDirective");
    (() => {
