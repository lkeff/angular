...
exports.HeroListGroupsComponent = void 0;
  ...
  `,
            ...
            animations: [
                (0, animations_1.trigger)('flyInOut', [
                    (0, animations_1.state)('in', (0, animations_1.style)({
                        width: '*',
                        transform: 'translateX(0)',
                        opacity: 1,
                    })),
                    (0, animations_1.transition)(':enter', [
                        (0, animations_1.style)({ width: 10, transform: 'translateX(50px)', opacity: 0 }),
                        (0, animations_1.group)([
                            (0, animations_1.animate)('0.3s 0.1s ease', (0, animations_1.style)({
                                transform: 'translateX(0)',
                                width: '*',
                            })),
                            (0, animations_1.animate)('0.3s ease', (0, animations_1.style)({
                                opacity: 1,
                            })),
                        ]),
                    ]),
                    (0, animations_1.transition)(':leave', [
                        (0, animations_1.group)([
                            ...
                            (0, animations_1.animate)('0.3s 0.2s ease', (0, animations_1.style)({
                                opacity: 0,
                            })),
                        ]),
                    ]),
    ...
    var HeroListGroupsComponent = _classThis = class {
        removeHero(id) {
            this.remove.emit(id);
        }
        constructor() {
    ...
    __setFunctionName(_classThis, "HeroListGroupsComponent");
    (() => {
