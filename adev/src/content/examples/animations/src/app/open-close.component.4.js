...
exports.OpenCloseChildComponent = void 0;
// #docplaster
// #docregion
...
let OpenCloseChildComponent = (() => {
    ...
    let _classThis;
    var OpenCloseChildComponent = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "OpenCloseChildComponent");
    (() => {
...
exports.OpenCloseChildComponent = OpenCloseChildComponent;
// #enddocregion toggle-animation
