...
exports.OpenClosePageComponent = void 0;
const core_1 = require("@angular/core");
const open_close_component_1 = require("./open-close.component");
let OpenClosePageComponent = (() => {
  ...
  `,
            imports: [open_close_component_1.OpenCloseComponent],
        })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var OpenClosePageComponent = _classThis = class {
        constructor() {
            this.logging = false;
        }
        toggleLogging() {
    ...
    __setFunctionName(_classThis, "OpenClosePageComponent");
    (() => {
...
exports.OpenClosePageComponent = OpenClosePageComponent;
