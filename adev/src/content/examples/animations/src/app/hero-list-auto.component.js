...
exports.HeroListAutoComponent = void 0;
...
let HeroListAutoComponent = (() => {
    let _classDecorators = [(0, core_1.Component)({
            ...
            // #docregion auto-calc
            animations: [
                (0, animations_1.trigger)('shrinkOut', [
                    (0, animations_1.state)('in', (0, animations_1.style)({ height: '*' })),
                    (0, animations_1.transition)('* => void', [(0, animations_1.style)({ height: '*' }), (0, animations_1.animate)(250, (0, animations_1.style)({ height: 0 }))]),
                ]),
            ],
    ...
    var HeroListAutoComponent = _classThis = class {
        removeHero(id) {
            this.remove.emit(id);
        }
        constructor() {
    ...
    __setFunctionName(_classThis, "HeroListAutoComponent");
    (() => {
