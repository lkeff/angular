...
exports.OpenCloseKeyframeComponent = void 0;
...
let OpenCloseKeyframeComponent = (() => {
    let _classDecorators = [(0, core_1.Component)({
            ...
            animations: [
                ...
                (0, animations_1.trigger)('openClose', [
                    ...
                    (0, animations_1.state)('close', (0, animations_1.style)({
                        height: '100px',
                        opacity: 0.5,
                    ...
                    (0, animations_1.transition)('* => *', [
                        (0, animations_1.animate)('1s', (0, animations_1.keyframes)([
                            (0, animations_1.style)({ opacity: 0.1, offset: 0.1 }),
                            (0, animations_1.style)({ opacity: 0.6, offset: 0.2 }),
                            (0, animations_1.style)({ opacity: 1, offset: 0.5 }),
                            (0, animations_1.style)({ opacity: 0.2, offset: 0.7 }),
                        ])),
                    ]),
                ]),
    ...
    var OpenCloseKeyframeComponent = _classThis = class {
        toggle() {
    ...
    __setFunctionName(_classThis, "OpenCloseKeyframeComponent");
    (() => {
...
exports.OpenCloseKeyframeComponent = OpenCloseKeyframeComponent;
