...
exports.StaggerComponent = void 0;
// #docplaster
// #docregion
...
let StaggerComponent = (() => {
                ...
                (0, animations_1.trigger)('pageAnimations', [
                    (0, animations_1.transition)(':enter', [
                        (0, animations_1.query)('.item', [
                            ...
                            (0, animations_1.stagger)(200, [(0, animations_1.animate)('500ms ease-in', (0, animations_1.style)({ opacity: 1, transform: 'none' }))]),
                        ]),
                    ]),
                ]),
            ],
    ...
    var StaggerComponent = _classThis = class {
        constructor() {
            this.items = __runInitializers(this, _items_initializers, [1, 2, 3]);
            __runInitializers(this, _items_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "StaggerComponent");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _items_decorators = [(0, core_1.HostBinding)('@pageAnimations')];
...
exports.StaggerComponent = StaggerComponent;
