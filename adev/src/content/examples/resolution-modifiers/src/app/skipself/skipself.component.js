...
exports.SkipselfComponent = void 0;
const core_1 = require("@angular/core");
const leaf_service_1 = require("../leaf.service");
...
let SkipselfComponent = (() => {
    let _classDecorators = [(0, core_1.Component)({
            ...
            providers: [{ provide: leaf_service_1.LeafService, useValue: { emoji: '🍁' } }],
        })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var SkipselfComponent = _classThis = class {
        // Use @SkipSelf() in the constructor
        constructor(leaf) {
            this.leaf = leaf;
        }
    };
    __setFunctionName(_classThis, "SkipselfComponent");
    (() => {
...
exports.SkipselfComponent = SkipselfComponent;
