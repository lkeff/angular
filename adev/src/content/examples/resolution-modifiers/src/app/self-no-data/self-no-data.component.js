...
exports.SelfNoDataComponent = void 0;
...
let SelfNoDataComponent = (() => {
    ...
    let _classThis;
    var SelfNoDataComponent = _classThis = class {
        constructor(leaf) {
            this.leaf = leaf;
        }
    };
    __setFunctionName(_classThis, "SelfNoDataComponent");
    (() => {
...
exports.SelfNoDataComponent = SelfNoDataComponent;
