...
const hero_switch_components_1 = require("./hero-switch.components");
const hero_component_1 = require("./hero.component");
const unless_directive_1 = require("./unless.directive");
const trigonometry_directive_1 = require("./trigonometry.directive");
...
let AppComponent = (() => {
    let _classDecorators = [(0, core_1.Component)({
            ...
            imports: [
                ...
                trigonometry_directive_1.TrigonometryDirective,
            ],
        })];
