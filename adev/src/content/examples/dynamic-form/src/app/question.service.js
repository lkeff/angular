...
const question_dropdown_1 = require("./question-dropdown");
const question_textbox_1 = require("./question-textbox");
...
let QuestionService = (() => {
    ...
    let _classThis;
    var QuestionService = _classThis = class {
        ...
        getQuestions() {
            ...
            return (0, rxjs_1.of)(questions.sort((a, b) => a.order - b.order));
        }
    };
