...
exports.DynamicFormQuestionComponent = void 0;
// #docregion
...
let DynamicFormQuestionComponent = (() => {
    ...
    let _classThis;
    var DynamicFormQuestionComponent = _classThis = class {
        constructor() {
            this.question = core_1.input.required();
            this.form = core_1.input.required();
        }
        get isValid() {
            return this.form().controls[this.question().key].valid;
        }
    };
    __setFunctionName(_classThis, "DynamicFormQuestionComponent");
    (() => {
