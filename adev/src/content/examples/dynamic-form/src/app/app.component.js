...
let AppComponent = (() => {
  ...
  `,
            ...
            imports: [common_1.AsyncPipe, dynamic_form_component_1.DynamicFormComponent],
        })];
    ...
    var AppComponent = _classThis = class {
        constructor() {
            this.questions$ = (0, core_1.inject)(question_service_1.QuestionService).getQuestions();
        }
    };
