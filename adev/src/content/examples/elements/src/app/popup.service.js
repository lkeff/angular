...
let PopupService = (() => {
    ...
    let _classThis;
    var PopupService = _classThis = class {
        ...
        showAsComponent(message) {
            ...
            const popupComponentRef = (0, core_1.createComponent)(popup_component_1.PopupComponent, {
    ...
    __setFunctionName(_classThis, "PopupService");
    (() => {
