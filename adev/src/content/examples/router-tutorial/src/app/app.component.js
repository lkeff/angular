...
let AppComponent = (() => {
    let _classDecorators = [(0, core_1.Component)({
            selector: 'app-root',
            imports: [router_1.RouterOutlet, router_1.RouterLink, router_1.RouterLinkActive, crisis_list_component_1.CrisisListComponent, heroes_list_component_1.HeroesListComponent],
