...
require("zone.js/plugins/zone-patch-canvas");
...
let CanvasComponent = (() => {
    ...
    var CanvasComponent = _classThis = class {
        ngAfterViewInit() {
        ...
        constructor() {
            this.blobSize = 0;
            this.sampleCanvas = __runInitializers(this, _sampleCanvas_initializers, void 0);
            __runInitializers(this, _sampleCanvas_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "CanvasComponent");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _sampleCanvas_decorators = [(0, core_1.ViewChild)('sampleCanvas')];
        __esDecorate(null, null, _sampleCanvas_decorators, { kind: "field", name: "sampleCanvas", static: false, private: false, access: { has: obj => "sampleCanvas" in obj, get: obj => obj.sampleCanvas, set: (obj, value) => { obj.sampleCanvas = value; } }, metadata: _metadata }, _sampleCanvas_initializers, _sampleCanvas_extraInitializers);
