...
let HighlightDirective = (() => {
    let _classDecorators = [(0, core_1.Directive)({ selector: '[highlight]' })];
    ...
    var HighlightDirective = _classThis = class {
        constructor() {
            ...
            this.bgColor = __runInitializers(this, _bgColor_initializers, '');
            this.el = (__runInitializers(this, _bgColor_extraInitializers), (0, core_1.inject)(core_1.ElementRef));
    ...
    (() => {
        ...
        _bgColor_decorators = [(0, core_1.Input)('highlight')];
