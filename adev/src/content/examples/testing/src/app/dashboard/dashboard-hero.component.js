...
let DashboardHeroComponent = (() => {
  ...
  `,
    ...
    let _classThis;
    var DashboardHeroComponent = _classThis = class {
        constructor() {
            this.hero = core_1.input.required();
            this.selected = (0, core_1.output)();
        }
        click() {
            this.selected.emit(this.hero());
        }
    };
    __setFunctionName(_classThis, "DashboardHeroComponent");
    (() => {
