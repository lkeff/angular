...
let HeroDetailService = (() => {
    ...
    let _classThis;
    var HeroDetailService = _classThis = class {
        constructor() {
        ...
        getHero(id) {
            ...
            return this.heroService.getHero(id).pipe((0, operators_1.map)((hero) => (hero ? Object.assign({}, hero) : null)));
        }
        saveHero(hero) {
            return this.heroService.updateHero(hero);
        }
    };
    __setFunctionName(_classThis, "HeroDetailService");
    (() => {
