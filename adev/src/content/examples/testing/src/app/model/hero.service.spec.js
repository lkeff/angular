...
const async_observable_helpers_1 = require("../../testing/async-observable-helpers");
...
describe('HeroesService (with spies)', () => {
    ...
    it('should return expected heroes (HttpClient called once)', (done) => {
        ...
        httpClientSpy.get.and.returnValue((0, async_observable_helpers_1.asyncData)(expectedHeroes));
    ...
    it('should return an error when the server returns a 404', (done) => {
        const errorResponse = new http_1.HttpErrorResponse({
            error: 'test 404 error',
            status: 404,
            statusText: 'Not Found',
        });
        httpClientSpy.get.and.returnValue((0, async_observable_helpers_1.asyncError)(errorResponse));
        heroService.getHeroes().subscribe({
...
describe('HeroesService (with mocks)', () => {
    ...
    beforeEach(() => {
        ...
        httpClient = testing_2.TestBed.inject(http_1.HttpClient);
        httpTestingController = testing_2.TestBed.inject(testing_1.HttpTestingController);
        heroService = testing_2.TestBed.inject(hero_service_1.HeroService);
    });
    afterEach(() => {
    ...
    describe('#getHeroes', () => {
        ...
        it('should return expected heroes (called once)', () => {
            heroService.getHeroes().subscribe({
                next: (heroes) => expect(heroes).withContext('should return expected heroes').toEqual(expectedHeroes),
                error: fail,
            });
        ...
        it('should be OK returning no heroes', () => {
            heroService.getHeroes().subscribe({
                next: (heroes) => expect(heroes.length).withContext('should have empty heroes array').toEqual(0),
                error: fail,
            });
            const req = httpTestingController.expectOne(heroService.heroesUrl);
    ...
    describe('#updateHero', () => {
        ...
        it('should update a hero and return it', () => {
            ...
            const expectedResponse = new http_1.HttpResponse({
                status: 200,
                statusText: 'OK',
                body: updateHero,
            });
