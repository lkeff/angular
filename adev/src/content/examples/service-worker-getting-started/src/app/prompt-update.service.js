...
exports.PromptUpdateService = void 0;
// #docplaster
...
let PromptUpdateService = (() => {
    ...
    let _classThis;
    var PromptUpdateService = _classThis = class {
        constructor() {
            const swUpdate = (0, core_1.inject)(service_worker_1.SwUpdate);
            ...
            // #docregion sw-replicate-available
            // ...
            const updatesAvailable = swUpdate.versionUpdates.pipe((0, operators_1.filter)((evt) => evt.type === 'VERSION_READY'), (0, operators_1.map)((evt) => ({
    ...
    __setFunctionName(_classThis, "PromptUpdateService");
    (() => {
...
exports.PromptUpdateService = PromptUpdateService;
// #enddocregion sw-version-ready
