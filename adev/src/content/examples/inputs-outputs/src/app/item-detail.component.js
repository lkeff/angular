...
exports.ItemDetailComponent = void 0;
// #docplaster
// #docregion use-input
...
let ItemDetailComponent = (() => {
    ...
    var ItemDetailComponent = _classThis = class {
        constructor() {
            this.item = __runInitializers(this, _item_initializers, ''); // decorate the property with @Input()
            __runInitializers(this, _item_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "ItemDetailComponent");
    (() => {
