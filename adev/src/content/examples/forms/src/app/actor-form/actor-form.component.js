...
exports.ActorFormComponent = void 0;
// #docplaster
// #docregion , v1, final
...
let ActorFormComponent = (() => {
    let _classDecorators = [(0, core_1.Component)({
            ...
            imports: [forms_1.FormsModule, common_1.JsonPipe],
        })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var ActorFormComponent = _classThis = class {
        constructor() {
            // #enddocregion imports
            this.skills = ['Method Acting', 'Singing', 'Dancing', 'Swordfighting'];
            this.model = new actor_1.Actor(18, 'Tom Cruise', this.skills[3], 'CW Productions');
            // #docregion submitted
        ...
        newActor() {
            this.model = new actor_1.Actor(42, '', '');
        }
        // #enddocregion final, new-actor
        heroine() {
            // #docregion Marilyn
            const myActress = new actor_1.Actor(42, 'Marilyn Monroe', 'Singing');
    ...
    __setFunctionName(_classThis, "ActorFormComponent");
    (() => {
