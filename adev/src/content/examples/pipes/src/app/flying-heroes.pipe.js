...
exports.FlyingHeroesImpurePipe = exports.FlyingHeroesPipe = void 0;
// #docregion
// #docregion pure
...
let FlyingHeroesPipe = (() => {
    ...
    let _classThis;
    var FlyingHeroesPipe = _classThis = class {
        transform(allHeroes) {
            // #docregion filter
    ...
    __setFunctionName(_classThis, "FlyingHeroesPipe");
    (() => {
...
let FlyingHeroesImpurePipe = (() => {
    ...
    var FlyingHeroesImpurePipe = _classThis = class extends _classSuper {
    };
    __setFunctionName(_classThis, "FlyingHeroesImpurePipe");
    (() => {
        var _a;
