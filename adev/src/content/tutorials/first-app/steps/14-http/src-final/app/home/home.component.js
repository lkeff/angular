...
const housing_location_component_1 = require("../housing-location/housing-location.component");
  ...
  `,
    ...
    var HomeComponent = _classThis = class {
        ...
        filterResults(text) {
            ...
            this.filteredLocationList = this.housingLocationList.filter((housingLocation) => housingLocation === null || housingLocation === void 0 ? void 0 : housingLocation.city.toLowerCase().includes(text.toLowerCase()));
        }
    };
