...
const table_of_contents_loader_service_1 = require("./table-of-contents-loader.service");
describe('TableOfContentsLoader', () => {
    let service;
    beforeEach(() => {
        testing_1.TestBed.configureTestingModule({
            providers: [table_of_contents_loader_service_1.TableOfContentsLoader],
        });
        service = testing_1.TestBed.inject(table_of_contents_loader_service_1.TableOfContentsLoader);
    });
    ...
    it(`should not display in ToC heading with ${table_of_contents_loader_service_1.TOC_SKIP_CONTENT_MARKER} attr`, () => {
