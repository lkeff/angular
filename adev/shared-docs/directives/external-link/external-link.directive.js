...
let ExternalLink = (() => {
    ...
    let _classThis;
    var ExternalLink = _classThis = class {
        constructor() {
            this.anchor = (0, core_1.inject)(core_1.ElementRef);
        ...
        setAnchorTarget() {
            ...
            if ((0, index_1.isExternalLink)(this.anchor.nativeElement.href)) {
                this.target = '_blank';
            }
        }
    };
    __setFunctionName(_classThis, "ExternalLink");
    (() => {
