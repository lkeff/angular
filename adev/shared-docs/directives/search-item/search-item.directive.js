...
let SearchItem = (() => {
    ...
    var SearchItem = _classThis = class {
        constructor() {
            this.item = __runInitializers(this, _item_initializers, void 0);
            this.disabled = (__runInitializers(this, _item_extraInitializers), __runInitializers(this, _disabled_initializers, false));
            this.elementRef = (__runInitializers(this, _disabled_extraInitializers), (0, core_1.inject)((core_1.ElementRef)));
            this._isActive = (0, core_1.signal)(false);
        }
        get isActive() {
    ...
    __setFunctionName(_classThis, "SearchItem");
    (() => {
