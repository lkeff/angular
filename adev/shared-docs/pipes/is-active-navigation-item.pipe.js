...
exports.IsActiveNavigationItem = void 0;
...
let IsActiveNavigationItem = (() => {
    ...
    let _classThis;
    var IsActiveNavigationItem = _classThis = class {
    ...
    __setFunctionName(_classThis, "IsActiveNavigationItem");
    (() => {
...
exports.IsActiveNavigationItem = IsActiveNavigationItem;
