...
const docs_viewer_component_1 = require("./docs-viewer.component");
...
describe('DocViewer', () => {
  ...
  `;
    beforeEach(() => {
        ...
        navigationStateSpy = jasmine.createSpyObj(services_1.NavigationState, ['activeNavigationItem']);
    });
    beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
        yield testing_1.TestBed.configureTestingModule({
            imports: [docs_viewer_component_1.DocViewer],
            providers: [
                ...
                { provide: services_1.NavigationState, useValue: navigationStateSpy },
            ],
        }).compileComponents();
        fixture = testing_1.TestBed.createComponent(docs_viewer_component_1.DocViewer);
        fixture.detectChanges();
    }));
    it('should load doc into innerHTML', () => {
        const fixture = testing_1.TestBed.createComponent(docs_viewer_component_1.DocViewer);
        fixture.componentRef.setInput('docContent', 'hello world');
        fixture.detectChanges();
        expect(fixture.nativeElement.innerHTML).toBe('hello world');
    });
    it('should instantiate example viewer in snippet view mode', () => __awaiter(void 0, void 0, void 0, function* () {
        const fixture = testing_1.TestBed.createComponent(docs_viewer_component_1.DocViewer);
        fixture.componentRef.setInput('docContent', exampleDocContentWithExampleViewerPlaceholders);
        fixture.detectChanges();
        yield fixture.whenStable();
        const exampleViewer = fixture.debugElement.query(platform_browser_1.By.directive(example_viewer_component_1.ExampleViewer));
        expect(exampleViewer).not.toBeNull();
        expect(exampleViewer.componentInstance.view()).toBe(example_viewer_component_1.CodeExampleViewMode.SNIPPET);
        const checkIcon = fixture.debugElement.query(platform_browser_1.By.directive(icon_component_1.IconComponent));
        expect(checkIcon.nativeElement.classList).toContain(`material-symbols-outlined`);
        expect(checkIcon.nativeElement.classList).toContain(`docs-check`);
        expect(checkIcon.nativeElement.innerHTML).toBe('check');
    }));
    it('should display example viewer in multi file mode when provided example is multi file snippet', () => __awaiter(void 0, void 0, void 0, function* () {
        const fixture = testing_1.TestBed.createComponent(docs_viewer_component_1.DocViewer);
        fixture.componentRef.setInput('docContent', exampleDocContentWithExpandedExampleViewerPlaceholders);
        fixture.detectChanges();
        yield fixture.whenStable();
        const exampleViewer = fixture.debugElement.query(platform_browser_1.By.directive(example_viewer_component_1.ExampleViewer));
        expect(exampleViewer).not.toBeNull();
        expect(exampleViewer.componentInstance.view()).toBe(example_viewer_component_1.CodeExampleViewMode.MULTI_FILE);
        expect(exampleViewer.componentInstance.tabs().length).toBe(2);
    }));
    it('should render Icon component when content has <docs-icon> element', () => __awaiter(void 0, void 0, void 0, function* () {
        const fixture = testing_1.TestBed.createComponent(docs_viewer_component_1.DocViewer);
        const renderComponentSpy = spyOn(fixture.componentInstance, 'renderComponent');
        fixture.componentRef.setInput('docContent', exampleContentWithIcons);
        fixture.detectChanges();
        yield fixture.whenStable();
        expect(renderComponentSpy).toHaveBeenCalledTimes(2);
        expect(renderComponentSpy.calls.allArgs()[0][0]).toBe(icon_component_1.IconComponent);
        expect(renderComponentSpy.calls.allArgs()[0][1].innerText).toEqual(`light_mode`);
        expect(renderComponentSpy.calls.allArgs()[1][0]).toBe(icon_component_1.IconComponent);
        expect(renderComponentSpy.calls.allArgs()[1][1].innerText).toEqual(`dark_mode`);
    }));
    it('should render Breadcrumb component when content has <docs-breadcrumb> element', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect(renderComponentSpy.calls.allArgs()[0][0]).toBe(breadcrumb_component_1.Breadcrumb);
    }));
    it('should render copy source code buttons', () => __awaiter(void 0, void 0, void 0, function* () {
        const fixture = testing_1.TestBed.createComponent(docs_viewer_component_1.DocViewer);
        fixture.componentRef.setInput('docContent', exampleContentWithCodeSnippet);
        fixture.detectChanges();
        yield fixture.whenStable();
        const copySourceCodeButton = fixture.debugElement.query(platform_browser_1.By.directive(copy_source_code_button_component_1.CopySourceCodeButton));
        expect(copySourceCodeButton).toBeTruthy();
    }));
    it('should render ToC', () => __awaiter(void 0, void 0, void 0, function* () {
        const fixture = testing_1.TestBed.createComponent(docs_viewer_component_1.DocViewer);
        const renderComponentSpy = spyOn(fixture.componentInstance, 'renderComponent');
        ...
        expect(renderComponentSpy.calls.allArgs()[0][0]).toBe(table_of_contents_component_1.TableOfContents);
    }));
    it('should not render ToC when hasToc is false', () => __awaiter(void 0, void 0, void 0, function* () {
        const fixture = testing_1.TestBed.createComponent(docs_viewer_component_1.DocViewer);
        const renderComponentSpy = spyOn(fixture.componentInstance, 'renderComponent');
        fixture.componentRef.setInput('docContent', exampleContentWithHeadings);
