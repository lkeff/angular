...
let Breadcrumb = (() => {
    ...
    let _classThis;
    var Breadcrumb = _classThis = class {
        constructor() {
            this.navigationState = (0, core_1.inject)(index_1.NavigationState);
            this.breadcrumbItems = (0, core_1.computed)(() => {
                var _a;
                const breadcrumbs = [];
                let activeItem = (_a = this.navigationState.activeNavigationItem()) === null || _a === void 0 ? void 0 : _a.parent;
    ...
    __setFunctionName(_classThis, "Breadcrumb");
    (() => {
