...
const is_active_navigation_item_pipe_1 = require("../../pipes/is-active-navigation-item.pipe");
...
let NavigationList = (() => {
    let _classDecorators = [(0, core_1.Component)({
            ...
            imports: [
                ...
                is_active_navigation_item_pipe_1.IsActiveNavigationItem,
    ...
    let _classThis;
    var NavigationList = _classThis = class {
        constructor() {
            this.navigationItems = core_1.input.required();
            this.displayItemsToLevel = (0, core_1.input)(2);
            this.collapsableLevel = (0, core_1.input)();
            this.expandableLevel = (0, core_1.input)(2);
            this.isDropdownView = (0, core_1.input)(false);
            this.linkClicked = (0, core_1.output)();
    ...
    __setFunctionName(_classThis, "NavigationList");
    (() => {
