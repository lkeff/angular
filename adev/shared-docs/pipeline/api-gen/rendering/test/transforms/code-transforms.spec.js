...
describe('makeGenericsText', () => {
    it('should return an empty string if no generics are provided', () => {
        expect((0, code_transforms_1.makeGenericsText)(undefined)).toBe('');
        expect((0, code_transforms_1.makeGenericsText)([])).toBe('');
    });
    ...
    it('should handle a single generic type with both constraint and default value', () => {
        ...
        expect((0, code_transforms_1.makeGenericsText)(generics)).toBe('<T extends string = number>');
    });
    it('should handle multiple generic types without constraints or defaults', () => {
        ...
        expect((0, code_transforms_1.makeGenericsText)(generics)).toBe('<T, U>');
    });
    it('should handle multiple generic types with constraints and defaults', () => {
        ...
        expect((0, code_transforms_1.makeGenericsText)(generics)).toBe('<T extends string = number, U extends boolean, V = any>');
    });
    it('should handle complex generics with mixed constraints and defaults', () => {
        ...
        expect((0, code_transforms_1.makeGenericsText)(generics)).toBe('<A extends string, B, C = number, D extends boolean = true>');
    });
});
