...
describe('jsdoc transforms', () => {
    it('should transform links', () => {
        (0, symbol_context_1.setCurrentSymbol)('Router');
        (0, symbol_context_1.setSymbols)(new Map([
            ['Route', 'test'],
            ['Router', 'test'],
        ...
        const entry = (0, jsdoc_transforms_1.addHtmlAdditionalLinks)({
            jsdocTags: [
                {
                    name: 'see',
    ...
    it('should throw on invalid relatie @link', () => {
        const entryFn = () => (0, jsdoc_transforms_1.addHtmlAdditionalLinks)({
            jsdocTags: [
                {
                    name: 'see',
                    comment: '{@link cli/build ng build}',
