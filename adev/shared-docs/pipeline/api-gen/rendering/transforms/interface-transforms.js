...
exports.getInterfaceRenderable = getInterfaceRenderable;
...
function getInterfaceRenderable(entry, moduleName, repo) {
    return (0, jsdoc_transforms_1.setEntryFlags)((0, code_transforms_1.addRenderableCodeToc)((0, member_transforms_1.addRenderableMembers)((0, jsdoc_transforms_1.addHtmlAdditionalLinks)((0, jsdoc_transforms_1.addHtmlUsageNotes)((0, jsdoc_transforms_1.addHtmlJsDocTagComments)((0, jsdoc_transforms_1.addHtmlDescription)((0, repo_1.addRepo)((0, module_name_1.addModuleName)(entry, moduleName), repo))))))));
}
