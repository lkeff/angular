...
exports.replaceKeywordFromShikiHtml = replaceKeywordFromShikiHtml;
let highlighter;
function initHighlighter() {
    return __awaiter(this, void 0, void 0, function* () {
        const { createHighlighter } = yield Promise.resolve().then(() => __importStar(require('shiki')));
        highlighter = yield createHighlighter({
...
function codeToHtml(code, language) {
    const html = highlighter.codeToHtml(code, {
        lang: language !== null && language !== void 0 ? language : 'text',
        themes: {
            light: 'github-light',
            dark: 'github-dark',
        },
...
function replaceKeywordFromShikiHtml(keyword, shikiHtml, replaceWith = '') {
    return (shikiHtml
