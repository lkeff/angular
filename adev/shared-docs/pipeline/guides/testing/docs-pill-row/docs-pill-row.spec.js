...
describe('markdown to html', () => {
    ...
    beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
        const markdownContent = yield (0, promises_1.readFile)(runfiles_1.runfiles.resolvePackageRelative('docs-pill-row/docs-pill-row.md'), { encoding: 'utf-8' });
    ...
    it('should create a nav container with all of the docs pills inside', () => {
        ...
        expect(navEl === null || navEl === void 0 ? void 0 : navEl.children.length).toBe(2);
        expect(navEl === null || navEl === void 0 ? void 0 : navEl.classList.contains('docs-pill-row')).toBeTrue();
    });
});
