...
describe('markdown to html', () => {
    ...
    beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const markdownContent = yield (0, promises_1.readFile)(runfiles_1.runfiles.resolvePackageRelative('docs-code-multifile/docs-code-multifile.md'), { encoding: 'utf-8' });
    ...
    it('converts triple ticks into a code block', () => {
        ...
        expect((_a = codeBlockOne === null || codeBlockOne === void 0 ? void 0 : codeBlockOne.textContent) === null || _a === void 0 ? void 0 : _a.trim()).toBe('this is code');
        const codeBlockTwo = multiFileEl.children[1];
        expect(codeBlockTwo).toBeTruthy();
        expect((_b = codeBlockTwo === null || codeBlockTwo === void 0 ? void 0 : codeBlockTwo.textContent) === null || _b === void 0 ? void 0 : _b.trim()).toBe('this is also code');
    });
});
