...
describe('markdown to html', () => {
    ...
    beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
        const markdownContent = yield (0, promises_1.readFile)(runfiles_1.runfiles.resolvePackageRelative('text/text.md'), {
            encoding: 'utf-8',
        });
    ...
    it('should wrap emoji in custom classes', () => {
        ...
        expect(emoji === null || emoji === void 0 ? void 0 : emoji.textContent).toContain('😎');
    });
    it('should not apply a custom class if no emoji is present', () => {
        ...
        expect(noemoji === null || noemoji === void 0 ? void 0 : noemoji.textContent).not.toContain('😎');
    });
});
