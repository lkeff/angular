...
exports.docsAlertExtension = exports.AlertSeverityLevel = void 0;
...
exports.docsAlertExtension = {
    ...
    tokenizer(src) {
        ...
        for (const key of Object.keys(AlertSeverityLevel)) {
            ...
            if (possibleMatch === null || possibleMatch === void 0 ? void 0 : possibleMatch[1]) {
                match = {
                    severityLevel: key,
                    alert: possibleMatch,
                };
        ...
        if (match === null || match === void 0 ? void 0 : match.alert) {
            const token = {
                type: 'docs-alert',
                raw: match.alert[0],
