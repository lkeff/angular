...
exports.bootstrapClientApp = bootstrapClientApp;
/**
 * @license
...
function navigateTo(url) {
    return __awaiter(this, void 0, void 0, function* () {
        yield protractor_1.browser.driver.get(protractor_1.browser.baseUrl + url);
    });
}
function bootstrapClientApp() {
    return __awaiter(this, void 0, void 0, function* () {
        yield protractor_1.browser.executeScript('doBootstrap()');
    });
}
