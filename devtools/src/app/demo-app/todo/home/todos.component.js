...
const todos_pipe_1 = require("./todos.pipe");
...
let TodosComponent = (() => {
    let _classDecorators = [(0, core_1.Component)({
            ...
            selector: 'app-todos',
            imports: [router_1.RouterLink, todo_component_1.TodoComponent, tooltip_directive_1.TooltipDirective, sample_pipe_1.SamplePipe, todos_pipe_1.TodosFilter],
        })];
    ...
    var TodosComponent = _classThis = class {
        constructor() {
            ...
            this.update = (0, core_1.output)();
            this.delete = (0, core_1.output)();
