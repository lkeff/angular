...
const highlighter = __importStar(require("./highlighter"));
describe('highlighter', () => {
    ...
    xdescribe('highlightHydrationElement', () => {
        ...
        it('should show hydration overlay with svg', () => {
            ...
            expect(overlay === null || overlay === void 0 ? void 0 : overlay.getBoundingClientRect().width).toBe(500);
            expect(overlay === null || overlay === void 0 ? void 0 : overlay.getBoundingClientRect().height).toBe(400);
        ...
        it('should show hydration overlay without svg (too small)', () => {
            ...
            expect(document.body.querySelectorAll('svg').length).toBe(0);
            const overlay = document.body.querySelector('.ng-devtools-overlay');
            expect(overlay === null || overlay === void 0 ? void 0 : overlay.getBoundingClientRect().width).toBe(25);
            expect(overlay === null || overlay === void 0 ? void 0 : overlay.getBoundingClientRect().height).toBe(20);
            highlighter.removeHydrationHighlights();
            expect(document.body.querySelectorAll('div').length).toBe(0);
            expect(document.body.querySelectorAll('svg').length).toBe(0);
        });
