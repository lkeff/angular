...
const start = (onFrame) => {
    ...
    (0, _1.initializeOrGetDirectiveForestHooks)().profiler.subscribe(hooks);
};
exports.start = start;
const stop = () => {
    const directiveForestHooks = (0, _1.initializeOrGetDirectiveForestHooks)();
    const result = flushBuffer(directiveForestHooks);
    (0, _1.initializeOrGetDirectiveForestHooks)().profiler.unsubscribe(hooks);
    hooks = {};
    inProgress = false;
    return result;
};
...
const startEvent = (map, directive, label) => {
    const name = (0, highlighter_1.getDirectiveName)(directive);
    ...
    return {
        ...
        onCreate(directive, node, _, isComponent, position) {
            eventMap.set(directive, {
                ...
                name: (0, highlighter_1.getDirectiveName)(directive),
                isComponent,
                lifecycle: {},
                outputs: {},
            });
        ...
        onChangeDetectionStart(component, node) {
            ...
            if (!inChangeDetection) {
                ...
                (0, utils_1.runOutsideAngular)(() => {
                    Promise.resolve().then(() => {
                        ...
                        onFrame(flushBuffer((0, _1.initializeOrGetDirectiveForestHooks)(), source));
                    });
                });
            }
            if (!eventMap.has(component)) {
                eventMap.set(component, {
                    isElement: (0, utils_1.isCustomElement)(node),
                    name: (0, highlighter_1.getDirectiveName)(component),
                    isComponent: true,
                    changeDetection: 0,
                    lifecycle: {},
                    outputs: {},
        ...
        onDestroy(directive, node, _, isComponent, __) {
            ...
            if (!eventMap.has(directive)) {
                eventMap.set(directive, {
                    isElement: isComponent && (0, utils_1.isCustomElement)(node),
                    name: (0, highlighter_1.getDirectiveName)(directive),
                    isComponent,
                    lifecycle: {},
                    outputs: {},
        ...
        onOutputStart(componentOrDirective, outputName, node, isComponent) {
            ...
            if (!eventMap.has(componentOrDirective)) {
                eventMap.set(componentOrDirective, {
                    isElement: (0, utils_1.isCustomElement)(node),
                    name: (0, highlighter_1.getDirectiveName)(componentOrDirective),
                    isComponent,
                    lifecycle: {},
                    outputs: {},
                });
    ...
    const traverse = (node, children = frame.directives) => {
        ...
        const directives = node.directives.map((d) => {
            return {
                isComponent: false,
                isElement: false,
                name: (0, highlighter_1.getDirectiveName)(d.instance),
                outputs: {},
                lifecycle: {},
            };
        });
        if (node.component) {
            directives.push({
                ...
                lifecycle: {},
                outputs: {},
                name: (0, highlighter_1.getDirectiveName)(node.component.instance),
            });
        }
        const result = {
            children: [],
