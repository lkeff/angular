...
const state_serializer_1 = require("./state-serializer");
const QUERY_1_1 = [];
const QUERY_1_2 = [
    {
        name: 'nested',
...
describe('deeplySerializeSelectedProperties', () => {
    it('should work with empty queries', () => {
        const result = (0, state_serializer_1.deeplySerializeSelectedProperties)(dir1, QUERY_1_1);
    ...
    it('should collect not specified but existing props below level', () => {
        const result = (0, state_serializer_1.deeplySerializeSelectedProperties)(dir1, QUERY_1_2);
        expect(result).toEqual({
            one: {
                type: protocol_1.PropType.Number,
                expandable: false,
    ...
    it('should handle deletions even of the query asks for such props', () => {
        const result = (0, state_serializer_1.deeplySerializeSelectedProperties)(dir2, [
            {
                name: 'one',
                children: [],
            },
    ...
    it('should work with getters with specified query', () => {
        const result = (0, state_serializer_1.deeplySerializeSelectedProperties)({
            get foo() {
                return {
                    baz: {
                        qux: 3,
    ...
    it('should preview the undefined values correctly', () => {
        const result = (0, state_serializer_1.deeplySerializeSelectedProperties)({ obj: undefined }, []);
        expect(result).toEqual({
            obj: {
                type: protocol_1.PropType.Undefined,
                editable: true,
    ...
    it('getDescriptor should get the descriptors for both getters and setters correctly from the prototype', () => {
        ...
        const descriptorFoo = (0, object_utils_1.getDescriptor)(instance, 'foo');
        ...
        const descriptorBar = (0, object_utils_1.getDescriptor)(instance, 'bar');
        ...
        const descriptorBaz = (0, object_utils_1.getDescriptor)(instance, 'baz');
    ...
    it('getKeys should all keys including getters and setters', () => {
        ...
        expect((0, object_utils_1.getKeys)(instance)).toEqual(['baz', 'foo', 'bar']);
    });
    it('getKeys should not throw on empty object without prototype', () => {
        // creates an object without a prototype
        const instance = Object.create(null);
        expect((0, object_utils_1.getKeys)(instance)).toEqual([]);
    });
    it('getKeys would ignore getters and setters for "__proto__"', () => {
        const instance = {
            baz: 2,
            __proto__: {
                set __proto__(newObj) { },
                get __proto__() {
                    return {};
                },
            },
        };
        expect((0, object_utils_1.getKeys)(instance)).toEqual(['baz']);
    });
});
