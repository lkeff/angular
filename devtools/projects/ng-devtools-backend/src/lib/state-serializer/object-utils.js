...
function getKeys(obj) {
    ...
    obj = (0, utils_1.unwrapSignal)(obj);
    const properties = Object.getOwnPropertyNames(obj);
    // Object.getPrototypeOf can return null, on empty objectwithout prototype for example
    const prototypeMembers = Object.getOwnPropertyDescriptors((_a = Object.getPrototypeOf(obj)) !== null && _a !== void 0 ? _a : {});
 ...
 */
const getDescriptor = (instance, propName) => Object.getOwnPropertyDescriptor(instance, propName) ||
