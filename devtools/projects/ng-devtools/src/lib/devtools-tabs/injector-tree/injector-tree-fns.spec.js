...
describe('getInjectorIdsToRootFromNode', () => {
    it('should be able to get ids from a node', () => {
        ...
        expect((0, injector_tree_fns_1.getInjectorIdsToRootFromNode)(root)).toEqual(['1']);
        expect((0, injector_tree_fns_1.getInjectorIdsToRootFromNode)(child)).toEqual(['2', '1']);
        expect((0, injector_tree_fns_1.getInjectorIdsToRootFromNode)(grandChild)).toEqual(['3', '2', '1']);
    });
});
describe('generateEdgeIdsFromNodeIds', () => {
    it('should be able to generate edge ids from node ids', () => {
        const injectorIds = ['1', '2', '3'];
        expect((0, injector_tree_fns_1.generateEdgeIdsFromNodeIds)(injectorIds)).toEqual(['1-to-2', '2-to-3']);
    });
    it('should be able to generate edge ids from node ids with 1 id', () => {
        const injectorIds = ['1'];
        expect((0, injector_tree_fns_1.generateEdgeIdsFromNodeIds)(injectorIds)).toEqual([]);
    });
});
describe('equalInjector', () => {
    it('should be able to compare injectors', () => {
        ...
        expect((0, injector_tree_fns_1.equalInjector)(injector1, injector2)).toEqual(true);
        expect((0, injector_tree_fns_1.equalInjector)(injector2, injector1)).toEqual(true);
        expect((0, injector_tree_fns_1.equalInjector)(injector1, injector3)).toEqual(false);
        expect((0, injector_tree_fns_1.equalInjector)(injector3, injector1)).toEqual(false);
        expect((0, injector_tree_fns_1.equalInjector)(injector2, injector3)).toEqual(false);
        expect((0, injector_tree_fns_1.equalInjector)(injector3, injector2)).toEqual(false);
    });
});
describe('transformInjectorResolutionPathsIntoTree', () => {
    it('should be able to transform injector paths to a d3 tree', () => {
        ...
        expect((0, injector_tree_fns_1.transformInjectorResolutionPathsIntoTree)(injectorPaths)).toEqual(expected);
    });
});
...
describe('grabInjectorPathsFromDirectiveForest', () => {
    it('should be able to get a list of injector paths from a directive forest', () => {
        ...
        expect((0, injector_tree_fns_1.grabInjectorPathsFromDirectiveForest)(directiveForest)).toEqual(expectedInjectorPaths);
    });
});
