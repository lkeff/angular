...
exports.InjectorProvidersComponent = void 0;
...
let InjectorProvidersComponent = (() => {
    ...
    let _classThis;
    var InjectorProvidersComponent = _classThis = class {
        constructor() {
            this.injector = core_1.input.required();
            this.providers = (0, core_1.input)([]);
            this.searchToken = (0, core_1.signal)('');
            this.searchType = (0, core_1.signal)('');
            this.visibleProviders = (0, core_1.computed)(() => {
                ...
                return this.providers().filter((provider) => predicates.every((predicate) => predicate(provider)));
            });
        ...
        get displayedColumns() {
            var _a;
            if (((_a = this.injector()) === null || _a === void 0 ? void 0 : _a.type) === 'element') {
                return ['token', 'type', 'isViewProvider', 'log'];
            }
            return ['token', 'type', 'log'];
        }
    };
    __setFunctionName(_classThis, "InjectorProvidersComponent");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        InjectorProvidersComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return InjectorProvidersComponent = _classThis;
})();
exports.InjectorProvidersComponent = InjectorProvidersComponent;
