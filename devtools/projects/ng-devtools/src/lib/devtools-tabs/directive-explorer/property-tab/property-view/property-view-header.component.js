...
exports.PropertyViewHeaderComponent = void 0;
...
let PropertyViewHeaderComponent = (() => {
    let _classDecorators = [(0, core_1.Component)({
            ...
            imports: [toolbar_1.MatToolbar, tooltip_1.MatTooltip, icon_1.MatIcon],
        })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var PropertyViewHeaderComponent = _classThis = class {
        constructor() {
            ...
            this.disableViewSourceButton = (0, core_1.computed)(() => {
    ...
    __setFunctionName(_classThis, "PropertyViewHeaderComponent");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        PropertyViewHeaderComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PropertyViewHeaderComponent = _classThis;
})();
exports.PropertyViewHeaderComponent = PropertyViewHeaderComponent;
