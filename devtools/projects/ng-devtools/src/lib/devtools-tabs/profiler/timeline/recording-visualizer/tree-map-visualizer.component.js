...
exports.TreeMapVisualizerComponent = void 0;
const core_1 = require("@angular/core");
const rxjs_1 = require("rxjs");
const operators_1 = require("rxjs/operators");
const treemap_1 = require("../../../../vendor/webtreemap/treemap");
const tree_map_formatter_1 = require("../record-formatter/tree-map-formatter");
let TreeMapVisualizerComponent = (() => {
    ...
    let _classThis;
    var TreeMapVisualizerComponent = _classThis = class {
        constructor() {
            this._formatter = new tree_map_formatter_1.TreeMapFormatter();
            this.frame = core_1.input.required();
            this._ngZone = (0, core_1.inject)(core_1.NgZone);
            this.resize$ = new rxjs_1.Subject();
            this._resizeObserver = new ResizeObserver(() => this._ngZone.run(() => this.resize$.next()));
            this.treeMapRecords = (0, core_1.computed)(() => {
                // first element in data is the Application node
                return this._formatter.formatFrame(this.frame());
            });
            this.tree = core_1.viewChild.required('webTree');
            (0, core_1.effect)(() => {
                if (this.tree())
                    this._renderTree();
            });
        ...
        _createTree() {
            (0, treemap_1.render)(this.tree().nativeElement, this.treeMapRecords(), {
                padding: [20, 5, 5, 5],
    ...
    __setFunctionName(_classThis, "TreeMapVisualizerComponent");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        TreeMapVisualizerComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TreeMapVisualizerComponent = _classThis;
})();
exports.TreeMapVisualizerComponent = TreeMapVisualizerComponent;
