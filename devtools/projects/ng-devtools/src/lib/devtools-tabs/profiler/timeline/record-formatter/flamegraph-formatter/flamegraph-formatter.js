...
exports.FlamegraphFormatter = exports.ROOT_LEVEL_ELEMENT_LABEL = void 0;
const record_formatter_1 = require("../record-formatter");
exports.ROOT_LEVEL_ELEMENT_LABEL = 'Entire application';
class FlamegraphFormatter extends record_formatter_1.RecordFormatter {
    formatFrame(frame, showChangeDetection, theme) {
        const result = {
            value: 0,
            label: exports.ROOT_LEVEL_ELEMENT_LABEL,
            children: [],
            instances: 1,
...
exports.FlamegraphFormatter = FlamegraphFormatter;
