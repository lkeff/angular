...
exports.createFilter = exports.parseFilter = exports.noopFilter = void 0;
const noopFilter = (_) => true;
...
class DurationQuery {
    ...
    parseArguments([arg]) {
        var _a;
        arg = arg.trim();
        const operator = ((_a = arg.match(operatorRe)) !== null && _a !== void 0 ? _a : [null])[0];
        if (!operator) {
            return undefined;
        }
...
const queryRe = new RegExp(`!?s*(${"duration" /* QueryType.Duration */}|${"source" /* QueryType.Source */})$`, 'g');
/**
...
const createFilter = (query) => {
    const queries = (0, exports.parseFilter)(query);
    return (frame) => {
