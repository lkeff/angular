...
let FrameManager = (() => {
    ...
    let _classThis;
    var FrameManager = _classThis = class {
        constructor() {
            this._selectedFrameId = (0, core_1.signal)(null);
            this._frames = (0, core_1.signal)(new Map());
            this._inspectedWindowTabId = null;
            this._frameUrlToFrameIds = new Map();
            this._messageBus = (0, core_1.inject)(protocol_1.MessageBus);
            this.frames = (0, core_1.computed)(() => Array.from(this._frames().values()));
            this.selectedFrame = (0, core_1.computed)(() => {
                var _a;
                const selectedFrameId = this._selectedFrameId();
                if (selectedFrameId === null) {
                    return null;
                }
                return (_a = this._frames().get(selectedFrameId)) !== null && _a !== void 0 ? _a : null;
            });
            this.topLevelFrameIsActive = (0, core_1.computed)(() => {
                return this._selectedFrameId() === application_environment_1.TOP_LEVEL_FRAME_ID;
            });
            this.activeFrameHasUniqueUrl = (0, core_1.computed)(() => {
        ...
        initialize(inspectedWindowTabIdTestOnly) {
            ...
            this._messageBus.on('contentScriptDisconnected', (frameId) => {
                ...
                if (frameId === selectedFrameId) {
                    this._selectedFrameId.set(application_environment_1.TOP_LEVEL_FRAME_ID);
                    this.inspectFrame(this._frames().get(application_environment_1.TOP_LEVEL_FRAME_ID));
                    return;
                }
            });
        }
        ...
        frameHasUniqueUrl(frame) {
            ...
            const frameIds = (_a = this._frameUrlToFrameIds.get(frameUrl)) !== null && _a !== void 0 ? _a : new Set();
        ...
        addFrame(frame) {
            this._frames.update((frames) => {
                ...
                const frameUrl = frame.url.toString();
                const frameIdSet = (_a = this._frameUrlToFrameIds.get(frameUrl)) !== null && _a !== void 0 ? _a : new Set();
        ...
        removeFrame(frame) {
            ...
            const frameUrl = frame.url.toString();
            const urlFrameIds = (_a = this._frameUrlToFrameIds.get(frameUrl)) !== null && _a !== void 0 ? _a : new Set();
    ...
    __setFunctionName(_classThis, "FrameManager");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        FrameManager = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FrameManager = _classThis;
})();
