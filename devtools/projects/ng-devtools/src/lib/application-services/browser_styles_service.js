...
exports.BrowserStylesService = void 0;
...
let BrowserStylesService = (() => {
    ...
    let _classThis;
    var BrowserStylesService = _classThis = class {
        constructor() {
            this.doc = (0, core_1.inject)(common_1.DOCUMENT);
            this.rendererFactory = (0, core_1.inject)(core_1.RendererFactory2);
    ...
    __setFunctionName(_classThis, "BrowserStylesService");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        BrowserStylesService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return BrowserStylesService = _classThis;
})();
exports.BrowserStylesService = BrowserStylesService;
