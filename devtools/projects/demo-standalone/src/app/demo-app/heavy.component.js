...
let HeavyComponent = (() => {
    let _classDecorators = [(0, core_1.Component)({ selector: 'app-heavy', template: `<h1>{{ calculate() }}</h1>` })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _instanceExtraInitializers = [];
    let _set_foo_decorators;
    var HeavyComponent = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "HeavyComponent");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _set_foo_decorators = [(0, core_1.Input)()];
        ...
        HeavyComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return HeavyComponent = _classThis;
})();
