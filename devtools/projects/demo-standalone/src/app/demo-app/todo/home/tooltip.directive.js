...
let TooltipDirective = (() => {
    let _classDecorators = [(0, core_1.Directive)({ selector: '[appTooltip]' })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _instanceExtraInitializers = [];
    let _handleClick_decorators;
    var TooltipDirective = _classThis = class {
        constructor() {
            this.visible = (__runInitializers(this, _instanceExtraInitializers), false);
            this.nested = {
                child: {
                    grandchild: {
                        prop: 1,
    ...
    __setFunctionName(_classThis, "TooltipDirective");
    (() => {
        ...
        TooltipDirective = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TooltipDirective = _classThis;
})();
